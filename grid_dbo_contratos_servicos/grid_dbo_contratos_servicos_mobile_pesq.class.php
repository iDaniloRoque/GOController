...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idcontratos_servicos";$Nm_numeric[] = "idcontratos";$Nm_numeric[] = "idservico";$Nm_numeric[] = "idcontratos_servicos";$Nm_numeric[] = "idcontratos";$Nm_numeric[] = "idservico";
...
<HTML>
<HEAD>
 <TITLE> dbo.contratos_servicos</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idcontratos_servicos_cond" name="idcontratos_servicos_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcontratos_servicos'), this, 'idcontratos_servicos')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idcontratos_cond" name="idcontratos_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcontratos'), this, 'idcontratos')">
      ...
      <br><span id="id_hide_idcontratos"  <?php echo $str_hide_idcontratos?>><INPUT  type="text" id="SC_idcontratos" name="idcontratos" value="<?php echo NM_encode_input($idcontratos) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idservico_cond" name="idservico_cond" onChange="nm_campos_between(document.getElementById('id_vis_idservico'), this, 'idservico')">
      ...
      <br><span id="id_hide_idservico"  <?php echo $str_hide_idservico?>><INPUT  type="text" id="SC_idservico" name="idservico" value="<?php echo NM_encode_input($idservico) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
