...
class grid_dbo_contratos_servicos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_dbo_contratos_servicos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_dbo_contratos_servicos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_dbo_contratos_servicos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         $nome_sum = "dbo.contratos_servicos.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> dbo.contratos_servicos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_dbo_contratos_servicos/grid_dbo_contratos_servicos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_dbo_contratos_servicos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_dbo_contratos_servicos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_dbo_contratos_servicos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_dbo_contratos_servicos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_dbo_contratos_servicos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idcontratos_servicos_cond#NMF#' + search_get_sel_txt('SC_idcontratos_servicos_cond') + '@NMF@';
  str_out += 'SC_idcontratos_servicos#NMF#' + search_get_text('SC_idcontratos_servicos') + '@NMF@';
  str_out += 'SC_idcontratos_cond#NMF#' + search_get_sel_txt('SC_idcontratos_cond') + '@NMF@';
  str_out += 'SC_idcontratos#NMF#' + search_get_text('SC_idcontratos') + '@NMF@';
  str_out += 'SC_idservico_cond#NMF#' + search_get_sel_txt('SC_idservico_cond') + '@NMF@';
  str_out += 'SC_idservico#NMF#' + search_get_text('SC_idservico') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> dbo.contratos_servicos</div>
...
<?php
   ...
   {
      global 
             $idcontratos_servicos_cond, $idcontratos_servicos,
             $idcontratos_cond, $idcontratos,
             $idservico_cond, $idservico,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $idcontratos_servicos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idcontratos_servicos']; 
          $idcontratos_servicos_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idcontratos_servicos_cond']; 
          $idcontratos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idcontratos']; 
          $idcontratos_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idcontratos_cond']; 
          $idservico = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idservico']; 
          $idservico_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idservico_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['NM_operador']; 
          if (strtoupper($idcontratos_servicos_cond) != "II" && strtoupper($idcontratos_servicos_cond) != "QP" && strtoupper($idcontratos_servicos_cond) != "NP" && strtoupper($idcontratos_servicos_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idcontratos_servicos, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($idcontratos_cond) != "II" && strtoupper($idcontratos_cond) != "QP" && strtoupper($idcontratos_cond) != "NP" && strtoupper($idcontratos_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idcontratos, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($idservico_cond) != "II" && strtoupper($idservico_cond) != "QP" && strtoupper($idservico_cond) != "NP" && strtoupper($idservico_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idservico, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($idcontratos_servicos_cond) || empty($idcontratos_servicos_cond))
      {
         $idcontratos_servicos_cond = "gt";
      }
      if (!isset($idcontratos_cond) || empty($idcontratos_cond))
      {
         $idcontratos_cond = "gt";
      }
      if (!isset($idservico_cond) || empty($idservico_cond))
      {
         $idservico_cond = "gt";
      }
      ...
      $str_hide_idcontratos_servicos = (in_array($idcontratos_servicos_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idcontratos = (in_array($idcontratos_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idservico = (in_array($idservico_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($idcontratos_servicos) || $idcontratos_servicos == "")
      {
          $idcontratos_servicos = "";
      }
      if (isset($idcontratos_servicos) && !empty($idcontratos_servicos))
      {
         $tmp_pos = strpos($idcontratos_servicos, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idcontratos_servicos = substr($idcontratos_servicos, 0, $tmp_pos);
         }
      }
      if (!isset($idcontratos) || $idcontratos == "")
      {
          $idcontratos = "";
      }
      if (isset($idcontratos) && !empty($idcontratos))
      {
      ...
      if (isset($idservico) && !empty($idservico))
      {
         $tmp_pos = strpos($idservico, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idservico = substr($idservico, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idcontratos_servicos_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idcontratos_servicos'])) ? $this->New_label['idcontratos_servicos'] : "Código"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idcontratos_servicos_cond" name="idcontratos_servicos_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcontratos_servicos'), this, 'idcontratos_servicos')">
       <OPTION value="gt" <?php if ("gt" == $idcontratos_servicos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idcontratos_servicos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idcontratos_servicos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idcontratos_servicos" <?php echo $str_hide_idcontratos_servicos?> valign="top">
 ...
 $nmgp_tab_label .= "idcontratos_servicos?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_idcontratos_servicos" name="idcontratos_servicos" value="<?php echo NM_encode_input($idcontratos_servicos) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_idcontratos_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idcontratos'])) ? $this->New_label['idcontratos'] : "Contratada"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idcontratos_cond" name="idcontratos_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcontratos'), this, 'idcontratos')">
       <OPTION value="gt" <?php if ("gt" == $idcontratos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idcontratos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idcontratos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idcontratos" <?php echo $str_hide_idcontratos?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idcontratos'])) ? $this->New_label['idcontratos'] : "Contratada";
 $nmgp_tab_label .= "idcontratos?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idcontratos" name="idcontratos" value="<?php echo NM_encode_input($idcontratos) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_idservico_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idservico'])) ? $this->New_label['idservico'] : "Id Servico"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idservico_cond" name="idservico_cond" onChange="nm_campos_between(document.getElementById('id_vis_idservico'), this, 'idservico')">
       <OPTION value="gt" <?php if ("gt" == $idservico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idservico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idservico_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idservico" <?php echo $str_hide_idservico?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idservico'])) ? $this->New_label['idservico'] : "Id Servico";
 $nmgp_tab_label .= "idservico?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idservico" name="idservico" value="<?php echo NM_encode_input($idservico) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_dbo_contratos_servicos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_dbo_contratos_servicos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_dbo_contratos_servicos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idcontratos_servicos_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idcontratos_servicos'), document.F1.idcontratos_servicos_cond, 'idcontratos_servicos');
   document.F1.idcontratos_servicos.value = "";
   document.F1.idcontratos_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idcontratos'), document.F1.idcontratos_cond, 'idcontratos');
   document.F1.idcontratos.value = "";
   document.F1.idservico_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idservico'), document.F1.idservico_cond, 'idservico');
   document.F1.idservico.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_dbo_contratos_servicos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idcontratos_servicos_cond'] = 'cond';
      $tp_fields['SC_idcontratos_servicos'] = 'text';
      $tp_fields['SC_idcontratos_cond'] = 'cond';
      $tp_fields['SC_idcontratos'] = 'text';
      $tp_fields['SC_idservico_cond'] = 'cond';
      $tp_fields['SC_idservico'] = 'text';
   ...
   {
      global $idcontratos_servicos_cond, $idcontratos_servicos,
             $idcontratos_cond, $idcontratos,
             $idservico_cond, $idservico, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $idcontratos_servicos_cond_salva = $idcontratos_servicos_cond; 
      if (!isset($idcontratos_servicos_input_2) || $idcontratos_servicos_input_2 == "")
      {
          $idcontratos_servicos_input_2 = $idcontratos_servicos;
      }
      $idcontratos_cond_salva = $idcontratos_cond; 
      if (!isset($idcontratos_input_2) || $idcontratos_input_2 == "")
      {
          $idcontratos_input_2 = $idcontratos;
      }
      $idservico_cond_salva = $idservico_cond; 
      if (!isset($idservico_input_2) || $idservico_input_2 == "")
      {
          $idservico_input_2 = $idservico;
      }
      if ($idcontratos_servicos_cond != "in")
      {
          nm_limpa_numero($idcontratos_servicos, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idcontratos_cond != "in")
      {
          nm_limpa_numero($idcontratos, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idservico_cond != "in")
      {
          nm_limpa_numero($idservico, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idcontratos_servicos'] = $idcontratos_servicos; 
      if (is_array($idcontratos_servicos) && !empty($idcontratos_servicos))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['val'][0] = $idcontratos_servicos;
      }
      elseif ($idcontratos_servicos_cond_salva == "nu" || $idcontratos_servicos_cond_salva == "nn" || $idcontratos_servicos_cond_salva == "ep" || $idcontratos_servicos_cond_salva == "ne" || !empty($idcontratos_servicos))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['val'][0][0] = $idcontratos_servicos;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idcontratos_servicos_cond'] = $idcontratos_servicos_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['cmp'] = "idcontratos_servicos"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['opc'] = $idcontratos_servicos_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq']['idcontratos_servicos'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idcontratos'] = $idcontratos; 
      if (is_array($idcontratos) && !empty($idcontratos))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['val'][0] = $idcontratos;
      }
      elseif ($idcontratos_cond_salva == "nu" || $idcontratos_cond_salva == "nn" || $idcontratos_cond_salva == "ep" || $idcontratos_cond_salva == "ne" || !empty($idcontratos))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['val'][0][0] = $idcontratos;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idcontratos_cond'] = $idcontratos_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['cmp'] = "idcontratos"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['opc'] = $idcontratos_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq']['idcontratos'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idservico'] = $idservico; 
      if (is_array($idservico) && !empty($idservico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['val'][0] = $idservico;
      }
      elseif ($idservico_cond_salva == "nu" || $idservico_cond_salva == "nn" || $idservico_cond_salva == "ep" || $idservico_cond_salva == "ne" || !empty($idservico))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['val'][0][0] = $idservico;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['idservico_cond'] = $idservico_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['cmp'] = "idservico"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid]['opc'] = $idservico_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['grid_pesq']['idservico'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $idcontratos_servicos;
      if (strtoupper($idcontratos_servicos_cond) != "II" && strtoupper($idcontratos_servicos_cond) != "QP" && strtoupper($idcontratos_servicos_cond) != "NP" && strtoupper($idcontratos_servicos_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idcontratos_servicos'] = $Conteudo;
      $Conteudo = $idcontratos;
      if (strtoupper($idcontratos_cond) != "II" && strtoupper($idcontratos_cond) != "QP" && strtoupper($idcontratos_cond) != "NP" && strtoupper($idcontratos_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idcontratos'] = $Conteudo;
      $Conteudo = $idservico;
      if (strtoupper($idservico_cond) != "II" && strtoupper($idservico_cond) != "QP" && strtoupper($idservico_cond) != "NP" && strtoupper($idservico_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idservico'] = $Conteudo;

      //----- $idcontratos_servicos
      $this->Date_part = false;
      if (isset($idcontratos_servicos) || $idcontratos_servicos_cond == "nu" || $idcontratos_servicos_cond == "nn" || $idcontratos_servicos_cond == "ep" || $idcontratos_servicos_cond == "ne")
      {
         $this->monta_condicao("idContratos_servicos", $idcontratos_servicos_cond, $idcontratos_servicos, "", "idcontratos_servicos");
      }

      //----- $idcontratos
      $this->Date_part = false;
      if (isset($idcontratos) || $idcontratos_cond == "nu" || $idcontratos_cond == "nn" || $idcontratos_cond == "ep" || $idcontratos_cond == "ne")
      {
         $this->monta_condicao("idContratos", $idcontratos_cond, $idcontratos, "", "idcontratos");
      }

      //----- $idservico
      $this->Date_part = false;
      if (isset($idservico) || $idservico_cond == "nu" || $idservico_cond == "nn" || $idservico_cond == "ep" || $idservico_cond == "ne")
      {
         $this->monta_condicao("idServico", $idservico_cond, $idservico, "", "idservico");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_contratos_servicos']['cond_pesq'] .= $this->NM_operador;
