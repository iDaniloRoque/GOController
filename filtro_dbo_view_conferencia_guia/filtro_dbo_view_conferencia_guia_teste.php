<?php  
  ...
  session_start() ;
  class filtro_dbo_view_conferencia_guia_form_teste
  {
   function filtro_dbo_view_conferencia_guia_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "filtro_dbo_view_conferencia_guia/img";
...
?> 
<br> 
<B><FONT SIZE="4">filtro_dbo_view_conferencia_guia</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="filtro_dbo_view_conferencia_guia"> 
</form> 
...
<?php
  ...
  $frm_teste = new filtro_dbo_view_conferencia_guia_form_teste();
  $frm_teste->filtro_dbo_view_conferencia_guia_teste();
?>
