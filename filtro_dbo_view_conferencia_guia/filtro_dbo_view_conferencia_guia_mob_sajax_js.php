  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_filtro_dbo_view_conferencia_guia_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_filtro_dbo_view_conferencia_guia_mob_form();
	}
...
?>
  ...
  // ---------- Validate idpessoas
  function do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_idpessoas()
  {
    var nomeCampo_idpessoas = "idpessoas";
    var var_idpessoas = scAjaxGetFieldSelect(nomeCampo_idpessoas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_dbo_view_conferencia_guia_mob_validate_idpessoas(var_idpessoas, var_script_case_init, do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_idpessoas_cb);
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_idpessoas

  function do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_idpessoas_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_idpessoas_cb

  // ---------- Validate data_inicial
  function do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_inicial()
  {
    var nomeCampo_data_inicial = "data_inicial";
    var var_data_inicial = scAjaxGetFieldText(nomeCampo_data_inicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_inicial(var_data_inicial, var_script_case_init, do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_inicial_cb);
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_inicial

  function do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_inicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_inicial_cb

  // ---------- Validate data_final
  function do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_final()
  {
    var nomeCampo_data_final = "data_final";
    var var_data_final = scAjaxGetFieldText(nomeCampo_data_final);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_final(var_data_final, var_script_case_init, do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_final_cb);
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_final

  function do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_final_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_validate_data_final_cb

  // ---------- Refresh idpessoas
  function do_ajax_filtro_dbo_view_conferencia_guia_mob_refresh_idpessoas()
  {
    var var_idpessoas = scAjaxGetFieldSelect("idpessoas");
    var var_nmgp_refresh_fields = "data_inicial";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_filtro_dbo_view_conferencia_guia_mob_refresh_idpessoas(var_idpessoas, var_nmgp_refresh_fields, var_script_case_init, do_ajax_filtro_dbo_view_conferencia_guia_mob_refresh_idpessoas_cb);
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_refresh_idpessoas

  function do_ajax_filtro_dbo_view_conferencia_guia_mob_refresh_idpessoas_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_refresh_idpessoas_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_filtro_dbo_view_conferencia_guia_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_filtro_dbo_view_conferencia_guia_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpessoas = scAjaxGetFieldSelect("idpessoas");
    ...
    scAjaxProcOn();
    x_ajax_filtro_dbo_view_conferencia_guia_mob_submit_form(var_idpessoas, var_data_inicial, var_data_final, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_filtro_dbo_view_conferencia_guia_mob_submit_form_cb);
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_submit_form

  function do_ajax_filtro_dbo_view_conferencia_guia_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_filtro_dbo_view_conferencia_guia_mob_submit_form_cb_after_alert);
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_submit_form_cb
  function do_ajax_filtro_dbo_view_conferencia_guia_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_filtro_dbo_view_conferencia_guia_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_filtro_dbo_view_conferencia_guia_mob_navigate_form, function() {});
    } else {
      perform_ajax_filtro_dbo_view_conferencia_guia_mob_navigate_form();
    }
  }

  function perform_ajax_filtro_dbo_view_conferencia_guia_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['filtro_dbo_view_conferencia_guia_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_filtro_dbo_view_conferencia_guia_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_filtro_dbo_view_conferencia_guia_mob_navigate_form_cb_after_alert);
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_navigate_form_cb
  function do_ajax_filtro_dbo_view_conferencia_guia_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_filtro_dbo_view_conferencia_guia_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_filtro_dbo_view_conferencia_guia_mob_navigate_form_cb_after_alert
  function sc_hide_filtro_dbo_view_conferencia_guia_mob_form()
  {
