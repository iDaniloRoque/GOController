<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idpesssoas_impostos_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idpesssoas_impostos_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_dbo_pessoa_juridica_fisica_impostos"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_dbo_pessoa_juridica_fisica_impostos_submit_form(y, z);
