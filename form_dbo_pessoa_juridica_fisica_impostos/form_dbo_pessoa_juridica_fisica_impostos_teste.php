<?php  
  ...
  session_start() ;
  class form_dbo_pessoa_juridica_fisica_impostos_form_teste
  {
   function form_dbo_pessoa_juridica_fisica_impostos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_dbo_pessoa_juridica_fisica_impostos/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_dbo_pessoa_juridica_fisica_impostos</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_dbo_pessoa_juridica_fisica_impostos"> 
</form> 
<script language=javascript> 
 document.Fedit.usr_idPessoas.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_dbo_pessoa_juridica_fisica_impostos_form_teste();
  $frm_teste->form_dbo_pessoa_juridica_fisica_impostos_teste();
?>
