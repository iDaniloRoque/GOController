...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idempresa";$Nm_numeric[] = "cnpj";$Nm_numeric[] = "idempresa";$Nm_numeric[] = "cnpj";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idempresa_cond" name="idempresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_idempresa'), this, 'idempresa')">
      ...
      <br><span id="id_hide_idempresa"  <?php echo $str_hide_idempresa?>><INPUT  type="text" id="SC_idempresa" name="idempresa" value="<?php echo NM_encode_input($idempresa) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_descricaoempresa_cond" name="descricaoempresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_descricaoempresa'), this, 'descricaoempresa')">
      ...
      <br><span id="id_hide_descricaoempresa"  <?php echo $str_hide_descricaoempresa?>><?php
      if ($descricaoempresa != "")
      {
      $descricaoempresa_look = substr($this->Db->qstr($descricaoempresa), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cnpj_cond" name="cnpj_cond" onChange="nm_campos_between(document.getElementById('id_vis_cnpj'), this, 'cnpj')">
      ...
      <br><span id="id_hide_cnpj"  <?php echo $str_hide_cnpj?>><INPUT  type="text" id="SC_cnpj" name="cnpj" value="<?php echo NM_encode_input($cnpj) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
