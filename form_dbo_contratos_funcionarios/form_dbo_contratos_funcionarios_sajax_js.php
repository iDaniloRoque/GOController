  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_contratos_funcionarios" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_contratos_funcionarios_form();
	}
...
?>
  ...
  // ---------- Validate idsocios_
  function do_ajax_form_dbo_contratos_funcionarios_validate_idsocios_(iNumLinha)
  {
    var nomeCampo_idsocios_ = "idsocios_" + iNumLinha;
    var var_idsocios_ = scAjaxGetFieldSelect(nomeCampo_idsocios_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_funcionarios_validate_idsocios_(var_idsocios_, iNumLinha, var_script_case_init, do_ajax_form_dbo_contratos_funcionarios_validate_idsocios__cb);
  } // do_ajax_form_dbo_contratos_funcionarios_validate_idsocios_

  function do_ajax_form_dbo_contratos_funcionarios_validate_idsocios__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_funcionarios_validate_idsocios__cb

  // ---------- Validate idcontratos_funcionarios_
  function do_ajax_form_dbo_contratos_funcionarios_validate_idcontratos_funcionarios_(iNumLinha)
  {
    var nomeCampo_idcontratos_funcionarios_ = "idcontratos_funcionarios_" + iNumLinha;
    var var_idcontratos_funcionarios_ = scAjaxGetFieldHidden(nomeCampo_idcontratos_funcionarios_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_funcionarios_validate_idcontratos_funcionarios_(var_idcontratos_funcionarios_, iNumLinha, var_script_case_init, do_ajax_form_dbo_contratos_funcionarios_validate_idcontratos_funcionarios__cb);
  } // do_ajax_form_dbo_contratos_funcionarios_validate_idcontratos_funcionarios_

  function do_ajax_form_dbo_contratos_funcionarios_validate_idcontratos_funcionarios__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idcontratos_funcionarios_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idcontratos_funcionarios_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idcontratos_funcionarios_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idcontratos_funcionarios_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_funcionarios_validate_idcontratos_funcionarios__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_contratos_funcionarios_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_contratos_funcionarios_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_contratos_funcionarios_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_contratos_funcionarios_add_new_line_cb);
  } // do_ajax_form_dbo_contratos_funcionarios_add_new_line

  function do_ajax_form_dbo_contratos_funcionarios_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_dbo_contratos_funcionarios_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_contratos_funcionarios_backup_line(iNumLinha)
  {
    var var_idcontratos_funcionarios_ = scAjaxGetFieldHidden("idcontratos_funcionarios_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_funcionarios_backup_line(var_idcontratos_funcionarios_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_contratos_funcionarios_backup_line_cb);
  } // do_ajax_form_dbo_contratos_funcionarios_backup_line

  function do_ajax_form_dbo_contratos_funcionarios_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_dbo_contratos_funcionarios_backup_line_cb

  function do_ajax_form_dbo_contratos_funcionarios_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_contratos_funcionarios_cancel_insert

  function do_ajax_form_dbo_contratos_funcionarios_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_contratos_funcionarios_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_contratos_funcionarios_cancel_update

  function do_ajax_form_dbo_contratos_funcionarios_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_contratos_funcionarios_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_contratos_funcionarios_table_refresh()
  {
    var var_idcontratos_funcionarios_ = document.F2.idcontratos_funcionarios_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_contratos_funcionarios_table_refresh(var_idcontratos_funcionarios_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_contratos_funcionarios_table_refresh_cb);
  } //  do_ajax_form_dbo_contratos_funcionarios_table_refresh

  function do_ajax_form_dbo_contratos_funcionarios_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idcontratos_funcionarios_.value = scAjaxGetKeyValue("idcontratos_funcionarios_");
    ...
    scAjaxAlert(do_ajax_form_dbo_contratos_funcionarios_table_refresh_cb_after_alert);
  } // do_ajax_form_dbo_contratos_funcionarios_table_refresh_cb
  function do_ajax_form_dbo_contratos_funcionarios_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_contratos_funcionarios_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_contratos_funcionarios_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_dbo_contratos_funcionarios_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_idsocios_ = scAjaxGetFieldSelect("idsocios_" + iNumLinha);
    var var_idcontratos_funcionarios_ = scAjaxGetFieldHidden("idcontratos_funcionarios_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_dbo_contratos_funcionarios_submit_form(var_idsocios_, var_idcontratos_funcionarios_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_contratos_funcionarios_submit_form_cb);
  } // do_ajax_form_dbo_contratos_funcionarios_submit_form

  function do_ajax_form_dbo_contratos_funcionarios_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("idcontratos_funcionarios_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_contratos_funcionarios_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_contratos_funcionarios_submit_form_cb
  function do_ajax_form_dbo_contratos_funcionarios_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_contratos_funcionarios_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_contratos_funcionarios_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_contratos_funcionarios_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_contratos_funcionarios_navigate_form();
    }
  }

  function perform_ajax_form_dbo_contratos_funcionarios_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_contratos_funcionarios_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("idcontratos_funcionarios_" + iNavForm);
    }
    var var_idcontratos_funcionarios_ = document.F2.idcontratos_funcionarios_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_contratos_funcionarios_navigate_form(var_idcontratos_funcionarios_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_contratos_funcionarios_navigate_form_cb);
  } // do_ajax_form_dbo_contratos_funcionarios_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_contratos_funcionarios']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_contratos_funcionarios_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcontratos_funcionarios_.value = scAjaxGetKeyValue("idcontratos_funcionarios_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_contratos_funcionarios_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_contratos_funcionarios_navigate_form_cb
  function do_ajax_form_dbo_contratos_funcionarios_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_dbo_contratos_funcionarios_navigate_form_cb_after_alert
  function sc_hide_form_dbo_contratos_funcionarios_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idcontratos_funcionarios_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idsocios_" + iNumLinha] = {"label": "Sócios/Funcionários<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idcontratos_funcionarios_" + iNumLinha] = {"label": "Codigo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idsocios_"][iNumLinha] = "idsocios_" + iNumLinha;
    ajax_field_mult["idcontratos_funcionarios_"][iNumLinha] = "idcontratos_funcionarios_" + iNumLinha;
    ajax_field_id["idsocios_" + iNumLinha] = new Array("hidden_field_label_idsocios_", "hidden_field_data_idsocios_" + iNumLinha);
    ajax_error_count["idsocios_" + iNumLinha] = "off";
    ajax_error_count["idcontratos_funcionarios_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idsocios_" + iNumLinha] = "off";
    ajax_read_only["idcontratos_funcionarios_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["idcontratos_funcionarios_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idsocios_": new Array(),
    "idcontratos_funcionarios_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["idcontratos_funcionarios_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idcontratos_funcionarios_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idcontratos_funcionarios_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idcontratos_funcionarios_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idcontratos_funcionarios_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idsocios_'])) ? $this->nmgp_cmp_readonly['idsocios_'] : 'off';
?>
    scAjaxFieldRead("idsocios_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcontratos_funcionarios_'])) ? $this->nmgp_cmp_readonly['idcontratos_funcionarios_'] : 'on';
?>
    scAjaxFieldRead("idcontratos_funcionarios_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idsocios_" + iSeq, "on");
    scAjaxFieldRead("idcontratos_funcionarios_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idsocios_" + iRow] || "on" == ajax_error_count["idcontratos_funcionarios_" + iRow]))
    {
      ...
      $("#hidden_field_data_idcontratos_funcionarios_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idsocios_" + iRow] && "off" == ajax_error_count["idcontratos_funcionarios_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idsocios_" + iRow] = "off";
        ajax_error_count["idcontratos_funcionarios_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idcontratos_funcionarios_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idcontratos_funcionarios_" == sIndex)
    {
