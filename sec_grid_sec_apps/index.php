<?php
   ...
   $_SESSION['scriptcase']['sec_grid_sec_apps']['glo_nm_path_conf']       = "C:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/conf";
   ...
   $_SESSION['scriptcase']['sec_grid_sec_apps']['glo_nm_path_cache']      = "C:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['sec_grid_sec_apps']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9-php73/wwwrootC:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['sec_grid_sec_apps']['glo_nm_conexao']         = "conn_mssql";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sec_grid_sec_apps']['glo_nm_conexao'], $this->root . $this->path_prod, 'Controller', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['sec_grid_sec_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_Controller.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['sec_grid_sec_apps']['glo_nm_path_imag_temp'] . "/sc_apl_default_Controller.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_Controller'])) {
               $_SESSION['scriptcase']['sec_grid_sec_apps']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Controller'];
           }
       }
   }
