...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "momento";$Nm_datas[] = "momento";$Nm_numeric[] = "idpessoas";
...
<HTML>
<HEAD>
 <TITLE> dbo.pessoa_juridica_fisica</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_idpessoas"  <?php echo $str_hide_idpessoas?>>
<?php
