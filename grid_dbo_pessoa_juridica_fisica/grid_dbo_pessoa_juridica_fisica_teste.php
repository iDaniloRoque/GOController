<?php  
  ...
  session_start() ;
  class grid_dbo_pessoa_juridica_fisica_form_teste
  {
  function grid_dbo_pessoa_juridica_fisica_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_dbo_pessoa_juridica_fisica</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_dbo_pessoa_juridica_fisica"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_dbo_pessoa_juridica_fisica_form_teste();
  $frm_teste->grid_dbo_pessoa_juridica_fisica_teste();
?>
