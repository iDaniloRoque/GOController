...
class chart_dbo_view_geral_lancamentos_pizza_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_descricao_especialidade;
   var $array_total_ano;
   var $array_total_mes;
   ...
   var $conv_col;
   var $count_ger;
   var $cnt_descricao_especialidade;
   var $sc_proc_quebra_descricao_especialidade;
   var $count_descricao_especialidade;
   var $cnt_descricao_especialidade_descricao_especialidade;
   var $sc_proc_quebra_ano;
   var $count_ano;
   var $cnt_ano_descricao_especialidade;
   var $sc_proc_quebra_mes;
   var $count_mes;
   var $cnt_mes_descricao_especialidade;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_descricao_especialidade = array();
      $this->array_total_ano                     = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_dbo_view_geral_lancamentos_pizza'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_dbo_view_geral_lancamentos_pizza'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_dbo_view_geral_lancamentos_pizza']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_dbo_view_geral_lancamentos_pizza']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_dbo_view_geral_lancamentos_pizza']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_step']     = 'image';
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_step'] = 'end';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['chart_dbo_view_geral_lancamentos_pizza']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['campos_busca'];
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_combination_type']        = 'column2d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_combination_order_field'] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_combination_order_rule_groupby']["descricao_especialidade"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_combination_order_field_groupby']["descricao_especialidade"] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_combination_order_rule_groupby']["ano"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_combination_order_field_groupby']["ano"] = 'label';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_combination_order_rule_groupby']["mes"]  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_combination_order_field_groupby']["mes"] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_y_axys'][0] = 0;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_y_axys'][1] = 1;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_y_axys'][2] = 2;
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['comb_field_display_type'][2] = '';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_display_values'][2] = null;


           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_order']['sc_free_group_by'][] = 2;
       }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pesq_tab_label']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pesq_tab_label'] = "";
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_search_add']))
      {
          $this->monta_css();
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pesq_tab_label'];
          ...
          $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_search_add']['seq'];
          $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_search_add']['cmp'];
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_search_add']);
          exit;
      }
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("chart_dbo_view_geral_lancamentos_pizza", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['json_use_label'])
       {
          $Lab_descricao_especialidade = "descricao_especialidade";
          $Lab_ano = "Ano";
          $Lab_mes = "mes";
       }
       else
       {
       $Lab_descricao_especialidade = "Descricao Especialidade";
       $Lab_ano = "Ano";
       $Lab_mes = "Mes";
       }
       $prep_field = array();
       $prep_field['descricao_especialidade'] = $Lab_descricao_especialidade;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['descricao_especialidade'] = $Lab_descricao_especialidade; 
       $prep_field['ano'] = $Lab_ano;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['ano'] = $Lab_ano; 
       $prep_field['mes'] = $Lab_mes;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['mes'] = $Lab_mes; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['idfilial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['idfilial'] = "Id Filial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['ano']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['ano'] = "Ano"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['descricao_especialidade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['descricao_especialidade'] = "Descricao Especialidade"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['totalservico']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['totalservico'] = "Total Servico"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['mes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['labels']['mes'] = "Mes"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "Descricao Especialidade (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "descricao_especialidade", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_descricao_especialidade_cnt",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "descricao_especialidade_cnt",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['descricao_especialidade']['alin'] = "''";
       $Arr_parms['descricao_especialidade']['link'] = "S";
       $Arr_parms['ano']['alin'] = "''";
       $Arr_parms['ano']['link'] = "S";
       $Arr_parms['mes']['alin'] = "''";
       $Arr_parms['mes']['link'] = "S";
       $Arr_parms['descricao_especialidade']['fill'] = "true";
       $Arr_parms['descricao_especialidade']['order'] = "label";
       $Arr_parms['descricao_especialidade']['order_start'] = 'asc';
       $Arr_parms['descricao_especialidade']['order_invert'] = 'false';
       $Arr_parms['descricao_especialidade']['order_enabled'] = 'true';
       $Arr_parms['ano']['fill'] = "true";
       $Arr_parms['ano']['order'] = "value";
       $Arr_parms['ano']['order_start'] = 'asc';
       $Arr_parms['ano']['order_invert'] = 'false';
       $Arr_parms['ano']['order_enabled'] = 'true';
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['descricao_especialidade'] = array(0 => 'descricao_especialidade', 1 => '@aspass@');
       $prep_links_fl['ano'] = array(0 => 'ano', 1 => '');
       $prep_links_fl['mes'] = array(0 => 'mes', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_dbo_view_geral_lancamentos_pizza@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['proc_pdf_vert'])
   {
     $this->comp_tab_hover = true;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           'descricao_especialidade' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("Descricao Especialidade (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'descricao_especialidade',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_descricao_especialidade)),
               'label_y'  => $this->getChartText(strip_tags("Descricao Especialidade (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
           ...
           '1' => array(
               ...
               'field_x'  => 'ano',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_ano)),
               'label_y'  => $this->getChartText(strip_tags("Descricao Especialidade (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'field_x'  => 'mes',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_mes)),
               'label_y'  => $this->getChartText(strip_tags("Descricao Especialidade (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_order']['sc_free_group_by'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_dbo_view_geral_lancamentos_pizza_' . session_id() . '_!!!C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__!!!.json' : '',
                               'xml'         => 'sc_chart_dbo_view_geral_lancamentos_pizza_' . session_id() . '_!!!C_' . $i_index_group . '_' . $s_index_comb . '!!!.json',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
	...
	function filterChartsByMultiseries() {
		...
		if ($applyFilter && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['summarizing_drill_down'])) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts'] as $chartIndex => $chartData) {
				$indexParts = explode('|', $chartIndex);
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_chart_dbo_view_geral_lancamentos_pizza_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_chart_dbo_view_geral_lancamentos_pizza_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      $this->monta_html_ini();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
      ...
      { 
         ...
         { 
             $seq_search = 1;
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_pesq'] as $cmp => $def)
             {
                $Seq_grid      = $seq_search;
                $Cmp_grid      = $cmp;
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_dbo_view_geral_lancamentos_pizza']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_dbo_view_geral_lancamentos_pizza']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_dbo_view_geral_lancamentos_pizza']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_dbo_view_geral_lancamentos_pizza']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_dbo_view_geral_lancamentos_pizza_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new chart_dbo_view_geral_lancamentos_pizza_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_descricao_especialidade = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['arr_total']['descricao_especialidade'];
      $this->array_total_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['arr_total']['ano'];
      $this->array_total_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['arr_total']['mes'];
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
...
$_SESSION['scriptcase']['refresh']['chart_dbo_view_geral_lancamentos_pizza']['init'] = $this->Ini->sc_page;
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_title'] . " dbo.view_geral_lancamentos</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_dbo_view_geral_lancamentos_pizza_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_dbo_view_geral_lancamentos_pizza_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_dbo_view_geral_lancamentos_pizza_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_dbo_view_geral_lancamentos_pizza_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_dbo_view_geral_lancamentos_pizza_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_dbo_view_geral_lancamentos_pizza_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_chart\" class=\"" . $this->css_scGridPage . "\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['embutida'])
      {
...
;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&pdf_zip=N&origem=chart&language=pt_br&conf_socor=N&is_chart_app=Y&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=chart_dbo_view_geral_lancamentos_pizza&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=chart&nm_all_modules=chart&password=n&origem=chart&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=chart_dbo_view_geral_lancamentos_pizza&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&origem=chart&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&password=n&nm_res_cons=s&nm_ini_xml_res=chart&nm_all_modules=chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=chart&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&password=n&nm_res_cons=s&nm_ini_json_res=chart&nm_all_modules=chart&nm_json_format=N&nm_json_label=S&language=&origem=chart&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_res_cons=s&nm_ini_csv_res=chart&nm_all_modules=chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=chart&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=chart&nm_all_modules=chart&password=n&origem=chart&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opc_psq'] && !$this->grid_emb_form)
      {
              $this->nm_btn_exist['reload'][] = "reload_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "breload", "window.location = '" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/index.php';", "window.location = '" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/index.php';", "reload_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
         if (is_file("chart_dbo_view_geral_lancamentos_pizza_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_dbo_view_geral_lancamentos_pizza_help.txt"); 
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rpdf_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['pdf'][] = "Rpdf_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=8&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&pdf_zip=N&origem=chart&language=pt_br&conf_socor=N&is_chart_app=Y&nm_label_group=N&nm_all_cab=S&nm_all_label=S&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=chart_dbo_view_geral_lancamentos_pizza&KeepThis=true&TB_iframe=true&modal=true", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rword_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['word'][] = "Rword_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=CO&nm_res_cons=s&nm_ini_word_res=chart&nm_all_modules=chart&password=n&origem=chart&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&password=n&nm_res_cons=s&nm_ini_xml_res=chart&nm_all_modules=chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=chart&KeepThis=true&TB_iframe=true&modal=true", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_res_cons=s&nm_ini_csv_res=chart&nm_all_modules=chart&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=chart&KeepThis=true&TB_iframe=true&modal=true", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rprinttop\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['print'][] = "Rprint_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=chart&nm_all_modules=chart&password=n&origem=chart&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_5", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_dbo_view_geral_lancamentos_pizza']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_dbo_view_geral_lancamentos_pizza']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_dbo_view_geral_lancamentos_pizza_config_pivot.php?nome_apl=chart_dbo_view_geral_lancamentos_pizza&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"chart_dbo_view_geral_lancamentos_pizza_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
          ...
          $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
          $nm_saida->saida("       }\r\n");
          $nm_saida->saida("       else\r\n");
          $nm_saida->saida("       {\r\n");
          ...
          $nm_saida->saida("               document.Fprint.action = \"chart_dbo_view_geral_lancamentos_pizza_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          $nm_saida->saida("           else\r\n");
          $nm_saida->saida("           {\r\n");
          ...
          $nm_saida->saida("       document.Fexport.action = \"chart_dbo_view_geral_lancamentos_pizza_export_ctrl.php\";\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_dbo_view_geral_lancamentos_pizza_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_dbo_view_geral_lancamentos_pizza@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
...
;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_dbo_view_geral_lancamentos_pizza_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_dbo_view_geral_lancamentos_pizza/chart_dbo_view_geral_lancamentos_pizza_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['skip_charts']))
   {
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts'] as $chart_index => $chart_data)
       {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               chart_dbo_view_geral_lancamentos_pizza_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['this_chart_label'] = '';
           $this->Graf->monta_grafico($chart_index, 'pdf');
           if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['this_chart_label']) {
               $nm_saida->saida("<script type=\"text/javascript\">$(\"#$random_id\").html(\"{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['this_chart_label']}\")</script>\r\n");
           }
       ...
       if ($bChartFP)
       {
           ...
           chart_dbo_view_geral_lancamentos_pizza_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_dbo_view_geral_lancamentos_pizza_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           chart_dbo_view_geral_lancamentos_pizza_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
           chart_dbo_view_geral_lancamentos_pizza_pdf_progress_call("\n", $this->Ini->Nm_lang);
           chart_dbo_view_geral_lancamentos_pizza_pdf_progress_call("\n", $this->Ini->Nm_lang);
           chart_dbo_view_geral_lancamentos_pizza_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   chart_dbo_view_geral_lancamentos_pizza_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   //---- 
   function adiciona_registro($cnt_descricao_especialidade, $quebra_descricao_especialidade, $quebra_ano, $quebra_mes, $quebra_descricao_especialidade_orig, $quebra_ano_orig, $quebra_mes_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($cnt_descricao_especialidade)) {$cnt_descricao_especialidade = '0';}
          eval ('
   ...
   function compat_arrays()
   {
      ...
      {
          $Arr_gb[]   = $cmp_gb;
          $Arr_name[] = "_SESSION['sc_session'][" . $this->Ini->sc_page . "]['chart_dbo_view_geral_lancamentos_pizza']['arr_total']['" .$cmp_gb . "']" . $Control;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT idFilial, Ano, descricao_especialidade, TotalServico, mes from " . $this->Ini->nm_tabela; 
     } 
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['where_pesq']; 
     $nmgp_select .= " group by idFilial 	,Ano 	,mes 	,descricao_especialidade 	,TotalServico"; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->idfilial = $rs_res->fields[0] ;  
            $this->ano = $rs_res->fields[1] ;  
            $this->descricao_especialidade = $rs_res->fields[2] ;  
            $this->totalservico = $rs_res->fields[3] ;  
            $this->mes = $rs_res->fields[4] ;  
            $this->descricao_especialidade_orig = $this->descricao_especialidade;
            $this->ano_orig = $this->ano;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->descricao_especialidade, $this->descricao_especialidade, $this->ano, $this->mes, $this->descricao_especialidade_orig,  $this->ano_orig,  $this->mes_orig);
            }
   }
//
   ...
   function totaliza_php_sc_free_group_by()
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['where_pesq_filtro'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['contr_total_geral'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['contr_array_resumo'] == "OK")
      {
          return;
      }
      //----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['ordem_grid']) 
        {
   ...
   $campos_order = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['ordem_desc']; 
   } 
   ...
   $nmgp_select .= $nmgp_order_by; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['order_grid'] = $nmgp_order_by;
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      ...
      while (!$this->rs_grid->EOF) 
      {
         ...
         $this->descricao_especialidade = $this->rs_grid->fields[2] ;  
         $this->totalservico = $this->rs_grid->fields[3] ;  
         $this->mes = $this->rs_grid->fields[4] ;  
         $this->mes = (string)$this->mes;  
         $descricao_especialidade_orig = $this->descricao_especialidade;
         $ano_orig = $this->ano;
         $mes_orig = $this->mes;
         $this->arg_sum_ano = " = " . $this->ano;
         $this->arg_sum_descricao_especialidade = " = " . $this->Db->qstr($this->descricao_especialidade);
         $this->arg_sum_mes = " = " . $this->mes;
         $this->GB_ano = $this->ano;
         nmgp_Form_Num_Val($this->GB_ano, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         $this->GB_mes = $this->mes;
         nmgp_Form_Num_Val($this->GB_mes, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         $this->adiciona_registro(sc_strip_script($this->descricao_especialidade), sc_strip_script($this->descricao_especialidade), NM_encode_input(sc_strip_script($this->GB_ano)), NM_encode_input(sc_strip_script($this->GB_mes)), sc_strip_script($descricao_especialidade_orig), NM_encode_input(sc_strip_script($ano_orig)), NM_encode_input(sc_strip_script($mes_orig)));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['tot_geral'][1] = $this->array_total_geral[0];
      $count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['tot_geral'][1];
      $cnt_descricao_especialidade = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['tot_geral'][2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['contr_total_geral'] = "OK";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              eval ('$_SESSION["sc_session"][' . $this->Ini->sc_page . ']["chart_dbo_view_geral_lancamentos_pizza"]["arr_total"]["' . $cmp_gb . '"] = $this->array_total_' .  $cmp_gb . ';');
          }
      }
   }
   ...
   function html_grid_search()
   {
       ...
       $tmp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['cond_pesq'];
       $pos = strrpos($tmp, "##*@@");
       if ($pos !== false)
       {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_pesq']))
           { 
   ...
   function grid_search_add_tag()
   {
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_pesq']) < 0)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_dbo_view_geral_lancamentos_pizza']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "Controller/chart_dbo_view_geral_lancamentos_pizza";
