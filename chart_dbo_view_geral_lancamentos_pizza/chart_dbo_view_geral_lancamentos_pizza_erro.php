...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['chart_dbo_view_geral_lancamentos_pizza']['contr_erro']) && $_SESSION['scriptcase']['chart_dbo_view_geral_lancamentos_pizza']['contr_erro'] == 'on')
    {
