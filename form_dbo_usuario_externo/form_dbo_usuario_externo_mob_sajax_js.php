  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_usuario_externo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_usuario_externo_mob_form();
	}
...
?>
  ...
  // ---------- Validate nome_do_usuario
  function do_ajax_form_dbo_usuario_externo_mob_validate_nome_do_usuario()
  {
    var nomeCampo_nome_do_usuario = "nome_do_usuario";
    var var_nome_do_usuario = scAjaxGetFieldText(nomeCampo_nome_do_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_usuario_externo_mob_validate_nome_do_usuario(var_nome_do_usuario, var_script_case_init, do_ajax_form_dbo_usuario_externo_mob_validate_nome_do_usuario_cb);
  } // do_ajax_form_dbo_usuario_externo_mob_validate_nome_do_usuario

  function do_ajax_form_dbo_usuario_externo_mob_validate_nome_do_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_do_usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_usuario_externo_mob_validate_nome_do_usuario_cb

  // ---------- Validate cpf_usuario
  function do_ajax_form_dbo_usuario_externo_mob_validate_cpf_usuario()
  {
    var nomeCampo_cpf_usuario = "cpf_usuario";
    var var_cpf_usuario = scAjaxGetFieldText(nomeCampo_cpf_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_usuario_externo_mob_validate_cpf_usuario(var_cpf_usuario, var_script_case_init, do_ajax_form_dbo_usuario_externo_mob_validate_cpf_usuario_cb);
  } // do_ajax_form_dbo_usuario_externo_mob_validate_cpf_usuario

  function do_ajax_form_dbo_usuario_externo_mob_validate_cpf_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cpf_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_usuario_externo_mob_validate_cpf_usuario_cb

  // ---------- Validate idfilial
  function do_ajax_form_dbo_usuario_externo_mob_validate_idfilial()
  {
    var nomeCampo_idfilial = "idfilial";
    var var_idfilial = scAjaxGetFieldSelect(nomeCampo_idfilial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_usuario_externo_mob_validate_idfilial(var_idfilial, var_script_case_init, do_ajax_form_dbo_usuario_externo_mob_validate_idfilial_cb);
  } // do_ajax_form_dbo_usuario_externo_mob_validate_idfilial

  function do_ajax_form_dbo_usuario_externo_mob_validate_idfilial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_usuario_externo_mob_validate_idfilial_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_usuario_externo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_usuario_externo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nome_do_usuario = scAjaxGetFieldText("nome_do_usuario");
    var var_cpf_usuario = scAjaxGetFieldText("cpf_usuario");
    var var_idfilial = scAjaxGetFieldSelect("idfilial");
    var var_idusuarioexternos = scAjaxGetFieldText("idusuarioexternos");
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_usuario_externo_mob_submit_form(var_nome_do_usuario, var_cpf_usuario, var_idfilial, var_idusuarioexternos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_usuario_externo_mob_submit_form_cb);
  } // do_ajax_form_dbo_usuario_externo_mob_submit_form

  function do_ajax_form_dbo_usuario_externo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nome_do_usuario");
      scAjaxHideErrorDisplay("cpf_usuario");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_usuario_externo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_usuario_externo_mob_submit_form_cb
  function do_ajax_form_dbo_usuario_externo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_usuario_externo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_usuario_externo_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_usuario_externo_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_usuario_externo_mob_navigate_form();
    }
  }

  function perform_ajax_form_dbo_usuario_externo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("cpf_usuario");
    scAjaxHideErrorDisplay("idfilial");
    var var_idusuarioexternos = document.F2.idusuarioexternos.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_usuario_externo_mob_navigate_form(var_idusuarioexternos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_usuario_externo_mob_navigate_form_cb);
  } // do_ajax_form_dbo_usuario_externo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_usuario_externo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_usuario_externo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idusuarioexternos.value = scAjaxGetKeyValue("idusuarioexternos");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_usuario_externo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_usuario_externo_mob_navigate_form_cb
  function do_ajax_form_dbo_usuario_externo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_usuario_externo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_usuario_externo_mob_navigate_form_cb_after_alert
  function sc_hide_form_dbo_usuario_externo_mob_form()
  {
  ...
  ajax_field_list[0] = "nome_do_usuario";
  ajax_field_list[1] = "cpf_usuario";
  ...
  var ajax_error_list = {
    "nome_do_usuario": {"label": "Nome Completo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cpf_usuario": {"label": "CPF", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "nome_do_usuario": new Array(),
    "cpf_usuario": new Array(),
    "idfilial": new Array()
  };
  ajax_field_mult["nome_do_usuario"][1] = "nome_do_usuario";
  ajax_field_mult["cpf_usuario"][1] = "cpf_usuario";
  ajax_field_mult["idfilial"][1] = "idfilial";

  var ajax_field_id = {
    "nome_do_usuario": new Array("hidden_field_label_nome_do_usuario", "hidden_field_data_nome_do_usuario"),
    "cpf_usuario": new Array("hidden_field_label_cpf_usuario", "hidden_field_data_cpf_usuario"),
