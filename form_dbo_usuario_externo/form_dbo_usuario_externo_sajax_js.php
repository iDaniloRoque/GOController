  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_usuario_externo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_usuario_externo_form();
	}
...
?>
  ...
  function do_ajax_form_dbo_usuario_externo_validate_nome_do_usuario()
  {
    ...
    x_ajax_form_dbo_usuario_externo_validate_nome_do_usuario(var_nome_do_usuario, var_script_case_init, do_ajax_form_dbo_usuario_externo_validate_nome_do_usuario_cb);
  } // do_ajax_form_dbo_usuario_externo_validate_nome_do_usuario

  function do_ajax_form_dbo_usuario_externo_validate_nome_do_usuario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_usuario_externo_validate_nome_do_usuario_cb

  // ---------- Validate cpf_usuario
  function do_ajax_form_dbo_usuario_externo_validate_cpf_usuario()
  {
    var nomeCampo_cpf_usuario = "cpf_usuario";
    var var_cpf_usuario = scAjaxGetFieldText(nomeCampo_cpf_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_usuario_externo_validate_cpf_usuario(var_cpf_usuario, var_script_case_init, do_ajax_form_dbo_usuario_externo_validate_cpf_usuario_cb);
  } // do_ajax_form_dbo_usuario_externo_validate_cpf_usuario

  function do_ajax_form_dbo_usuario_externo_validate_cpf_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_usuario_externo_validate_cpf_usuario_cb

  // ---------- Validate idfilial
  function do_ajax_form_dbo_usuario_externo_validate_idfilial()
  {
    var nomeCampo_idfilial = "idfilial";
    var var_idfilial = scAjaxGetFieldSelect(nomeCampo_idfilial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_usuario_externo_validate_idfilial(var_idfilial, var_script_case_init, do_ajax_form_dbo_usuario_externo_validate_idfilial_cb);
  } // do_ajax_form_dbo_usuario_externo_validate_idfilial

  function do_ajax_form_dbo_usuario_externo_validate_idfilial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_usuario_externo_validate_idfilial_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_usuario_externo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_usuario_externo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_usuario_externo_submit_form(var_nome_do_usuario, var_cpf_usuario, var_idfilial, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_usuario_externo_submit_form_cb);
  } // do_ajax_form_dbo_usuario_externo_submit_form

  function do_ajax_form_dbo_usuario_externo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_usuario_externo_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_usuario_externo_submit_form_cb
  function do_ajax_form_dbo_usuario_externo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_usuario_externo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_usuario_externo_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_usuario_externo_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_usuario_externo_navigate_form();
    }
  }

  function perform_ajax_form_dbo_usuario_externo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_usuario_externo_navigate_form(var_idusuarioexternos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_usuario_externo_navigate_form_cb);
  } // do_ajax_form_dbo_usuario_externo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_usuario_externo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_usuario_externo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_usuario_externo_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_usuario_externo_navigate_form_cb
  function do_ajax_form_dbo_usuario_externo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_usuario_externo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_usuario_externo_navigate_form_cb_after_alert
  function sc_hide_form_dbo_usuario_externo_form()
  {
