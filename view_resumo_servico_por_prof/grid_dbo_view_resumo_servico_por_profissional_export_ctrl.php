<?php
@session_start() ;
$_SESSION['scriptcase']['grid_dbo_view_resumo_servico_por_profissional']['sc_process_barr'] = true;
require_once('../view_resumo_servico_por_prof/index.php');
unset($_SESSION['scriptcase']['grid_dbo_view_resumo_servico_por_profissional']['sc_process_barr']);
$ExportCtrl = new grid_dbo_view_resumo_servico_por_profissional_export_control;
$ExportCtrl->Export_barr();

class grid_dbo_view_resumo_servico_por_profissional_export_control
{
