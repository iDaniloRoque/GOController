<?php  
  ...
  session_start() ;
  class grid_dbo_view_resumo_servico_por_profissional_form_teste
  {
  function grid_dbo_view_resumo_servico_por_profissional_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">view_resumo_servico_por_prof</FONT></B> 
<br> 
<br> 
...
<input type=submit value="view_resumo_servico_por_prof"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_dbo_view_resumo_servico_por_profissional_form_teste();
  $frm_teste->grid_dbo_view_resumo_servico_por_profissional_teste();
?>
