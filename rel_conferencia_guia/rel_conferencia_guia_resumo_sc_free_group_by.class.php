...
class rel_conferencia_guia_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_pessoa_juridica_fisica_nome_razao_social;
   var $array_total_contratos;
   var $array_total_profissional;
   var $array_total_especialidade_servicos_descricao_especialidade;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_pessoa_juridica_fisica_nome_razao_social       = array();
      $this->array_total_contratos                                      = array();
      $this->array_total_profissional                                   = array();
      $this->array_total_especialidade_servicos_descricao_especialidade = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['rel_conferencia_guia']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['rel_conferencia_guia']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['arr_total']['pessoa_juridica_fisica_nome_razao_social'] = $this->array_total_pessoa_juridica_fisica_nome_razao_social;
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['arr_total']['contratos'] = $this->array_total_contratos;
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['arr_total']['profissional'] = $this->array_total_profissional;
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['arr_total']['especialidade_servicos_descricao_especialidade'] = $this->array_total_especialidade_servicos_descricao_especialidade;
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['json_use_label'])
       {
          $Lab_pessoa_juridica_fisica_nome_razao_social = "pessoa_juridica_fisica.nome_razao_social";
          $Lab_contratos = "Contratos";
          $Lab_profissional = "Profissional";
          $Lab_especialidade_servicos_descricao_especialidade = "especialidade_servicos.descricao_especialidade";
       }
       else
       {
       $Lab_pessoa_juridica_fisica_nome_razao_social = "Nome Razao Social";
       $Lab_contratos = "Contratos";
       $Lab_profissional = "Profissional";
       $Lab_especialidade_servicos_descricao_especialidade = "Descricao Especialidade";
       }
       $prep_field = array();
       $prep_field['pessoa_juridica_fisica_nome_razao_social'] = $Lab_pessoa_juridica_fisica_nome_razao_social;
       $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['pessoa_juridica_fisica_nome_razao_social'] = $Lab_pessoa_juridica_fisica_nome_razao_social; 
       $prep_field['contratos'] = $Lab_contratos;
       $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['contratos'] = $Lab_contratos; 
       $prep_field['profissional'] = $Lab_profissional;
       $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['profissional'] = $Lab_profissional; 
       $prep_field['especialidade_servicos_descricao_especialidade'] = $Lab_especialidade_servicos_descricao_especialidade;
       $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['especialidade_servicos_descricao_especialidade'] = $Lab_especialidade_servicos_descricao_especialidade; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['lancamento_servicos_data_do_servico']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['lancamento_servicos_data_do_servico'] = "Data"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['lancamento_servicos_numero_da_guia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['lancamento_servicos_numero_da_guia'] = "Nº Guia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['servicos_descricao_servico']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['servicos_descricao_servico'] = "Descrição do Serviço"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['lancamento_servicos_vlr_servico']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['lancamento_servicos_vlr_servico'] = "Vlr Unit."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['lancamento_servicos_quantidade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['lancamento_servicos_quantidade'] = "Qtd"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['lancamento_servicos_total_servico']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['lancamento_servicos_total_servico'] = "Total Serviço"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['pessoa_juridica_fisica_nome_razao_social']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['pessoa_juridica_fisica_nome_razao_social'] = "Razão Social"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['contratos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['contratos'] = "Contrato"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['profissional']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['profissional'] = "Profissional"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['atividade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['atividade'] = "Atividade"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['especialidade_servicos_descricao_especialidade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['especialidade_servicos_descricao_especialidade'] = "Especialidade"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['pessoa_juridica_fisica_idpessoas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['pessoa_juridica_fisica_idpessoas'] = "Id Pessoas"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['labels']['total'] = "Vlr.Total"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['pessoa_juridica_fisica_nome_razao_social']['alin'] = "''";
       $Arr_parms['pessoa_juridica_fisica_nome_razao_social']['link'] = "S";
       $Arr_parms['contratos']['alin'] = "''";
       $Arr_parms['contratos']['link'] = "S";
       $Arr_parms['profissional']['alin'] = "''";
       $Arr_parms['profissional']['link'] = "S";
       $Arr_parms['especialidade_servicos_descricao_especialidade']['alin'] = "''";
       $Arr_parms['especialidade_servicos_descricao_especialidade']['link'] = "S";
       $Arr_parms['pessoa_juridica_fisica_nome_razao_social']['fill'] = "true";
       $Arr_parms['pessoa_juridica_fisica_nome_razao_social']['order'] = "label";
       $Arr_parms['pessoa_juridica_fisica_nome_razao_social']['order_start'] = 'asc';
       $Arr_parms['pessoa_juridica_fisica_nome_razao_social']['order_invert'] = 'false';
       $Arr_parms['pessoa_juridica_fisica_nome_razao_social']['order_enabled'] = 'true';
       ...
       $Arr_parms['especialidade_servicos_descricao_especialidade']['fill'] = "true";
       $Arr_parms['especialidade_servicos_descricao_especialidade']['order'] = "label";
       $Arr_parms['especialidade_servicos_descricao_especialidade']['order_start'] = 'asc';
       $Arr_parms['especialidade_servicos_descricao_especialidade']['order_invert'] = 'false';
       $Arr_parms['especialidade_servicos_descricao_especialidade']['order_enabled'] = 'true';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['pessoa_juridica_fisica_nome_razao_social'] = array(0 => 'pessoa_juridica_fisica_nome_razao_social', 1 => '@aspass@');
       $prep_links_fl['contratos'] = array(0 => 'contratos', 1 => '@aspass@');
       $prep_links_fl['profissional'] = array(0 => 'profissional', 1 => '@aspass@');
       $prep_links_fl['especialidade_servicos_descricao_especialidade'] = array(0 => 'especialidade_servicos_descricao_especialidade', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@rel_conferencia_guia@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "rel_conferencia_guia_total.class.php"); 
      }
      $this->Print_All = true;
      ...
      $this->Total   = new rel_conferencia_guia_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"rel_conferencia_guia_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"rel_conferencia_guia_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"rel_conferencia_guia_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "rel_conferencia_guia/rel_conferencia_guia_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_rel_conferencia_guia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_rel_conferencia_guia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_rel_conferencia_guia_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "rel_conferencia_guia/rel_conferencia_guia_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=rel_conferencia_guia&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "rel_conferencia_guia/rel_conferencia_guia_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid&nm_all_modules=grid&nm_json_format=N&nm_json_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "rel_conferencia_guia/rel_conferencia_guia_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['opc_psq'] && !$this->grid_emb_form)
      {
         ...
         if (is_file("rel_conferencia_guia_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "rel_conferencia_guia/rel_conferencia_guia_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['rel_conferencia_guia']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['rel_conferencia_guia']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'rel_conferencia_guia_config_pivot.php?nome_apl=rel_conferencia_guia&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "rel_conferencia_guia/rel_conferencia_guia_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_rel_conferencia_guia_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "rel_conferencia_guia/rel_conferencia_guia_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $pessoa_juridica_fisica_nome_razao_social = $Busca_temp['pessoa_juridica_fisica_nome_razao_social']; 
          $tmp_pos = strpos($pessoa_juridica_fisica_nome_razao_social, "##@@");
          if ($tmp_pos !== false && !is_array($pessoa_juridica_fisica_nome_razao_social))
          {
              $pessoa_juridica_fisica_nome_razao_social = substr($pessoa_juridica_fisica_nome_razao_social, 0, $tmp_pos);
          }
   ...
   //---- 
   function adiciona_registro($quebra_pessoa_juridica_fisica_nome_razao_social, $quebra_contratos, $quebra_profissional, $quebra_especialidade_servicos_descricao_especialidade, $quebra_pessoa_juridica_fisica_nome_razao_social_orig, $quebra_contratos_orig, $quebra_profissional_orig, $quebra_especialidade_servicos_descricao_especialidade_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->lancamento_servicos_data_do_servico = $rs_res->fields[0] ;  
            $this->lancamento_servicos_numero_da_guia = $rs_res->fields[1] ;  
            $this->servicos_descricao_servico = $rs_res->fields[2] ;  
            $this->lancamento_servicos_vlr_servico = $rs_res->fields[3] ;  
            $this->lancamento_servicos_vlr_servico =  str_replace(",", ".", $this->lancamento_servicos_vlr_servico);
            $this->lancamento_servicos_quantidade = $rs_res->fields[4] ;  
            $this->lancamento_servicos_quantidade =  str_replace(",", ".", $this->lancamento_servicos_quantidade);
            $this->lancamento_servicos_total_servico = $rs_res->fields[5] ;  
            $this->lancamento_servicos_total_servico =  str_replace(",", ".", $this->lancamento_servicos_total_servico);
            $this->pessoa_juridica_fisica_nome_razao_social = $rs_res->fields[6] ;  
            $this->contratos = $rs_res->fields[7] ;  
            $this->profissional = $rs_res->fields[8] ;  
            $this->especialidade_servicos_descricao_especialidade = $rs_res->fields[9] ;  
            $this->pessoa_juridica_fisica_nome_razao_social_orig = $this->pessoa_juridica_fisica_nome_razao_social;
            $this->contratos_orig = $this->contratos;
            $this->profissional_orig = $this->profissional;
            $this->especialidade_servicos_descricao_especialidade_orig = $this->especialidade_servicos_descricao_especialidade;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->pessoa_juridica_fisica_nome_razao_social, $this->contratos, $this->profissional, $this->especialidade_servicos_descricao_especialidade, $this->pessoa_juridica_fisica_nome_razao_social_orig,  $this->contratos_orig,  $this->profissional_orig,  $this->especialidade_servicos_descricao_especialidade_orig);
            }
   }
//
