...
class rel_conferencia_guia_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['rel_conferencia_guia']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['rel_conferencia_guia']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['contr_total_geral'] = "OK";
   } 

   //-----  pessoa_juridica_fisica_nome_razao_social
   function quebra_pessoa_juridica_fisica_nome_razao_social_sc_free_group_by($pessoa_juridica_fisica_nome_razao_social, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_pessoa_juridica_fisica_nome_razao_social = array() ;  
      $tot_pessoa_juridica_fisica_nome_razao_social[0] = $pessoa_juridica_fisica_nome_razao_social ; 
   }
   //-----  contratos
   ...
   function quebra_profissional_sc_free_group_by($profissional, $Where_qb, $Cmp_Name) 
   {
      ...
      $tot_profissional[0] = $profissional ; 
   }
   //-----  especialidade_servicos_descricao_especialidade
   function quebra_especialidade_servicos_descricao_especialidade_sc_free_group_by($especialidade_servicos_descricao_especialidade, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_especialidade_servicos_descricao_especialidade = array() ;  
      $tot_especialidade_servicos_descricao_especialidade[0] = $especialidade_servicos_descricao_especialidade ; 
   }

   //----- 
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      global $nm_lang, $total;
      $this->nm_data = new nm_data("pt_br");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('pessoa_juridica_fisica_nome_razao_social' => "pessoa_juridica_fisica.nome_razao_social",'contratos' => "'Contrato nº ' + CONVERT(VARCHAR(MAX),contratos.numero_do_contrato) + ' -  Data Inicio.: ' + Format(contratos.data_inicio_contrato,'dd/MM/yyyy') + ' - Data Final.: ' + Format(contratos.data_final_contrato,'dd/MM/yyyy')",'profissional' => "pessoa_juridica_fisica_1.nome_razao_social",'especialidade_servicos_descricao_especialidade' => "especialidade_servicos.descricao_especialidade");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('lancamento_servicos_vlr_servico' => 'N','lancamento_servicos_quantidade' => 'N','lancamento_servicos_numero_da_guia' => 'N','pessoa_juridica_fisica_idpessoas' => 'N','lancamento_servicos_total_servico' => 'N','total' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['rel_conferencia_guia']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['pessoa_juridica_fisica_nome_razao_social']['reg'] = "S";
      $format_dimensions['pessoa_juridica_fisica_nome_razao_social']['msk'] = "";
      ...
      $format_dimensions['especialidade_servicos_descricao_especialidade']['reg'] = "S";
      $format_dimensions['especialidade_servicos_descricao_especialidade']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "pessoa_juridica_fisica_nome_razao_social") {
              }
              if ($Cada_dim == "contratos") {
              }
              if ($Cada_dim == "profissional") {
              }
              if ($Cada_dim == "especialidade_servicos_descricao_especialidade") {
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
