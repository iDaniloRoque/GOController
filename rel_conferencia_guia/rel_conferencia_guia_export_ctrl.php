<?php
@session_start() ;
$_SESSION['scriptcase']['rel_conferencia_guia']['sc_process_barr'] = true;
require_once('../rel_conferencia_guia/index.php');
unset($_SESSION['scriptcase']['rel_conferencia_guia']['sc_process_barr']);
$ExportCtrl = new rel_conferencia_guia_export_control;
$ExportCtrl->Export_barr();

class rel_conferencia_guia_export_control
{
