  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_param_impostos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_param_impostos_form();
	}
...
?>
  ...
  // ---------- Validate idparam_impostos_
  function do_ajax_form_dbo_param_impostos_validate_idparam_impostos_(iNumLinha)
  {
    var nomeCampo_idparam_impostos_ = "idparam_impostos_" + iNumLinha;
    var var_idparam_impostos_ = scAjaxGetFieldHidden(nomeCampo_idparam_impostos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_impostos_validate_idparam_impostos_(var_idparam_impostos_, iNumLinha, var_script_case_init, do_ajax_form_dbo_param_impostos_validate_idparam_impostos__cb);
  } // do_ajax_form_dbo_param_impostos_validate_idparam_impostos_

  function do_ajax_form_dbo_param_impostos_validate_idparam_impostos__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idparam_impostos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idparam_impostos_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idparam_impostos_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idparam_impostos_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_param_impostos_validate_idparam_impostos__cb

  // ---------- Validate idimpostos_
  function do_ajax_form_dbo_param_impostos_validate_idimpostos_(iNumLinha)
  {
    var nomeCampo_idimpostos_ = "idimpostos_" + iNumLinha;
    var var_idimpostos_ = scAjaxGetFieldSelect(nomeCampo_idimpostos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_impostos_validate_idimpostos_(var_idimpostos_, iNumLinha, var_script_case_init, do_ajax_form_dbo_param_impostos_validate_idimpostos__cb);
  } // do_ajax_form_dbo_param_impostos_validate_idimpostos_

  function do_ajax_form_dbo_param_impostos_validate_idimpostos__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_param_impostos_validate_idimpostos__cb

  // ---------- Validate codgo_imposto_vision_
  function do_ajax_form_dbo_param_impostos_validate_codgo_imposto_vision_(iNumLinha)
  {
    var nomeCampo_codgo_imposto_vision_ = "codgo_imposto_vision_" + iNumLinha;
    var var_codgo_imposto_vision_ = scAjaxGetFieldText(nomeCampo_codgo_imposto_vision_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_impostos_validate_codgo_imposto_vision_(var_codgo_imposto_vision_, iNumLinha, var_script_case_init, do_ajax_form_dbo_param_impostos_validate_codgo_imposto_vision__cb);
  } // do_ajax_form_dbo_param_impostos_validate_codgo_imposto_vision_

  function do_ajax_form_dbo_param_impostos_validate_codgo_imposto_vision__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codgo_imposto_vision_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codgo_imposto_vision_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codgo_imposto_vision_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codgo_imposto_vision_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_param_impostos_validate_codgo_imposto_vision__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_param_impostos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_param_impostos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_param_impostos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_param_impostos_add_new_line_cb);
  } // do_ajax_form_dbo_param_impostos_add_new_line

  function do_ajax_form_dbo_param_impostos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_dbo_param_impostos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_param_impostos_backup_line(iNumLinha)
  {
    var var_idparam_impostos_ = scAjaxGetFieldHidden("idparam_impostos_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_impostos_backup_line(var_idparam_impostos_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_param_impostos_backup_line_cb);
  } // do_ajax_form_dbo_param_impostos_backup_line

  function do_ajax_form_dbo_param_impostos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_dbo_param_impostos_backup_line_cb

  function do_ajax_form_dbo_param_impostos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_param_impostos_cancel_insert

  function do_ajax_form_dbo_param_impostos_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_param_impostos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_param_impostos_cancel_update

  function do_ajax_form_dbo_param_impostos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_param_impostos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_param_impostos_table_refresh()
  {
    var var_idparam_impostos_ = document.F2.idparam_impostos_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_param_impostos_table_refresh(var_idparam_impostos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_param_impostos_table_refresh_cb);
  } //  do_ajax_form_dbo_param_impostos_table_refresh

  function do_ajax_form_dbo_param_impostos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idparam_impostos_.value = scAjaxGetKeyValue("idparam_impostos_");
    ...
    scAjaxAlert(do_ajax_form_dbo_param_impostos_table_refresh_cb_after_alert);
  } // do_ajax_form_dbo_param_impostos_table_refresh_cb
  function do_ajax_form_dbo_param_impostos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_param_impostos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_param_impostos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_dbo_param_impostos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_codgo_imposto_vision_ = scAjaxGetFieldText("codgo_imposto_vision_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_dbo_param_impostos_submit_form(var_idparam_impostos_, var_idimpostos_, var_codgo_imposto_vision_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_param_impostos_submit_form_cb);
  } // do_ajax_form_dbo_param_impostos_submit_form

  function do_ajax_form_dbo_param_impostos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idparam_impostos_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idimpostos_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codgo_imposto_vision_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_param_impostos_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_param_impostos_submit_form_cb
  function do_ajax_form_dbo_param_impostos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_param_impostos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_param_impostos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_param_impostos_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_param_impostos_navigate_form();
    }
  }

  function perform_ajax_form_dbo_param_impostos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_param_impostos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idparam_impostos_" + iNavForm);
      scAjaxHideErrorDisplay("idimpostos_" + iNavForm);
      scAjaxHideErrorDisplay("codgo_imposto_vision_" + iNavForm);
    }
    var var_idparam_impostos_ = document.F2.idparam_impostos_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_param_impostos_navigate_form(var_idparam_impostos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_param_impostos_navigate_form_cb);
  } // do_ajax_form_dbo_param_impostos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_param_impostos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_param_impostos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idparam_impostos_.value = scAjaxGetKeyValue("idparam_impostos_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_param_impostos_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_param_impostos_navigate_form_cb
  function do_ajax_form_dbo_param_impostos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_dbo_param_impostos_navigate_form_cb_after_alert
  function sc_hide_form_dbo_param_impostos_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idparam_impostos_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idimpostos_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codgo_imposto_vision_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idparam_impostos_" + iNumLinha] = {"label": "Id Param Impostos<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idimpostos_" + iNumLinha] = {"label": "Imposto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codgo_imposto_vision_" + iNumLinha] = {"label": "Codgo Imposto Vision<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idparam_impostos_"][iNumLinha] = "idparam_impostos_" + iNumLinha;
    ajax_field_mult["idimpostos_"][iNumLinha] = "idimpostos_" + iNumLinha;
    ajax_field_mult["codgo_imposto_vision_"][iNumLinha] = "codgo_imposto_vision_" + iNumLinha;
    ajax_field_id["idimpostos_" + iNumLinha] = new Array("hidden_field_label_idimpostos_", "hidden_field_data_idimpostos_" + iNumLinha);
    ajax_field_id["codgo_imposto_vision_" + iNumLinha] = new Array("hidden_field_label_codgo_imposto_vision_", "hidden_field_data_codgo_imposto_vision_" + iNumLinha);
    ajax_error_count["idparam_impostos_" + iNumLinha] = "off";
    ajax_error_count["idimpostos_" + iNumLinha] = "off";
    ajax_error_count["codgo_imposto_vision_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idparam_impostos_" + iNumLinha] = "on";
    ajax_read_only["idimpostos_" + iNumLinha] = "off";
    ajax_read_only["codgo_imposto_vision_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["codgo_imposto_vision_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idparam_impostos_" + iNumLinha] = null;
    ajax_error_list["idimpostos_" + iNumLinha] = null;
    ajax_error_list["codgo_imposto_vision_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idparam_impostos_": new Array(),
    "idimpostos_": new Array(),
    "codgo_imposto_vision_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idparam_impostos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idparam_impostos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idparam_impostos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idparam_impostos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idparam_impostos_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["codgo_imposto_vision_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codgo_imposto_vision_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codgo_imposto_vision_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codgo_imposto_vision_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codgo_imposto_vision_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idparam_impostos_'])) ? $this->nmgp_cmp_readonly['idparam_impostos_'] : 'on';
?>
    scAjaxFieldRead("idparam_impostos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codgo_imposto_vision_'])) ? $this->nmgp_cmp_readonly['codgo_imposto_vision_'] : 'off';
?>
    scAjaxFieldRead("codgo_imposto_vision_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idparam_impostos_" + iSeq, "on");
    scAjaxFieldRead("idimpostos_" + iSeq, "on");
    scAjaxFieldRead("codgo_imposto_vision_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idparam_impostos_" + iRow] || "on" == ajax_error_count["idimpostos_" + iRow] || "on" == ajax_error_count["codgo_imposto_vision_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idparam_impostos_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idimpostos_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codgo_imposto_vision_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idparam_impostos_" + iRow] && "off" == ajax_error_count["idimpostos_" + iRow] && "off" == ajax_error_count["codgo_imposto_vision_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idparam_impostos_" + iRow] = "off";
        ajax_error_count["idimpostos_" + iRow] = "off";
        ajax_error_count["codgo_imposto_vision_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idparam_impostos_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idimpostos_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codgo_imposto_vision_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("codgo_imposto_vision_" == sIndex)
    {
