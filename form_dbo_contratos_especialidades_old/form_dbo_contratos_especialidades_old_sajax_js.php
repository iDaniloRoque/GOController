  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_contratos_especialidades_old" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_contratos_especialidades_old_form();
	}
...
?>
  ...
  function do_ajax_form_dbo_contratos_especialidades_old_validate_idespecialidade_servicos_(iNumLinha)
  {
    ...
    x_ajax_form_dbo_contratos_especialidades_old_validate_idespecialidade_servicos_(var_idespecialidade_servicos_, iNumLinha, var_script_case_init, do_ajax_form_dbo_contratos_especialidades_old_validate_idespecialidade_servicos__cb);
  } // do_ajax_form_dbo_contratos_especialidades_old_validate_idespecialidade_servicos_

  function do_ajax_form_dbo_contratos_especialidades_old_validate_idespecialidade_servicos__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_especialidades_old_validate_idespecialidade_servicos__cb

  // ---------- Validate idcontratos_especialidades_
  function do_ajax_form_dbo_contratos_especialidades_old_validate_idcontratos_especialidades_(iNumLinha)
  {
    var nomeCampo_idcontratos_especialidades_ = "idcontratos_especialidades_" + iNumLinha;
    var var_idcontratos_especialidades_ = scAjaxGetFieldHidden(nomeCampo_idcontratos_especialidades_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_especialidades_old_validate_idcontratos_especialidades_(var_idcontratos_especialidades_, iNumLinha, var_script_case_init, do_ajax_form_dbo_contratos_especialidades_old_validate_idcontratos_especialidades__cb);
  } // do_ajax_form_dbo_contratos_especialidades_old_validate_idcontratos_especialidades_

  function do_ajax_form_dbo_contratos_especialidades_old_validate_idcontratos_especialidades__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idcontratos_especialidades_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idcontratos_especialidades_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idcontratos_especialidades_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idcontratos_especialidades_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_especialidades_old_validate_idcontratos_especialidades__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_contratos_especialidades_old_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_contratos_especialidades_old_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_contratos_especialidades_old_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_contratos_especialidades_old_add_new_line_cb);
  } // do_ajax_form_dbo_contratos_especialidades_old_add_new_line

  function do_ajax_form_dbo_contratos_especialidades_old_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_dbo_contratos_especialidades_old_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_contratos_especialidades_old_backup_line(iNumLinha)
  {
    var var_idcontratos_especialidades_ = scAjaxGetFieldHidden("idcontratos_especialidades_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_especialidades_old_backup_line(var_idcontratos_especialidades_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_contratos_especialidades_old_backup_line_cb);
  } // do_ajax_form_dbo_contratos_especialidades_old_backup_line

  function do_ajax_form_dbo_contratos_especialidades_old_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_dbo_contratos_especialidades_old_backup_line_cb

  function do_ajax_form_dbo_contratos_especialidades_old_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_contratos_especialidades_old_cancel_insert

  function do_ajax_form_dbo_contratos_especialidades_old_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_contratos_especialidades_old_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_contratos_especialidades_old_cancel_update

  function do_ajax_form_dbo_contratos_especialidades_old_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_contratos_especialidades_old_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_contratos_especialidades_old_table_refresh()
  {
    var var_idcontratos_especialidades_ = document.F2.idcontratos_especialidades_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_contratos_especialidades_old_table_refresh(var_idcontratos_especialidades_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_contratos_especialidades_old_table_refresh_cb);
  } //  do_ajax_form_dbo_contratos_especialidades_old_table_refresh

  function do_ajax_form_dbo_contratos_especialidades_old_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idcontratos_especialidades_.value = scAjaxGetKeyValue("idcontratos_especialidades_");
    ...
    scAjaxAlert(do_ajax_form_dbo_contratos_especialidades_old_table_refresh_cb_after_alert);
  } // do_ajax_form_dbo_contratos_especialidades_old_table_refresh_cb
  function do_ajax_form_dbo_contratos_especialidades_old_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_contratos_especialidades_old_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_contratos_especialidades_old_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_dbo_contratos_especialidades_old_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_dbo_contratos_especialidades_old_submit_form(var_idespecialidade_servicos_, var_idcontratos_especialidades_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_contratos_especialidades_old_submit_form_cb);
  } // do_ajax_form_dbo_contratos_especialidades_old_submit_form

  function do_ajax_form_dbo_contratos_especialidades_old_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("idcontratos_especialidades_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_contratos_especialidades_old_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_contratos_especialidades_old_submit_form_cb
  function do_ajax_form_dbo_contratos_especialidades_old_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_contratos_especialidades_old_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_contratos_especialidades_old_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_contratos_especialidades_old_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_contratos_especialidades_old_navigate_form();
    }
  }

  function perform_ajax_form_dbo_contratos_especialidades_old_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_contratos_especialidades_old_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("idcontratos_especialidades_" + iNavForm);
    }
    var var_idcontratos_especialidades_ = document.F2.idcontratos_especialidades_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_contratos_especialidades_old_navigate_form(var_idcontratos_especialidades_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_contratos_especialidades_old_navigate_form_cb);
  } // do_ajax_form_dbo_contratos_especialidades_old_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_contratos_especialidades_old']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_contratos_especialidades_old_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcontratos_especialidades_.value = scAjaxGetKeyValue("idcontratos_especialidades_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_contratos_especialidades_old_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_contratos_especialidades_old_navigate_form_cb
  function do_ajax_form_dbo_contratos_especialidades_old_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_dbo_contratos_especialidades_old_navigate_form_cb_after_alert
  function sc_hide_form_dbo_contratos_especialidades_old_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idcontratos_especialidades_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["idcontratos_especialidades_" + iNumLinha] = {"label": "Id Contratos Especialidades<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idespecialidade_servicos_"][iNumLinha] = "idespecialidade_servicos_" + iNumLinha;
    ajax_field_mult["idcontratos_especialidades_"][iNumLinha] = "idcontratos_especialidades_" + iNumLinha;
    ...
    ajax_error_count["idcontratos_especialidades_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idespecialidade_servicos_" + iNumLinha] = "off";
    ajax_read_only["idcontratos_especialidades_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["idcontratos_especialidades_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "idcontratos_especialidades_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["idcontratos_especialidades_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idcontratos_especialidades_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idcontratos_especialidades_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idcontratos_especialidades_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idcontratos_especialidades_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcontratos_especialidades_'])) ? $this->nmgp_cmp_readonly['idcontratos_especialidades_'] : 'on';
?>
    scAjaxFieldRead("idcontratos_especialidades_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idespecialidade_servicos_" + iSeq, "on");
    scAjaxFieldRead("idcontratos_especialidades_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idespecialidade_servicos_" + iRow] || "on" == ajax_error_count["idcontratos_especialidades_" + iRow]))
    {
      ...
      $("#hidden_field_data_idcontratos_especialidades_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idespecialidade_servicos_" + iRow] && "off" == ajax_error_count["idcontratos_especialidades_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idespecialidade_servicos_" + iRow] = "off";
        ajax_error_count["idcontratos_especialidades_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idcontratos_especialidades_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idcontratos_especialidades_" == sIndex)
    {
