  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_contratos_servicos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_contratos_servicos_form();
	}
...
?>
  ...
  // ---------- Validate idservico_
  function do_ajax_form_dbo_contratos_servicos_validate_idservico_(iNumLinha)
  {
    var nomeCampo_idservico_ = "idservico_" + iNumLinha;
    var var_idservico_ = scAjaxGetFieldSelect(nomeCampo_idservico_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_servicos_validate_idservico_(var_idservico_, iNumLinha, var_script_case_init, do_ajax_form_dbo_contratos_servicos_validate_idservico__cb);
  } // do_ajax_form_dbo_contratos_servicos_validate_idservico_

  function do_ajax_form_dbo_contratos_servicos_validate_idservico__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_servicos_validate_idservico__cb

  // ---------- Validate plantao_
  function do_ajax_form_dbo_contratos_servicos_validate_plantao_(iNumLinha)
  {
    var nomeCampo_plantao_ = "plantao_" + iNumLinha;
    var var_plantao_ = scAjaxGetFieldText(nomeCampo_plantao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_servicos_validate_plantao_(var_plantao_, iNumLinha, var_script_case_init, do_ajax_form_dbo_contratos_servicos_validate_plantao__cb);
  } // do_ajax_form_dbo_contratos_servicos_validate_plantao_

  function do_ajax_form_dbo_contratos_servicos_validate_plantao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "plantao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "plantao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "plantao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "plantao_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_servicos_validate_plantao__cb

  // ---------- Validate valores_
  function do_ajax_form_dbo_contratos_servicos_validate_valores_(iNumLinha)
  {
    var nomeCampo_valores_ = "valores_" + iNumLinha;
    var var_valores_ = scAjaxGetFieldText(nomeCampo_valores_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_servicos_validate_valores_(var_valores_, iNumLinha, var_script_case_init, do_ajax_form_dbo_contratos_servicos_validate_valores__cb);
  } // do_ajax_form_dbo_contratos_servicos_validate_valores_

  function do_ajax_form_dbo_contratos_servicos_validate_valores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "valores_" + iLineNumber;
    }
    else
    {
      sFieldValid = "valores_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "valores_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "valores_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_servicos_validate_valores__cb

  // ---------- Validate idcontratos_servicos_
  function do_ajax_form_dbo_contratos_servicos_validate_idcontratos_servicos_(iNumLinha)
  {
    var nomeCampo_idcontratos_servicos_ = "idcontratos_servicos_" + iNumLinha;
    var var_idcontratos_servicos_ = scAjaxGetFieldHidden(nomeCampo_idcontratos_servicos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_servicos_validate_idcontratos_servicos_(var_idcontratos_servicos_, iNumLinha, var_script_case_init, do_ajax_form_dbo_contratos_servicos_validate_idcontratos_servicos__cb);
  } // do_ajax_form_dbo_contratos_servicos_validate_idcontratos_servicos_

  function do_ajax_form_dbo_contratos_servicos_validate_idcontratos_servicos__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idcontratos_servicos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idcontratos_servicos_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idcontratos_servicos_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idcontratos_servicos_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_servicos_validate_idcontratos_servicos__cb

  // ---------- Event onchange idservico_
  function do_ajax_form_dbo_contratos_servicos_event_idservico__onchange(iSeqForm)
  {
    var var_idservico_ = scAjaxGetFieldSelect("idservico_" + iSeqForm);
    var var_valores_ = scAjaxGetFieldText("valores_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_dbo_contratos_servicos_event_idservico__onchange(var_idservico_, var_valores_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_dbo_contratos_servicos_event_idservico__onchange_cb);
  } // do_ajax_form_dbo_contratos_servicos_event_idservico__onchange

  function do_ajax_form_dbo_contratos_servicos_event_idservico__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_contratos_servicos_event_idservico__onchange_cb_after_alert);
  } // do_ajax_form_dbo_contratos_servicos_event_idservico__onchange_cb
  function do_ajax_form_dbo_contratos_servicos_event_idservico__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_dbo_contratos_servicos_event_idservico__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_contratos_servicos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_contratos_servicos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_contratos_servicos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_contratos_servicos_add_new_line_cb);
  } // do_ajax_form_dbo_contratos_servicos_add_new_line

  function do_ajax_form_dbo_contratos_servicos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_dbo_contratos_servicos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_contratos_servicos_backup_line(iNumLinha)
  {
    var var_idcontratos_servicos_ = scAjaxGetFieldHidden("idcontratos_servicos_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_servicos_backup_line(var_idcontratos_servicos_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_contratos_servicos_backup_line_cb);
  } // do_ajax_form_dbo_contratos_servicos_backup_line

  function do_ajax_form_dbo_contratos_servicos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_dbo_contratos_servicos_backup_line_cb

  function do_ajax_form_dbo_contratos_servicos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_contratos_servicos_cancel_insert

  function do_ajax_form_dbo_contratos_servicos_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_contratos_servicos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_contratos_servicos_cancel_update

  function do_ajax_form_dbo_contratos_servicos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_contratos_servicos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_contratos_servicos_table_refresh()
  {
    var var_idcontratos_servicos_ = document.F2.idcontratos_servicos_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_contratos_servicos_table_refresh(var_idcontratos_servicos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_contratos_servicos_table_refresh_cb);
  } //  do_ajax_form_dbo_contratos_servicos_table_refresh

  function do_ajax_form_dbo_contratos_servicos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idcontratos_servicos_.value = scAjaxGetKeyValue("idcontratos_servicos_");
    ...
    scAjaxAlert(do_ajax_form_dbo_contratos_servicos_table_refresh_cb_after_alert);
  } // do_ajax_form_dbo_contratos_servicos_table_refresh_cb
  function do_ajax_form_dbo_contratos_servicos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_contratos_servicos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_contratos_servicos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_dbo_contratos_servicos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_plantao_ = scAjaxGetFieldText("plantao_" + iNumLinha);
    var var_valores_ = scAjaxGetFieldText("valores_" + iNumLinha);
    var var_idcontratos_servicos_ = scAjaxGetFieldHidden("idcontratos_servicos_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_dbo_contratos_servicos_submit_form(var_idservico_, var_plantao_, var_valores_, var_idcontratos_servicos_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_contratos_servicos_submit_form_cb);
  } // do_ajax_form_dbo_contratos_servicos_submit_form

  function do_ajax_form_dbo_contratos_servicos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("plantao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("valores_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idcontratos_servicos_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_contratos_servicos_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_contratos_servicos_submit_form_cb
  function do_ajax_form_dbo_contratos_servicos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_contratos_servicos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_contratos_servicos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_contratos_servicos_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_contratos_servicos_navigate_form();
    }
  }

  function perform_ajax_form_dbo_contratos_servicos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_contratos_servicos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("plantao_" + iNavForm);
      scAjaxHideErrorDisplay("valores_" + iNavForm);
      scAjaxHideErrorDisplay("idcontratos_servicos_" + iNavForm);
    }
    var var_idcontratos_servicos_ = document.F2.idcontratos_servicos_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_contratos_servicos_navigate_form(var_idcontratos_servicos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_contratos_servicos_navigate_form_cb);
  } // do_ajax_form_dbo_contratos_servicos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_contratos_servicos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_contratos_servicos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcontratos_servicos_.value = scAjaxGetKeyValue("idcontratos_servicos_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_contratos_servicos_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_contratos_servicos_navigate_form_cb
  function do_ajax_form_dbo_contratos_servicos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_dbo_contratos_servicos_navigate_form_cb_after_alert
  function sc_hide_form_dbo_contratos_servicos_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "plantao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valores_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idcontratos_servicos_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["plantao_" + iNumLinha] = {"label": "Plantao<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["valores_" + iNumLinha] = {"label": "Valores<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idcontratos_servicos_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idservico_"][iNumLinha] = "idservico_" + iNumLinha;
    ajax_field_mult["plantao_"][iNumLinha] = "plantao_" + iNumLinha;
    ajax_field_mult["valores_"][iNumLinha] = "valores_" + iNumLinha;
    ajax_field_mult["idcontratos_servicos_"][iNumLinha] = "idcontratos_servicos_" + iNumLinha;
    ajax_field_id["idservico_" + iNumLinha] = new Array("hidden_field_label_idservico_", "hidden_field_data_idservico_" + iNumLinha);
    ajax_field_id["plantao_" + iNumLinha] = new Array("hidden_field_label_plantao_", "hidden_field_data_plantao_" + iNumLinha);
    ajax_field_id["valores_" + iNumLinha] = new Array("hidden_field_label_valores_", "hidden_field_data_valores_" + iNumLinha);
    ajax_error_count["idservico_" + iNumLinha] = "off";
    ajax_error_count["plantao_" + iNumLinha] = "off";
    ajax_error_count["valores_" + iNumLinha] = "off";
    ajax_error_count["idcontratos_servicos_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idservico_" + iNumLinha] = "off";
    ajax_read_only["plantao_" + iNumLinha] = "off";
    ajax_read_only["valores_" + iNumLinha] = "off";
    ajax_read_only["idcontratos_servicos_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ...
    ajax_read_only["plantao_" + iNumLinha] = "on";
    ajax_read_only["valores_" + iNumLinha] = "on";
    ajax_read_only["idcontratos_servicos_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["plantao_" + iNumLinha] = null;
    ajax_error_list["valores_" + iNumLinha] = null;
    ajax_error_list["idcontratos_servicos_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "plantao_": new Array(),
    "valores_": new Array(),
    "idcontratos_servicos_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["plantao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["plantao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["plantao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["plantao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["plantao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["valores_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["valores_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["valores_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["valores_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["valores_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idcontratos_servicos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idcontratos_servicos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idcontratos_servicos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idcontratos_servicos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idcontratos_servicos_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['plantao_'])) ? $this->nmgp_cmp_readonly['plantao_'] : 'off';
?>
    scAjaxFieldRead("plantao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valores_'])) ? $this->nmgp_cmp_readonly['valores_'] : 'off';
?>
    scAjaxFieldRead("valores_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcontratos_servicos_'])) ? $this->nmgp_cmp_readonly['idcontratos_servicos_'] : 'on';
?>
    scAjaxFieldRead("idcontratos_servicos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idservico_" + iSeq, "on");
    scAjaxFieldRead("plantao_" + iSeq, "on");
    scAjaxFieldRead("valores_" + iSeq, "on");
    scAjaxFieldRead("idcontratos_servicos_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idservico_" + iRow] || "on" == ajax_error_count["plantao_" + iRow] || "on" == ajax_error_count["valores_" + iRow] || "on" == ajax_error_count["idcontratos_servicos_" + iRow]))
    {
      ...
      $("#hidden_field_data_plantao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valores_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idcontratos_servicos_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idservico_" + iRow] && "off" == ajax_error_count["plantao_" + iRow] && "off" == ajax_error_count["valores_" + iRow] && "off" == ajax_error_count["idcontratos_servicos_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idservico_" + iRow] = "off";
        ajax_error_count["plantao_" + iRow] = "off";
        ajax_error_count["valores_" + iRow] = "off";
        ajax_error_count["idcontratos_servicos_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_plantao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valores_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idcontratos_servicos_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idcontratos_servicos_" == sIndex)
    {
