<?php  
  ...
  session_start() ;
  class pre_lancamento_cabecalho_form_teste
  {
   function pre_lancamento_cabecalho_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "pre_lancamento_cabecalho/img";
...
?> 
<br> 
<B><FONT SIZE="4">pre_lancamento_cabecalho</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="pre_lancamento_cabecalho"> 
</form> 
...
<?php
  ...
  $frm_teste = new pre_lancamento_cabecalho_form_teste();
  $frm_teste->pre_lancamento_cabecalho_teste();
?>
