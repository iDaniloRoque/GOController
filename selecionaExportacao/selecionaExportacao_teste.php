<?php  
  ...
  session_start() ;
  class selecionaExportacao_form_teste
  {
   function selecionaExportacao_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "selecionaExportacao/img";
...
?> 
<br> 
<B><FONT SIZE="4">selecionaExportacao</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="selecionaExportacao"> 
</form> 
...
<?php
  ...
  $frm_teste = new selecionaExportacao_form_teste();
  $frm_teste->selecionaExportacao_teste();
?>
