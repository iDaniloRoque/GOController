<?php  
  ...
  session_start() ;
  class filtro_conferencia_form_teste
  {
   function filtro_conferencia_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "filtro_conferencia/img";
...
?> 
<br> 
<B><FONT SIZE="4">filtro_conferencia</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="filtro_conferencia"> 
</form> 
...
<?php
  ...
  $frm_teste = new filtro_conferencia_form_teste();
  $frm_teste->filtro_conferencia_teste();
?>
