  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_filtro_declaracoes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_filtro_declaracoes_mob_form();
	}
...
?>
  ...
  // ---------- Validate idpessoas
  function do_ajax_filtro_declaracoes_mob_validate_idpessoas()
  {
    var nomeCampo_idpessoas = "idpessoas";
    var var_idpessoas = scAjaxGetFieldSelect(nomeCampo_idpessoas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_declaracoes_mob_validate_idpessoas(var_idpessoas, var_script_case_init, do_ajax_filtro_declaracoes_mob_validate_idpessoas_cb);
  } // do_ajax_filtro_declaracoes_mob_validate_idpessoas

  function do_ajax_filtro_declaracoes_mob_validate_idpessoas_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_mob_validate_idpessoas_cb

  // ---------- Validate idcontratos
  function do_ajax_filtro_declaracoes_mob_validate_idcontratos()
  {
    var nomeCampo_idcontratos = "idcontratos";
    var var_idcontratos = scAjaxGetFieldSelect(nomeCampo_idcontratos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_declaracoes_mob_validate_idcontratos(var_idcontratos, var_script_case_init, do_ajax_filtro_declaracoes_mob_validate_idcontratos_cb);
  } // do_ajax_filtro_declaracoes_mob_validate_idcontratos

  function do_ajax_filtro_declaracoes_mob_validate_idcontratos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_mob_validate_idcontratos_cb

  // ---------- Validate profissional
  function do_ajax_filtro_declaracoes_mob_validate_profissional()
  {
    var nomeCampo_profissional = "profissional";
    var var_profissional = scAjaxGetFieldSelect(nomeCampo_profissional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_declaracoes_mob_validate_profissional(var_profissional, var_script_case_init, do_ajax_filtro_declaracoes_mob_validate_profissional_cb);
  } // do_ajax_filtro_declaracoes_mob_validate_profissional

  function do_ajax_filtro_declaracoes_mob_validate_profissional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "profissional";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_mob_validate_profissional_cb

  // ---------- Validate mesano
  function do_ajax_filtro_declaracoes_mob_validate_mesano()
  {
    var nomeCampo_mesano = "mesano";
    var var_mesano = scAjaxGetFieldText(nomeCampo_mesano);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_declaracoes_mob_validate_mesano(var_mesano, var_script_case_init, do_ajax_filtro_declaracoes_mob_validate_mesano_cb);
  } // do_ajax_filtro_declaracoes_mob_validate_mesano

  function do_ajax_filtro_declaracoes_mob_validate_mesano_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mesano";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_mob_validate_mesano_cb

  // ---------- Refresh idpessoas
  function do_ajax_filtro_declaracoes_mob_refresh_idpessoas()
  {
    var var_idpessoas = scAjaxGetFieldSelect("idpessoas");
    var var_nmgp_refresh_fields = "idcontratos";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_filtro_declaracoes_mob_refresh_idpessoas(var_idpessoas, var_nmgp_refresh_fields, var_script_case_init, do_ajax_filtro_declaracoes_mob_refresh_idpessoas_cb);
  } // do_ajax_filtro_declaracoes_mob_refresh_idpessoas

  function do_ajax_filtro_declaracoes_mob_refresh_idpessoas_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_filtro_declaracoes_mob_refresh_idcontratos();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_mob_refresh_idpessoas_cb

  // ---------- Refresh idcontratos
  function do_ajax_filtro_declaracoes_mob_refresh_idcontratos()
  {
    var var_idcontratos = scAjaxGetFieldSelect("idcontratos");
    var var_idpessoas = scAjaxGetFieldSelect("idpessoas");
    var var_nmgp_refresh_fields = "profissional";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_filtro_declaracoes_mob_refresh_idcontratos(var_idcontratos, var_idpessoas, var_nmgp_refresh_fields, var_script_case_init, do_ajax_filtro_declaracoes_mob_refresh_idcontratos_cb);
  } // do_ajax_filtro_declaracoes_mob_refresh_idcontratos

  function do_ajax_filtro_declaracoes_mob_refresh_idcontratos_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_mob_refresh_idcontratos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_filtro_declaracoes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_filtro_declaracoes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpessoas = scAjaxGetFieldSelect("idpessoas");
    var var_idcontratos = scAjaxGetFieldSelect("idcontratos");
    var var_profissional = scAjaxGetFieldSelect("profissional");
    var var_mesano = scAjaxGetFieldText("mesano");
    ...
    scAjaxProcOn();
    x_ajax_filtro_declaracoes_mob_submit_form(var_idpessoas, var_idcontratos, var_profissional, var_mesano, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_filtro_declaracoes_mob_submit_form_cb);
  } // do_ajax_filtro_declaracoes_mob_submit_form

  function do_ajax_filtro_declaracoes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_filtro_declaracoes_mob_submit_form_cb_after_alert);
  } // do_ajax_filtro_declaracoes_mob_submit_form_cb
  function do_ajax_filtro_declaracoes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_filtro_declaracoes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_filtro_declaracoes_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_filtro_declaracoes_mob_navigate_form, function() {});
    } else {
      perform_ajax_filtro_declaracoes_mob_navigate_form();
    }
  }

  function perform_ajax_filtro_declaracoes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_filtro_declaracoes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['filtro_declaracoes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_filtro_declaracoes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_filtro_declaracoes_mob_navigate_form_cb_after_alert);
  } // do_ajax_filtro_declaracoes_mob_navigate_form_cb
  function do_ajax_filtro_declaracoes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_filtro_declaracoes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_filtro_declaracoes_mob_navigate_form_cb_after_alert
  function sc_hide_filtro_declaracoes_mob_form()
  {
  ...
  ajax_field_list[2] = "profissional";
  ajax_field_list[3] = "mesano";
  ...
  var ajax_error_list = {
    ...
    "profissional": {"label": "Profissional", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mesano": {"label": "Mês/Ano", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "profissional": new Array(),
    "mesano": new Array()
  };
  ajax_field_mult["idpessoas"][1] = "idpessoas";
  ajax_field_mult["idcontratos"][1] = "idcontratos";
  ajax_field_mult["profissional"][1] = "profissional";
  ajax_field_mult["mesano"][1] = "mesano";
  ...
  var ajax_field_id = {
    ...
    "profissional": new Array("hidden_field_label_profissional", "hidden_field_data_profissional"),
    "mesano": new Array("hidden_field_label_mesano", "hidden_field_data_mesano")
  };
