  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_filtro_declaracoes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_filtro_declaracoes_form();
	}
...
?>
  ...
  // ---------- Validate idpessoas
  function do_ajax_filtro_declaracoes_validate_idpessoas()
  {
    var nomeCampo_idpessoas = "idpessoas";
    var var_idpessoas = scAjaxGetFieldSelect(nomeCampo_idpessoas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_declaracoes_validate_idpessoas(var_idpessoas, var_script_case_init, do_ajax_filtro_declaracoes_validate_idpessoas_cb);
  } // do_ajax_filtro_declaracoes_validate_idpessoas

  function do_ajax_filtro_declaracoes_validate_idpessoas_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_validate_idpessoas_cb

  // ---------- Validate idcontratos
  function do_ajax_filtro_declaracoes_validate_idcontratos()
  {
    var nomeCampo_idcontratos = "idcontratos";
    var var_idcontratos = scAjaxGetFieldSelect(nomeCampo_idcontratos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_declaracoes_validate_idcontratos(var_idcontratos, var_script_case_init, do_ajax_filtro_declaracoes_validate_idcontratos_cb);
  } // do_ajax_filtro_declaracoes_validate_idcontratos

  function do_ajax_filtro_declaracoes_validate_idcontratos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_validate_idcontratos_cb

  // ---------- Validate profissional
  function do_ajax_filtro_declaracoes_validate_profissional()
  {
    var nomeCampo_profissional = "profissional";
    var var_profissional = scAjaxGetFieldSelect(nomeCampo_profissional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_declaracoes_validate_profissional(var_profissional, var_script_case_init, do_ajax_filtro_declaracoes_validate_profissional_cb);
  } // do_ajax_filtro_declaracoes_validate_profissional

  function do_ajax_filtro_declaracoes_validate_profissional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_validate_profissional_cb

  // ---------- Validate mesano
  function do_ajax_filtro_declaracoes_validate_mesano()
  {
    var nomeCampo_mesano = "mesano";
    var var_mesano = scAjaxGetFieldText(nomeCampo_mesano);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_declaracoes_validate_mesano(var_mesano, var_script_case_init, do_ajax_filtro_declaracoes_validate_mesano_cb);
  } // do_ajax_filtro_declaracoes_validate_mesano

  function do_ajax_filtro_declaracoes_validate_mesano_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mesano";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_validate_mesano_cb

  // ---------- Refresh idpessoas
  function do_ajax_filtro_declaracoes_refresh_idpessoas()
  {
    var var_idpessoas = scAjaxGetFieldSelect("idpessoas");
    var var_nmgp_refresh_fields = "idcontratos";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_filtro_declaracoes_refresh_idpessoas(var_idpessoas, var_nmgp_refresh_fields, var_script_case_init, do_ajax_filtro_declaracoes_refresh_idpessoas_cb);
  } // do_ajax_filtro_declaracoes_refresh_idpessoas

  function do_ajax_filtro_declaracoes_refresh_idpessoas_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_filtro_declaracoes_refresh_idcontratos();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_refresh_idpessoas_cb

  // ---------- Refresh idcontratos
  function do_ajax_filtro_declaracoes_refresh_idcontratos()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_filtro_declaracoes_refresh_idcontratos(var_idcontratos, var_idpessoas, var_nmgp_refresh_fields, var_script_case_init, do_ajax_filtro_declaracoes_refresh_idcontratos_cb);
  } // do_ajax_filtro_declaracoes_refresh_idcontratos

  function do_ajax_filtro_declaracoes_refresh_idcontratos_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_declaracoes_refresh_idcontratos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_filtro_declaracoes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_filtro_declaracoes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpessoas = scAjaxGetFieldSelect("idpessoas");
    ...
    scAjaxProcOn();
    x_ajax_filtro_declaracoes_submit_form(var_idpessoas, var_idcontratos, var_profissional, var_mesano, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_filtro_declaracoes_submit_form_cb);
  } // do_ajax_filtro_declaracoes_submit_form

  function do_ajax_filtro_declaracoes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_filtro_declaracoes_submit_form_cb_after_alert);
  } // do_ajax_filtro_declaracoes_submit_form_cb
  function do_ajax_filtro_declaracoes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_filtro_declaracoes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_filtro_declaracoes_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_filtro_declaracoes_navigate_form, function() {});
    } else {
      perform_ajax_filtro_declaracoes_navigate_form();
    }
  }

  function perform_ajax_filtro_declaracoes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_filtro_declaracoes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['filtro_declaracoes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_filtro_declaracoes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_filtro_declaracoes_navigate_form_cb_after_alert);
  } // do_ajax_filtro_declaracoes_navigate_form_cb
  function do_ajax_filtro_declaracoes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_filtro_declaracoes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_filtro_declaracoes_navigate_form_cb_after_alert
  function sc_hide_filtro_declaracoes_form()
  {
