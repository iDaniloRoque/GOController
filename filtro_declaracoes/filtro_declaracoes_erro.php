...
$old_error_handler = set_error_handler("filtro_declaracoes_scriptcase_error_handler");

function filtro_declaracoes_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['filtro_declaracoes']['contr_erro']) && $_SESSION['scriptcase']['filtro_declaracoes']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_filtro_declaracoes->contr_filtro_declaracoes->Apl_com_erro = true;
            if ($inicial_filtro_declaracoes->contr_filtro_declaracoes->NM_ajax_flag)
            {
                $inicial_filtro_declaracoes->contr_filtro_declaracoes->NM_ajax_info['errList']['geral_filtro_declaracoes'][] = $msg;
                return;
            }
            filtro_declaracoes_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function filtro_declaracoes_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['filtro_declaracoes'])  && '' != $_SESSION['scriptcase']['error_icon']['filtro_declaracoes'])  ? $_SESSION['scriptcase']['error_icon']['filtro_declaracoes']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['filtro_declaracoes']) && '' != $_SESSION['scriptcase']['error_span_title']['filtro_declaracoes']) ? $_SESSION['scriptcase']['error_span_title']['filtro_declaracoes'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['filtro_declaracoes']) && '' != $_SESSION['scriptcase']['error_icon_title']['filtro_declaracoes']) ? $_SESSION['scriptcase']['error_icon_title']['filtro_declaracoes'] : '';
?>
