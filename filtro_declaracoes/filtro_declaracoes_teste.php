<?php  
  ...
  session_start() ;
  class filtro_declaracoes_form_teste
  {
   function filtro_declaracoes_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "filtro_declaracoes/img";
...
?> 
<br> 
<B><FONT SIZE="4">filtro_declaracoes</FONT></B> 
<br> 
<br> 
...
<?php
  ...
  $frm_teste = new filtro_declaracoes_form_teste();
  $frm_teste->filtro_declaracoes_teste();
?>
