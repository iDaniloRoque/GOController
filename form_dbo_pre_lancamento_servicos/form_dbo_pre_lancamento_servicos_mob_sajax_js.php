  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_pre_lancamento_servicos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_pre_lancamento_servicos_mob_form();
	}
...
?>
  ...
  // ---------- Validate mes_ano
  function do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_mes_ano()
  {
    var nomeCampo_mes_ano = "mes_ano";
    var var_mes_ano = scAjaxGetFieldText(nomeCampo_mes_ano);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_pre_lancamento_servicos_mob_validate_mes_ano(var_mes_ano, var_script_case_init, do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_mes_ano_cb);
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_mes_ano

  function do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_mes_ano_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_mes_ano_cb

  // ---------- Validate idespecialidade_servicos
  function do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_idespecialidade_servicos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_pre_lancamento_servicos_mob_validate_idespecialidade_servicos(var_idespecialidade_servicos, var_script_case_init, do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_idespecialidade_servicos_cb);
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_idespecialidade_servicos

  function do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_idespecialidade_servicos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_idespecialidade_servicos_cb

  // ---------- Validate detalhe
  function do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_detalhe()
  {
    var nomeCampo_detalhe = "detalhe";
    var var_detalhe = scAjaxGetFieldText(nomeCampo_detalhe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_pre_lancamento_servicos_mob_validate_detalhe(var_detalhe, var_script_case_init, do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_detalhe_cb);
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_detalhe

  function do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_detalhe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalhe";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_detalhe_cb

  // ---------- Event onchange idespecialidade_servicos
  function do_ajax_form_dbo_pre_lancamento_servicos_mob_event_idespecialidade_servicos_onchange()
  {
    var var_idespecialidade_servicos = scAjaxGetFieldSelect("idespecialidade_servicos");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_pre_lancamento_servicos_mob_event_idespecialidade_servicos_onchange(var_idespecialidade_servicos, var_script_case_init, do_ajax_form_dbo_pre_lancamento_servicos_mob_event_idespecialidade_servicos_onchange_cb);
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_event_idespecialidade_servicos_onchange

  function do_ajax_form_dbo_pre_lancamento_servicos_mob_event_idespecialidade_servicos_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idespecialidade_servicos";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_pre_lancamento_servicos_mob_event_idespecialidade_servicos_onchange_cb_after_alert);
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_event_idespecialidade_servicos_onchange_cb
  function do_ajax_form_dbo_pre_lancamento_servicos_mob_event_idespecialidade_servicos_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_event_idespecialidade_servicos_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_pre_lancamento_servicos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_pre_lancamento_servicos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_mes_ano = scAjaxGetFieldText("mes_ano");
    var var_idespecialidade_servicos = scAjaxGetFieldSelect("idespecialidade_servicos");
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_pre_lancamento_servicos_mob_submit_form(var_mes_ano, var_idespecialidade_servicos, var_idpre_lancamento, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_pre_lancamento_servicos_mob_submit_form_cb);
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_submit_form

  function do_ajax_form_dbo_pre_lancamento_servicos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("mes_ano");
      scAjaxHideErrorDisplay("idespecialidade_servicos");
      scAjaxHideErrorDisplay("detalhe");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_pre_lancamento_servicos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_submit_form_cb
  function do_ajax_form_dbo_pre_lancamento_servicos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_dbo_pre_lancamento_servicos"] = "off";

  function do_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form();
    }
  }

  function perform_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["grid_dbo_pre_lancamento_servicos"] = "on";
    x_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form(var_idpre_lancamento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form_cb);
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pre_lancamento_servicos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_dbo_pre_lancamento_servicos"] && "nmsc_iframe_liga_grid_dbo_pre_lancamento_servicos" != scMasterDetailIframe["nmsc_iframe_liga_grid_dbo_pre_lancamento_servicos"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_dbo_pre_lancamento_servicos"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_dbo_pre_lancamento_servicos').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form_cb
  function do_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_pre_lancamento_servicos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_dbo_pre_lancamento_servicos_mob_navigate_form_cb_after_alert
  function sc_hide_form_dbo_pre_lancamento_servicos_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_dbo_pre_lancamento_servicos"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "mes_ano";
  ajax_field_list[1] = "idespecialidade_servicos";
  ajax_field_list[2] = "detalhe";
  ...
  var ajax_error_list = {
    "mes_ano": {"label": "Mês/Ano", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "detalhe": {"label": "detalhe", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["mes_ano"][1] = "mes_ano";
  ajax_field_mult["idespecialidade_servicos"][1] = "idespecialidade_servicos";
  ajax_field_mult["detalhe"][1] = "detalhe";

  var ajax_field_id = {
    "mes_ano": new Array("hidden_field_label_mes_ano", "hidden_field_data_mes_ano"),
    ...
    "detalhe": new Array("hidden_field_label_detalhe", "hidden_field_data_detalhe")
  };
