...
function scHidePage(pageNo) {
	$("#id_form_dbo_pre_lancamento_servicos_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_data_do_servico" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_data_do_servico(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_momento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_momento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_momento_geracao_lote" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_dbo_pre_lancamento_servicos_mob_validate_momento_geracao_lote(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_anexo_guia" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_dbo_pre_lancamento_servicos_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_dbo_pre_lancamento_servicos_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
