...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['idfilial'] = "Id Filial";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
...
<?php } else { $sc_hidden_no++; ?>
<?php  $this->idfilial_1 = explode(",", trim($this->idfilial)) ; ?>
    ...
    <TD class="scFormDataOdd css_idfilial_line" id="hidden_field_data_idfilial" style="<?php echo $sStyleHidden_idfilial; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idfilial_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   echo " <span id=\"idAjaxSelect_idfilial\" class=\"" . $this->classes_100perc_fields['span_select'] . "\"><select class=\"sc-js-input scFormObjectOdd css_idfilial_obj" . $this->classes_100perc_fields['input'] . "\" style=\"\" id=\"id_sc_field_idfilial\" name=\"idfilial_orig\" size=\"7\" multiple onDblClick=\"nm_add_sel('idfilial_orig', 'idfilial_dest', null);  \" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          ...
          foreach ($this->idfilial_1 as $Dados)
          {
   ...
   echo "<div class='scBtnPassField' id='idfilial_all_right'>";
   echo         $sCondStyle = '';
?>
<?php
        $buttonMacroDisabled = '';
...
?>
<?php echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('idfilial_orig', 'idfilial_dest', null);    return false;", "nm_add_all('idfilial_orig', 'idfilial_dest', null);    return false;", "Bbpassfld_rightall", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
?>
<?php echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('idfilial_orig', 'idfilial_dest', null);    return false;", "nm_add_sel('idfilial_orig', 'idfilial_dest', null);    return false;", "Bbpassfld_righ", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
?>
<?php echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('idfilial_dest', 'idfilial_orig', null);    return false;", "nm_del_sel('idfilial_dest', 'idfilial_orig', null);    return false;", "Bbpassfld_left", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
 
<?php
;
   echo "</div>";
   echo "<div class='scBtnPassField' id='idfilial_all_left'>";
   echo         $sCondStyle = '';
?>
<?php
        $buttonMacroDisabled = '';
...
?>
<?php echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('idfilial_dest', 'idfilial_orig', null);    return false;", "nm_del_all('idfilial_dest', 'idfilial_orig', null);    return false;", "Bbpassfld_leftall", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
;
   ...
   echo "</td>";
   echo "<td>";
   echo " <select class=\"sc-js-input scFormObjectOdd css_idfilial_obj" . $this->classes_100perc_fields['input'] . "\" style=\"\" name=\"idfilial_dest\"  onBlur=\"scCssBlur(this);\"  onFocus=\"scCssFocus(this);\"  size=7 multiple onDblClick=\"nm_del_sel('idfilial_dest', 'idfilial_orig', null);  \" alt=\"{type: 'select', enterTab: false}\">";
   $x = 0 ; 
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   echo " </select>" ; 
   echo " <input type=\"hidden\" name=\"idfilial\" value=\"\">" ; 
   echo "</td></tr></table>";
   echo " <script>document.F1.idfilial_dest.selectedIndex = -1;</script>" ; 
   echo "\r" ; 
   echo "</span>";
?> 
<?php  }?>
