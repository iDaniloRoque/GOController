...
<?php
   ...
   echo " <span id=\"idAjaxSelect_idfilial\" class=\"" . $this->classes_100perc_fields['span_select'] . "\"><select class=\"sc-js-input scFormObjectOdd css_idfilial_obj" . $this->classes_100perc_fields['input'] . "\" style=\"\" id=\"id_sc_field_idfilial\" name=\"idfilial\" size=\"7\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
