<?php  
  ...
  session_start() ;
  class dashboard_pag_principal_form_teste
  {
   function dashboard_pag_principal_teste()
   {
...
<html> 
<HEAD>
 <title>dashboard_pag_principal</title> 
...
<?php  
  ...
  $path_img     = $path_img . "dashboard_pag_principal/img";
  if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'dashboard_pag_principal')
  {
...
?> 
<br> 
<B><FONT SIZE="4">dashboard_pag_principal</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="dashboard_pag_principal"> 
</form> 
...
<?php
  ...
  $frm_teste = new dashboard_pag_principal_form_teste();
  $frm_teste->dashboard_pag_principal_teste();
?>
