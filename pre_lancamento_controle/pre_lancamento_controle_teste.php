<?php  
  ...
  session_start() ;
  class pre_lancamento_controle_form_teste
  {
   function pre_lancamento_controle_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "pre_lancamento_controle/img";
...
?> 
<br> 
<B><FONT SIZE="4">pre_lancamento_controle</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="pre_lancamento_controle"> 
</form> 
<script language=javascript> 
 document.Fedit.usr_idFilial.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new pre_lancamento_controle_form_teste();
  $frm_teste->pre_lancamento_controle_teste();
?>
