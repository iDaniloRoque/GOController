  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_pre_lancamento_controle_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_pre_lancamento_controle_mob_form();
	}
...
?>
  ...
  // ---------- Validate num_identificador
  function do_ajax_pre_lancamento_controle_mob_validate_num_identificador()
  {
    var nomeCampo_num_identificador = "num_identificador";
    var var_num_identificador = scAjaxGetFieldText(nomeCampo_num_identificador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_controle_mob_validate_num_identificador(var_num_identificador, var_script_case_init, do_ajax_pre_lancamento_controle_mob_validate_num_identificador_cb);
  } // do_ajax_pre_lancamento_controle_mob_validate_num_identificador

  function do_ajax_pre_lancamento_controle_mob_validate_num_identificador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "num_identificador";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_controle_mob_validate_num_identificador_cb

  // ---------- Validate mensagem
  function do_ajax_pre_lancamento_controle_mob_validate_mensagem()
  {
  } // do_ajax_pre_lancamento_controle_mob_validate_mensagem

  function do_ajax_pre_lancamento_controle_mob_validate_mensagem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_controle_mob_validate_mensagem_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_pre_lancamento_controle_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_pre_lancamento_controle_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_num_identificador = scAjaxGetFieldText("num_identificador");
    ...
    scAjaxProcOn();
    x_ajax_pre_lancamento_controle_mob_submit_form(var_num_identificador, var_mensagem, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_pre_lancamento_controle_mob_submit_form_cb);
  } // do_ajax_pre_lancamento_controle_mob_submit_form

  function do_ajax_pre_lancamento_controle_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_pre_lancamento_controle_mob_submit_form_cb_after_alert);
  } // do_ajax_pre_lancamento_controle_mob_submit_form_cb
  function do_ajax_pre_lancamento_controle_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_pre_lancamento_controle_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_pre_lancamento_controle_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_pre_lancamento_controle_mob_navigate_form, function() {});
    } else {
      perform_ajax_pre_lancamento_controle_mob_navigate_form();
    }
  }

  function perform_ajax_pre_lancamento_controle_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_pre_lancamento_controle_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_controle_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_pre_lancamento_controle_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_pre_lancamento_controle_mob_navigate_form_cb_after_alert);
  } // do_ajax_pre_lancamento_controle_mob_navigate_form_cb
  function do_ajax_pre_lancamento_controle_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_pre_lancamento_controle_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_pre_lancamento_controle_mob_navigate_form_cb_after_alert
  function sc_hide_pre_lancamento_controle_mob_form()
  {
  ...
  ajax_field_list[0] = "num_identificador";
  ajax_field_list[1] = "mensagem";
  ...
  var ajax_error_list = {
    "num_identificador": {"label": "Numero Identificador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mensagem": {"label": "mensagem", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "num_identificador": new Array(),
    "mensagem": new Array()
  };
  ajax_field_mult["num_identificador"][1] = "num_identificador";
  ajax_field_mult["mensagem"][1] = "mensagem";

  var ajax_field_id = {
    "num_identificador": new Array("hidden_field_label_num_identificador", "hidden_field_data_num_identificador"),
    "mensagem": new Array("hidden_field_label_mensagem", "hidden_field_data_mensagem")
  };

  var ajax_read_only = {
    "num_identificador": "off",
    "mensagem": "off"
  };
