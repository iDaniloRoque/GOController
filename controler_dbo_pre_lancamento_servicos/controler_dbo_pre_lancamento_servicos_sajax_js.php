  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_controler_dbo_pre_lancamento_servicos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_controler_dbo_pre_lancamento_servicos_form();
	}
...
?>
  ...
  // ---------- Validate periodo
  function do_ajax_controler_dbo_pre_lancamento_servicos_validate_periodo()
  {
    var nomeCampo_periodo = "periodo";
    var var_periodo = scAjaxGetFieldText(nomeCampo_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_controler_dbo_pre_lancamento_servicos_validate_periodo(var_periodo, var_script_case_init, do_ajax_controler_dbo_pre_lancamento_servicos_validate_periodo_cb);
  } // do_ajax_controler_dbo_pre_lancamento_servicos_validate_periodo

  function do_ajax_controler_dbo_pre_lancamento_servicos_validate_periodo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_controler_dbo_pre_lancamento_servicos_validate_periodo_cb

  // ---------- Validate especialidade
  function do_ajax_controler_dbo_pre_lancamento_servicos_validate_especialidade()
  {
    var nomeCampo_especialidade = "especialidade";
    var var_especialidade = scAjaxGetFieldSelect(nomeCampo_especialidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_controler_dbo_pre_lancamento_servicos_validate_especialidade(var_especialidade, var_script_case_init, do_ajax_controler_dbo_pre_lancamento_servicos_validate_especialidade_cb);
  } // do_ajax_controler_dbo_pre_lancamento_servicos_validate_especialidade

  function do_ajax_controler_dbo_pre_lancamento_servicos_validate_especialidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_controler_dbo_pre_lancamento_servicos_validate_especialidade_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_controler_dbo_pre_lancamento_servicos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_controler_dbo_pre_lancamento_servicos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_controler_dbo_pre_lancamento_servicos_submit_form(var_periodo, var_especialidade, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_controler_dbo_pre_lancamento_servicos_submit_form_cb);
  } // do_ajax_controler_dbo_pre_lancamento_servicos_submit_form

  function do_ajax_controler_dbo_pre_lancamento_servicos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_controler_dbo_pre_lancamento_servicos_submit_form_cb_after_alert);
  } // do_ajax_controler_dbo_pre_lancamento_servicos_submit_form_cb
  function do_ajax_controler_dbo_pre_lancamento_servicos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_controler_dbo_pre_lancamento_servicos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_controler_dbo_pre_lancamento_servicos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_controler_dbo_pre_lancamento_servicos_navigate_form, function() {});
    } else {
      perform_ajax_controler_dbo_pre_lancamento_servicos_navigate_form();
    }
  }

  function perform_ajax_controler_dbo_pre_lancamento_servicos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_controler_dbo_pre_lancamento_servicos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['controler_dbo_pre_lancamento_servicos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_controler_dbo_pre_lancamento_servicos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_controler_dbo_pre_lancamento_servicos_navigate_form_cb_after_alert);
  } // do_ajax_controler_dbo_pre_lancamento_servicos_navigate_form_cb
  function do_ajax_controler_dbo_pre_lancamento_servicos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_controler_dbo_pre_lancamento_servicos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_controler_dbo_pre_lancamento_servicos_navigate_form_cb_after_alert
  function sc_hide_controler_dbo_pre_lancamento_servicos_form()
  {
