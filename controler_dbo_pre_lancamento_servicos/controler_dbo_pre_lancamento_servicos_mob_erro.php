...
$old_error_handler = set_error_handler("controler_dbo_pre_lancamento_servicos_mob_scriptcase_error_handler");

function controler_dbo_pre_lancamento_servicos_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['controler_dbo_pre_lancamento_servicos_mob']['contr_erro']) && $_SESSION['scriptcase']['controler_dbo_pre_lancamento_servicos_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_controler_dbo_pre_lancamento_servicos_mob->contr_controler_dbo_pre_lancamento_servicos_mob->Apl_com_erro = true;
            if ($inicial_controler_dbo_pre_lancamento_servicos_mob->contr_controler_dbo_pre_lancamento_servicos_mob->NM_ajax_flag)
            {
                $inicial_controler_dbo_pre_lancamento_servicos_mob->contr_controler_dbo_pre_lancamento_servicos_mob->NM_ajax_info['errList']['geral_controler_dbo_pre_lancamento_servicos_mob'][] = $msg;
                return;
            }
            controler_dbo_pre_lancamento_servicos_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function controler_dbo_pre_lancamento_servicos_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['controler_dbo_pre_lancamento_servicos_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['controler_dbo_pre_lancamento_servicos_mob'])  ? $_SESSION['scriptcase']['error_icon']['controler_dbo_pre_lancamento_servicos_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['controler_dbo_pre_lancamento_servicos_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['controler_dbo_pre_lancamento_servicos_mob']) ? $_SESSION['scriptcase']['error_span_title']['controler_dbo_pre_lancamento_servicos_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['controler_dbo_pre_lancamento_servicos_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['controler_dbo_pre_lancamento_servicos_mob']) ? $_SESSION['scriptcase']['error_icon_title']['controler_dbo_pre_lancamento_servicos_mob'] : '';
?>
