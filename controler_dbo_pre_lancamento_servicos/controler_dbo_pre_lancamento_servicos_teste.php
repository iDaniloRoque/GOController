<?php  
  ...
  session_start() ;
  class controler_dbo_pre_lancamento_servicos_form_teste
  {
   function controler_dbo_pre_lancamento_servicos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "controler_dbo_pre_lancamento_servicos/img";
...
?> 
<br> 
<B><FONT SIZE="4">controler_dbo_pre_lancamento_servicos</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="controler_dbo_pre_lancamento_servicos"> 
</form> 
...
<?php
  ...
  $frm_teste = new controler_dbo_pre_lancamento_servicos_form_teste();
  $frm_teste->controler_dbo_pre_lancamento_servicos_teste();
?>
