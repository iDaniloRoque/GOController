  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_contratos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_contratos_mob_form();
	}
...
?>
  ...
  // ---------- Validate idcontratos
  function do_ajax_form_dbo_contratos_mob_validate_idcontratos()
  {
    var nomeCampo_idcontratos = "idcontratos";
    var var_idcontratos = scAjaxGetFieldHidden(nomeCampo_idcontratos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_idcontratos(var_idcontratos, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_idcontratos_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_idcontratos

  function do_ajax_form_dbo_contratos_mob_validate_idcontratos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcontratos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_idcontratos_cb

  // ---------- Validate idpessoas
  function do_ajax_form_dbo_contratos_mob_validate_idpessoas()
  {
    var nomeCampo_idpessoas = "idpessoas";
    var var_idpessoas = scAjaxGetFieldSelect(nomeCampo_idpessoas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_idpessoas(var_idpessoas, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_idpessoas_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_idpessoas

  function do_ajax_form_dbo_contratos_mob_validate_idpessoas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_idpessoas_cb

  // ---------- Validate idfilial
  function do_ajax_form_dbo_contratos_mob_validate_idfilial()
  {
    var nomeCampo_idfilial = "idfilial";
    var var_idfilial = scAjaxGetFieldSelect(nomeCampo_idfilial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_idfilial(var_idfilial, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_idfilial_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_idfilial

  function do_ajax_form_dbo_contratos_mob_validate_idfilial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idfilial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_idfilial_cb

  // ---------- Validate numero_do_contrato
  function do_ajax_form_dbo_contratos_mob_validate_numero_do_contrato()
  {
    var nomeCampo_numero_do_contrato = "numero_do_contrato";
    var var_numero_do_contrato = scAjaxGetFieldText(nomeCampo_numero_do_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_numero_do_contrato(var_numero_do_contrato, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_numero_do_contrato_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_numero_do_contrato

  function do_ajax_form_dbo_contratos_mob_validate_numero_do_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero_do_contrato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_numero_do_contrato_cb

  // ---------- Validate data_inicio_contrato
  function do_ajax_form_dbo_contratos_mob_validate_data_inicio_contrato()
  {
    var nomeCampo_data_inicio_contrato = "data_inicio_contrato";
    var var_data_inicio_contrato = scAjaxGetFieldText(nomeCampo_data_inicio_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_data_inicio_contrato(var_data_inicio_contrato, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_data_inicio_contrato_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_data_inicio_contrato

  function do_ajax_form_dbo_contratos_mob_validate_data_inicio_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_inicio_contrato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_data_inicio_contrato_cb

  // ---------- Validate data_final_contrato
  function do_ajax_form_dbo_contratos_mob_validate_data_final_contrato()
  {
    var nomeCampo_data_final_contrato = "data_final_contrato";
    var var_data_final_contrato = scAjaxGetFieldText(nomeCampo_data_final_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_data_final_contrato(var_data_final_contrato, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_data_final_contrato_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_data_final_contrato

  function do_ajax_form_dbo_contratos_mob_validate_data_final_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_final_contrato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_data_final_contrato_cb

  // ---------- Validate momento
  function do_ajax_form_dbo_contratos_mob_validate_momento()
  {
    var nomeCampo_momento = "momento";
    var var_momento = scAjaxGetFieldText(nomeCampo_momento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_momento(var_momento, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_momento_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_momento

  function do_ajax_form_dbo_contratos_mob_validate_momento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "momento";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_momento_cb

  // ---------- Validate usuario
  function do_ajax_form_dbo_contratos_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_usuario_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_usuario

  function do_ajax_form_dbo_contratos_mob_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_usuario_cb

  // ---------- Validate situacao
  function do_ajax_form_dbo_contratos_mob_validate_situacao()
  {
    var nomeCampo_situacao = "situacao";
    var var_situacao = scAjaxGetFieldSelect(nomeCampo_situacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_situacao(var_situacao, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_situacao_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_situacao

  function do_ajax_form_dbo_contratos_mob_validate_situacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_situacao_cb

  // ---------- Validate idtipo_servico
  function do_ajax_form_dbo_contratos_mob_validate_idtipo_servico()
  {
    var nomeCampo_idtipo_servico = "idtipo_servico";
    var var_idtipo_servico = scAjaxGetFieldSelect(nomeCampo_idtipo_servico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_idtipo_servico(var_idtipo_servico, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_idtipo_servico_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_idtipo_servico

  function do_ajax_form_dbo_contratos_mob_validate_idtipo_servico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtipo_servico";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_idtipo_servico_cb

  // ---------- Validate observacao
  function do_ajax_form_dbo_contratos_mob_validate_observacao()
  {
    var nomeCampo_observacao = "observacao";
    var var_observacao = scAjaxGetFieldText(nomeCampo_observacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_observacao(var_observacao, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_observacao_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_observacao

  function do_ajax_form_dbo_contratos_mob_validate_observacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_observacao_cb

  // ---------- Validate servicos
  function do_ajax_form_dbo_contratos_mob_validate_servicos()
  {
    var nomeCampo_servicos = "servicos";
    var var_servicos = scAjaxGetFieldText(nomeCampo_servicos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_servicos(var_servicos, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_servicos_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_servicos

  function do_ajax_form_dbo_contratos_mob_validate_servicos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "servicos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_servicos_cb

  // ---------- Validate funcionarios
  function do_ajax_form_dbo_contratos_mob_validate_funcionarios()
  {
    var nomeCampo_funcionarios = "funcionarios";
    var var_funcionarios = scAjaxGetFieldText(nomeCampo_funcionarios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_funcionarios(var_funcionarios, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_funcionarios_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_funcionarios

  function do_ajax_form_dbo_contratos_mob_validate_funcionarios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "funcionarios";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_funcionarios_cb

  // ---------- Validate especialidades
  function do_ajax_form_dbo_contratos_mob_validate_especialidades()
  {
    var nomeCampo_especialidades = "especialidades";
    var var_especialidades = scAjaxGetFieldText(nomeCampo_especialidades);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_mob_validate_especialidades(var_especialidades, var_script_case_init, do_ajax_form_dbo_contratos_mob_validate_especialidades_cb);
  } // do_ajax_form_dbo_contratos_mob_validate_especialidades

  function do_ajax_form_dbo_contratos_mob_validate_especialidades_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_mob_validate_especialidades_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_contratos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_contratos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idcontratos = scAjaxGetFieldHidden("idcontratos");
    var var_idpessoas = scAjaxGetFieldSelect("idpessoas");
    var var_idfilial = scAjaxGetFieldSelect("idfilial");
    var var_numero_do_contrato = scAjaxGetFieldText("numero_do_contrato");
    var var_data_inicio_contrato = scAjaxGetFieldText("data_inicio_contrato");
    var var_data_final_contrato = scAjaxGetFieldText("data_final_contrato");
    ...
    var var_idtipo_servico = scAjaxGetFieldSelect("idtipo_servico");
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_contratos_mob_submit_form(var_idcontratos, var_idpessoas, var_idfilial, var_numero_do_contrato, var_data_inicio_contrato, var_data_final_contrato, var_momento, var_usuario, var_situacao, var_idtipo_servico, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_contratos_mob_submit_form_cb);
  } // do_ajax_form_dbo_contratos_mob_submit_form

  function do_ajax_form_dbo_contratos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idcontratos");
      scAjaxHideErrorDisplay("idpessoas");
      scAjaxHideErrorDisplay("idfilial");
      scAjaxHideErrorDisplay("numero_do_contrato");
      scAjaxHideErrorDisplay("data_inicio_contrato");
      scAjaxHideErrorDisplay("data_final_contrato");
      scAjaxHideErrorDisplay("momento");
      scAjaxHideErrorDisplay("usuario");
      scAjaxHideErrorDisplay("situacao");
      scAjaxHideErrorDisplay("idtipo_servico");
      scAjaxHideErrorDisplay("observacao");
      scAjaxHideErrorDisplay("servicos");
      scAjaxHideErrorDisplay("funcionarios");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_contratos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_contratos_mob_submit_form_cb
  function do_ajax_form_dbo_contratos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_contratos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_dbo_observacao_contratos_mob"] = "off";
  scStatusDetail["form_dbo_contratos_servicos_mob"] = "off";
  scStatusDetail["form_dbo_contratos_funcionarios_mob"] = "off";
  scStatusDetail["form_dbo_contratos_especialidades_mob"] = "off";

  function do_ajax_form_dbo_contratos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_contratos_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_contratos_mob_navigate_form();
    }
  }

  function perform_ajax_form_dbo_contratos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("funcionarios");
    scAjaxHideErrorDisplay("especialidades");
    var var_idcontratos = document.F2.idcontratos.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_dbo_observacao_contratos_mob"] = "on";
    scStatusDetail["form_dbo_contratos_servicos_mob"] = "on";
    scStatusDetail["form_dbo_contratos_funcionarios_mob"] = "on";
    scStatusDetail["form_dbo_contratos_especialidades_mob"] = "on";
    x_ajax_form_dbo_contratos_mob_navigate_form(var_idcontratos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_contratos_mob_navigate_form_cb);
  } // do_ajax_form_dbo_contratos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_contratos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_contratos_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcontratos.value = scAjaxGetKeyValue("idcontratos");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_dbo_observacao_contratos_mob"] && "nmsc_iframe_liga_form_dbo_observacao_contratos_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_dbo_observacao_contratos_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_dbo_observacao_contratos_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_dbo_observacao_contratos_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_dbo_observacao_contratos_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_dbo_observacao_contratos_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_servicos_mob"] && "nmsc_iframe_liga_form_dbo_contratos_servicos_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_servicos_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_servicos_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_servicos_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_servicos_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_servicos_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_funcionarios_mob"] && "nmsc_iframe_liga_form_dbo_contratos_funcionarios_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_funcionarios_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_funcionarios_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_funcionarios_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_funcionarios_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_funcionarios_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_especialidades_mob"] && "nmsc_iframe_liga_form_dbo_contratos_especialidades_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_especialidades_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_especialidades_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_especialidades_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_especialidades_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_especialidades_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_contratos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_contratos_mob_navigate_form_cb
  function do_ajax_form_dbo_contratos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_contratos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_contratos_mob_navigate_form_cb_after_alert
  function sc_hide_form_dbo_contratos_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_dbo_observacao_contratos_mob"] && "off" == scStatusDetail["form_dbo_contratos_servicos_mob"] && "off" == scStatusDetail["form_dbo_contratos_funcionarios_mob"] && "off" == scStatusDetail["form_dbo_contratos_especialidades_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "idcontratos";
  ajax_field_list[1] = "idpessoas";
  ajax_field_list[2] = "idfilial";
  ajax_field_list[3] = "numero_do_contrato";
  ajax_field_list[4] = "data_inicio_contrato";
  ajax_field_list[5] = "data_final_contrato";
  ajax_field_list[6] = "momento";
  ajax_field_list[7] = "usuario";
  ajax_field_list[8] = "situacao";
  ajax_field_list[9] = "idtipo_servico";
  ajax_field_list[10] = "observacao";
  ajax_field_list[11] = "servicos";
  ajax_field_list[12] = "funcionarios";
  ...
  var ajax_error_list = {
    "idcontratos": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idpessoas": {"label": "Contratada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idfilial": {"label": "Filial", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numero_do_contrato": {"label": "Nº Contrato", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_inicio_contrato": {"label": "Data Inicio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_final_contrato": {"label": "Data Final", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "idtipo_servico": {"label": "Natureza do Serviço Executado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "servicos": {"label": "servicos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "funcionarios": {"label": "Funcionários", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idcontratos": new Array(),
    "idpessoas": new Array(),
    "idfilial": new Array(),
    "numero_do_contrato": new Array(),
    "data_inicio_contrato": new Array(),
    "data_final_contrato": new Array(),
    "momento": new Array(),
    "usuario": new Array(),
    "situacao": new Array(),
    "idtipo_servico": new Array(),
    "observacao": new Array(),
    "servicos": new Array(),
    "funcionarios": new Array(),
    "especialidades": new Array()
  };
  ajax_field_mult["idcontratos"][1] = "idcontratos";
  ajax_field_mult["idpessoas"][1] = "idpessoas";
  ajax_field_mult["idfilial"][1] = "idfilial";
  ajax_field_mult["numero_do_contrato"][1] = "numero_do_contrato";
  ajax_field_mult["data_inicio_contrato"][1] = "data_inicio_contrato";
  ajax_field_mult["data_final_contrato"][1] = "data_final_contrato";
  ajax_field_mult["momento"][1] = "momento";
  ajax_field_mult["usuario"][1] = "usuario";
  ajax_field_mult["situacao"][1] = "situacao";
  ajax_field_mult["idtipo_servico"][1] = "idtipo_servico";
  ajax_field_mult["observacao"][1] = "observacao";
  ajax_field_mult["servicos"][1] = "servicos";
  ajax_field_mult["funcionarios"][1] = "funcionarios";
  ajax_field_mult["especialidades"][1] = "especialidades";

  var ajax_field_id = {
    "idcontratos": new Array("hidden_field_label_idcontratos", "hidden_field_data_idcontratos"),
    "idpessoas": new Array("hidden_field_label_idpessoas", "hidden_field_data_idpessoas"),
    "idfilial": new Array("hidden_field_label_idfilial", "hidden_field_data_idfilial"),
    "numero_do_contrato": new Array("hidden_field_label_numero_do_contrato", "hidden_field_data_numero_do_contrato"),
    "data_inicio_contrato": new Array("hidden_field_label_data_inicio_contrato", "hidden_field_data_data_inicio_contrato"),
    "data_final_contrato": new Array("hidden_field_label_data_final_contrato", "hidden_field_data_data_final_contrato"),
    "situacao": new Array("hidden_field_label_situacao", "hidden_field_data_situacao"),
    "idtipo_servico": new Array("hidden_field_label_idtipo_servico", "hidden_field_data_idtipo_servico"),
    "observacao": new Array("hidden_field_label_observacao", "hidden_field_data_observacao"),
    "servicos": new Array("hidden_field_label_servicos", "hidden_field_data_servicos"),
    "funcionarios": new Array("hidden_field_label_funcionarios", "hidden_field_data_funcionarios"),
  ...
  var ajax_read_only = {
    ...
    "idpessoas": "off",
    "idfilial": "off",
    "numero_do_contrato": "off",
    "data_inicio_contrato": "off",
    "data_final_contrato": "off",
    "momento": "off",
    "usuario": "off",
    "situacao": "off",
    "idtipo_servico": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("data_inicio_contrato" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
