  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_contratos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_contratos_form();
	}
...
?>
  ...
  function do_ajax_form_dbo_contratos_validate_idcontratos()
  {
    var nomeCampo_idcontratos = "idcontratos";
    var var_idcontratos = scAjaxGetFieldHidden(nomeCampo_idcontratos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_idcontratos(var_idcontratos, var_script_case_init, do_ajax_form_dbo_contratos_validate_idcontratos_cb);
  } // do_ajax_form_dbo_contratos_validate_idcontratos

  function do_ajax_form_dbo_contratos_validate_idcontratos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_idcontratos_cb

  // ---------- Validate idpessoas
  function do_ajax_form_dbo_contratos_validate_idpessoas()
  {
    var nomeCampo_idpessoas = "idpessoas";
    var var_idpessoas = scAjaxGetFieldSelect(nomeCampo_idpessoas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_idpessoas(var_idpessoas, var_script_case_init, do_ajax_form_dbo_contratos_validate_idpessoas_cb);
  } // do_ajax_form_dbo_contratos_validate_idpessoas

  function do_ajax_form_dbo_contratos_validate_idpessoas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_idpessoas_cb

  // ---------- Validate idfilial
  function do_ajax_form_dbo_contratos_validate_idfilial()
  {
    var nomeCampo_idfilial = "idfilial";
    var var_idfilial = scAjaxGetFieldSelect(nomeCampo_idfilial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_idfilial(var_idfilial, var_script_case_init, do_ajax_form_dbo_contratos_validate_idfilial_cb);
  } // do_ajax_form_dbo_contratos_validate_idfilial

  function do_ajax_form_dbo_contratos_validate_idfilial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_idfilial_cb

  // ---------- Validate numero_do_contrato
  function do_ajax_form_dbo_contratos_validate_numero_do_contrato()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_numero_do_contrato(var_numero_do_contrato, var_script_case_init, do_ajax_form_dbo_contratos_validate_numero_do_contrato_cb);
  } // do_ajax_form_dbo_contratos_validate_numero_do_contrato

  function do_ajax_form_dbo_contratos_validate_numero_do_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_numero_do_contrato_cb

  // ---------- Validate data_inicio_contrato
  function do_ajax_form_dbo_contratos_validate_data_inicio_contrato()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_data_inicio_contrato(var_data_inicio_contrato, var_script_case_init, do_ajax_form_dbo_contratos_validate_data_inicio_contrato_cb);
  } // do_ajax_form_dbo_contratos_validate_data_inicio_contrato

  function do_ajax_form_dbo_contratos_validate_data_inicio_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_data_inicio_contrato_cb

  // ---------- Validate data_final_contrato
  function do_ajax_form_dbo_contratos_validate_data_final_contrato()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_data_final_contrato(var_data_final_contrato, var_script_case_init, do_ajax_form_dbo_contratos_validate_data_final_contrato_cb);
  } // do_ajax_form_dbo_contratos_validate_data_final_contrato

  function do_ajax_form_dbo_contratos_validate_data_final_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_data_final_contrato_cb

  // ---------- Validate momento
  function do_ajax_form_dbo_contratos_validate_momento()
  {
    var nomeCampo_momento = "momento";
    var var_momento = scAjaxGetFieldText(nomeCampo_momento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_momento(var_momento, var_script_case_init, do_ajax_form_dbo_contratos_validate_momento_cb);
  } // do_ajax_form_dbo_contratos_validate_momento

  function do_ajax_form_dbo_contratos_validate_momento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "momento";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_momento_cb

  // ---------- Validate usuario
  function do_ajax_form_dbo_contratos_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_dbo_contratos_validate_usuario_cb);
  } // do_ajax_form_dbo_contratos_validate_usuario

  function do_ajax_form_dbo_contratos_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_usuario_cb

  // ---------- Validate situacao
  function do_ajax_form_dbo_contratos_validate_situacao()
  {
    var nomeCampo_situacao = "situacao";
    var var_situacao = scAjaxGetFieldSelect(nomeCampo_situacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_situacao(var_situacao, var_script_case_init, do_ajax_form_dbo_contratos_validate_situacao_cb);
  } // do_ajax_form_dbo_contratos_validate_situacao

  function do_ajax_form_dbo_contratos_validate_situacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_situacao_cb

  // ---------- Validate idtipo_servico
  function do_ajax_form_dbo_contratos_validate_idtipo_servico()
  {
    var nomeCampo_idtipo_servico = "idtipo_servico";
    var var_idtipo_servico = scAjaxGetFieldSelect(nomeCampo_idtipo_servico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_idtipo_servico(var_idtipo_servico, var_script_case_init, do_ajax_form_dbo_contratos_validate_idtipo_servico_cb);
  } // do_ajax_form_dbo_contratos_validate_idtipo_servico

  function do_ajax_form_dbo_contratos_validate_idtipo_servico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_idtipo_servico_cb

  // ---------- Validate observacao
  function do_ajax_form_dbo_contratos_validate_observacao()
  {
    var nomeCampo_observacao = "observacao";
    var var_observacao = scAjaxGetFieldText(nomeCampo_observacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_observacao(var_observacao, var_script_case_init, do_ajax_form_dbo_contratos_validate_observacao_cb);
  } // do_ajax_form_dbo_contratos_validate_observacao

  function do_ajax_form_dbo_contratos_validate_observacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_observacao_cb

  // ---------- Validate servicos
  function do_ajax_form_dbo_contratos_validate_servicos()
  {
    var nomeCampo_servicos = "servicos";
    var var_servicos = scAjaxGetFieldText(nomeCampo_servicos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_servicos(var_servicos, var_script_case_init, do_ajax_form_dbo_contratos_validate_servicos_cb);
  } // do_ajax_form_dbo_contratos_validate_servicos

  function do_ajax_form_dbo_contratos_validate_servicos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_servicos_cb

  // ---------- Validate funcionarios
  function do_ajax_form_dbo_contratos_validate_funcionarios()
  {
    var nomeCampo_funcionarios = "funcionarios";
    var var_funcionarios = scAjaxGetFieldText(nomeCampo_funcionarios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_funcionarios(var_funcionarios, var_script_case_init, do_ajax_form_dbo_contratos_validate_funcionarios_cb);
  } // do_ajax_form_dbo_contratos_validate_funcionarios

  function do_ajax_form_dbo_contratos_validate_funcionarios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_funcionarios_cb

  // ---------- Validate especialidades
  function do_ajax_form_dbo_contratos_validate_especialidades()
  {
    var nomeCampo_especialidades = "especialidades";
    var var_especialidades = scAjaxGetFieldText(nomeCampo_especialidades);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_contratos_validate_especialidades(var_especialidades, var_script_case_init, do_ajax_form_dbo_contratos_validate_especialidades_cb);
  } // do_ajax_form_dbo_contratos_validate_especialidades

  function do_ajax_form_dbo_contratos_validate_especialidades_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_contratos_validate_especialidades_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_contratos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_contratos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_contratos_submit_form(var_idcontratos, var_idpessoas, var_idfilial, var_numero_do_contrato, var_data_inicio_contrato, var_data_final_contrato, var_momento, var_usuario, var_situacao, var_idtipo_servico, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_contratos_submit_form_cb);
  } // do_ajax_form_dbo_contratos_submit_form

  function do_ajax_form_dbo_contratos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_contratos_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_contratos_submit_form_cb
  function do_ajax_form_dbo_contratos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_contratos_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_dbo_observacao_contratos"] = "off";
  scStatusDetail["form_dbo_contratos_servicos"] = "off";
  scStatusDetail["form_dbo_contratos_funcionarios"] = "off";
  scStatusDetail["form_dbo_contratos_especialidades"] = "off";

  function do_ajax_form_dbo_contratos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_contratos_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_contratos_navigate_form();
    }
  }

  function perform_ajax_form_dbo_contratos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_dbo_observacao_contratos"] = "on";
    scStatusDetail["form_dbo_contratos_servicos"] = "on";
    scStatusDetail["form_dbo_contratos_funcionarios"] = "on";
    scStatusDetail["form_dbo_contratos_especialidades"] = "on";
    x_ajax_form_dbo_contratos_navigate_form(var_idcontratos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_contratos_navigate_form_cb);
  } // do_ajax_form_dbo_contratos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_contratos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_contratos_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_dbo_observacao_contratos"] && "nmsc_iframe_liga_form_dbo_observacao_contratos" != scMasterDetailIframe["nmsc_iframe_liga_form_dbo_observacao_contratos"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_dbo_observacao_contratos"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_dbo_observacao_contratos').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_dbo_observacao_contratos').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_dbo_observacao_contratos').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_servicos"] && "nmsc_iframe_liga_form_dbo_contratos_servicos" != scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_servicos"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_servicos"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_servicos').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_servicos').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_servicos').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_funcionarios"] && "nmsc_iframe_liga_form_dbo_contratos_funcionarios" != scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_funcionarios"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_funcionarios"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_funcionarios').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_funcionarios').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_funcionarios').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_especialidades"] && "nmsc_iframe_liga_form_dbo_contratos_especialidades" != scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_especialidades"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_dbo_contratos_especialidades"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_especialidades').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_especialidades').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_dbo_contratos_especialidades').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_contratos_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_contratos_navigate_form_cb
  function do_ajax_form_dbo_contratos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_contratos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_contratos_navigate_form_cb_after_alert
  function sc_hide_form_dbo_contratos_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_dbo_observacao_contratos"] && "off" == scStatusDetail["form_dbo_contratos_servicos"] && "off" == scStatusDetail["form_dbo_contratos_funcionarios"] && "off" == scStatusDetail["form_dbo_contratos_especialidades"])
    {
      return true;
    }
    return false;
