<?php  
  ...
  session_start() ;
  class form_dbo_contratos_form_teste
  {
   function form_dbo_contratos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_dbo_contratos/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_dbo_contratos</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_dbo_contratos"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_dbo_contratos_form_teste();
  $frm_teste->form_dbo_contratos_teste();
?>
