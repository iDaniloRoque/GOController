<?php  
  ...
  session_start() ;
  class rel_recibos_pessoas_form_teste
  {
  function rel_recibos_pessoas_teste()
  {
...
<html> 
<HEAD>
 <title>rel_recibos_pessoas</title> 
...
?> 
<br> 
<B><FONT SIZE="4">rel_recibos_pessoas</FONT></B> 
<br> 
<br> 
...
<input type=submit value="rel_recibos_pessoas"> 
</form> 
...
<?php
  ...
  $frm_teste = new rel_recibos_pessoas_form_teste();
  $frm_teste->rel_recibos_pessoas_teste();
?>
