<?php
   include_once('rel_recibos_pessoas_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_conf']       = "C:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/conf";
   $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_cache']      = "C:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao']         = "conn_mssql";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class rel_recibos_pessoas_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "rel_recibos_pessoas"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['rel_recibos_pessoas']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['rel_recibos_pessoas']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['rel_recibos_pessoas']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/rel_recibos_pessoas';
      ...
      $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['rel_recibos_pessoas']['actual_lang']) || $_SESSION['scriptcase']['rel_recibos_pessoas']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['rel_recibos_pessoas']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("rel_recibos_pessoas_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["rel_recibos_pessoas"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["rel_recibos_pessoas"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "rel_recibos_pessoas_erro.class.php"); 
      $this->Erro = new rel_recibos_pessoas_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('rel_recibos_pessoas'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao']) && $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_perfil']) && $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_conexao'], $this->root . $this->path_prod, 'Controller', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['rel_recibos_pessoas']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new rel_recibos_pessoas_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['rel_recibos_pessoas']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['rel_recibos_pessoas']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['rel_recibos_pessoas']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['rel_recibos_pessoas'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['rel_recibos_pessoas']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['rel_recibos_pessoas']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('rel_recibos_pessoas') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['rel_recibos_pessoas']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['rel_recibos_pessoas']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['rel_recibos_pessoas']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['rel_recibos_pessoas']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "rel_recibos_pessoas_erro.class.php"); 
      $this->Erro      = new rel_recibos_pessoas_erro();
...
//
      ...
      $_SESSION['scriptcase']['rel_recibos_pessoas']['contr_erro'] = 'on';
...
$sql = "SELECT 
		...
		FROM dbo.Recibo (".$this->sc_temp_usr_idPessoas.",".$this->sc_temp_usr_idContratos.",'".$this->sc_temp_usr_MesAno."',".$this->sc_temp_usr_company.")";
...
$DataValidade		= $this->d[$i][0];
$Mes				= $this->d[$i][1];
$Ano				= $this->d[$i][2];
$usr_cofins_perc	= $this->d[$i][3];
$usr_csll_perc		= $this->d[$i][4];
$usr_irrf_perc		= $this->d[$i][5];
$usr_iss_perc		= $this->d[$i][6];
$usr_pis_perc		= $this->d[$i][7];
$usr_valor_bruto	= $this->d[$i][8];
$usr_cofins			= $this->d[$i][9];
$usr_csll			= $this->d[$i][10];
$usr_irrf			= $this->d[$i][11];
$usr_iss			= $this->d[$i][12];
$usr_pis			= $this->d[$i][13];
$ValorLiquido		= $this->d[$i][14];
$ValorExtenso		= $this->d[$i][15];
$EmpresaContratada	= $this->d[$i][16];
$CNPJContratada		= $this->d[$i][17];
$Endereco			= $this->d[$i][18];
$Bairro				= $this->d[$i][19];
$Cidade				= $this->d[$i][20];
$Estado				= $this->d[$i][21];
$Cep				= $this->d[$i][22];
$Unidade			= $this->d[$i][23];
$NomeContratante	= $this->d[$i][24];
$CNPJContratante	= $this->d[$i][25];
$NumeroContrato		= $this->d[$i][26];
$NomeSocio			= $this->d[$i][27];
$CPFSocio			= $this->d[$i][28];
	$NumeroRG			= $this->d[$i][29];
	...
	$Tab = '<style>
				...
				<table align="center">
				  <tr>
					<th>Valor Bruto</th>
					<th>'.$usr_valor_bruto.'</th>
					<th> %  </th>
				  </tr>
				  <tr>
					<td>COFINS</td>
					<td>'.$usr_cofins.'</td>
					<td>'.$usr_cofins_perc.'</td>
				  </tr>
				  <tr>
					<td>CSLL A RECOLHER</td>
					<td>'.$usr_csll.'</td>
					<td>'.$usr_csll_perc.'</td>
				  </tr>
				  <tr>
...
$textoPadraoDeclaracaoCARTAAUTORIZACAO = 'O '.$NomeContratante.',  inscrita no CNPJ  sob nº '.$CNPJContratante.', autoriza o Setor Financeiro desta instituição, a fazer o pagamento do valor liquido de R$ '.$ValorLiquido.' ('.$ValorExtenso.') referente aos serviços prestados conforme contrato de nº '.$NumeroContrato.' , com validade ate '.$DataValidade.' , a empresa , '.$EmpresaContratada.' inscrita no CNPJ  sob nº '.$CNPJContratada.'.';

$textoPadraoRECIBO = 'Recebemos do '.$NomeContratante.'., a importância de R$ '.$ValorLiquido.' ('.$ValorExtenso.') correspondente a liquidação da Nota Fiscal Nº________ ________ ________, referente aos serviços médicos prestados pessoalmente pelo(s) sócio(s)  no  '.$Unidade.'  no mês de '.$Mes.'  de  '.$Ano.', conforme CPSE nº  '.$NumeroContrato.'.' ;
	
$textoPadraoDeclaracaoSIMPLESNACIONAL = $EmpresaContratada.' , com sede em '.$Endereco.', '.$Bairro.', '.$Cidade.', inscrita no CNPJ  sob nº '.$CNPJContratada.',  DECLARA ao,  '.$NomeContratante.' , '.$CNPJContratante.', para fins de não incidência na fonte do Imposto sobre Renda da Pessoa Jurídica IRPJ), da Contribuição Social sobre o Lucro Liquido (CSLL), da Contribuição Social sobre o Lucro Liquido (Cofins), e da Contribuição para o Financiamento da Seguradora Social (Cofins), e da Contribuição para o PIS/PASEB, a que se refere o art. 64 da Lei nº 9.430, de 27 de dezembro de 1996, que é regularmente inscrita no Regime Especial Unificado de Arrecadação e Tributos e Contribuições das Microempresas e das Empresas de Pequeno Porte ? Simples Nacional, de que trata o art. 12 da Lei Complementar nº 123, de 14  de dezembro de 2006.';
...
$pdf->AddPage();
	...
	$html = 
		...
		CEP : '.$Cep.' - CNPJ : '.$CNPJContratada.'</h2>
		 <h1  align="center"> Declaração de autorização <br> </h1> <br> <br> <br>
		 <div align="justify">'.$textoPadraoDeclaracaoCARTAAUTORIZACAO.'</div> 
		  <br> <br> <br> <br> <br> <br>
		 <h3  align="center"> '.$NomeSocio.' <br>
		 RG: '.$NumeroRG.'<br>
		 CPF: '.$CPFSocio.' <br>
...
$pdf->AddPage();
		...
		Endereço : Rua '.$Endereco.' - Cidade: '.$Cidade.' - Estado: '.$Estado.'<br>
		CEP : '.$Cep.' - CNPJ : '.$CNPJContratada.'</h2>
		 <h1  align="center"> Recibo <br> </h1> 
		'.$Tab.'
		 <br> <br> <br>
		 <div align="justify">'.$textoPadraoRECIBO.'</div> 
		  <br> <br> <br> <br> <br> <br> 
			 <h3  align="center"> '.$NomeSocio.' <br>
		 RG: '.$NumeroRG.'<br>
		 CPF: '.$CPFSocio.' <br>
...
$html = 
		'<h2  align="center">'.$EmpresaContratada.' <br>
			Endereço : Rua '.$Endereco.' - Cidade: '.$Cidade.' - Estado: '.$Estado.'<br>
		CEP : '.$Cep.' - CNPJ : '.$CNPJContratada.'</h2>
		 <h1  align="center"> Declaração simples nacional <br> </h1> <br> <br> <br>
		 <div align="justify">'.$textoPadraoDeclaracaoSIMPLESNACIONAL.'</div> 
		  <br> <br> <br> <br> <br> <br>
		 <h3  align="center"> '.$NomeSocio.' <br>
		 RG: '.$NumeroRG.'<br>
		 CPF: '.$CPFSocio.' <br>
...
$_SESSION['scriptcase']['rel_recibos_pessoas']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_rel_recibos_pessoas($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imag_temp'] . "/sc_apl_default_Controller.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['rel_recibos_pessoas']['glo_nm_path_imag_temp'] . "/sc_apl_default_Controller.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "rel_recibos_pessoas") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_Controller'])) {
               $_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_Controller'];
           }
       }
   }
   ...
   if (isset($_POST["usr_idPessoas"])) 
   {
       ...
       nm_limpa_str_rel_recibos_pessoas($_SESSION["usr_idPessoas"]);
   }
   ...
   if (isset($_POST["usr_idContratos"])) 
   {
       ...
       nm_limpa_str_rel_recibos_pessoas($_SESSION["usr_idContratos"]);
   }
   ...
   if (isset($_POST["usr_MesAno"])) 
   {
       ...
       nm_limpa_str_rel_recibos_pessoas($_SESSION["usr_MesAno"]);
   }
   ...
   if (isset($_POST["usr_company"])) 
   {
       ...
       nm_limpa_str_rel_recibos_pessoas($_SESSION["usr_company"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "rel_recibos_pessoas";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'rel_recibos_pessoas' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('rel_recibos_pessoas' == $sReferer || 'rel_recibos_pessoas_' == substr($sReferer, 0, 20))
       {
           $_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['lang'];
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'rel_recibos_pessoas')
   {
       $_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/rel_recibos_pessoas_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_rel_recibos_pessoas($cadapar[1]);
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['rel_recibos_pessoas'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['opc_psq'] && !isset($_SESSION['scriptcase']['rel_recibos_pessoas']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['rel_recibos_pessoas']) || $_SESSION['scriptcase']['sc_apl_seg']['rel_recibos_pessoas'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['rel_recibos_pessoas']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("rel_recibos_pessoas", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
...
<?php
   ...
   $contr_rel_recibos_pessoas = new rel_recibos_pessoas_apl();
   $contr_rel_recibos_pessoas->controle();
//
   function nm_limpa_str_rel_recibos_pessoas(&$str)
   {
