  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_servicos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_servicos_mob_form();
	}
...
?>
  ...
  // ---------- Validate idservico
  function do_ajax_form_dbo_servicos_mob_validate_idservico()
  {
    var nomeCampo_idservico = "idservico";
    var var_idservico = scAjaxGetFieldHidden(nomeCampo_idservico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_servicos_mob_validate_idservico(var_idservico, var_script_case_init, do_ajax_form_dbo_servicos_mob_validate_idservico_cb);
  } // do_ajax_form_dbo_servicos_mob_validate_idservico

  function do_ajax_form_dbo_servicos_mob_validate_idservico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idservico";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_servicos_mob_validate_idservico_cb

  // ---------- Validate descricao_servico
  function do_ajax_form_dbo_servicos_mob_validate_descricao_servico()
  {
    var nomeCampo_descricao_servico = "descricao_servico";
    var var_descricao_servico = scAjaxGetFieldText(nomeCampo_descricao_servico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_servicos_mob_validate_descricao_servico(var_descricao_servico, var_script_case_init, do_ajax_form_dbo_servicos_mob_validate_descricao_servico_cb);
  } // do_ajax_form_dbo_servicos_mob_validate_descricao_servico

  function do_ajax_form_dbo_servicos_mob_validate_descricao_servico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descricao_servico";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_servicos_mob_validate_descricao_servico_cb

  // ---------- Validate vlr_unit
  function do_ajax_form_dbo_servicos_mob_validate_vlr_unit()
  {
    var nomeCampo_vlr_unit = "vlr_unit";
    var var_vlr_unit = scAjaxGetFieldText(nomeCampo_vlr_unit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_servicos_mob_validate_vlr_unit(var_vlr_unit, var_script_case_init, do_ajax_form_dbo_servicos_mob_validate_vlr_unit_cb);
  } // do_ajax_form_dbo_servicos_mob_validate_vlr_unit

  function do_ajax_form_dbo_servicos_mob_validate_vlr_unit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vlr_unit";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_servicos_mob_validate_vlr_unit_cb

  // ---------- Validate tipo
  function do_ajax_form_dbo_servicos_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_servicos_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_dbo_servicos_mob_validate_tipo_cb);
  } // do_ajax_form_dbo_servicos_mob_validate_tipo

  function do_ajax_form_dbo_servicos_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_servicos_mob_validate_tipo_cb

  // ---------- Validate idempresa
  function do_ajax_form_dbo_servicos_mob_validate_idempresa()
  {
    var nomeCampo_idempresa = "idempresa";
    var var_idempresa = scAjaxGetFieldText(nomeCampo_idempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_servicos_mob_validate_idempresa(var_idempresa, var_script_case_init, do_ajax_form_dbo_servicos_mob_validate_idempresa_cb);
  } // do_ajax_form_dbo_servicos_mob_validate_idempresa

  function do_ajax_form_dbo_servicos_mob_validate_idempresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_servicos_mob_validate_idempresa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_servicos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_servicos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idservico = scAjaxGetFieldHidden("idservico");
    var var_descricao_servico = scAjaxGetFieldText("descricao_servico");
    var var_vlr_unit = scAjaxGetFieldText("vlr_unit");
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_servicos_mob_submit_form(var_idservico, var_descricao_servico, var_vlr_unit, var_tipo, var_idempresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_servicos_mob_submit_form_cb);
  } // do_ajax_form_dbo_servicos_mob_submit_form

  function do_ajax_form_dbo_servicos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idservico");
      scAjaxHideErrorDisplay("descricao_servico");
      scAjaxHideErrorDisplay("vlr_unit");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_servicos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_servicos_mob_submit_form_cb
  function do_ajax_form_dbo_servicos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_servicos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_servicos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_servicos_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_servicos_mob_navigate_form();
    }
  }

  function perform_ajax_form_dbo_servicos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tipo");
    scAjaxHideErrorDisplay("idempresa");
    var var_idservico = document.F2.idservico.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_servicos_mob_navigate_form(var_idservico, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_servicos_mob_navigate_form_cb);
  } // do_ajax_form_dbo_servicos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_servicos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_servicos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idservico.value = scAjaxGetKeyValue("idservico");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_servicos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_servicos_mob_navigate_form_cb
  function do_ajax_form_dbo_servicos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_servicos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_servicos_mob_navigate_form_cb_after_alert
  function sc_hide_form_dbo_servicos_mob_form()
  {
  ...
  ajax_field_list[0] = "idservico";
  ajax_field_list[1] = "descricao_servico";
  ajax_field_list[2] = "vlr_unit";
  ajax_field_list[3] = "tipo";
  ajax_field_list[4] = "idempresa";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idservico": {"label": "Id Servico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descricao_servico": {"label": "Descricao Servico", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vlr_unit": {"label": "Vlr Unit", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idservico": new Array(),
    "descricao_servico": new Array(),
    "vlr_unit": new Array(),
    "tipo": new Array(),
    "idempresa": new Array()
  };
  ajax_field_mult["idservico"][1] = "idservico";
  ajax_field_mult["descricao_servico"][1] = "descricao_servico";
  ajax_field_mult["vlr_unit"][1] = "vlr_unit";
  ajax_field_mult["tipo"][1] = "tipo";
  ajax_field_mult["idempresa"][1] = "idempresa";

  var ajax_field_id = {
    "descricao_servico": new Array("hidden_field_label_descricao_servico", "hidden_field_data_descricao_servico"),
    "vlr_unit": new Array("hidden_field_label_vlr_unit", "hidden_field_data_vlr_unit"),
    "tipo": new Array("hidden_field_label_tipo", "hidden_field_data_tipo")
  };

  var ajax_read_only = {
    "idservico": "on",
    "descricao_servico": "off",
    "vlr_unit": "off",
    "tipo": "off",
    "idempresa": "off"
  };
