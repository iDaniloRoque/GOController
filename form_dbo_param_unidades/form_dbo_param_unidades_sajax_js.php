  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_param_unidades" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_param_unidades_form();
	}
...
?>
  ...
  // ---------- Validate idparam_unidades_
  function do_ajax_form_dbo_param_unidades_validate_idparam_unidades_(iNumLinha)
  {
    var nomeCampo_idparam_unidades_ = "idparam_unidades_" + iNumLinha;
    var var_idparam_unidades_ = scAjaxGetFieldHidden(nomeCampo_idparam_unidades_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_unidades_validate_idparam_unidades_(var_idparam_unidades_, iNumLinha, var_script_case_init, do_ajax_form_dbo_param_unidades_validate_idparam_unidades__cb);
  } // do_ajax_form_dbo_param_unidades_validate_idparam_unidades_

  function do_ajax_form_dbo_param_unidades_validate_idparam_unidades__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idparam_unidades_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idparam_unidades_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idparam_unidades_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idparam_unidades_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_param_unidades_validate_idparam_unidades__cb

  // ---------- Validate idfilial_
  function do_ajax_form_dbo_param_unidades_validate_idfilial_(iNumLinha)
  {
    var nomeCampo_idfilial_ = "idfilial_" + iNumLinha;
    var var_idfilial_ = scAjaxGetFieldSelect(nomeCampo_idfilial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_unidades_validate_idfilial_(var_idfilial_, iNumLinha, var_script_case_init, do_ajax_form_dbo_param_unidades_validate_idfilial__cb);
  } // do_ajax_form_dbo_param_unidades_validate_idfilial_

  function do_ajax_form_dbo_param_unidades_validate_idfilial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_param_unidades_validate_idfilial__cb

  // ---------- Validate idcodigoempresa_
  function do_ajax_form_dbo_param_unidades_validate_idcodigoempresa_(iNumLinha)
  {
    var nomeCampo_idcodigoempresa_ = "idcodigoempresa_" + iNumLinha;
    var var_idcodigoempresa_ = scAjaxGetFieldText(nomeCampo_idcodigoempresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_unidades_validate_idcodigoempresa_(var_idcodigoempresa_, iNumLinha, var_script_case_init, do_ajax_form_dbo_param_unidades_validate_idcodigoempresa__cb);
  } // do_ajax_form_dbo_param_unidades_validate_idcodigoempresa_

  function do_ajax_form_dbo_param_unidades_validate_idcodigoempresa__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idcodigoempresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idcodigoempresa_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idcodigoempresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idcodigoempresa_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_param_unidades_validate_idcodigoempresa__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_param_unidades_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_param_unidades_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_param_unidades_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_param_unidades_add_new_line_cb);
  } // do_ajax_form_dbo_param_unidades_add_new_line

  function do_ajax_form_dbo_param_unidades_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_dbo_param_unidades_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_param_unidades_backup_line(iNumLinha)
  {
    var var_idparam_unidades_ = scAjaxGetFieldHidden("idparam_unidades_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_unidades_backup_line(var_idparam_unidades_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_param_unidades_backup_line_cb);
  } // do_ajax_form_dbo_param_unidades_backup_line

  function do_ajax_form_dbo_param_unidades_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_dbo_param_unidades_backup_line_cb

  function do_ajax_form_dbo_param_unidades_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_param_unidades_cancel_insert

  function do_ajax_form_dbo_param_unidades_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_param_unidades_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_param_unidades_cancel_update

  function do_ajax_form_dbo_param_unidades_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_param_unidades_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_param_unidades_table_refresh()
  {
    var var_idparam_unidades_ = document.F2.idparam_unidades_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_param_unidades_table_refresh(var_idparam_unidades_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_param_unidades_table_refresh_cb);
  } //  do_ajax_form_dbo_param_unidades_table_refresh

  function do_ajax_form_dbo_param_unidades_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idparam_unidades_.value = scAjaxGetKeyValue("idparam_unidades_");
    ...
    scAjaxAlert(do_ajax_form_dbo_param_unidades_table_refresh_cb_after_alert);
  } // do_ajax_form_dbo_param_unidades_table_refresh_cb
  function do_ajax_form_dbo_param_unidades_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_param_unidades_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_param_unidades_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_dbo_param_unidades_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_idcodigoempresa_ = scAjaxGetFieldText("idcodigoempresa_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_dbo_param_unidades_submit_form(var_idparam_unidades_, var_idfilial_, var_idcodigoempresa_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_param_unidades_submit_form_cb);
  } // do_ajax_form_dbo_param_unidades_submit_form

  function do_ajax_form_dbo_param_unidades_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idparam_unidades_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idfilial_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idcodigoempresa_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_param_unidades_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_param_unidades_submit_form_cb
  function do_ajax_form_dbo_param_unidades_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_param_unidades_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_param_unidades_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_param_unidades_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_param_unidades_navigate_form();
    }
  }

  function perform_ajax_form_dbo_param_unidades_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_param_unidades_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idparam_unidades_" + iNavForm);
      scAjaxHideErrorDisplay("idfilial_" + iNavForm);
      scAjaxHideErrorDisplay("idcodigoempresa_" + iNavForm);
    }
    var var_idparam_unidades_ = document.F2.idparam_unidades_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_param_unidades_navigate_form(var_idparam_unidades_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_param_unidades_navigate_form_cb);
  } // do_ajax_form_dbo_param_unidades_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_param_unidades']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_param_unidades_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idparam_unidades_.value = scAjaxGetKeyValue("idparam_unidades_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_param_unidades_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_param_unidades_navigate_form_cb
  function do_ajax_form_dbo_param_unidades_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_dbo_param_unidades_navigate_form_cb_after_alert
  function sc_hide_form_dbo_param_unidades_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idparam_unidades_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idfilial_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idcodigoempresa_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idparam_unidades_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idfilial_" + iNumLinha] = {"label": "Filial<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idcodigoempresa_" + iNumLinha] = {"label": "Cod. Contrapartida<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idparam_unidades_"][iNumLinha] = "idparam_unidades_" + iNumLinha;
    ajax_field_mult["idfilial_"][iNumLinha] = "idfilial_" + iNumLinha;
    ajax_field_mult["idcodigoempresa_"][iNumLinha] = "idcodigoempresa_" + iNumLinha;
    ajax_field_id["idparam_unidades_" + iNumLinha] = new Array("hidden_field_label_idparam_unidades_", "hidden_field_data_idparam_unidades_" + iNumLinha);
    ajax_field_id["idfilial_" + iNumLinha] = new Array("hidden_field_label_idfilial_", "hidden_field_data_idfilial_" + iNumLinha);
    ajax_field_id["idcodigoempresa_" + iNumLinha] = new Array("hidden_field_label_idcodigoempresa_", "hidden_field_data_idcodigoempresa_" + iNumLinha);
    ajax_error_count["idparam_unidades_" + iNumLinha] = "off";
    ajax_error_count["idfilial_" + iNumLinha] = "off";
    ajax_error_count["idcodigoempresa_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idparam_unidades_" + iNumLinha] = "on";
    ajax_read_only["idfilial_" + iNumLinha] = "off";
    ajax_read_only["idcodigoempresa_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["idcodigoempresa_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idparam_unidades_" + iNumLinha] = null;
    ajax_error_list["idfilial_" + iNumLinha] = null;
    ajax_error_list["idcodigoempresa_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idparam_unidades_": new Array(),
    "idfilial_": new Array(),
    "idcodigoempresa_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idparam_unidades_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idparam_unidades_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idparam_unidades_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idparam_unidades_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idparam_unidades_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["idcodigoempresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idcodigoempresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idcodigoempresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idcodigoempresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idcodigoempresa_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idparam_unidades_'])) ? $this->nmgp_cmp_readonly['idparam_unidades_'] : 'on';
?>
    scAjaxFieldRead("idparam_unidades_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcodigoempresa_'])) ? $this->nmgp_cmp_readonly['idcodigoempresa_'] : 'off';
?>
    scAjaxFieldRead("idcodigoempresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idparam_unidades_" + iSeq, "on");
    scAjaxFieldRead("idfilial_" + iSeq, "on");
    scAjaxFieldRead("idcodigoempresa_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idparam_unidades_" + iRow] || "on" == ajax_error_count["idfilial_" + iRow] || "on" == ajax_error_count["idcodigoempresa_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idparam_unidades_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idfilial_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idcodigoempresa_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idparam_unidades_" + iRow] && "off" == ajax_error_count["idfilial_" + iRow] && "off" == ajax_error_count["idcodigoempresa_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idparam_unidades_" + iRow] = "off";
        ajax_error_count["idfilial_" + iRow] = "off";
        ajax_error_count["idcodigoempresa_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idparam_unidades_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idfilial_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idcodigoempresa_" + iRow).removeClass("scFormErrorLine");
    }
  }
