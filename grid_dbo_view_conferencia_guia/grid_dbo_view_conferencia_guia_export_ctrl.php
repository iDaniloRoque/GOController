<?php
@session_start() ;
$_SESSION['scriptcase']['grid_dbo_view_conferencia_guia']['sc_process_barr'] = true;
require_once('../grid_dbo_view_conferencia_guia/index.php');
unset($_SESSION['scriptcase']['grid_dbo_view_conferencia_guia']['sc_process_barr']);
$ExportCtrl = new grid_dbo_view_conferencia_guia_export_control;
$ExportCtrl->Export_barr();

class grid_dbo_view_conferencia_guia_export_control
{
