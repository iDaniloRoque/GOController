...
class grid_dbo_view_resumo_servico_por_especialidade_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['campos_busca']))
      { 
