...
class grid_dbo_view_resumo_servico_por_especialidade_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_dbo_view_resumo_servico_por_especialidade']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_dbo_view_resumo_servico_por_especialidade']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['json_use_label'])
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['profissional'] = $Lab_profissional; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['mes_ano']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['mes_ano'] = "Mes Ano"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['nome_razao_social']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['nome_razao_social'] = "Razão Social"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['contratos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['contratos'] = "Contratos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['profissional']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['profissional'] = "Profissional"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['atividade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['atividade'] = "Atividade"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['descricao_especialidade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['descricao_especialidade'] = "Especialidade"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['descricao_servico']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['descricao_servico'] = "Serviço"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['quantidade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['quantidade'] = "Quantidade"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['total_servico']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['labels']['total_servico'] = "Total Serviço"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_dbo_view_resumo_servico_por_especialidade@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_dbo_view_resumo_servico_por_especialidade_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_profissional = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['arr_total']['profissional'];
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "view_resumo_servico_por_espec/grid_dbo_view_resumo_servico_por_especialidade_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_dbo_view_resumo_servico_por_especialidade_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_dbo_view_resumo_servico_por_especialidade_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_dbo_view_resumo_servico_por_especialidade_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "view_resumo_servico_por_espec/grid_dbo_view_resumo_servico_por_especialidade_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_dbo_view_resumo_servico_por_especialidade&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "view_resumo_servico_por_espec/grid_dbo_view_resumo_servico_por_especialidade_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid&nm_all_modules=grid&nm_json_format=N&nm_json_label=S&language=&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "view_resumo_servico_por_espec/grid_dbo_view_resumo_servico_por_especialidade_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "view_resumo_servico_por_espec/grid_dbo_view_resumo_servico_por_especialidade_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['opc_psq'] && !$this->grid_emb_form)
      {
         ...
         if (is_file("grid_dbo_view_resumo_servico_por_especialidade_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_dbo_view_resumo_servico_por_especialidade']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_dbo_view_resumo_servico_por_especialidade']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_dbo_view_resumo_servico_por_especialidade_config_pivot.php?nome_apl=grid_dbo_view_resumo_servico_por_especialidade&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_dbo_view_resumo_servico_por_especialidade_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "view_resumo_servico_por_espec/grid_dbo_view_resumo_servico_por_especialidade_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   function adiciona_registro($sum_quantidade, $sum_total_servico, $quebra_profissional, $quebra_profissional_orig)
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
   ...
   function compat_arrays()
   {
      ...
      {
          $Arr_gb[]   = $cmp_gb;
          $Arr_name[] = "_SESSION['sc_session'][" . $this->Ini->sc_page . "]['grid_dbo_view_resumo_servico_por_especialidade']['arr_total']['" .$cmp_gb . "']" . $Control;
...
//
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['order_grid'] = $nmgp_order_by;
      ...
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['contr_array_resumo'] = "OK";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['tot_geral'][1] = $this->array_total_geral[0];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_especialidade']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              eval ('$_SESSION["sc_session"][' . $this->Ini->sc_page . ']["grid_dbo_view_resumo_servico_por_especialidade"]["arr_total"]["' . $cmp_gb . '"] = $this->array_total_' .  $cmp_gb . ';');
          }
      }
   }
