...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['grid_dbo_view_resumo_servico_por_especialidade']['contr_erro']) && $_SESSION['scriptcase']['grid_dbo_view_resumo_servico_por_especialidade']['contr_erro'] == 'on')
    {
