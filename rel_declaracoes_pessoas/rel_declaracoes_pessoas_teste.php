<?php  
  ...
  session_start() ;
  class rel_declaracoes_pessoas_form_teste
  {
  function rel_declaracoes_pessoas_teste()
  {
...
<html> 
<HEAD>
 <title>rel_declaracoes_pessoas</title> 
...
?> 
<br> 
<B><FONT SIZE="4">rel_declaracoes_pessoas</FONT></B> 
<br> 
<br> 
...
<input type=submit value="rel_declaracoes_pessoas"> 
</form> 
<script language=javascript> 
 document.FCons.usr_idPessoas.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new rel_declaracoes_pessoas_form_teste();
  $frm_teste->rel_declaracoes_pessoas_teste();
?>
