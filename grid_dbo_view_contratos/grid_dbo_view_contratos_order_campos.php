...
<?php
   ...
   $Ord_Cmp = new grid_dbo_view_contratos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_dbo_view_contratos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["cpf_cnpj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["cpf_cnpj"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["cpf_cnpj"] : "Cpf Cnpj";
   $tab_ger_campos['data_inicio_contrato'] = "on";
   $tab_def_campos['data_inicio_contrato'] = "data_inicio_contrato";
   $tab_labels["data_inicio_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["data_inicio_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["data_inicio_contrato"] : "Data Inicio Contrato";
   $tab_ger_campos['data_final_contrato'] = "on";
   $tab_def_campos['data_final_contrato'] = "data_final_contrato";
   $tab_labels["data_final_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["data_final_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["data_final_contrato"] : "Data Final Contrato";
   $tab_ger_campos['numero_do_contrato'] = "on";
   $tab_def_campos['numero_do_contrato'] = "numero_do_contrato";
   $tab_labels["numero_do_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["numero_do_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["numero_do_contrato"] : "Numero Do Contrato";
   $tab_ger_campos['descricao_servico'] = "on";
   $tab_def_campos['descricao_servico'] = "descricao_servico";
   $tab_labels["descricao_servico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["descricao_servico"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["descricao_servico"] : "Descricao Servico";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "Valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["valor"] : "Valor";
   ...
   {
       $tab_def_campos['sc_field_0'] = "Observação";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['labels']["sc_field_0"] : "Observação";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_dbo_view_contratos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_dbo_view_contratos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
