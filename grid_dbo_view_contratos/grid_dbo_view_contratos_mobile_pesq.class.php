...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "data_inicio_contrato";$Nm_datas[] = "data_inicio_contrato";$Nm_datas[] = "data_final_contrato";$Nm_datas[] = "data_final_contrato";$Nm_numeric[] = "idfilial";$Nm_numeric[] = "idpessoas";$Nm_numeric[] = "valor";
...
<HTML>
<HEAD>
 <TITLE> dbo.view_contratos</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_comercial_cond" name="comercial_cond" onChange="nm_campos_between(document.getElementById('id_vis_comercial'), this, 'comercial')">
      ...
      <br><span id="id_hide_comercial"  <?php echo $str_hide_comercial?>><?php
      if ($comercial != "")
      {
      $comercial_look = substr($this->Db->qstr($comercial), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idfilial_cond" name="idfilial_cond" onChange="nm_campos_between(document.getElementById('id_vis_idfilial'), this, 'idfilial')">
      ...
      <br><span id="id_hide_idfilial"  <?php echo $str_hide_idfilial?>><INPUT  type="text" id="SC_idfilial" name="idfilial" value="<?php echo NM_encode_input($idfilial) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_situacao_cond" name="situacao_cond" onChange="nm_campos_between(document.getElementById('id_vis_situacao'), this, 'situacao')">
      ...
      <br><span id="id_hide_situacao"  <?php echo $str_hide_situacao?>><?php
      if ($situacao != "")
      {
      $situacao_look = substr($this->Db->qstr($situacao), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idpessoas_cond" name="idpessoas_cond" onChange="nm_campos_between(document.getElementById('id_vis_idpessoas'), this, 'idpessoas')">
