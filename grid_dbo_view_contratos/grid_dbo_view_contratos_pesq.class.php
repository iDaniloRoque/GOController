...
class grid_dbo_view_contratos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_dbo_view_contratos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_dbo_view_contratos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_dbo_view_contratos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_comercial')
      {
          $comercial = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_comercial($comercial);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_situacao')
      {
          $situacao = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_situacao($situacao);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "data_inicio_contrato";$Nm_datas[] = "data_inicio_contrato";$Nm_datas[] = "data_final_contrato";$Nm_datas[] = "data_final_contrato";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "dbo.view_contratos.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> dbo.view_contratos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_dbo_view_contratos/grid_dbo_view_contratos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_dbo_view_contratos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_dbo_view_contratos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_dbo_view_contratos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_dbo_view_contratos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_dbo_view_contratos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_comercial_cond#NMF#' + search_get_sel_txt('SC_comercial_cond') + '@NMF@';
  str_out += 'SC_comercial#NMF#' + search_get_text('SC_comercial') + '@NMF@';
  str_out += 'id_ac_comercial#NMF#' + search_get_text('id_ac_comercial') + '@NMF@';
  str_out += 'SC_idfilial_cond#NMF#' + search_get_sel_txt('SC_idfilial_cond') + '@NMF@';
  str_out += 'SC_idfilial#NMF#' + search_get_text('SC_idfilial') + '@NMF@';
  str_out += 'SC_situacao_cond#NMF#' + search_get_sel_txt('SC_situacao_cond') + '@NMF@';
  str_out += 'SC_situacao#NMF#' + search_get_text('SC_situacao') + '@NMF@';
  str_out += 'id_ac_situacao#NMF#' + search_get_text('id_ac_situacao') + '@NMF@';
  str_out += 'SC_idpessoas_cond#NMF#' + search_get_sel_txt('SC_idpessoas_cond') + '@NMF@';
  str_out += 'SC_idpessoas#NMF#' + search_get_text('SC_idpessoas') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_comercial").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_comercial").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_comercial",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_comercial").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_comercial").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_situacao").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_situacao").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_situacao",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> dbo.view_contratos</div>
...
<?php
   ...
   {
      global 
             $comercial_cond, $comercial, $comercial_autocomp,
             $idfilial_cond, $idfilial,
             $situacao_cond, $situacao, $situacao_autocomp,
             $idpessoas_cond, $idpessoas,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $comercial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['comercial']; 
          $comercial_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['comercial_cond']; 
          $idfilial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['idfilial']; 
          $idfilial_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['idfilial_cond']; 
          $situacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['situacao']; 
          $situacao_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['situacao_cond']; 
          $idpessoas = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['idpessoas']; 
          $idpessoas_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['idpessoas_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['NM_operador']; 
          if (strtoupper($idfilial_cond) != "II" && strtoupper($idfilial_cond) != "QP" && strtoupper($idfilial_cond) != "NP" && strtoupper($idfilial_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idfilial, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($idpessoas_cond) != "II" && strtoupper($idpessoas_cond) != "QP" && strtoupper($idpessoas_cond) != "NP" && strtoupper($idpessoas_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idpessoas, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($comercial_cond) || empty($comercial_cond))
      {
         $comercial_cond = "qp";
      }
      if (!isset($idfilial_cond) || empty($idfilial_cond))
      {
         $idfilial_cond = "gt";
      }
      if (!isset($situacao_cond) || empty($situacao_cond))
      {
         $situacao_cond = "qp";
      }
      if (!isset($idpessoas_cond) || empty($idpessoas_cond))
      {
         $idpessoas_cond = "gt";
      }
      ...
      $str_hide_comercial = (in_array($comercial_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idfilial = (in_array($idfilial_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_situacao = (in_array($situacao_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idpessoas = (in_array($idpessoas_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($comercial) || $comercial == "")
      {
          $comercial = "";
      }
      if (isset($comercial) && !empty($comercial))
      {
      ...
      if (!isset($idfilial) || $idfilial == "")
      {
          $idfilial = "";
      }
      if (isset($idfilial) && !empty($idfilial))
      {
      ...
      if (!isset($idpessoas) || $idpessoas == "")
      {
          $idpessoas = "";
      }
      if (isset($idpessoas) && !empty($idpessoas))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_comercial_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['comercial'])) ? $this->New_label['comercial'] : "Comercial"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_comercial_cond" name="comercial_cond" onChange="nm_campos_between(document.getElementById('id_vis_comercial'), this, 'comercial')">
       <OPTION value="qp" <?php if ("qp" == $comercial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $comercial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $comercial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $comercial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_comercial" <?php echo $str_hide_comercial?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['comercial'])) ? $this->New_label['comercial'] : "Comercial";
 $nmgp_tab_label .= "comercial?#?" . $SC_Label . "?@?";
...
<?php
      ...
      {
          $sAutocompValue = $comercial;
      }
?>
<INPUT  type="text" id="SC_comercial" name="comercial" value="<?php echo NM_encode_input($comercial) ?>"  size=50 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_comercial" name="comercial_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idfilial_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idfilial'])) ? $this->New_label['idfilial'] : "Id Filial"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idfilial_cond" name="idfilial_cond" onChange="nm_campos_between(document.getElementById('id_vis_idfilial'), this, 'idfilial')">
       <OPTION value="gt" <?php if ("gt" == $idfilial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idfilial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idfilial_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idfilial" <?php echo $str_hide_idfilial?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idfilial'])) ? $this->New_label['idfilial'] : "Id Filial";
 $nmgp_tab_label .= "idfilial?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idfilial" name="idfilial" value="<?php echo NM_encode_input($idfilial) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_situacao_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['situacao'])) ? $this->New_label['situacao'] : "Situacao"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_situacao_cond" name="situacao_cond" onChange="nm_campos_between(document.getElementById('id_vis_situacao'), this, 'situacao')">
       <OPTION value="qp" <?php if ("qp" == $situacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $situacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $situacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $situacao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_situacao" <?php echo $str_hide_situacao?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['situacao'])) ? $this->New_label['situacao'] : "Situacao";
 $nmgp_tab_label .= "situacao?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $situacao;
      }
?>
<INPUT  type="text" id="SC_situacao" name="situacao" value="<?php echo NM_encode_input($situacao) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_situacao" name="situacao_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idpessoas_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idpessoas'])) ? $this->New_label['idpessoas'] : "Id Pessoas"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idpessoas_cond" name="idpessoas_cond" onChange="nm_campos_between(document.getElementById('id_vis_idpessoas'), this, 'idpessoas')">
       <OPTION value="gt" <?php if ("gt" == $idpessoas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idpessoas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idpessoas_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idpessoas" <?php echo $str_hide_idpessoas?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idpessoas'])) ? $this->New_label['idpessoas'] : "Id Pessoas";
 $nmgp_tab_label .= "idpessoas?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idpessoas" name="idpessoas" value="<?php echo NM_encode_input($idpessoas) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_dbo_view_contratos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_dbo_view_contratos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_dbo_view_contratos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.comercial_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_comercial'), document.F1.comercial_cond, 'comercial');
   document.F1.comercial.value = "";
   document.F1.comercial_autocomp.value = "";
   document.F1.idfilial_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idfilial'), document.F1.idfilial_cond, 'idfilial');
   document.F1.idfilial.value = "";
   document.F1.situacao_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_situacao'), document.F1.situacao_cond, 'situacao');
   document.F1.situacao.value = "";
   document.F1.situacao_autocomp.value = "";
   document.F1.idpessoas_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idpessoas'), document.F1.idpessoas_cond, 'idpessoas');
   document.F1.idpessoas.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_dbo_view_contratos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_comercial_cond'] = 'cond';
      $tp_fields['SC_comercial'] = 'text_aut';
      $tp_fields['id_ac_comercial'] = 'text_aut';
      $tp_fields['SC_idfilial_cond'] = 'cond';
      $tp_fields['SC_idfilial'] = 'text';
      $tp_fields['SC_situacao_cond'] = 'cond';
      $tp_fields['SC_situacao'] = 'text_aut';
      $tp_fields['id_ac_situacao'] = 'text_aut';
      $tp_fields['SC_idpessoas_cond'] = 'cond';
      $tp_fields['SC_idpessoas'] = 'text';
   ...
   {
      global $comercial_cond, $comercial, $comercial_autocomp,
             $idfilial_cond, $idfilial,
             $situacao_cond, $situacao, $situacao_autocomp,
             $idpessoas_cond, $idpessoas, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($comercial_autocomp) && empty($comercial))
      {
          $comercial = $comercial_autocomp;
      }
      if (!empty($situacao_autocomp) && empty($situacao))
      {
          $situacao = $situacao_autocomp;
      }
      $comercial_cond_salva = $comercial_cond; 
      if (!isset($comercial_input_2) || $comercial_input_2 == "")
      {
          $comercial_input_2 = $comercial;
      }
      $idfilial_cond_salva = $idfilial_cond; 
      if (!isset($idfilial_input_2) || $idfilial_input_2 == "")
      {
          $idfilial_input_2 = $idfilial;
      }
      $situacao_cond_salva = $situacao_cond; 
      if (!isset($situacao_input_2) || $situacao_input_2 == "")
      {
          $situacao_input_2 = $situacao;
      }
      $idpessoas_cond_salva = $idpessoas_cond; 
      if (!isset($idpessoas_input_2) || $idpessoas_input_2 == "")
      {
          $idpessoas_input_2 = $idpessoas;
      }
      if ($idfilial_cond != "in")
      {
          nm_limpa_numero($idfilial, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idpessoas_cond != "in")
      {
          nm_limpa_numero($idpessoas, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['comercial'] = $comercial; 
      if (is_array($comercial) && !empty($comercial))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['val'][0] = $comercial;
      }
      elseif ($comercial_cond_salva == "nu" || $comercial_cond_salva == "nn" || $comercial_cond_salva == "ep" || $comercial_cond_salva == "ne" || !empty($comercial))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['val'][0][0] = $comercial;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['comercial_cond'] = $comercial_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['cmp'] = "comercial"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['opc'] = $comercial_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq']['comercial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['idfilial'] = $idfilial; 
      if (is_array($idfilial) && !empty($idfilial))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['val'][0] = $idfilial;
      }
      elseif ($idfilial_cond_salva == "nu" || $idfilial_cond_salva == "nn" || $idfilial_cond_salva == "ep" || $idfilial_cond_salva == "ne" || !empty($idfilial))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['val'][0][0] = $idfilial;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['idfilial_cond'] = $idfilial_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['cmp'] = "idfilial"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['opc'] = $idfilial_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq']['idfilial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['situacao'] = $situacao; 
      if (is_array($situacao) && !empty($situacao))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['val'][0] = $situacao;
      }
      elseif ($situacao_cond_salva == "nu" || $situacao_cond_salva == "nn" || $situacao_cond_salva == "ep" || $situacao_cond_salva == "ne" || !empty($situacao))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['val'][0][0] = $situacao;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['situacao_cond'] = $situacao_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['cmp'] = "situacao"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['opc'] = $situacao_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq']['situacao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['idpessoas'] = $idpessoas; 
      if (is_array($idpessoas) && !empty($idpessoas))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['val'][0] = $idpessoas;
      }
      elseif ($idpessoas_cond_salva == "nu" || $idpessoas_cond_salva == "nn" || $idpessoas_cond_salva == "ep" || $idpessoas_cond_salva == "ne" || !empty($idpessoas))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['val'][0][0] = $idpessoas;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['idpessoas_cond'] = $idpessoas_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['cmp'] = "idpessoas"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid]['opc'] = $idpessoas_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['grid_pesq']['idpessoas'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($comercial != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['comercial'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['comercial'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['comercial'] = $comercial;
      }
      $Conteudo = $idfilial;
      if (strtoupper($idfilial_cond) != "II" && strtoupper($idfilial_cond) != "QP" && strtoupper($idfilial_cond) != "NP" && strtoupper($idfilial_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idfilial'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($situacao != '') {
      $situacao_look = substr($this->Db->qstr($situacao), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['situacao'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['situacao'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['situacao'] = $situacao;
      }
      $Conteudo = $idpessoas;
      if (strtoupper($idpessoas_cond) != "II" && strtoupper($idpessoas_cond) != "QP" && strtoupper($idpessoas_cond) != "NP" && strtoupper($idpessoas_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idpessoas'] = $Conteudo;

      //----- $comercial
      $this->Date_part = false;
      if (isset($comercial) || $comercial_cond == "nu" || $comercial_cond == "nn" || $comercial_cond == "ep" || $comercial_cond == "ne")
      {
         $this->monta_condicao("comercial", $comercial_cond, $comercial, "", "comercial");
      }

      //----- $idfilial
      $this->Date_part = false;
      if (isset($idfilial) || $idfilial_cond == "nu" || $idfilial_cond == "nn" || $idfilial_cond == "ep" || $idfilial_cond == "ne")
      {
         $this->monta_condicao("idFilial", $idfilial_cond, $idfilial, "", "idfilial");
      }

      //----- $situacao
      $this->Date_part = false;
      if (isset($situacao) || $situacao_cond == "nu" || $situacao_cond == "nn" || $situacao_cond == "ep" || $situacao_cond == "ne")
      {
         $this->monta_condicao("situacao", $situacao_cond, $situacao, "", "situacao");
      }

      //----- $idpessoas
      $this->Date_part = false;
      if (isset($idpessoas) || $idpessoas_cond == "nu" || $idpessoas_cond == "nn" || $idpessoas_cond == "ep" || $idpessoas_cond == "ne")
      {
         $this->monta_condicao("idPessoas", $idpessoas_cond, $idpessoas, "", "idpessoas");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_contratos']['cond_pesq'] .= $this->NM_operador;
