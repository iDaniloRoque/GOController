...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_view_contratos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_view_contratos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_view_contratos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_view_contratos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_view_contratos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_view_contratos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dbo_view_contratos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_dbo_view_contratos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_view_contratos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dbo_view_contratos']['embutida_filho'] as $ind => $sc_init)
          {
