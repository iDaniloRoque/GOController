<?php  
  ...
  session_start() ;
  class chart_dbo_view_geral_lancamentos_linha_form_teste
  {
  function chart_dbo_view_geral_lancamentos_linha_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">chart_dbo_view_geral_lancamentos_linha</FONT></B> 
<br> 
<br> 
...
<input type=submit value="chart_dbo_view_geral_lancamentos_linha"> 
</form> 
...
<?php
  ...
  $frm_teste = new chart_dbo_view_geral_lancamentos_linha_form_teste();
  $frm_teste->chart_dbo_view_geral_lancamentos_linha_teste();
?>
