<?php
@session_start() ;
$_SESSION['scriptcase']['chart_dbo_view_geral_lancamentos_linha']['sc_process_barr'] = true;
require_once('../chart_dbo_view_geral_lancamentos_linha/index.php');
unset($_SESSION['scriptcase']['chart_dbo_view_geral_lancamentos_linha']['sc_process_barr']);
$ExportCtrl = new chart_dbo_view_geral_lancamentos_linha_export_control;
$ExportCtrl->Export_barr();

class chart_dbo_view_geral_lancamentos_linha_export_control
{
