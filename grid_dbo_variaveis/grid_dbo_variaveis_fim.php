...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_variaveis"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_variaveis"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_dbo_variaveis'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_variaveis']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_variaveis']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_variaveis']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_variaveis']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dbo_variaveis']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_dbo_variaveis</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_variaveis']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dbo_variaveis']['embutida_filho'] as $ind => $sc_init)
          {
