<?php  
  ...
  session_start() ;
  class form_dbo_lancamento_guias_form_teste
  {
   function form_dbo_lancamento_guias_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_dbo_lancamento_guias/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_dbo_lancamento_guias</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="form_dbo_lancamento_guias"> 
</form> 
<script language=javascript> 
 document.Fedit.usr_idContratos.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_dbo_lancamento_guias_form_teste();
  $frm_teste->form_dbo_lancamento_guias_teste();
?>
