<?php  
  ...
  session_start() ;
  class filtro_recibos_form_teste
  {
   function filtro_recibos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "filtro_recibos/img";
...
?> 
<br> 
<B><FONT SIZE="4">filtro_recibos</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="filtro_recibos"> 
</form> 
...
<?php
  ...
  $frm_teste = new filtro_recibos_form_teste();
  $frm_teste->filtro_recibos_teste();
?>
