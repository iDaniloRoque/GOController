...
<?php
   ...
   $Ord_Cmp = new grid_dbo_filial_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_dbo_filial_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idfilial'] = "idFilial";
   $tab_labels["idfilial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['labels']["idfilial"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['labels']["idfilial"] : "Cod.";
   $tab_ger_campos['cnpj'] = "on";
   $tab_def_campos['cnpj'] = "cnpj";
   $tab_labels["cnpj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['labels']["cnpj"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['labels']["cnpj"] : "Cnpj";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['labels']["nome"] : "Nome";
   $tab_ger_campos['fantasia'] = "on";
   $tab_def_campos['fantasia'] = "fantasia";
   $tab_labels["fantasia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['labels']["fantasia"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['labels']["fantasia"] : "Fantasia";
   $tab_ger_campos['comercial'] = "on";
   $tab_def_campos['comercial'] = "comercial";
   $tab_labels["comercial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['labels']["comercial"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['labels']["comercial"] : "Comercial";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_dbo_filial_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_dbo_filial']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
