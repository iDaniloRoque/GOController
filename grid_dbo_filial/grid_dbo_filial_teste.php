<?php  
  ...
  session_start() ;
  class grid_dbo_filial_form_teste
  {
  function grid_dbo_filial_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_dbo_filial</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_dbo_filial"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_dbo_filial_form_teste();
  $frm_teste->grid_dbo_filial_teste();
?>
