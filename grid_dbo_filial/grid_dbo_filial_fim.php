...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_filial"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_filial"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_dbo_filial'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_filial']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_filial']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_filial']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_filial']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dbo_filial']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_filial']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dbo_filial']['embutida_filho'] as $ind => $sc_init)
          {
