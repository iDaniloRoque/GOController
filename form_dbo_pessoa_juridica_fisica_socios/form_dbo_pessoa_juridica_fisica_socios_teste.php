<?php  
  ...
  session_start() ;
  class form_dbo_pessoa_juridica_fisica_socios_form_teste
  {
   function form_dbo_pessoa_juridica_fisica_socios_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_dbo_pessoa_juridica_fisica_socios/img";
...
<?php
  ...
  $frm_teste = new form_dbo_pessoa_juridica_fisica_socios_form_teste();
  $frm_teste->form_dbo_pessoa_juridica_fisica_socios_teste();
?>
