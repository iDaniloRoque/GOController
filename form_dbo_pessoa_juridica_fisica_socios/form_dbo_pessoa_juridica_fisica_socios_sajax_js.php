  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_pessoa_juridica_fisica_socios" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_pessoa_juridica_fisica_socios_form();
	}
...
?>
  ...
  // ---------- Validate idpessoas_socios_
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idpessoas_socios_(iNumLinha)
  {
    var nomeCampo_idpessoas_socios_ = "idpessoas_socios_" + iNumLinha;
    var var_idpessoas_socios_ = scAjaxGetFieldSelect(nomeCampo_idpessoas_socios_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idpessoas_socios_(var_idpessoas_socios_, iNumLinha, var_script_case_init, do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idpessoas_socios__cb);
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idpessoas_socios_

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idpessoas_socios__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idpessoas_socios_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idpessoas_socios_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idpessoas_socios_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpessoas_socios_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idpessoas_socios__cb

  // ---------- Validate tipo_socios_
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_socios_(iNumLinha)
  {
    var nomeCampo_tipo_socios_ = "tipo_socios_" + iNumLinha;
    var var_tipo_socios_ = scAjaxGetFieldSelect(nomeCampo_tipo_socios_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_socios_(var_tipo_socios_, iNumLinha, var_script_case_init, do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_socios__cb);
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_socios_

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_socios__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tipo_socios_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipo_socios_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tipo_socios_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipo_socios_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_socios__cb

  // ---------- Validate tipo_adm_
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_adm_(iNumLinha)
  {
    var nomeCampo_tipo_adm_ = "tipo_adm_" + iNumLinha;
    var var_tipo_adm_ = scAjaxGetFieldSelect(nomeCampo_tipo_adm_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_adm_(var_tipo_adm_, iNumLinha, var_script_case_init, do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_adm__cb);
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_adm_

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_adm__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tipo_adm_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipo_adm_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tipo_adm_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipo_adm_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_tipo_adm__cb

  // ---------- Validate idsocios_
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idsocios_(iNumLinha)
  {
    var nomeCampo_idsocios_ = "idsocios_" + iNumLinha;
    var var_idsocios_ = scAjaxGetFieldHidden(nomeCampo_idsocios_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idsocios_(var_idsocios_, iNumLinha, var_script_case_init, do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idsocios__cb);
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idsocios_

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idsocios__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idsocios_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idsocios_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idsocios_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idsocios_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_validate_idsocios__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_pessoa_juridica_fisica_socios_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_pessoa_juridica_fisica_socios_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_pessoa_juridica_fisica_socios_add_new_line_cb);
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_add_new_line

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_backup_line(iNumLinha)
  {
    var var_idsocios_ = scAjaxGetFieldHidden("idsocios_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_pessoa_juridica_fisica_socios_backup_line(var_idsocios_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_pessoa_juridica_fisica_socios_backup_line_cb);
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_backup_line

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_backup_line_cb

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_cancel_insert

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_pessoa_juridica_fisica_socios_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_cancel_update

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_table_refresh()
  {
    var var_idsocios_ = document.F2.idsocios_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_pessoa_juridica_fisica_socios_table_refresh(var_idsocios_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_pessoa_juridica_fisica_socios_table_refresh_cb);
  } //  do_ajax_form_dbo_pessoa_juridica_fisica_socios_table_refresh

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idsocios_.value = scAjaxGetKeyValue("idsocios_");
    ...
    scAjaxAlert(do_ajax_form_dbo_pessoa_juridica_fisica_socios_table_refresh_cb_after_alert);
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_table_refresh_cb
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_dbo_pessoa_juridica_fisica_socios_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_idpessoas_socios_ = scAjaxGetFieldSelect("idpessoas_socios_" + iNumLinha);
    var var_tipo_socios_ = scAjaxGetFieldSelect("tipo_socios_" + iNumLinha);
    var var_tipo_adm_ = scAjaxGetFieldSelect("tipo_adm_" + iNumLinha);
    var var_idsocios_ = scAjaxGetFieldHidden("idsocios_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_dbo_pessoa_juridica_fisica_socios_submit_form(var_idpessoas_socios_, var_tipo_socios_, var_tipo_adm_, var_idsocios_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_pessoa_juridica_fisica_socios_submit_form_cb);
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_submit_form

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idpessoas_socios_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tipo_socios_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tipo_adm_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idsocios_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_pessoa_juridica_fisica_socios_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_submit_form_cb
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form();
    }
  }

  function perform_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_pessoa_juridica_fisica_socios_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idpessoas_socios_" + iNavForm);
      scAjaxHideErrorDisplay("tipo_socios_" + iNavForm);
      scAjaxHideErrorDisplay("tipo_adm_" + iNavForm);
      scAjaxHideErrorDisplay("idsocios_" + iNavForm);
    }
    var var_idsocios_ = document.F2.idsocios_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form(var_idsocios_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form_cb);
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica_socios']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idsocios_.value = scAjaxGetKeyValue("idsocios_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form_cb
  function do_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_dbo_pessoa_juridica_fisica_socios_navigate_form_cb_after_alert
  function sc_hide_form_dbo_pessoa_juridica_fisica_socios_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idpessoas_socios_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipo_socios_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipo_adm_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idsocios_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idpessoas_socios_" + iNumLinha] = {"label": "Pessoas<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tipo_socios_" + iNumLinha] = {"label": "Sócio?<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tipo_adm_" + iNumLinha] = {"label": "Tipo Adm<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idsocios_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idpessoas_socios_"][iNumLinha] = "idpessoas_socios_" + iNumLinha;
    ajax_field_mult["tipo_socios_"][iNumLinha] = "tipo_socios_" + iNumLinha;
    ajax_field_mult["tipo_adm_"][iNumLinha] = "tipo_adm_" + iNumLinha;
    ajax_field_mult["idsocios_"][iNumLinha] = "idsocios_" + iNumLinha;
    ajax_field_id["idpessoas_socios_" + iNumLinha] = new Array("hidden_field_label_idpessoas_socios_", "hidden_field_data_idpessoas_socios_" + iNumLinha);
    ajax_field_id["tipo_socios_" + iNumLinha] = new Array("hidden_field_label_tipo_socios_", "hidden_field_data_tipo_socios_" + iNumLinha);
    ajax_field_id["tipo_adm_" + iNumLinha] = new Array("hidden_field_label_tipo_adm_", "hidden_field_data_tipo_adm_" + iNumLinha);
    ajax_error_count["idpessoas_socios_" + iNumLinha] = "off";
    ajax_error_count["tipo_socios_" + iNumLinha] = "off";
    ajax_error_count["tipo_adm_" + iNumLinha] = "off";
    ajax_error_count["idsocios_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idpessoas_socios_" + iNumLinha] = "off";
    ajax_read_only["tipo_socios_" + iNumLinha] = "off";
    ajax_read_only["tipo_adm_" + iNumLinha] = "off";
    ajax_read_only["idsocios_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["idpessoas_socios_" + iNumLinha] = "on";
    ajax_read_only["tipo_socios_" + iNumLinha] = "on";
    ajax_read_only["tipo_adm_" + iNumLinha] = "on";
    ajax_read_only["idsocios_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["idpessoas_socios_" + iNumLinha] = null;
    ajax_error_list["tipo_socios_" + iNumLinha] = null;
    ajax_error_list["tipo_adm_" + iNumLinha] = null;
    ajax_error_list["idsocios_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idpessoas_socios_": new Array(),
    "tipo_socios_": new Array(),
    "tipo_adm_": new Array(),
    "idsocios_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idpessoas_socios_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idpessoas_socios_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idpessoas_socios_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idpessoas_socios_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idpessoas_socios_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tipo_socios_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipo_socios_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipo_socios_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipo_socios_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipo_socios_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["tipo_adm_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipo_adm_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipo_adm_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipo_adm_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipo_adm_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idsocios_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idsocios_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idsocios_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idsocios_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idsocios_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idpessoas_socios_'])) ? $this->nmgp_cmp_readonly['idpessoas_socios_'] : 'off';
?>
    scAjaxFieldRead("idpessoas_socios_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipo_socios_'])) ? $this->nmgp_cmp_readonly['tipo_socios_'] : 'off';
?>
    scAjaxFieldRead("tipo_socios_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipo_adm_'])) ? $this->nmgp_cmp_readonly['tipo_adm_'] : 'off';
?>
    scAjaxFieldRead("tipo_adm_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idsocios_'])) ? $this->nmgp_cmp_readonly['idsocios_'] : 'on';
?>
    scAjaxFieldRead("idsocios_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idpessoas_socios_" + iSeq, "on");
    scAjaxFieldRead("tipo_socios_" + iSeq, "on");
    scAjaxFieldRead("tipo_adm_" + iSeq, "on");
    scAjaxFieldRead("idsocios_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idpessoas_socios_" + iRow] || "on" == ajax_error_count["tipo_socios_" + iRow] || "on" == ajax_error_count["tipo_adm_" + iRow] || "on" == ajax_error_count["idsocios_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idpessoas_socios_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tipo_socios_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tipo_adm_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idsocios_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idpessoas_socios_" + iRow] && "off" == ajax_error_count["tipo_socios_" + iRow] && "off" == ajax_error_count["tipo_adm_" + iRow] && "off" == ajax_error_count["idsocios_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idpessoas_socios_" + iRow] = "off";
        ajax_error_count["tipo_socios_" + iRow] = "off";
        ajax_error_count["tipo_adm_" + iRow] = "off";
        ajax_error_count["idsocios_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idpessoas_socios_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tipo_socios_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tipo_adm_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idsocios_" + iRow).removeClass("scFormErrorLine");
    }
  }
