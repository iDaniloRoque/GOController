<?php  
  ...
  session_start() ;
  class grid_rel_geral_lancamentos_completo_form_teste
  {
  function grid_rel_geral_lancamentos_completo_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_rel_geral_lancamentos_completo</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_rel_geral_lancamentos_completo"> 
</form> 
<script language=javascript> 
 document.FCons.usr_MesAno.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_rel_geral_lancamentos_completo_form_teste();
  $frm_teste->grid_rel_geral_lancamentos_completo_teste();
?>
