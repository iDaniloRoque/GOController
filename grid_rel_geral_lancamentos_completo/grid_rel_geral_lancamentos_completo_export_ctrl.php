<?php
@session_start() ;
$_SESSION['scriptcase']['grid_rel_geral_lancamentos_completo']['sc_process_barr'] = true;
require_once('../grid_rel_geral_lancamentos_completo/index.php');
unset($_SESSION['scriptcase']['grid_rel_geral_lancamentos_completo']['sc_process_barr']);
$ExportCtrl = new grid_rel_geral_lancamentos_completo_export_control;
$ExportCtrl->Export_barr();

class grid_rel_geral_lancamentos_completo_export_control
{
