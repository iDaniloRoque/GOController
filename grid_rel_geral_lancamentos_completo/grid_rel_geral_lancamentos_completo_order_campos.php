...
<?php
   ...
   $Ord_Cmp = new grid_rel_geral_lancamentos_completo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_rel_geral_lancamentos_completo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["mes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["mes"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["mes"] : "Mes";
   $tab_ger_campos['ano'] = "on";
   $tab_def_campos['ano'] = "Ano";
   $tab_labels["ano"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["ano"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["ano"] : "Ano";
   $tab_ger_campos['nome_razao_social'] = "on";
   $tab_def_campos['nome_razao_social'] = "nome_razao_social";
   $tab_labels["nome_razao_social"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["nome_razao_social"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["nome_razao_social"] : "Razão Social";
   $tab_ger_campos['dadoscontratos'] = "on";
   $tab_def_campos['dadoscontratos'] = "DadosContratos";
   $tab_labels["dadoscontratos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["dadoscontratos"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["dadoscontratos"] : "Contratos";
   $tab_ger_campos['totalservico'] = "on";
   $tab_def_campos['totalservico'] = "TotalServico";
   $tab_labels["totalservico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["totalservico"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["totalservico"] : "Total Serviço";
   $tab_ger_campos['perc_cofins'] = "on";
   $tab_def_campos['perc_cofins'] = "Perc_Cofins";
   $tab_labels["perc_cofins"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["perc_cofins"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["perc_cofins"] : "Perc Cofins";
   $tab_ger_campos['valorcofins'] = "on";
   $tab_def_campos['valorcofins'] = "ValorCofins";
   $tab_labels["valorcofins"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valorcofins"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valorcofins"] : "Valor Cofins";
   $tab_ger_campos['perc_csll'] = "on";
   $tab_def_campos['perc_csll'] = "Perc_CSLL";
   $tab_labels["perc_csll"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["perc_csll"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["perc_csll"] : "Perc CSLL";
   $tab_ger_campos['valorcsll'] = "on";
   $tab_def_campos['valorcsll'] = "ValorCSLL";
   $tab_labels["valorcsll"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valorcsll"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valorcsll"] : "Valor CSLL";
   $tab_ger_campos['perc_irpj'] = "on";
   $tab_def_campos['perc_irpj'] = "Perc_IRPJ";
   $tab_labels["perc_irpj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["perc_irpj"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["perc_irpj"] : "Perc IRPJ";
   $tab_ger_campos['valorirpj'] = "on";
   $tab_def_campos['valorirpj'] = "ValorIRPJ";
   $tab_labels["valorirpj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valorirpj"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valorirpj"] : "Valor IRPJ";
   $tab_ger_campos['perc_iss'] = "on";
   $tab_def_campos['perc_iss'] = "Perc_ISS";
   $tab_labels["perc_iss"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["perc_iss"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["perc_iss"] : "Perc ISS";
   $tab_ger_campos['valoriss'] = "on";
   $tab_def_campos['valoriss'] = "ValorISS";
   $tab_labels["valoriss"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valoriss"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valoriss"] : "Valor ISS";
   $tab_ger_campos['perc_pis'] = "on";
   $tab_def_campos['perc_pis'] = "Perc_PIS";
   $tab_labels["perc_pis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["perc_pis"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["perc_pis"] : "Perc PIS";
   $tab_ger_campos['valorpis'] = "on";
   $tab_def_campos['valorpis'] = "ValorPIS";
   $tab_labels["valorpis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valorpis"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valorpis"] : "Valor PIS";
   $tab_ger_campos['valorliquido'] = "on";
   $tab_def_campos['valorliquido'] = "ValorLiquido";
   $tab_labels["valorliquido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valorliquido"])) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['labels']["valorliquido"] : "Valor Liquido";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_rel_geral_lancamentos_completo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_rel_geral_lancamentos_completo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
