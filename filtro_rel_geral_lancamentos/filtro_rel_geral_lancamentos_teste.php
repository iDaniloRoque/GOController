<?php  
  ...
  session_start() ;
  class filtro_rel_geral_lancamentos_form_teste
  {
   function filtro_rel_geral_lancamentos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "filtro_rel_geral_lancamentos/img";
...
?> 
<br> 
<B><FONT SIZE="4">filtro_rel_geral_lancamentos</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="filtro_rel_geral_lancamentos"> 
</form> 
<script language=javascript> 
 document.Fedit.usr_MesAno.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new filtro_rel_geral_lancamentos_form_teste();
  $frm_teste->filtro_rel_geral_lancamentos_teste();
?>
