  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_filtro_rel_geral_lancamentos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_filtro_rel_geral_lancamentos_mob_form();
	}
...
?>
  ...
  // ---------- Validate mes
  function do_ajax_filtro_rel_geral_lancamentos_mob_validate_mes()
  {
    var nomeCampo_mes = "mes";
    var var_mes = scAjaxGetFieldText(nomeCampo_mes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_rel_geral_lancamentos_mob_validate_mes(var_mes, var_script_case_init, do_ajax_filtro_rel_geral_lancamentos_mob_validate_mes_cb);
  } // do_ajax_filtro_rel_geral_lancamentos_mob_validate_mes

  function do_ajax_filtro_rel_geral_lancamentos_mob_validate_mes_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_rel_geral_lancamentos_mob_validate_mes_cb

  // ---------- Validate pqual
  function do_ajax_filtro_rel_geral_lancamentos_mob_validate_pqual()
  {
    var nomeCampo_pqual = "pqual";
    var var_pqual = scAjaxGetFieldCheckbox(nomeCampo_pqual, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_filtro_rel_geral_lancamentos_mob_validate_pqual(var_pqual, var_script_case_init, do_ajax_filtro_rel_geral_lancamentos_mob_validate_pqual_cb);
  } // do_ajax_filtro_rel_geral_lancamentos_mob_validate_pqual

  function do_ajax_filtro_rel_geral_lancamentos_mob_validate_pqual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pqual";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_filtro_rel_geral_lancamentos_mob_validate_pqual_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_filtro_rel_geral_lancamentos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_filtro_rel_geral_lancamentos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_mes = scAjaxGetFieldText("mes");
    var var_pqual = scAjaxGetFieldCheckbox("pqual", ";");
    ...
    scAjaxProcOn();
    x_ajax_filtro_rel_geral_lancamentos_mob_submit_form(var_mes, var_pqual, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_filtro_rel_geral_lancamentos_mob_submit_form_cb);
  } // do_ajax_filtro_rel_geral_lancamentos_mob_submit_form

  function do_ajax_filtro_rel_geral_lancamentos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_filtro_rel_geral_lancamentos_mob_submit_form_cb_after_alert);
  } // do_ajax_filtro_rel_geral_lancamentos_mob_submit_form_cb
  function do_ajax_filtro_rel_geral_lancamentos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_filtro_rel_geral_lancamentos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_filtro_rel_geral_lancamentos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_filtro_rel_geral_lancamentos_mob_navigate_form, function() {});
    } else {
      perform_ajax_filtro_rel_geral_lancamentos_mob_navigate_form();
    }
  }

  function perform_ajax_filtro_rel_geral_lancamentos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_filtro_rel_geral_lancamentos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['filtro_rel_geral_lancamentos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_filtro_rel_geral_lancamentos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_filtro_rel_geral_lancamentos_mob_navigate_form_cb_after_alert);
  } // do_ajax_filtro_rel_geral_lancamentos_mob_navigate_form_cb
  function do_ajax_filtro_rel_geral_lancamentos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_filtro_rel_geral_lancamentos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_filtro_rel_geral_lancamentos_mob_navigate_form_cb_after_alert
  function sc_hide_filtro_rel_geral_lancamentos_mob_form()
  {
  ...
  ajax_field_list[0] = "mes";
  ajax_field_list[1] = "pqual";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "mes": {"label": "Mês/Ano", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pqual": {"label": "Escolha o relatório", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["pqual"][1] = "pqual";

  var ajax_field_id = {
    "mes": new Array("hidden_field_label_mes", "hidden_field_data_mes"),
    "pqual": new Array("hidden_field_label_pqual", "hidden_field_data_pqual")
  };
