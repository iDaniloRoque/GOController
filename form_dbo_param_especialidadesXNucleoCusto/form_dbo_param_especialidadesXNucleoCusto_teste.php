<?php  
  ...
  session_start() ;
  class form_dbo_param_especialidadesXNucleoCusto_form_teste
  {
   function form_dbo_param_especialidadesXNucleoCusto_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_dbo_param_especialidadesXNucleoCusto/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_dbo_param_especialidadesXNucleoCusto</FONT></B> 
<br> 
<br> 
...
usr_name&nbsp;&nbsp;<input type="text" name="usr_name" size=20><br> 
usr_idEmpresa&nbsp;&nbsp;<input type="text" name="usr_idEmpresa" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="form_dbo_param_especialidadesXNucleoCusto"> 
</form> 
<script language=javascript> 
 document.Fedit.usr_name.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new form_dbo_param_especialidadesXNucleoCusto_form_teste();
  $frm_teste->form_dbo_param_especialidadesXNucleoCusto_teste();
?>
