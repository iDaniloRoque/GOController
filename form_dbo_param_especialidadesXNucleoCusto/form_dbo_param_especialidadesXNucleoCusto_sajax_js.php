  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_param_especialidadesXNucleoCusto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_param_especialidadesXNucleoCusto_form();
	}
...
?>
  ...
  // ---------- Validate idparam_especialidade_
  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idparam_especialidade_(iNumLinha)
  {
    var nomeCampo_idparam_especialidade_ = "idparam_especialidade_" + iNumLinha;
    var var_idparam_especialidade_ = scAjaxGetFieldHidden(nomeCampo_idparam_especialidade_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idparam_especialidade_(var_idparam_especialidade_, iNumLinha, var_script_case_init, do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idparam_especialidade__cb);
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idparam_especialidade_

  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idparam_especialidade__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idparam_especialidade_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idparam_especialidade_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idparam_especialidade_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idparam_especialidade_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idparam_especialidade__cb

  // ---------- Validate idespecialidade_
  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idespecialidade_(iNumLinha)
  {
    var nomeCampo_idespecialidade_ = "idespecialidade_" + iNumLinha;
    var var_idespecialidade_ = scAjaxGetFieldSelect(nomeCampo_idespecialidade_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idespecialidade_(var_idespecialidade_, iNumLinha, var_script_case_init, do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idespecialidade__cb);
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idespecialidade_

  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idespecialidade__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idespecialidade_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idespecialidade_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idespecialidade_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idespecialidade_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_idespecialidade__cb

  // ---------- Validate numnucleocusto_
  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_numnucleocusto_(iNumLinha)
  {
    var nomeCampo_numnucleocusto_ = "numnucleocusto_" + iNumLinha;
    var var_numnucleocusto_ = scAjaxGetFieldText(nomeCampo_numnucleocusto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_numnucleocusto_(var_numnucleocusto_, iNumLinha, var_script_case_init, do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_numnucleocusto__cb);
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_numnucleocusto_

  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_numnucleocusto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "numnucleocusto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "numnucleocusto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "numnucleocusto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "numnucleocusto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_validate_numnucleocusto__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_param_especialidadesXNucleoCusto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_param_especialidadesXNucleoCusto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_param_especialidadesXNucleoCusto_add_new_line_cb);
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_add_new_line

  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_backup_line(iNumLinha)
  {
    var var_idparam_especialidade_ = scAjaxGetFieldHidden("idparam_especialidade_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_param_especialidadesXNucleoCusto_backup_line(var_idparam_especialidade_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_param_especialidadesXNucleoCusto_backup_line_cb);
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_backup_line

  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_backup_line_cb

  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_cancel_insert

  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_param_especialidadesXNucleoCusto_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_cancel_update

  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_table_refresh()
  {
    var var_idparam_especialidade_ = document.F2.idparam_especialidade_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_param_especialidadesXNucleoCusto_table_refresh(var_idparam_especialidade_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_param_especialidadesXNucleoCusto_table_refresh_cb);
  } //  do_ajax_form_dbo_param_especialidadesXNucleoCusto_table_refresh

  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idparam_especialidade_.value = scAjaxGetKeyValue("idparam_especialidade_");
    ...
    scAjaxAlert(do_ajax_form_dbo_param_especialidadesXNucleoCusto_table_refresh_cb_after_alert);
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_table_refresh_cb
  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_dbo_param_especialidadesXNucleoCusto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idparam_especialidade_ = scAjaxGetFieldHidden("idparam_especialidade_" + iNumLinha);
    var var_idespecialidade_ = scAjaxGetFieldSelect("idespecialidade_" + iNumLinha);
    var var_numnucleocusto_ = scAjaxGetFieldText("numnucleocusto_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_dbo_param_especialidadesXNucleoCusto_submit_form(var_idparam_especialidade_, var_idespecialidade_, var_numnucleocusto_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_param_especialidadesXNucleoCusto_submit_form_cb);
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_submit_form

  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idparam_especialidade_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idespecialidade_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("numnucleocusto_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_param_especialidadesXNucleoCusto_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_submit_form_cb
  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form();
    }
  }

  function perform_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_param_especialidadesXNucleoCusto_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idparam_especialidade_" + iNavForm);
      scAjaxHideErrorDisplay("idespecialidade_" + iNavForm);
      scAjaxHideErrorDisplay("numnucleocusto_" + iNavForm);
    }
    var var_idparam_especialidade_ = document.F2.idparam_especialidade_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form(var_idparam_especialidade_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form_cb);
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_param_especialidadesXNucleoCusto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idparam_especialidade_.value = scAjaxGetKeyValue("idparam_especialidade_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form_cb
  function do_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_dbo_param_especialidadesXNucleoCusto_navigate_form_cb_after_alert
  function sc_hide_form_dbo_param_especialidadesXNucleoCusto_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idparam_especialidade_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idespecialidade_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "numnucleocusto_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idparam_especialidade_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idespecialidade_" + iNumLinha] = {"label": "Especialidade<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["numnucleocusto_" + iNumLinha] = {"label": "Numero<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idparam_especialidade_"][iNumLinha] = "idparam_especialidade_" + iNumLinha;
    ajax_field_mult["idespecialidade_"][iNumLinha] = "idespecialidade_" + iNumLinha;
    ajax_field_mult["numnucleocusto_"][iNumLinha] = "numnucleocusto_" + iNumLinha;
    ajax_field_id["idparam_especialidade_" + iNumLinha] = new Array("hidden_field_label_idparam_especialidade_", "hidden_field_data_idparam_especialidade_" + iNumLinha);
    ajax_field_id["idespecialidade_" + iNumLinha] = new Array("hidden_field_label_idespecialidade_", "hidden_field_data_idespecialidade_" + iNumLinha);
    ajax_field_id["numnucleocusto_" + iNumLinha] = new Array("hidden_field_label_numnucleocusto_", "hidden_field_data_numnucleocusto_" + iNumLinha);
    ajax_error_count["idparam_especialidade_" + iNumLinha] = "off";
    ajax_error_count["idespecialidade_" + iNumLinha] = "off";
    ajax_error_count["numnucleocusto_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idparam_especialidade_" + iNumLinha] = "on";
    ajax_read_only["idespecialidade_" + iNumLinha] = "off";
    ajax_read_only["numnucleocusto_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idparam_especialidade_" + iNumLinha] = "on";
    ajax_read_only["idespecialidade_" + iNumLinha] = "on";
    ajax_read_only["numnucleocusto_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idparam_especialidade_" + iNumLinha] = null;
    ajax_error_list["idespecialidade_" + iNumLinha] = null;
    ajax_error_list["numnucleocusto_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idparam_especialidade_": new Array(),
    "idespecialidade_": new Array(),
    "numnucleocusto_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idparam_especialidade_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idparam_especialidade_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idparam_especialidade_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idparam_especialidade_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idparam_especialidade_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idespecialidade_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idespecialidade_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idespecialidade_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idespecialidade_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idespecialidade_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["numnucleocusto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["numnucleocusto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["numnucleocusto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["numnucleocusto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["numnucleocusto_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idparam_especialidade_'])) ? $this->nmgp_cmp_readonly['idparam_especialidade_'] : 'on';
?>
    scAjaxFieldRead("idparam_especialidade_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idespecialidade_'])) ? $this->nmgp_cmp_readonly['idespecialidade_'] : 'off';
?>
    scAjaxFieldRead("idespecialidade_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['numnucleocusto_'])) ? $this->nmgp_cmp_readonly['numnucleocusto_'] : 'off';
?>
    scAjaxFieldRead("numnucleocusto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idparam_especialidade_" + iSeq, "on");
    scAjaxFieldRead("idespecialidade_" + iSeq, "on");
    scAjaxFieldRead("numnucleocusto_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idparam_especialidade_" + iRow] || "on" == ajax_error_count["idespecialidade_" + iRow] || "on" == ajax_error_count["numnucleocusto_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idparam_especialidade_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idespecialidade_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_numnucleocusto_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idparam_especialidade_" + iRow] && "off" == ajax_error_count["idespecialidade_" + iRow] && "off" == ajax_error_count["numnucleocusto_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idparam_especialidade_" + iRow] = "off";
        ajax_error_count["idespecialidade_" + iRow] = "off";
        ajax_error_count["numnucleocusto_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idparam_especialidade_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idespecialidade_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_numnucleocusto_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idparam_especialidade_" == sIndex)
    {
