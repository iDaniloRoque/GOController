<?php  
  ...
  session_start() ;
  class grid_form_dbo_usuario_externo_form_teste
  {
   function grid_form_dbo_usuario_externo_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "grid_form_dbo_usuario_externo/img";
...
<?php
  ...
  $frm_teste = new grid_form_dbo_usuario_externo_form_teste();
  $frm_teste->grid_form_dbo_usuario_externo_teste();
?>
