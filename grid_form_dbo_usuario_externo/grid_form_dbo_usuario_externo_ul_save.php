...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['grid_form_dbo_usuario_externo']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['grid_form_dbo_usuario_externo']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['grid_form_dbo_usuario_externo']['upload_field_info'][ $_POST['param_field'] ];
