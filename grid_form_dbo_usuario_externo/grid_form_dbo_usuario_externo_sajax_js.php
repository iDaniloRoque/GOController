  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_form_dbo_usuario_externo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_grid_form_dbo_usuario_externo_form();
	}
...
?>
  ...
  // ---------- Validate idusuarioexternos_
  function do_ajax_grid_form_dbo_usuario_externo_validate_idusuarioexternos_(iNumLinha)
  {
    var nomeCampo_idusuarioexternos_ = "idusuarioexternos_" + iNumLinha;
    var var_idusuarioexternos_ = scAjaxGetFieldHidden(nomeCampo_idusuarioexternos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_form_dbo_usuario_externo_validate_idusuarioexternos_(var_idusuarioexternos_, iNumLinha, var_script_case_init, do_ajax_grid_form_dbo_usuario_externo_validate_idusuarioexternos__cb);
  } // do_ajax_grid_form_dbo_usuario_externo_validate_idusuarioexternos_

  function do_ajax_grid_form_dbo_usuario_externo_validate_idusuarioexternos__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idusuarioexternos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idusuarioexternos_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idusuarioexternos_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idusuarioexternos_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_form_dbo_usuario_externo_validate_idusuarioexternos__cb

  // ---------- Validate nome_do_usuario_
  function do_ajax_grid_form_dbo_usuario_externo_validate_nome_do_usuario_(iNumLinha)
  {
    var nomeCampo_nome_do_usuario_ = "nome_do_usuario_" + iNumLinha;
    var var_nome_do_usuario_ = scAjaxGetFieldText(nomeCampo_nome_do_usuario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_form_dbo_usuario_externo_validate_nome_do_usuario_(var_nome_do_usuario_, iNumLinha, var_script_case_init, do_ajax_grid_form_dbo_usuario_externo_validate_nome_do_usuario__cb);
  } // do_ajax_grid_form_dbo_usuario_externo_validate_nome_do_usuario_

  function do_ajax_grid_form_dbo_usuario_externo_validate_nome_do_usuario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nome_do_usuario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nome_do_usuario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nome_do_usuario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nome_do_usuario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_form_dbo_usuario_externo_validate_nome_do_usuario__cb

  // ---------- Validate cpf_usuario_
  function do_ajax_grid_form_dbo_usuario_externo_validate_cpf_usuario_(iNumLinha)
  {
    var nomeCampo_cpf_usuario_ = "cpf_usuario_" + iNumLinha;
    var var_cpf_usuario_ = scAjaxGetFieldText(nomeCampo_cpf_usuario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_form_dbo_usuario_externo_validate_cpf_usuario_(var_cpf_usuario_, iNumLinha, var_script_case_init, do_ajax_grid_form_dbo_usuario_externo_validate_cpf_usuario__cb);
  } // do_ajax_grid_form_dbo_usuario_externo_validate_cpf_usuario_

  function do_ajax_grid_form_dbo_usuario_externo_validate_cpf_usuario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cpf_usuario_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cpf_usuario_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cpf_usuario_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cpf_usuario_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_form_dbo_usuario_externo_validate_cpf_usuario__cb

  // ---------- Validate idfilial_
  function do_ajax_grid_form_dbo_usuario_externo_validate_idfilial_(iNumLinha)
  {
    var nomeCampo_idfilial_ = "idfilial_" + iNumLinha;
    var var_idfilial_ = scAjaxGetFieldSelect(nomeCampo_idfilial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_form_dbo_usuario_externo_validate_idfilial_(var_idfilial_, iNumLinha, var_script_case_init, do_ajax_grid_form_dbo_usuario_externo_validate_idfilial__cb);
  } // do_ajax_grid_form_dbo_usuario_externo_validate_idfilial_

  function do_ajax_grid_form_dbo_usuario_externo_validate_idfilial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idfilial_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idfilial_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idfilial_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idfilial_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_form_dbo_usuario_externo_validate_idfilial__cb

  // ---------- Validate ativo_
  function do_ajax_grid_form_dbo_usuario_externo_validate_ativo_(iNumLinha)
  {
    var nomeCampo_ativo_ = "ativo_" + iNumLinha;
    var var_ativo_ = scAjaxGetFieldSelect(nomeCampo_ativo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_form_dbo_usuario_externo_validate_ativo_(var_ativo_, iNumLinha, var_script_case_init, do_ajax_grid_form_dbo_usuario_externo_validate_ativo__cb);
  } // do_ajax_grid_form_dbo_usuario_externo_validate_ativo_

  function do_ajax_grid_form_dbo_usuario_externo_validate_ativo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ativo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ativo_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ativo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ativo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_grid_form_dbo_usuario_externo_validate_ativo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_grid_form_dbo_usuario_externo_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_grid_form_dbo_usuario_externo_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_grid_form_dbo_usuario_externo_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_grid_form_dbo_usuario_externo_add_new_line_cb);
  } // do_ajax_grid_form_dbo_usuario_externo_add_new_line

  function do_ajax_grid_form_dbo_usuario_externo_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_grid_form_dbo_usuario_externo_add_new_line_cb

  // ---------- backup_line
  function do_ajax_grid_form_dbo_usuario_externo_backup_line(iNumLinha)
  {
    var var_idusuarioexternos_ = scAjaxGetFieldHidden("idusuarioexternos_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_grid_form_dbo_usuario_externo_backup_line(var_idusuarioexternos_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_grid_form_dbo_usuario_externo_backup_line_cb);
  } // do_ajax_grid_form_dbo_usuario_externo_backup_line

  function do_ajax_grid_form_dbo_usuario_externo_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_grid_form_dbo_usuario_externo_backup_line_cb

  function do_ajax_grid_form_dbo_usuario_externo_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_grid_form_dbo_usuario_externo_cancel_insert

  function do_ajax_grid_form_dbo_usuario_externo_cancel_update(iSeqVert)
  {
    do_ajax_grid_form_dbo_usuario_externo_backup_line(iSeqVert);
...
?>
  } // do_ajax_grid_form_dbo_usuario_externo_cancel_update

  function do_ajax_grid_form_dbo_usuario_externo_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_grid_form_dbo_usuario_externo_restore_buttons

  // ---------- table_refresh
  function do_ajax_grid_form_dbo_usuario_externo_table_refresh()
  {
    var var_idusuarioexternos_ = document.F2.idusuarioexternos_.value;
    ...
    scAjaxProcOn();
    x_ajax_grid_form_dbo_usuario_externo_table_refresh(var_idusuarioexternos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_grid_form_dbo_usuario_externo_table_refresh_cb);
  } //  do_ajax_grid_form_dbo_usuario_externo_table_refresh

  function do_ajax_grid_form_dbo_usuario_externo_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idusuarioexternos_.value = scAjaxGetKeyValue("idusuarioexternos_");
    ...
    scAjaxAlert(do_ajax_grid_form_dbo_usuario_externo_table_refresh_cb_after_alert);
  } // do_ajax_grid_form_dbo_usuario_externo_table_refresh_cb
  function do_ajax_grid_form_dbo_usuario_externo_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_grid_form_dbo_usuario_externo_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_grid_form_dbo_usuario_externo_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_grid_form_dbo_usuario_externo_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idusuarioexternos_ = scAjaxGetFieldHidden("idusuarioexternos_" + iNumLinha);
    var var_nome_do_usuario_ = scAjaxGetFieldText("nome_do_usuario_" + iNumLinha);
    var var_cpf_usuario_ = scAjaxGetFieldText("cpf_usuario_" + iNumLinha);
    var var_idfilial_ = scAjaxGetFieldSelect("idfilial_" + iNumLinha);
    var var_ativo_ = scAjaxGetFieldSelect("ativo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_grid_form_dbo_usuario_externo_submit_form(var_idusuarioexternos_, var_nome_do_usuario_, var_cpf_usuario_, var_idfilial_, var_ativo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_grid_form_dbo_usuario_externo_submit_form_cb);
  } // do_ajax_grid_form_dbo_usuario_externo_submit_form

  function do_ajax_grid_form_dbo_usuario_externo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idusuarioexternos_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nome_do_usuario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cpf_usuario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idfilial_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ativo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_grid_form_dbo_usuario_externo_submit_form_cb_after_alert);
  } // do_ajax_grid_form_dbo_usuario_externo_submit_form_cb
  function do_ajax_grid_form_dbo_usuario_externo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_grid_form_dbo_usuario_externo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_grid_form_dbo_usuario_externo_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_grid_form_dbo_usuario_externo_navigate_form, function() {});
    } else {
      perform_ajax_grid_form_dbo_usuario_externo_navigate_form();
    }
  }

  function perform_ajax_grid_form_dbo_usuario_externo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_grid_form_dbo_usuario_externo_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idusuarioexternos_" + iNavForm);
      scAjaxHideErrorDisplay("nome_do_usuario_" + iNavForm);
      scAjaxHideErrorDisplay("cpf_usuario_" + iNavForm);
      scAjaxHideErrorDisplay("idfilial_" + iNavForm);
      scAjaxHideErrorDisplay("ativo_" + iNavForm);
    }
    var var_idusuarioexternos_ = document.F2.idusuarioexternos_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_grid_form_dbo_usuario_externo_navigate_form(var_idusuarioexternos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_grid_form_dbo_usuario_externo_navigate_form_cb);
  } // do_ajax_grid_form_dbo_usuario_externo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['grid_form_dbo_usuario_externo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_grid_form_dbo_usuario_externo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idusuarioexternos_.value = scAjaxGetKeyValue("idusuarioexternos_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_grid_form_dbo_usuario_externo_navigate_form_cb_after_alert);
  } // do_ajax_grid_form_dbo_usuario_externo_navigate_form_cb
  function do_ajax_grid_form_dbo_usuario_externo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_grid_form_dbo_usuario_externo_navigate_form_cb_after_alert
  function sc_hide_grid_form_dbo_usuario_externo_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idusuarioexternos_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nome_do_usuario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cpf_usuario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idfilial_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ativo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idusuarioexternos_" + iNumLinha] = {"label": "Codigo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nome_do_usuario_" + iNumLinha] = {"label": "Nome Completo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cpf_usuario_" + iNumLinha] = {"label": "CPF<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idfilial_" + iNumLinha] = {"label": "Unidade<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["ativo_" + iNumLinha] = {"label": "Ativo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idusuarioexternos_"][iNumLinha] = "idusuarioexternos_" + iNumLinha;
    ajax_field_mult["nome_do_usuario_"][iNumLinha] = "nome_do_usuario_" + iNumLinha;
    ajax_field_mult["cpf_usuario_"][iNumLinha] = "cpf_usuario_" + iNumLinha;
    ajax_field_mult["idfilial_"][iNumLinha] = "idfilial_" + iNumLinha;
    ajax_field_mult["ativo_"][iNumLinha] = "ativo_" + iNumLinha;
    ajax_field_id["idusuarioexternos_" + iNumLinha] = new Array("hidden_field_label_idusuarioexternos_", "hidden_field_data_idusuarioexternos_" + iNumLinha);
    ajax_field_id["nome_do_usuario_" + iNumLinha] = new Array("hidden_field_label_nome_do_usuario_", "hidden_field_data_nome_do_usuario_" + iNumLinha);
    ajax_field_id["cpf_usuario_" + iNumLinha] = new Array("hidden_field_label_cpf_usuario_", "hidden_field_data_cpf_usuario_" + iNumLinha);
    ajax_field_id["idfilial_" + iNumLinha] = new Array("hidden_field_label_idfilial_", "hidden_field_data_idfilial_" + iNumLinha);
    ajax_field_id["ativo_" + iNumLinha] = new Array("hidden_field_label_ativo_", "hidden_field_data_ativo_" + iNumLinha);
    ajax_error_count["idusuarioexternos_" + iNumLinha] = "off";
    ajax_error_count["nome_do_usuario_" + iNumLinha] = "off";
    ajax_error_count["cpf_usuario_" + iNumLinha] = "off";
    ajax_error_count["idfilial_" + iNumLinha] = "off";
    ajax_error_count["ativo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idusuarioexternos_" + iNumLinha] = "on";
    ajax_read_only["nome_do_usuario_" + iNumLinha] = "off";
    ajax_read_only["cpf_usuario_" + iNumLinha] = "off";
    ajax_read_only["idfilial_" + iNumLinha] = "off";
    ajax_read_only["ativo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idusuarioexternos_" + iNumLinha] = "on";
    ajax_read_only["nome_do_usuario_" + iNumLinha] = "on";
    ajax_read_only["cpf_usuario_" + iNumLinha] = "on";
    ajax_read_only["idfilial_" + iNumLinha] = "on";
    ajax_read_only["ativo_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idusuarioexternos_" + iNumLinha] = null;
    ajax_error_list["nome_do_usuario_" + iNumLinha] = null;
    ajax_error_list["cpf_usuario_" + iNumLinha] = null;
    ajax_error_list["idfilial_" + iNumLinha] = null;
    ajax_error_list["ativo_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idusuarioexternos_": new Array(),
    "nome_do_usuario_": new Array(),
    "cpf_usuario_": new Array(),
    "idfilial_": new Array(),
    "ativo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idusuarioexternos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idusuarioexternos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idusuarioexternos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idusuarioexternos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idusuarioexternos_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nome_do_usuario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nome_do_usuario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nome_do_usuario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nome_do_usuario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nome_do_usuario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cpf_usuario_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cpf_usuario_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cpf_usuario_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cpf_usuario_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cpf_usuario_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idfilial_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idfilial_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idfilial_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idfilial_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idfilial_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ativo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ativo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ativo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ativo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ativo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idusuarioexternos_'])) ? $this->nmgp_cmp_readonly['idusuarioexternos_'] : 'on';
?>
    scAjaxFieldRead("idusuarioexternos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nome_do_usuario_'])) ? $this->nmgp_cmp_readonly['nome_do_usuario_'] : 'off';
?>
    scAjaxFieldRead("nome_do_usuario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cpf_usuario_'])) ? $this->nmgp_cmp_readonly['cpf_usuario_'] : 'off';
?>
    scAjaxFieldRead("cpf_usuario_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idfilial_'])) ? $this->nmgp_cmp_readonly['idfilial_'] : 'off';
?>
    scAjaxFieldRead("idfilial_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ativo_'])) ? $this->nmgp_cmp_readonly['ativo_'] : 'off';
?>
    scAjaxFieldRead("ativo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idusuarioexternos_" + iSeq, "on");
    scAjaxFieldRead("nome_do_usuario_" + iSeq, "on");
    scAjaxFieldRead("cpf_usuario_" + iSeq, "on");
    scAjaxFieldRead("idfilial_" + iSeq, "on");
    scAjaxFieldRead("ativo_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idusuarioexternos_" + iRow] || "on" == ajax_error_count["nome_do_usuario_" + iRow] || "on" == ajax_error_count["cpf_usuario_" + iRow] || "on" == ajax_error_count["idfilial_" + iRow] || "on" == ajax_error_count["ativo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idusuarioexternos_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nome_do_usuario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cpf_usuario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idfilial_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ativo_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idusuarioexternos_" + iRow] && "off" == ajax_error_count["nome_do_usuario_" + iRow] && "off" == ajax_error_count["cpf_usuario_" + iRow] && "off" == ajax_error_count["idfilial_" + iRow] && "off" == ajax_error_count["ativo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idusuarioexternos_" + iRow] = "off";
        ajax_error_count["nome_do_usuario_" + iRow] = "off";
        ajax_error_count["cpf_usuario_" + iRow] = "off";
        ajax_error_count["idfilial_" + iRow] = "off";
        ajax_error_count["ativo_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idusuarioexternos_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nome_do_usuario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cpf_usuario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idfilial_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ativo_" + iRow).removeClass("scFormErrorLine");
    }
  }
