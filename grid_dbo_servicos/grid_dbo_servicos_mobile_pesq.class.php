...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idservico";$Nm_numeric[] = "vlr_unit";$Nm_numeric[] = "idempresa";$Nm_numeric[] = "idservico";$Nm_numeric[] = "vlr_unit";$Nm_numeric[] = "idempresa";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_descricao_servico"  <?php echo $str_hide_descricao_servico?>>
<?php
