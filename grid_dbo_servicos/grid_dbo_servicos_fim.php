...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_servicos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_servicos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_dbo_servicos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_servicos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_servicos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_servicos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_servicos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dbo_servicos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_servicos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dbo_servicos']['embutida_filho'] as $ind => $sc_init)
          {
