<?php  
  ...
  session_start() ;
  class grid_dbo_servicos_form_teste
  {
  function grid_dbo_servicos_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_dbo_servicos</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_dbo_servicos"> 
</form> 
<script language=javascript> 
 document.FCons.usr_idEmpresa.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_dbo_servicos_form_teste();
  $frm_teste->grid_dbo_servicos_teste();
?>
