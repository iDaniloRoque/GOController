...
<?php
   ...
   $Ord_Cmp = new grid_dbo_Nucleo_de_atendimento_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_dbo_Nucleo_de_atendimento_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['nucleo_unidade_id_nucleo_atendimento'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['nucleo_unidade_id_nucleo_atendimento'] = "Nucleo_unidade.Id_nucleo_atendimento";
   }
   $tab_labels["nucleo_unidade_id_nucleo_atendimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['labels']["nucleo_unidade_id_nucleo_atendimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['labels']["nucleo_unidade_id_nucleo_atendimento"] : "Código";
   $tab_ger_campos['nucleo_de_atendimento_descricao_do_nucleo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['nucleo_de_atendimento_descricao_do_nucleo'] = "cmp_maior_30_2";
   }
   else
   {
       $tab_def_campos['nucleo_de_atendimento_descricao_do_nucleo'] = "Nucleo_de_atendimento.Descricao_do_nucleo";
   }
   $tab_labels["nucleo_de_atendimento_descricao_do_nucleo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['labels']["nucleo_de_atendimento_descricao_do_nucleo"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['labels']["nucleo_de_atendimento_descricao_do_nucleo"] : "Descrição";
   $tab_ger_campos['nucleo_de_atendimento_analitico_ou_sintetico'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['nucleo_de_atendimento_analitico_ou_sintetico'] = "cmp_maior_30_3";
   }
   else
   {
       $tab_def_campos['nucleo_de_atendimento_analitico_ou_sintetico'] = "Nucleo_de_atendimento.Analitico_ou_sintetico";
   }
   $tab_labels["nucleo_de_atendimento_analitico_ou_sintetico"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['labels']["nucleo_de_atendimento_analitico_ou_sintetico"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['labels']["nucleo_de_atendimento_analitico_ou_sintetico"] : "Analítico Ou Sintético";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_dbo_Nucleo_de_atendimento_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_dbo_Nucleo_de_atendimento']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
