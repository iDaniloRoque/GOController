<?php  
  ...
  session_start() ;
  class grid_dbo_Nucleo_de_atendimento_form_teste
  {
  function grid_dbo_Nucleo_de_atendimento_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_dbo_Nucleo_de_atendimento</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="./" 
               target="_self"> 
usr_unidade_Externo&nbsp;&nbsp;<input type=text name="usr_unidade_Externo" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_dbo_Nucleo_de_atendimento"> 
</form> 
<script language=javascript> 
 document.FCons.usr_unidade_Externo.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_dbo_Nucleo_de_atendimento_form_teste();
  $frm_teste->grid_dbo_Nucleo_de_atendimento_teste();
?>
