...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_Nucleo_de_atendimento"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_Nucleo_de_atendimento"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_Nucleo_de_atendimento']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_Nucleo_de_atendimento']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_Nucleo_de_atendimento']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_Nucleo_de_atendimento']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dbo_Nucleo_de_atendimento']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_dbo_Nucleo_de_atendimento</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_Nucleo_de_atendimento']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dbo_Nucleo_de_atendimento']['embutida_filho'] as $ind => $sc_init)
          {
