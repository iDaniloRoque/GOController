  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_observacao_contratos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_observacao_contratos_form();
	}
...
?>
  ...
  // ---------- Validate idobservacoescontratos_
  function do_ajax_form_dbo_observacao_contratos_validate_idobservacoescontratos_(iNumLinha)
  {
    var nomeCampo_idobservacoescontratos_ = "idobservacoescontratos_" + iNumLinha;
    var var_idobservacoescontratos_ = scAjaxGetFieldHidden(nomeCampo_idobservacoescontratos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_observacao_contratos_validate_idobservacoescontratos_(var_idobservacoescontratos_, iNumLinha, var_script_case_init, do_ajax_form_dbo_observacao_contratos_validate_idobservacoescontratos__cb);
  } // do_ajax_form_dbo_observacao_contratos_validate_idobservacoescontratos_

  function do_ajax_form_dbo_observacao_contratos_validate_idobservacoescontratos__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idobservacoescontratos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idobservacoescontratos_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idobservacoescontratos_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idobservacoescontratos_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_observacao_contratos_validate_idobservacoescontratos__cb

  // ---------- Validate idobservacaostatus_
  function do_ajax_form_dbo_observacao_contratos_validate_idobservacaostatus_(iNumLinha)
  {
    var nomeCampo_idobservacaostatus_ = "idobservacaostatus_" + iNumLinha;
    var var_idobservacaostatus_ = scAjaxGetFieldSelect(nomeCampo_idobservacaostatus_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_observacao_contratos_validate_idobservacaostatus_(var_idobservacaostatus_, iNumLinha, var_script_case_init, do_ajax_form_dbo_observacao_contratos_validate_idobservacaostatus__cb);
  } // do_ajax_form_dbo_observacao_contratos_validate_idobservacaostatus_

  function do_ajax_form_dbo_observacao_contratos_validate_idobservacaostatus__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idobservacaostatus_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idobservacaostatus_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idobservacaostatus_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idobservacaostatus_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_observacao_contratos_validate_idobservacaostatus__cb

  // ---------- Validate observacao_
  function do_ajax_form_dbo_observacao_contratos_validate_observacao_(iNumLinha)
  {
    var nomeCampo_observacao_ = "observacao_" + iNumLinha;
    var var_observacao_ = scAjaxGetFieldText(nomeCampo_observacao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_observacao_contratos_validate_observacao_(var_observacao_, iNumLinha, var_script_case_init, do_ajax_form_dbo_observacao_contratos_validate_observacao__cb);
  } // do_ajax_form_dbo_observacao_contratos_validate_observacao_

  function do_ajax_form_dbo_observacao_contratos_validate_observacao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "observacao_" + iLineNumber;
    }
    else
    {
      sFieldValid = "observacao_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "observacao_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "observacao_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_observacao_contratos_validate_observacao__cb

  // ---------- Validate quem_
  function do_ajax_form_dbo_observacao_contratos_validate_quem_(iNumLinha)
  {
    var nomeCampo_quem_ = "quem_" + iNumLinha;
    var var_quem_ = scAjaxGetFieldText(nomeCampo_quem_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_observacao_contratos_validate_quem_(var_quem_, iNumLinha, var_script_case_init, do_ajax_form_dbo_observacao_contratos_validate_quem__cb);
  } // do_ajax_form_dbo_observacao_contratos_validate_quem_

  function do_ajax_form_dbo_observacao_contratos_validate_quem__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "quem_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "quem_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_observacao_contratos_validate_quem__cb

  // ---------- Validate quando_
  function do_ajax_form_dbo_observacao_contratos_validate_quando_(iNumLinha)
  {
    var nomeCampo_quando_ = "quando_" + iNumLinha;
    var var_quando_ = scAjaxGetFieldText(nomeCampo_quando_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_observacao_contratos_validate_quando_(var_quando_, iNumLinha, var_script_case_init, do_ajax_form_dbo_observacao_contratos_validate_quando__cb);
  } // do_ajax_form_dbo_observacao_contratos_validate_quando_

  function do_ajax_form_dbo_observacao_contratos_validate_quando__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "quando_" + iLineNumber;
    }
    else
    {
      sFieldValid = "quando_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "quando_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "quando_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_observacao_contratos_validate_quando__cb

  // ---------- Validate idcontratos_
  function do_ajax_form_dbo_observacao_contratos_validate_idcontratos_(iNumLinha)
  {
    var nomeCampo_idcontratos_ = "idcontratos_" + iNumLinha;
    var var_idcontratos_ = scAjaxGetFieldText(nomeCampo_idcontratos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_observacao_contratos_validate_idcontratos_(var_idcontratos_, iNumLinha, var_script_case_init, do_ajax_form_dbo_observacao_contratos_validate_idcontratos__cb);
  } // do_ajax_form_dbo_observacao_contratos_validate_idcontratos_

  function do_ajax_form_dbo_observacao_contratos_validate_idcontratos__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_observacao_contratos_validate_idcontratos__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_observacao_contratos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_observacao_contratos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_observacao_contratos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_observacao_contratos_add_new_line_cb);
  } // do_ajax_form_dbo_observacao_contratos_add_new_line

  function do_ajax_form_dbo_observacao_contratos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("quem_=disabled;quando_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_dbo_observacao_contratos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_observacao_contratos_backup_line(iNumLinha)
  {
    var var_idobservacoescontratos_ = scAjaxGetFieldHidden("idobservacoescontratos_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_observacao_contratos_backup_line(var_idobservacoescontratos_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_observacao_contratos_backup_line_cb);
  } // do_ajax_form_dbo_observacao_contratos_backup_line

  function do_ajax_form_dbo_observacao_contratos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_dbo_observacao_contratos_backup_line_cb

  function do_ajax_form_dbo_observacao_contratos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_observacao_contratos_cancel_insert

  function do_ajax_form_dbo_observacao_contratos_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_observacao_contratos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_observacao_contratos_cancel_update

  function do_ajax_form_dbo_observacao_contratos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_observacao_contratos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_observacao_contratos_table_refresh()
  {
    var var_idobservacoescontratos_ = document.F2.idobservacoescontratos_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_observacao_contratos_table_refresh(var_idobservacoescontratos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_observacao_contratos_table_refresh_cb);
  } //  do_ajax_form_dbo_observacao_contratos_table_refresh

  function do_ajax_form_dbo_observacao_contratos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idobservacoescontratos_.value = scAjaxGetKeyValue("idobservacoescontratos_");
    ...
    scAjaxAlert(do_ajax_form_dbo_observacao_contratos_table_refresh_cb_after_alert);
  } // do_ajax_form_dbo_observacao_contratos_table_refresh_cb
  function do_ajax_form_dbo_observacao_contratos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_observacao_contratos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_observacao_contratos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_dbo_observacao_contratos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idobservacoescontratos_ = scAjaxGetFieldHidden("idobservacoescontratos_" + iNumLinha);
    var var_idobservacaostatus_ = scAjaxGetFieldSelect("idobservacaostatus_" + iNumLinha);
    var var_observacao_ = scAjaxGetFieldText("observacao_" + iNumLinha);
    var var_quem_ = scAjaxGetFieldText("quem_" + iNumLinha);
    var var_quando_ = scAjaxGetFieldText("quando_" + iNumLinha);
...
?>
    x_ajax_form_dbo_observacao_contratos_submit_form(var_idobservacoescontratos_, var_idobservacaostatus_, var_observacao_, var_quem_, var_quando_, var_idcontratos_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_observacao_contratos_submit_form_cb);
  } // do_ajax_form_dbo_observacao_contratos_submit_form

  function do_ajax_form_dbo_observacao_contratos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idobservacoescontratos_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idobservacaostatus_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("observacao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("quem_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("quando_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_observacao_contratos_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_observacao_contratos_submit_form_cb
  function do_ajax_form_dbo_observacao_contratos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_observacao_contratos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_observacao_contratos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_observacao_contratos_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_observacao_contratos_navigate_form();
    }
  }

  function perform_ajax_form_dbo_observacao_contratos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_observacao_contratos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idobservacoescontratos_" + iNavForm);
      scAjaxHideErrorDisplay("idobservacaostatus_" + iNavForm);
      scAjaxHideErrorDisplay("observacao_" + iNavForm);
      scAjaxHideErrorDisplay("quem_" + iNavForm);
      scAjaxHideErrorDisplay("quando_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_observacao_contratos_navigate_form(var_idobservacoescontratos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_observacao_contratos_navigate_form_cb);
  } // do_ajax_form_dbo_observacao_contratos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_observacao_contratos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_observacao_contratos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idobservacoescontratos_.value = scAjaxGetKeyValue("idobservacoescontratos_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_observacao_contratos_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_observacao_contratos_navigate_form_cb
  function do_ajax_form_dbo_observacao_contratos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_dbo_observacao_contratos_navigate_form_cb_after_alert
  function sc_hide_form_dbo_observacao_contratos_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idobservacoescontratos_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idobservacaostatus_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "observacao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "quem_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "quando_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idcontratos_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idobservacoescontratos_" + iNumLinha] = {"label": "Id Observacoes Contratos<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idobservacaostatus_" + iNumLinha] = {"label": "Status<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["observacao_" + iNumLinha] = {"label": "Observação<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["quem_" + iNumLinha] = {"label": "Quem<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["quando_" + iNumLinha] = {"label": "Quando<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idobservacoescontratos_"][iNumLinha] = "idobservacoescontratos_" + iNumLinha;
    ajax_field_mult["idobservacaostatus_"][iNumLinha] = "idobservacaostatus_" + iNumLinha;
    ajax_field_mult["observacao_"][iNumLinha] = "observacao_" + iNumLinha;
    ajax_field_mult["quem_"][iNumLinha] = "quem_" + iNumLinha;
    ajax_field_mult["quando_"][iNumLinha] = "quando_" + iNumLinha;
    ajax_field_mult["idcontratos_"][iNumLinha] = "idcontratos_" + iNumLinha;
    ajax_field_id["idobservacaostatus_" + iNumLinha] = new Array("hidden_field_label_idobservacaostatus_", "hidden_field_data_idobservacaostatus_" + iNumLinha);
    ajax_field_id["observacao_" + iNumLinha] = new Array("hidden_field_label_observacao_", "hidden_field_data_observacao_" + iNumLinha);
    ajax_field_id["quem_" + iNumLinha] = new Array("hidden_field_label_quem_", "hidden_field_data_quem_" + iNumLinha);
    ajax_field_id["quando_" + iNumLinha] = new Array("hidden_field_label_quando_", "hidden_field_data_quando_" + iNumLinha);
    ajax_error_count["idobservacoescontratos_" + iNumLinha] = "off";
    ajax_error_count["idobservacaostatus_" + iNumLinha] = "off";
    ajax_error_count["observacao_" + iNumLinha] = "off";
    ajax_error_count["quem_" + iNumLinha] = "off";
    ajax_error_count["quando_" + iNumLinha] = "off";
    ajax_error_count["idcontratos_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idobservacoescontratos_" + iNumLinha] = "on";
    ajax_read_only["idobservacaostatus_" + iNumLinha] = "off";
    ajax_read_only["observacao_" + iNumLinha] = "off";
    ajax_read_only["quem_" + iNumLinha] = "off";
    ajax_read_only["quando_" + iNumLinha] = "off";
...
?>
    ajax_read_only["idobservacoescontratos_" + iNumLinha] = "on";
    ajax_read_only["idobservacaostatus_" + iNumLinha] = "on";
    ajax_read_only["observacao_" + iNumLinha] = "on";
    ajax_read_only["quem_" + iNumLinha] = "on";
    ajax_read_only["quando_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idobservacoescontratos_" + iNumLinha] = null;
    ajax_error_list["idobservacaostatus_" + iNumLinha] = null;
    ajax_error_list["observacao_" + iNumLinha] = null;
    ajax_error_list["quem_" + iNumLinha] = null;
    ajax_error_list["quando_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "idobservacoescontratos_": new Array(),
    "idobservacaostatus_": new Array(),
    "observacao_": new Array(),
    "quem_": new Array(),
    "quando_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idobservacoescontratos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idobservacoescontratos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idobservacoescontratos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idobservacoescontratos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idobservacoescontratos_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idobservacaostatus_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idobservacaostatus_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idobservacaostatus_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idobservacaostatus_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idobservacaostatus_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["observacao_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["observacao_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["observacao_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["observacao_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["observacao_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["quem_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["quem_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["quem_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["quem_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["quem_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["quando_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["quando_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["quando_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["quando_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["quando_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idobservacoescontratos_'])) ? $this->nmgp_cmp_readonly['idobservacoescontratos_'] : 'on';
?>
    scAjaxFieldRead("idobservacoescontratos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idobservacaostatus_'])) ? $this->nmgp_cmp_readonly['idobservacaostatus_'] : 'off';
?>
    scAjaxFieldRead("idobservacaostatus_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['observacao_'])) ? $this->nmgp_cmp_readonly['observacao_'] : 'off';
?>
    scAjaxFieldRead("observacao_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['quem_'])) ? $this->nmgp_cmp_readonly['quem_'] : 'off';
?>
    scAjaxFieldRead("quem_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['quando_'])) ? $this->nmgp_cmp_readonly['quando_'] : 'off';
?>
    scAjaxFieldRead("quando_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("idobservacoescontratos_" + iSeq, "on");
    scAjaxFieldRead("idobservacaostatus_" + iSeq, "on");
    scAjaxFieldRead("observacao_" + iSeq, "on");
    scAjaxFieldRead("quem_" + iSeq, "on");
    scAjaxFieldRead("quando_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idobservacoescontratos_" + iRow] || "on" == ajax_error_count["idobservacaostatus_" + iRow] || "on" == ajax_error_count["observacao_" + iRow] || "on" == ajax_error_count["quem_" + iRow] || "on" == ajax_error_count["quando_" + iRow] || "on" == ajax_error_count["idcontratos_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idobservacoescontratos_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idobservacaostatus_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_observacao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_quem_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_quando_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idobservacoescontratos_" + iRow] && "off" == ajax_error_count["idobservacaostatus_" + iRow] && "off" == ajax_error_count["observacao_" + iRow] && "off" == ajax_error_count["quem_" + iRow] && "off" == ajax_error_count["quando_" + iRow] && "off" == ajax_error_count["idcontratos_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idobservacoescontratos_" + iRow] = "off";
        ajax_error_count["idobservacaostatus_" + iRow] = "off";
        ajax_error_count["observacao_" + iRow] = "off";
        ajax_error_count["quem_" + iRow] = "off";
        ajax_error_count["quando_" + iRow] = "off";
      ...
      $("#hidden_field_data_idobservacoescontratos_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idobservacaostatus_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_observacao_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_quem_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_quando_" + iRow).removeClass("scFormErrorLine");
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idobservacoescontratos_" == sIndex)
    {
