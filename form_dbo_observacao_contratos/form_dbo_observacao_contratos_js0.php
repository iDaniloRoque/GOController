<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idobservacoescontratos_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idobservacoescontratos_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_dbo_observacao_contratos"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_dbo_observacao_contratos_submit_form(y, z);
...
{
   nm_field_disabled("quem_=disabled;quando_=disabled", "");
   nm_field_disabled("idobservacaostatus_=disabled;observacao_=disabled", "U");
