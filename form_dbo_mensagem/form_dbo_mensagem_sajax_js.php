  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_mensagem" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_mensagem_form();
	}
...
?>
  ...
  // ---------- Validate cod_group
  function do_ajax_form_dbo_mensagem_validate_cod_group()
  {
    var nomeCampo_cod_group = "cod_group";
    var var_cod_group = scAjaxGetFieldSelect(nomeCampo_cod_group);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_mensagem_validate_cod_group(var_cod_group, var_script_case_init, do_ajax_form_dbo_mensagem_validate_cod_group_cb);
  } // do_ajax_form_dbo_mensagem_validate_cod_group

  function do_ajax_form_dbo_mensagem_validate_cod_group_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_mensagem_validate_cod_group_cb

  // ---------- Validate titulo_mensagem
  function do_ajax_form_dbo_mensagem_validate_titulo_mensagem()
  {
    var nomeCampo_titulo_mensagem = "titulo_mensagem";
    var var_titulo_mensagem = scAjaxGetFieldText(nomeCampo_titulo_mensagem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_mensagem_validate_titulo_mensagem(var_titulo_mensagem, var_script_case_init, do_ajax_form_dbo_mensagem_validate_titulo_mensagem_cb);
  } // do_ajax_form_dbo_mensagem_validate_titulo_mensagem

  function do_ajax_form_dbo_mensagem_validate_titulo_mensagem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_mensagem_validate_titulo_mensagem_cb

  // ---------- Validate text_mensagem
  function do_ajax_form_dbo_mensagem_validate_text_mensagem()
  {
    var nomeCampo_text_mensagem = "text_mensagem";
    var var_text_mensagem = scAjaxGetFieldText(nomeCampo_text_mensagem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_mensagem_validate_text_mensagem(var_text_mensagem, var_script_case_init, do_ajax_form_dbo_mensagem_validate_text_mensagem_cb);
  } // do_ajax_form_dbo_mensagem_validate_text_mensagem

  function do_ajax_form_dbo_mensagem_validate_text_mensagem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_mensagem_validate_text_mensagem_cb

  // ---------- Validate start_date
  function do_ajax_form_dbo_mensagem_validate_start_date()
  {
    var nomeCampo_start_date = "start_date";
    var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_mensagem_validate_start_date(var_start_date, var_script_case_init, do_ajax_form_dbo_mensagem_validate_start_date_cb);
  } // do_ajax_form_dbo_mensagem_validate_start_date

  function do_ajax_form_dbo_mensagem_validate_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_mensagem_validate_start_date_cb

  // ---------- Validate end_date
  function do_ajax_form_dbo_mensagem_validate_end_date()
  {
    var nomeCampo_end_date = "end_date";
    var var_end_date = scAjaxGetFieldText(nomeCampo_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_mensagem_validate_end_date(var_end_date, var_script_case_init, do_ajax_form_dbo_mensagem_validate_end_date_cb);
  } // do_ajax_form_dbo_mensagem_validate_end_date

  function do_ajax_form_dbo_mensagem_validate_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_mensagem_validate_end_date_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_mensagem_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_mensagem_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_mensagem_submit_form(var_cod_group, var_titulo_mensagem, var_text_mensagem, var_start_date, var_end_date, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_mensagem_submit_form_cb);
  } // do_ajax_form_dbo_mensagem_submit_form

  function do_ajax_form_dbo_mensagem_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_mensagem_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_mensagem_submit_form_cb
  function do_ajax_form_dbo_mensagem_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_mensagem_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_mensagem_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_mensagem_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_mensagem_navigate_form();
    }
  }

  function perform_ajax_form_dbo_mensagem_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_mensagem_navigate_form(var_idmensagem, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_mensagem_navigate_form_cb);
  } // do_ajax_form_dbo_mensagem_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_mensagem']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_mensagem_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_mensagem_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_mensagem_navigate_form_cb
  function do_ajax_form_dbo_mensagem_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_mensagem_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_mensagem_navigate_form_cb_after_alert
  function sc_hide_form_dbo_mensagem_form()
  {
