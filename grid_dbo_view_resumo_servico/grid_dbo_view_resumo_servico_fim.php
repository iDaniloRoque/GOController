...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_view_resumo_servico"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_view_resumo_servico"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_view_resumo_servico']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_view_resumo_servico']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_view_resumo_servico']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_view_resumo_servico']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dbo_view_resumo_servico']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_dbo_view_resumo_servico</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_view_resumo_servico']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dbo_view_resumo_servico']['embutida_filho'] as $ind => $sc_init)
          {
