  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_impostos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_impostos_mob_form();
	}
...
?>
  ...
  // ---------- Validate idimpostos
  function do_ajax_form_dbo_impostos_mob_validate_idimpostos()
  {
    var nomeCampo_idimpostos = "idimpostos";
    var var_idimpostos = scAjaxGetFieldHidden(nomeCampo_idimpostos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_impostos_mob_validate_idimpostos(var_idimpostos, var_script_case_init, do_ajax_form_dbo_impostos_mob_validate_idimpostos_cb);
  } // do_ajax_form_dbo_impostos_mob_validate_idimpostos

  function do_ajax_form_dbo_impostos_mob_validate_idimpostos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idimpostos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_impostos_mob_validate_idimpostos_cb

  // ---------- Validate sigla_impostos
  function do_ajax_form_dbo_impostos_mob_validate_sigla_impostos()
  {
    var nomeCampo_sigla_impostos = "sigla_impostos";
    var var_sigla_impostos = scAjaxGetFieldText(nomeCampo_sigla_impostos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_impostos_mob_validate_sigla_impostos(var_sigla_impostos, var_script_case_init, do_ajax_form_dbo_impostos_mob_validate_sigla_impostos_cb);
  } // do_ajax_form_dbo_impostos_mob_validate_sigla_impostos

  function do_ajax_form_dbo_impostos_mob_validate_sigla_impostos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sigla_impostos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_impostos_mob_validate_sigla_impostos_cb

  // ---------- Validate descricao_imposto
  function do_ajax_form_dbo_impostos_mob_validate_descricao_imposto()
  {
    var nomeCampo_descricao_imposto = "descricao_imposto";
    var var_descricao_imposto = scAjaxGetFieldText(nomeCampo_descricao_imposto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_impostos_mob_validate_descricao_imposto(var_descricao_imposto, var_script_case_init, do_ajax_form_dbo_impostos_mob_validate_descricao_imposto_cb);
  } // do_ajax_form_dbo_impostos_mob_validate_descricao_imposto

  function do_ajax_form_dbo_impostos_mob_validate_descricao_imposto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descricao_imposto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_impostos_mob_validate_descricao_imposto_cb

  // ---------- Validate percentual_default
  function do_ajax_form_dbo_impostos_mob_validate_percentual_default()
  {
    var nomeCampo_percentual_default = "percentual_default";
    var var_percentual_default = scAjaxGetFieldText(nomeCampo_percentual_default);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_impostos_mob_validate_percentual_default(var_percentual_default, var_script_case_init, do_ajax_form_dbo_impostos_mob_validate_percentual_default_cb);
  } // do_ajax_form_dbo_impostos_mob_validate_percentual_default

  function do_ajax_form_dbo_impostos_mob_validate_percentual_default_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "percentual_default";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_impostos_mob_validate_percentual_default_cb

  // ---------- Validate tipo_imposto
  function do_ajax_form_dbo_impostos_mob_validate_tipo_imposto()
  {
    var nomeCampo_tipo_imposto = "tipo_imposto";
    var var_tipo_imposto = scAjaxGetFieldText(nomeCampo_tipo_imposto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_impostos_mob_validate_tipo_imposto(var_tipo_imposto, var_script_case_init, do_ajax_form_dbo_impostos_mob_validate_tipo_imposto_cb);
  } // do_ajax_form_dbo_impostos_mob_validate_tipo_imposto

  function do_ajax_form_dbo_impostos_mob_validate_tipo_imposto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_imposto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_impostos_mob_validate_tipo_imposto_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_impostos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_impostos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idimpostos = scAjaxGetFieldHidden("idimpostos");
    var var_sigla_impostos = scAjaxGetFieldText("sigla_impostos");
    var var_descricao_imposto = scAjaxGetFieldText("descricao_imposto");
    var var_percentual_default = scAjaxGetFieldText("percentual_default");
    var var_tipo_imposto = scAjaxGetFieldText("tipo_imposto");
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_impostos_mob_submit_form(var_idimpostos, var_sigla_impostos, var_descricao_imposto, var_percentual_default, var_tipo_imposto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_impostos_mob_submit_form_cb);
  } // do_ajax_form_dbo_impostos_mob_submit_form

  function do_ajax_form_dbo_impostos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idimpostos");
      scAjaxHideErrorDisplay("sigla_impostos");
      scAjaxHideErrorDisplay("descricao_imposto");
      scAjaxHideErrorDisplay("percentual_default");
      scAjaxHideErrorDisplay("tipo_imposto");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_impostos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_impostos_mob_submit_form_cb
  function do_ajax_form_dbo_impostos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_impostos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_impostos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_impostos_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_impostos_mob_navigate_form();
    }
  }

  function perform_ajax_form_dbo_impostos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("percentual_default");
    scAjaxHideErrorDisplay("tipo_imposto");
    var var_idimpostos = document.F2.idimpostos.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_impostos_mob_navigate_form(var_idimpostos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_impostos_mob_navigate_form_cb);
  } // do_ajax_form_dbo_impostos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_impostos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_impostos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idimpostos.value = scAjaxGetKeyValue("idimpostos");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_impostos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_impostos_mob_navigate_form_cb
  function do_ajax_form_dbo_impostos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_impostos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_impostos_mob_navigate_form_cb_after_alert
  function sc_hide_form_dbo_impostos_mob_form()
  {
  ...
  ajax_field_list[0] = "idimpostos";
  ajax_field_list[1] = "sigla_impostos";
  ajax_field_list[2] = "descricao_imposto";
  ajax_field_list[3] = "percentual_default";
  ajax_field_list[4] = "tipo_imposto";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idimpostos": {"label": "Id Impostos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sigla_impostos": {"label": "Sigla Impostos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descricao_imposto": {"label": "Descricao Imposto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "percentual_default": {"label": "Percentual Default", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_imposto": {"label": "Tipo Imposto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idimpostos": new Array(),
    "sigla_impostos": new Array(),
    "descricao_imposto": new Array(),
    "percentual_default": new Array(),
    "tipo_imposto": new Array()
  };
  ajax_field_mult["idimpostos"][1] = "idimpostos";
  ajax_field_mult["sigla_impostos"][1] = "sigla_impostos";
  ajax_field_mult["descricao_imposto"][1] = "descricao_imposto";
  ajax_field_mult["percentual_default"][1] = "percentual_default";
  ajax_field_mult["tipo_imposto"][1] = "tipo_imposto";

  var ajax_field_id = {
    "idimpostos": new Array("hidden_field_label_idimpostos", "hidden_field_data_idimpostos"),
    "sigla_impostos": new Array("hidden_field_label_sigla_impostos", "hidden_field_data_sigla_impostos"),
    "descricao_imposto": new Array("hidden_field_label_descricao_imposto", "hidden_field_data_descricao_imposto"),
    "percentual_default": new Array("hidden_field_label_percentual_default", "hidden_field_data_percentual_default"),
    "tipo_imposto": new Array("hidden_field_label_tipo_imposto", "hidden_field_data_tipo_imposto")
  };

  var ajax_read_only = {
    "idimpostos": "on",
    "sigla_impostos": "off",
    "descricao_imposto": "off",
    "percentual_default": "off",
    "tipo_imposto": "off"
  };
