  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_impostos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_impostos_form();
	}
...
?>
  ...
  // ---------- Validate idimpostos
  function do_ajax_form_dbo_impostos_validate_idimpostos()
  {
    var nomeCampo_idimpostos = "idimpostos";
    var var_idimpostos = scAjaxGetFieldHidden(nomeCampo_idimpostos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_impostos_validate_idimpostos(var_idimpostos, var_script_case_init, do_ajax_form_dbo_impostos_validate_idimpostos_cb);
  } // do_ajax_form_dbo_impostos_validate_idimpostos

  function do_ajax_form_dbo_impostos_validate_idimpostos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_impostos_validate_idimpostos_cb

  // ---------- Validate sigla_impostos
  function do_ajax_form_dbo_impostos_validate_sigla_impostos()
  {
    var nomeCampo_sigla_impostos = "sigla_impostos";
    var var_sigla_impostos = scAjaxGetFieldText(nomeCampo_sigla_impostos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_impostos_validate_sigla_impostos(var_sigla_impostos, var_script_case_init, do_ajax_form_dbo_impostos_validate_sigla_impostos_cb);
  } // do_ajax_form_dbo_impostos_validate_sigla_impostos

  function do_ajax_form_dbo_impostos_validate_sigla_impostos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_impostos_validate_sigla_impostos_cb

  // ---------- Validate descricao_imposto
  function do_ajax_form_dbo_impostos_validate_descricao_imposto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_impostos_validate_descricao_imposto(var_descricao_imposto, var_script_case_init, do_ajax_form_dbo_impostos_validate_descricao_imposto_cb);
  } // do_ajax_form_dbo_impostos_validate_descricao_imposto

  function do_ajax_form_dbo_impostos_validate_descricao_imposto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_impostos_validate_descricao_imposto_cb

  // ---------- Validate percentual_default
  function do_ajax_form_dbo_impostos_validate_percentual_default()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_impostos_validate_percentual_default(var_percentual_default, var_script_case_init, do_ajax_form_dbo_impostos_validate_percentual_default_cb);
  } // do_ajax_form_dbo_impostos_validate_percentual_default

  function do_ajax_form_dbo_impostos_validate_percentual_default_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_impostos_validate_percentual_default_cb

  // ---------- Validate tipo_imposto
  function do_ajax_form_dbo_impostos_validate_tipo_imposto()
  {
    var nomeCampo_tipo_imposto = "tipo_imposto";
    var var_tipo_imposto = scAjaxGetFieldText(nomeCampo_tipo_imposto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_impostos_validate_tipo_imposto(var_tipo_imposto, var_script_case_init, do_ajax_form_dbo_impostos_validate_tipo_imposto_cb);
  } // do_ajax_form_dbo_impostos_validate_tipo_imposto

  function do_ajax_form_dbo_impostos_validate_tipo_imposto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_impostos_validate_tipo_imposto_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_impostos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_impostos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_impostos_submit_form(var_idimpostos, var_sigla_impostos, var_descricao_imposto, var_percentual_default, var_tipo_imposto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_impostos_submit_form_cb);
  } // do_ajax_form_dbo_impostos_submit_form

  function do_ajax_form_dbo_impostos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_impostos_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_impostos_submit_form_cb
  function do_ajax_form_dbo_impostos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_impostos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_impostos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_impostos_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_impostos_navigate_form();
    }
  }

  function perform_ajax_form_dbo_impostos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_impostos_navigate_form(var_idimpostos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_impostos_navigate_form_cb);
  } // do_ajax_form_dbo_impostos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_impostos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_impostos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_impostos_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_impostos_navigate_form_cb
  function do_ajax_form_dbo_impostos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_impostos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_impostos_navigate_form_cb_after_alert
  function sc_hide_form_dbo_impostos_form()
  {
