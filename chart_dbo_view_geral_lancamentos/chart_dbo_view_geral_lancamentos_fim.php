...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Controller_____chart_dbo_view_geral_lancamentos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Controller_____chart_dbo_view_geral_lancamentos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_dbo_view_geral_lancamentos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_dbo_view_geral_lancamentos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_dbo_view_geral_lancamentos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_dbo_view_geral_lancamentos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_dbo_view_geral_lancamentos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_dbo_view_geral_lancamentos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_dbo_view_geral_lancamentos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_dbo_view_geral_lancamentos']['embutida_filho'] as $ind => $sc_init)
          {
