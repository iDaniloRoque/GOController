<?php  
  ...
  session_start() ;
  class chart_dbo_view_geral_lancamentos_form_teste
  {
  function chart_dbo_view_geral_lancamentos_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">chart_dbo_view_geral_lancamentos</FONT></B> 
<br> 
<br> 
...
<input type=submit value="chart_dbo_view_geral_lancamentos"> 
</form> 
...
<?php
  ...
  $frm_teste = new chart_dbo_view_geral_lancamentos_form_teste();
  $frm_teste->chart_dbo_view_geral_lancamentos_teste();
?>
