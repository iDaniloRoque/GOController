<?php
@session_start() ;
$_SESSION['scriptcase']['chart_dbo_view_geral_lancamentos']['sc_process_barr'] = true;
require_once('../chart_dbo_view_geral_lancamentos/index.php');
unset($_SESSION['scriptcase']['chart_dbo_view_geral_lancamentos']['sc_process_barr']);
$ExportCtrl = new chart_dbo_view_geral_lancamentos_export_control;
$ExportCtrl->Export_barr();

class chart_dbo_view_geral_lancamentos_export_control
{
