...
?>
  ...
  // ---------- Validate mensagem
  function do_ajax_sec_Login_validate_mensagem()
  {
  } // do_ajax_sec_Login_validate_mensagem

  function do_ajax_sec_Login_validate_mensagem_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_Login_validate_mensagem_cb
  ...
  // ---------- Validate empresa
  function do_ajax_sec_Login_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldSelect(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_sec_Login_validate_empresa(var_empresa, var_script_case_init, do_ajax_sec_Login_validate_empresa_cb);
  } // do_ajax_sec_Login_validate_empresa

  function do_ajax_sec_Login_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_sec_Login_validate_empresa_cb
  ...
  function do_ajax_sec_Login_event_empresa_onchange()
  {
    var var_empresa = scAjaxGetFieldSelect("empresa");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_sec_Login_event_empresa_onchange(var_empresa, var_script_case_init, do_ajax_sec_Login_event_empresa_onchange_cb);
  } // do_ajax_sec_Login_event_empresa_onchange

  function do_ajax_sec_Login_event_empresa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "empresa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_sec_Login_event_empresa_onchange_cb_after_alert);
  } // do_ajax_sec_Login_event_empresa_onchange_cb
  function do_ajax_sec_Login_event_empresa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_sec_Login_event_empresa_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_sec_Login_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_sec_Login_submit_form(var_mensagem, var_login, var_pswd, var_empresa, var_remember_me, var_links, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_sec_Login_submit_form_cb);
