...
//
   ...
   $_SESSION['scriptcase']['sec_Login_mob']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['sec_Login_mob']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['sec_Login_mob']['glo_nm_path_imagens']    = "/scriptcase/file/img";
   $_SESSION['scriptcase']['sec_Login_mob']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['sec_Login_mob']['glo_nm_path_cache']  = "C:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['sec_Login_mob']['glo_nm_path_doc']        = "C:/Program Files/NetMake/v9-php73/wwwrootC:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/file/doc";
   $_SESSION['scriptcase']['sec_Login_mob']['glo_nm_conexao']         = "conn_mssql";
   $_SESSION['scriptcase']['sec_Login_mob']['glo_con_conn_mssql_infor']         = "conn_mssql_infor";
   $NM_dir_atual = getcwd();
...
/*NM*/            $_SESSION['scriptcase']['sec_Login_mob']['glo_nm_perfil'] = $NM_con_dest;
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['sec_Login_mob']['glo_con_conn_mssql_infor'], $this->path_libs, "S");
          $this->nm_con_conn_mssql_infor['servidor'] = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_conn_mssql_infor['usuario']  = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_conn_mssql_infor['banco']    = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_conn_mssql_infor['senha']    = $_SESSION['scriptcase']['glo_senha'];
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sec_Login_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'Controller', 1, $this->force_db_utf8); 
      } 
      else 
      { 
      ...
      if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_oracle))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['sec_Login_mob']['decimal_db'] = "."; 
      } 
  }
// 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['sec_Login_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['sec_Login_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['sec_Login_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'Controller', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    {
        if ('ajax_sec_Login_mob_validate_mensagem' == $_POST['rs'])
        {
        ...
        if ('ajax_sec_Login_mob_validate_empresa' == $_POST['rs'])
        {
        ...
        if ('ajax_sec_Login_mob_event_empresa_onchange' == $_POST['rs'])
        {
            $empresa = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
    ...
    else
    {
        ...
        if (isset($_POST["usr_company"])) 
        {
            ...
            nm_limpa_str_sec_Login_mob($_SESSION['usr_company']);
        }
        ...
        if (isset($_POST["usr_companys"])) 
        {
            ...
            nm_limpa_str_sec_Login_mob($_SESSION['usr_companys']);
        }
        ...
        if (isset($_POST["usr_idEmpresa"])) 
        {
            ...
            nm_limpa_str_sec_Login_mob($_SESSION['usr_idEmpresa']);
        }
        ...
        if (isset($_POST["usr_descricaoEmpresa"])) 
        {
            ...
            nm_limpa_str_sec_Login_mob($_SESSION['usr_descricaoEmpresa']);
        }
        ...
        if (isset($_POST["usr_bd"])) 
        {
            ...
            nm_limpa_str_sec_Login_mob($_SESSION['usr_bd']);
        }
        ...
        if (isset($_POST["usr_versao"])) 
        {
            ...
            nm_limpa_str_sec_Login_mob($_SESSION['usr_versao']);
        }
        ...
        if (isset($_POST["usr_unidade_Externo"])) 
        {
            ...
            nm_limpa_str_sec_Login_mob($_SESSION['usr_unidade_Externo']);
        }
    ...
    $inicial_sec_Login_mob->contr_sec_Login_mob->NM_ajax_info['select_html']['empresa'] = "class=\"sc-js-input scFormObjectOdd css_empresa_obj{SC_100PERC_CLASS_INPUT}\" style=\"\" id=\"id_sc_field_empresa\" name=\"empresa\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
...
//
    ...
    function ajax_sec_Login_mob_validate_mensagem($mensagem, $script_case_init)
    {
        global $inicial_sec_Login_mob;
        //register_shutdown_function("sec_Login_mob_pack_ajax_response");
        $inicial_sec_Login_mob->contr_sec_Login_mob->NM_ajax_flag          = true;
        $inicial_sec_Login_mob->contr_sec_Login_mob->NM_ajax_opcao         = 'validate_mensagem';
    ...
    function ajax_sec_Login_mob_validate_empresa($empresa, $script_case_init)
    {
        global $inicial_sec_Login_mob;
        //register_shutdown_function("sec_Login_mob_pack_ajax_response");
        $inicial_sec_Login_mob->contr_sec_Login_mob->NM_ajax_flag          = true;
        $inicial_sec_Login_mob->contr_sec_Login_mob->NM_ajax_opcao         = 'validate_empresa';
        $inicial_sec_Login_mob->contr_sec_Login_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_sec_Login_mob_event_empresa_onchange($empresa, $script_case_init)
    {
        global $inicial_sec_Login_mob;
        //register_shutdown_function("sec_Login_mob_pack_ajax_response");
        $inicial_sec_Login_mob->contr_sec_Login_mob->NM_ajax_flag          = true;
        $inicial_sec_Login_mob->contr_sec_Login_mob->NM_ajax_opcao         = 'event_empresa_onchange';
        $inicial_sec_Login_mob->contr_sec_Login_mob->NM_ajax_info['param'] = array(
                  'empresa' => NM_utf8_urldecode($empresa),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
    ...
    function ajax_sec_Login_mob_submit_form($mensagem, $login, $pswd, $empresa, $remember_me, $links, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_sec_Login_mob;
        //register_shutdown_function("sec_Login_mob_pack_ajax_response");
        $inicial_sec_Login_mob->contr_sec_Login_mob->NM_ajax_flag          = true;
