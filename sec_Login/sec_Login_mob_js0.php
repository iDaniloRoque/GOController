...
?> 
function sc_btn_lancamento_vias()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_lancamento_vias(); }, 500);
      return;
    }
    sc_btn_lancamento_vias_ok();
}
function sc_btn_lancamento_vias_cancel()
{
}
function sc_btn_lancamento_vias_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_pre_lancamento_controle_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo ""; ?>', '', '_self', '0', '0', 'pre_lancamento_controle');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['where_detal']))
  {
?>  
