...
$_SESSION['scriptcase']['sec_Login']['contr_erro'] = 'off';
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_Login']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sec_Login']['label'] = "GOHosp - Gestor Operacional Hospitalar";
      ...
      {
          $this->nmgp_botoes['lancamento_vias'] = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['botoes']['lancamento_vias'];
      }
...
<br>";
      ...
      if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "" || $campos_erro != "" || !isset($this->bok) || $this->bok != "OK" || $this->nmgp_opcao == "recarga")
      {
          if ($Campos_Crit == "" && empty($Campos_Falta) && $this->Campos_Mens_erro == "" && !isset($this->bok) && $this->nmgp_opcao != "recarga")
          {
              ...
              { 
                  $mensagem = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][0]; 
                  $login = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][1]; 
                  $pswd = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][2]; 
                  $empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][3]; 
                  $remember_me = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][4]; 
                  $links = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][5]; 
              } 
          }
          $this->nm_gera_html();
          $this->NM_close_db(); 
      ...
      elseif (isset($this->bok) && $this->bok == "OK")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][0] = $this->mensagem; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][1] = $this->login; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][2] = $this->pswd; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][3] = $this->empresa; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][4] = $this->remember_me; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['campos'][5] = $this->links; 
          if (!empty($this->links))
          {
...
$_SESSION['scriptcase']['sec_Login']['contr_erro'] = 'off'; 
    ...
    function ValidateField_empresa(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->empresa == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['php_cmp_required']['empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['php_cmp_required']['empresa'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->empresa) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Lookup_empresa']) && !in_array($this->empresa, $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Lookup_empresa']))
          {
              $hasError = true;
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Lookup_empresa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Lookup_empresa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Lookup_empresa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Lookup_empresa'] = array(); 
}
$aLookup[] = array(sec_Login_pack_protect_string('') => str_replace('<', '&lt;',sec_Login_pack_protect_string('Selecione')));
$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Lookup_empresa'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Ini->nm_db_conn_mssql_infor->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(sec_Login_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', sec_Login_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['Lookup_empresa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['empresa']['valList'][$i] = sec_Login_pack_protect_string($v);
          }
