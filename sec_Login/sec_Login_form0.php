...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("GOHosp - Gestor Operacional Hospitalar"); } else { echo strip_tags("GOHosp - Gestor Operacional Hospitalar"); } ?></TITLE>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_empresa_line" id="hidden_field_data_empresa" style="<?php echo $sStyleHidden_empresa; ?>"> <span class="scFormLabelOddFormat css_empresa_label" style=""><span id="id_label_empresa"><?php echo $this->nm_new_label['empresa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['php_cmp_required']['empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['php_cmp_required']['empresa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<input type="hidden" name="links_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_links('sec_form_add_users', '_self')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_new_user'] ?></a>
<br>

 <a href="javascript:nm_menu_link_links('sec_retrieve_pswd', '_self')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_subject_mail'] ?></a>
<?php  } ?>
 </TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_label'][''];
        }
?>
<?php
...
<?php
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['lancamento_vias'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = '';
        $buttonMacroLabel = "";
        
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['lancamento_vias']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_disabled']['lancamento_vias']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_label']['lancamento_vias']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_label']['lancamento_vias']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login']['btn_label']['lancamento_vias'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "lancamento_vias", "scBtnFn_lancamento_vias()", "scBtnFn_lancamento_vias()", "sc_lancamento_vias_bot", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        ...
        <TD class="scFormFooterFont">
          <?php echo "" . $_SESSION['usr_versao'] . "" ?>
        </TD>
       </TR>
       <TR align="right" valign="middle">
        <TD class="scFormFooterFont">
          <?php echo "© 2021- 2021 - Todos os direitos reservados. Segurança e privacidade." ?>
        </TD>
       </TR>
      </TABLE>
     </TD>
...
<script type="text/javascript">
	...
	function scBtnFn_lancamento_vias() {
		if ($("#sc_lancamento_vias_bot").length && $("#sc_lancamento_vias_bot").is(":visible")) {
		    if ($("#sc_lancamento_vias_bot").hasClass("disabled")) {
		        return;
		    }
			sc_btn_lancamento_vias()
			 return;
		}
	}
</script>
