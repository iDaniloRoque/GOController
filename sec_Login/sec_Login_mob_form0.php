...
<?php $sStyleHidden_mensagem_dumb = ('' == $sStyleHidden_mensagem) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_mensagem_dumb" style="<?php echo $sStyleHidden_mensagem_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_empresa_line" id="hidden_field_data_empresa" style="<?php echo $sStyleHidden_empresa; ?>"> <span class="scFormLabelOddFormat css_empresa_label" style=""><span id="id_label_empresa"><?php echo $this->nm_new_label['empresa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['php_cmp_required']['empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['php_cmp_required']['empresa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['sec_Login_mob']['dashboard_info']['maximized']))
  {
?>
</td></tr> 
