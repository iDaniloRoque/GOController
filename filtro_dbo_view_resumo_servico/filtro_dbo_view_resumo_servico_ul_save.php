...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['filtro_dbo_view_resumo_servico']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['filtro_dbo_view_resumo_servico']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['filtro_dbo_view_resumo_servico']['upload_field_info'][ $_POST['param_field'] ];
