<?php  
  ...
  session_start() ;
  class filtro_dbo_view_resumo_servico_form_teste
  {
   function filtro_dbo_view_resumo_servico_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "filtro_dbo_view_resumo_servico/img";
...
?> 
<br> 
<B><FONT SIZE="4">filtro_dbo_view_resumo_servico</FONT></B> 
<br> 
<br> 
...
usr_idEmpresa&nbsp;&nbsp;<input type="text" name="usr_idEmpresa" size=20><br> 
...
usr_desricao_especialidade&nbsp;&nbsp;<input type="text" name="usr_desricao_especialidade" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="filtro_dbo_view_resumo_servico"> 
</form> 
<script language=javascript> 
 document.Fedit.usr_company.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new filtro_dbo_view_resumo_servico_form_teste();
  $frm_teste->filtro_dbo_view_resumo_servico_teste();
?>
