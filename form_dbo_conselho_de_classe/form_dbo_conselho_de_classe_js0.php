<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idconselho_classe_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idconselho_classe_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_dbo_conselho_de_classe"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_dbo_conselho_de_classe_submit_form(y, z);
