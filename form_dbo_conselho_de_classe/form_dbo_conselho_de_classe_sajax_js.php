  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_conselho_de_classe" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_conselho_de_classe_form();
	}
...
?>
  ...
  // ---------- Validate idconselho_classe_
  function do_ajax_form_dbo_conselho_de_classe_validate_idconselho_classe_(iNumLinha)
  {
    var nomeCampo_idconselho_classe_ = "idconselho_classe_" + iNumLinha;
    var var_idconselho_classe_ = scAjaxGetFieldHidden(nomeCampo_idconselho_classe_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_conselho_de_classe_validate_idconselho_classe_(var_idconselho_classe_, iNumLinha, var_script_case_init, do_ajax_form_dbo_conselho_de_classe_validate_idconselho_classe__cb);
  } // do_ajax_form_dbo_conselho_de_classe_validate_idconselho_classe_

  function do_ajax_form_dbo_conselho_de_classe_validate_idconselho_classe__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idconselho_classe_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idconselho_classe_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idconselho_classe_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idconselho_classe_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_conselho_de_classe_validate_idconselho_classe__cb

  // ---------- Validate descricao_conselho_
  function do_ajax_form_dbo_conselho_de_classe_validate_descricao_conselho_(iNumLinha)
  {
    var nomeCampo_descricao_conselho_ = "descricao_conselho_" + iNumLinha;
    var var_descricao_conselho_ = scAjaxGetFieldText(nomeCampo_descricao_conselho_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_conselho_de_classe_validate_descricao_conselho_(var_descricao_conselho_, iNumLinha, var_script_case_init, do_ajax_form_dbo_conselho_de_classe_validate_descricao_conselho__cb);
  } // do_ajax_form_dbo_conselho_de_classe_validate_descricao_conselho_

  function do_ajax_form_dbo_conselho_de_classe_validate_descricao_conselho__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "descricao_conselho_" + iLineNumber;
    }
    else
    {
      sFieldValid = "descricao_conselho_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "descricao_conselho_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "descricao_conselho_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_conselho_de_classe_validate_descricao_conselho__cb

  // ---------- Validate sigla_conselho_
  function do_ajax_form_dbo_conselho_de_classe_validate_sigla_conselho_(iNumLinha)
  {
    var nomeCampo_sigla_conselho_ = "sigla_conselho_" + iNumLinha;
    var var_sigla_conselho_ = scAjaxGetFieldText(nomeCampo_sigla_conselho_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_conselho_de_classe_validate_sigla_conselho_(var_sigla_conselho_, iNumLinha, var_script_case_init, do_ajax_form_dbo_conselho_de_classe_validate_sigla_conselho__cb);
  } // do_ajax_form_dbo_conselho_de_classe_validate_sigla_conselho_

  function do_ajax_form_dbo_conselho_de_classe_validate_sigla_conselho__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "sigla_conselho_" + iLineNumber;
    }
    else
    {
      sFieldValid = "sigla_conselho_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "sigla_conselho_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "sigla_conselho_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_conselho_de_classe_validate_sigla_conselho__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_dbo_conselho_de_classe_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_dbo_conselho_de_classe_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_conselho_de_classe_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_dbo_conselho_de_classe_add_new_line_cb);
  } // do_ajax_form_dbo_conselho_de_classe_add_new_line

  function do_ajax_form_dbo_conselho_de_classe_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_dbo_conselho_de_classe_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_dbo_conselho_de_classe_backup_line(iNumLinha)
  {
    var var_idconselho_classe_ = scAjaxGetFieldHidden("idconselho_classe_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_conselho_de_classe_backup_line(var_idconselho_classe_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_dbo_conselho_de_classe_backup_line_cb);
  } // do_ajax_form_dbo_conselho_de_classe_backup_line

  function do_ajax_form_dbo_conselho_de_classe_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_dbo_conselho_de_classe_backup_line_cb

  function do_ajax_form_dbo_conselho_de_classe_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_dbo_conselho_de_classe_cancel_insert

  function do_ajax_form_dbo_conselho_de_classe_cancel_update(iSeqVert)
  {
    do_ajax_form_dbo_conselho_de_classe_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_dbo_conselho_de_classe_cancel_update

  function do_ajax_form_dbo_conselho_de_classe_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_dbo_conselho_de_classe_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_dbo_conselho_de_classe_table_refresh()
  {
    var var_idconselho_classe_ = document.F2.idconselho_classe_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_conselho_de_classe_table_refresh(var_idconselho_classe_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_conselho_de_classe_table_refresh_cb);
  } //  do_ajax_form_dbo_conselho_de_classe_table_refresh

  function do_ajax_form_dbo_conselho_de_classe_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idconselho_classe_.value = scAjaxGetKeyValue("idconselho_classe_");
    ...
    scAjaxAlert(do_ajax_form_dbo_conselho_de_classe_table_refresh_cb_after_alert);
  } // do_ajax_form_dbo_conselho_de_classe_table_refresh_cb
  function do_ajax_form_dbo_conselho_de_classe_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_dbo_conselho_de_classe_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_dbo_conselho_de_classe_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_dbo_conselho_de_classe_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idconselho_classe_ = scAjaxGetFieldHidden("idconselho_classe_" + iNumLinha);
    var var_descricao_conselho_ = scAjaxGetFieldText("descricao_conselho_" + iNumLinha);
    var var_sigla_conselho_ = scAjaxGetFieldText("sigla_conselho_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_dbo_conselho_de_classe_submit_form(var_idconselho_classe_, var_descricao_conselho_, var_sigla_conselho_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_conselho_de_classe_submit_form_cb);
  } // do_ajax_form_dbo_conselho_de_classe_submit_form

  function do_ajax_form_dbo_conselho_de_classe_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idconselho_classe_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descricao_conselho_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sigla_conselho_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_conselho_de_classe_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_conselho_de_classe_submit_form_cb
  function do_ajax_form_dbo_conselho_de_classe_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_conselho_de_classe_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_conselho_de_classe_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_conselho_de_classe_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_conselho_de_classe_navigate_form();
    }
  }

  function perform_ajax_form_dbo_conselho_de_classe_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_dbo_conselho_de_classe_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idconselho_classe_" + iNavForm);
      scAjaxHideErrorDisplay("descricao_conselho_" + iNavForm);
      scAjaxHideErrorDisplay("sigla_conselho_" + iNavForm);
    }
    var var_idconselho_classe_ = document.F2.idconselho_classe_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_conselho_de_classe_navigate_form(var_idconselho_classe_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_conselho_de_classe_navigate_form_cb);
  } // do_ajax_form_dbo_conselho_de_classe_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_conselho_de_classe']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_conselho_de_classe_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idconselho_classe_.value = scAjaxGetKeyValue("idconselho_classe_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_conselho_de_classe_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_conselho_de_classe_navigate_form_cb
  function do_ajax_form_dbo_conselho_de_classe_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_dbo_conselho_de_classe_navigate_form_cb_after_alert
  function sc_hide_form_dbo_conselho_de_classe_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idconselho_classe_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descricao_conselho_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sigla_conselho_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idconselho_classe_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["descricao_conselho_" + iNumLinha] = {"label": "Descricao Conselho<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["sigla_conselho_" + iNumLinha] = {"label": "Sigla Conselho<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idconselho_classe_"][iNumLinha] = "idconselho_classe_" + iNumLinha;
    ajax_field_mult["descricao_conselho_"][iNumLinha] = "descricao_conselho_" + iNumLinha;
    ajax_field_mult["sigla_conselho_"][iNumLinha] = "sigla_conselho_" + iNumLinha;
    ajax_field_id["idconselho_classe_" + iNumLinha] = new Array("hidden_field_label_idconselho_classe_", "hidden_field_data_idconselho_classe_" + iNumLinha);
    ajax_field_id["descricao_conselho_" + iNumLinha] = new Array("hidden_field_label_descricao_conselho_", "hidden_field_data_descricao_conselho_" + iNumLinha);
    ajax_field_id["sigla_conselho_" + iNumLinha] = new Array("hidden_field_label_sigla_conselho_", "hidden_field_data_sigla_conselho_" + iNumLinha);
    ajax_error_count["idconselho_classe_" + iNumLinha] = "off";
    ajax_error_count["descricao_conselho_" + iNumLinha] = "off";
    ajax_error_count["sigla_conselho_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idconselho_classe_" + iNumLinha] = "on";
    ajax_read_only["descricao_conselho_" + iNumLinha] = "off";
    ajax_read_only["sigla_conselho_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idconselho_classe_" + iNumLinha] = "on";
    ajax_read_only["descricao_conselho_" + iNumLinha] = "on";
    ajax_read_only["sigla_conselho_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idconselho_classe_" + iNumLinha] = null;
    ajax_error_list["descricao_conselho_" + iNumLinha] = null;
    ajax_error_list["sigla_conselho_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idconselho_classe_": new Array(),
    "descricao_conselho_": new Array(),
    "sigla_conselho_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idconselho_classe_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idconselho_classe_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idconselho_classe_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idconselho_classe_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idconselho_classe_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["descricao_conselho_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["descricao_conselho_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["descricao_conselho_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["descricao_conselho_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["descricao_conselho_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["sigla_conselho_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["sigla_conselho_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["sigla_conselho_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["sigla_conselho_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["sigla_conselho_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idconselho_classe_'])) ? $this->nmgp_cmp_readonly['idconselho_classe_'] : 'on';
?>
    scAjaxFieldRead("idconselho_classe_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['descricao_conselho_'])) ? $this->nmgp_cmp_readonly['descricao_conselho_'] : 'off';
?>
    scAjaxFieldRead("descricao_conselho_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['sigla_conselho_'])) ? $this->nmgp_cmp_readonly['sigla_conselho_'] : 'off';
?>
    scAjaxFieldRead("sigla_conselho_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idconselho_classe_" + iSeq, "on");
    scAjaxFieldRead("descricao_conselho_" + iSeq, "on");
    scAjaxFieldRead("sigla_conselho_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idconselho_classe_" + iRow] || "on" == ajax_error_count["descricao_conselho_" + iRow] || "on" == ajax_error_count["sigla_conselho_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idconselho_classe_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descricao_conselho_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sigla_conselho_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idconselho_classe_" + iRow] && "off" == ajax_error_count["descricao_conselho_" + iRow] && "off" == ajax_error_count["sigla_conselho_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idconselho_classe_" + iRow] = "off";
        ajax_error_count["descricao_conselho_" + iRow] = "off";
        ajax_error_count["sigla_conselho_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idconselho_classe_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descricao_conselho_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_sigla_conselho_" + iRow).removeClass("scFormErrorLine");
    }
  }
