<?php  
  ...
  session_start() ;
  class form_dbo_conselho_de_classe_form_teste
  {
   function form_dbo_conselho_de_classe_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_dbo_conselho_de_classe/img";
...
<?php
  ...
  $frm_teste = new form_dbo_conselho_de_classe_form_teste();
  $frm_teste->form_dbo_conselho_de_classe_teste();
?>
