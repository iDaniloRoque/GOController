  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_variaveis_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_variaveis_mob_form();
	}
...
?>
  ...
  // ---------- Validate idvariaveis
  function do_ajax_form_dbo_variaveis_mob_validate_idvariaveis()
  {
    var nomeCampo_idvariaveis = "idvariaveis";
    var var_idvariaveis = scAjaxGetFieldHidden(nomeCampo_idvariaveis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_variaveis_mob_validate_idvariaveis(var_idvariaveis, var_script_case_init, do_ajax_form_dbo_variaveis_mob_validate_idvariaveis_cb);
  } // do_ajax_form_dbo_variaveis_mob_validate_idvariaveis

  function do_ajax_form_dbo_variaveis_mob_validate_idvariaveis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idvariaveis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_variaveis_mob_validate_idvariaveis_cb

  // ---------- Validate descricao_variaveis
  function do_ajax_form_dbo_variaveis_mob_validate_descricao_variaveis()
  {
    var nomeCampo_descricao_variaveis = "descricao_variaveis";
    var var_descricao_variaveis = scAjaxGetFieldText(nomeCampo_descricao_variaveis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_variaveis_mob_validate_descricao_variaveis(var_descricao_variaveis, var_script_case_init, do_ajax_form_dbo_variaveis_mob_validate_descricao_variaveis_cb);
  } // do_ajax_form_dbo_variaveis_mob_validate_descricao_variaveis

  function do_ajax_form_dbo_variaveis_mob_validate_descricao_variaveis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descricao_variaveis";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_variaveis_mob_validate_descricao_variaveis_cb

  // ---------- Validate tipo_variaveis
  function do_ajax_form_dbo_variaveis_mob_validate_tipo_variaveis()
  {
    var nomeCampo_tipo_variaveis = "tipo_variaveis";
    var var_tipo_variaveis = scAjaxGetFieldText(nomeCampo_tipo_variaveis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_variaveis_mob_validate_tipo_variaveis(var_tipo_variaveis, var_script_case_init, do_ajax_form_dbo_variaveis_mob_validate_tipo_variaveis_cb);
  } // do_ajax_form_dbo_variaveis_mob_validate_tipo_variaveis

  function do_ajax_form_dbo_variaveis_mob_validate_tipo_variaveis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_variaveis";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_variaveis_mob_validate_tipo_variaveis_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_variaveis_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_variaveis_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idvariaveis = scAjaxGetFieldHidden("idvariaveis");
    var var_descricao_variaveis = scAjaxGetFieldText("descricao_variaveis");
    var var_tipo_variaveis = scAjaxGetFieldText("tipo_variaveis");
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_variaveis_mob_submit_form(var_idvariaveis, var_descricao_variaveis, var_tipo_variaveis, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_variaveis_mob_submit_form_cb);
  } // do_ajax_form_dbo_variaveis_mob_submit_form

  function do_ajax_form_dbo_variaveis_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idvariaveis");
      scAjaxHideErrorDisplay("descricao_variaveis");
      scAjaxHideErrorDisplay("tipo_variaveis");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_variaveis_mob_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_variaveis_mob_submit_form_cb
  function do_ajax_form_dbo_variaveis_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_variaveis_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_variaveis_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_variaveis_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_variaveis_mob_navigate_form();
    }
  }

  function perform_ajax_form_dbo_variaveis_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("descricao_variaveis");
    scAjaxHideErrorDisplay("tipo_variaveis");
    var var_idvariaveis = document.F2.idvariaveis.value;
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_variaveis_mob_navigate_form(var_idvariaveis, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_variaveis_mob_navigate_form_cb);
  } // do_ajax_form_dbo_variaveis_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_variaveis_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_variaveis_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idvariaveis.value = scAjaxGetKeyValue("idvariaveis");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_variaveis_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_variaveis_mob_navigate_form_cb
  function do_ajax_form_dbo_variaveis_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_variaveis_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_variaveis_mob_navigate_form_cb_after_alert
  function sc_hide_form_dbo_variaveis_mob_form()
  {
  ...
  ajax_field_list[0] = "idvariaveis";
  ajax_field_list[1] = "descricao_variaveis";
  ajax_field_list[2] = "tipo_variaveis";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idvariaveis": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descricao_variaveis": {"label": "Descrição Variáveis", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_variaveis": {"label": "Tipo Variáveis", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idvariaveis": new Array(),
    "descricao_variaveis": new Array(),
    "tipo_variaveis": new Array()
  };
  ajax_field_mult["idvariaveis"][1] = "idvariaveis";
  ajax_field_mult["descricao_variaveis"][1] = "descricao_variaveis";
  ajax_field_mult["tipo_variaveis"][1] = "tipo_variaveis";

  var ajax_field_id = {
    "idvariaveis": new Array("hidden_field_label_idvariaveis", "hidden_field_data_idvariaveis"),
    "descricao_variaveis": new Array("hidden_field_label_descricao_variaveis", "hidden_field_data_descricao_variaveis"),
    "tipo_variaveis": new Array("hidden_field_label_tipo_variaveis", "hidden_field_data_tipo_variaveis")
  };

  var ajax_read_only = {
    "idvariaveis": "on",
    "descricao_variaveis": "off",
    "tipo_variaveis": "off"
  };
