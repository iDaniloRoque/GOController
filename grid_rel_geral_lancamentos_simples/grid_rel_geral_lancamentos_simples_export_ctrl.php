<?php
@session_start() ;
$_SESSION['scriptcase']['grid_rel_geral_lancamentos_simples']['sc_process_barr'] = true;
require_once('../grid_rel_geral_lancamentos_simples/index.php');
unset($_SESSION['scriptcase']['grid_rel_geral_lancamentos_simples']['sc_process_barr']);
$ExportCtrl = new grid_rel_geral_lancamentos_simples_export_control;
$ExportCtrl->Export_barr();

class grid_rel_geral_lancamentos_simples_export_control
{
