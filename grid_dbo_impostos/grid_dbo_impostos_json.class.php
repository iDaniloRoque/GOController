...
class grid_dbo_impostos_json
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_dbo_impostos/grid_dbo_impostos_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "grid_dbo_impostos.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_name']);
      }
      ...
      { 
          ...
          { 
              ...
              $this->Res = new grid_dbo_impostos_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_res_grid']);
          } 
      }
   ...
   function NM_export_idimpostos()
   {
         ...
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->idimpostos;
   }
   //----- sigla_impostos
   function NM_export_sigla_impostos()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->sigla_impostos;
   }
   //----- descricao_imposto
   function NM_export_descricao_imposto()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->descricao_imposto;
   }
   //----- percentual_default
   function NM_export_percentual_default()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->percentual_default;
   }
   //----- tipo_imposto
   function NM_export_tipo_imposto()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->tipo_imposto;
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> dbo.impostos :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
