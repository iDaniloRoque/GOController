...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idimpostos";$Nm_numeric[] = "percentual_default";$Nm_numeric[] = "idimpostos";$Nm_numeric[] = "percentual_default";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_percentual_default_cond" name="percentual_default_cond" onChange="nm_campos_between(document.getElementById('id_vis_percentual_default'), this, 'percentual_default')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idimpostos_cond" name="idimpostos_cond" onChange="nm_campos_between(document.getElementById('id_vis_idimpostos'), this, 'idimpostos')">
      ...
      <br><span id="id_hide_idimpostos"  <?php echo $str_hide_idimpostos?>><INPUT  type="text" id="SC_idimpostos" name="idimpostos" value="<?php echo NM_encode_input($idimpostos) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_sigla_impostos_cond" name="sigla_impostos_cond" onChange="nm_campos_between(document.getElementById('id_vis_sigla_impostos'), this, 'sigla_impostos')">
      ...
      <br><span id="id_hide_sigla_impostos"  <?php echo $str_hide_sigla_impostos?>><?php
      if ($sigla_impostos != "")
      {
      $sigla_impostos_look = substr($this->Db->qstr($sigla_impostos), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_descricao_imposto_cond" name="descricao_imposto_cond" onChange="nm_campos_between(document.getElementById('id_vis_descricao_imposto'), this, 'descricao_imposto')">
      ...
      <br><span id="id_hide_descricao_imposto"  <?php echo $str_hide_descricao_imposto?>><?php
