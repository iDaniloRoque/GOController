...
<?php
   ...
   $Ord_Cmp = new grid_dbo_impostos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_dbo_impostos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idimpostos'] = "idImpostos";
   $tab_labels["idimpostos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['labels']["idimpostos"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['labels']["idimpostos"] : "Id Impostos";
   $tab_ger_campos['sigla_impostos'] = "on";
   $tab_def_campos['sigla_impostos'] = "sigla_impostos";
   $tab_labels["sigla_impostos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['labels']["sigla_impostos"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['labels']["sigla_impostos"] : "Sigla Impostos";
   $tab_ger_campos['descricao_imposto'] = "on";
   $tab_def_campos['descricao_imposto'] = "descricao_imposto";
   $tab_labels["descricao_imposto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['labels']["descricao_imposto"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['labels']["descricao_imposto"] : "Descricao Imposto";
   $tab_ger_campos['percentual_default'] = "on";
   $tab_def_campos['percentual_default'] = "percentual_default";
   $tab_labels["percentual_default"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['labels']["percentual_default"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['labels']["percentual_default"] : "Percentual Default";
   $tab_ger_campos['tipo_imposto'] = "on";
   $tab_def_campos['tipo_imposto'] = "tipo_imposto";
   $tab_labels["tipo_imposto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['labels']["tipo_imposto"])) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['labels']["tipo_imposto"] : "Tipo Imposto";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_dbo_impostos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_dbo_impostos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
