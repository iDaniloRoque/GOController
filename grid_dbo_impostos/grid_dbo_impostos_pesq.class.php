...
class grid_dbo_impostos_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['path_libs_php'] = $this->Ini->path_lib_php;
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_dbo_impostos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_dbo_impostos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_dbo_impostos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_sigla_impostos')
      {
          $sigla_impostos = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_sigla_impostos($sigla_impostos);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_descricao_imposto')
      {
          $descricao_imposto = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_descricao_imposto($descricao_imposto);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> dbo.impostos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_dbo_impostos/grid_dbo_impostos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_dbo_impostos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_dbo_impostos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_dbo_impostos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_dbo_impostos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_dbo_impostos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_percentual_default_cond#NMF#' + search_get_sel_txt('SC_percentual_default_cond') + '@NMF@';
  str_out += 'SC_percentual_default#NMF#' + search_get_text('SC_percentual_default') + '@NMF@';
  str_out += 'SC_idimpostos_cond#NMF#' + search_get_sel_txt('SC_idimpostos_cond') + '@NMF@';
  str_out += 'SC_idimpostos#NMF#' + search_get_text('SC_idimpostos') + '@NMF@';
  str_out += 'SC_sigla_impostos_cond#NMF#' + search_get_sel_txt('SC_sigla_impostos_cond') + '@NMF@';
  str_out += 'SC_sigla_impostos#NMF#' + search_get_text('SC_sigla_impostos') + '@NMF@';
  str_out += 'id_ac_sigla_impostos#NMF#' + search_get_text('id_ac_sigla_impostos') + '@NMF@';
  str_out += 'SC_descricao_imposto_cond#NMF#' + search_get_sel_txt('SC_descricao_imposto_cond') + '@NMF@';
  str_out += 'SC_descricao_imposto#NMF#' + search_get_text('SC_descricao_imposto') + '@NMF@';
  str_out += 'id_ac_descricao_imposto#NMF#' + search_get_text('id_ac_descricao_imposto') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_sigla_impostos").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_sigla_impostos").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_sigla_impostos",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_sigla_impostos").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_sigla_impostos").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_descricao_imposto").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_descricao_imposto").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_descricao_imposto",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_descricao_imposto").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_descricao_imposto").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> dbo.impostos</div>
...
<?php
   ...
   {
      global 
             $percentual_default_cond, $percentual_default,
             $idimpostos_cond, $idimpostos,
             $sigla_impostos_cond, $sigla_impostos, $sigla_impostos_autocomp,
             $descricao_imposto_cond, $descricao_imposto, $descricao_imposto_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $percentual_default = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['percentual_default']; 
          $percentual_default_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['percentual_default_cond']; 
          $idimpostos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['idimpostos']; 
          $idimpostos_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['idimpostos_cond']; 
          $sigla_impostos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['sigla_impostos']; 
          $sigla_impostos_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['sigla_impostos_cond']; 
          $descricao_imposto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['descricao_imposto']; 
          $descricao_imposto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['descricao_imposto_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['NM_operador']; 
          if (strtoupper($percentual_default_cond) != "II" && strtoupper($percentual_default_cond) != "QP" && strtoupper($percentual_default_cond) != "NP" && strtoupper($percentual_default_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($percentual_default, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($idimpostos_cond) != "II" && strtoupper($idimpostos_cond) != "QP" && strtoupper($idimpostos_cond) != "NP" && strtoupper($idimpostos_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idimpostos, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($percentual_default_cond) || empty($percentual_default_cond))
      {
         $percentual_default_cond = "gt";
      }
      if (!isset($idimpostos_cond) || empty($idimpostos_cond))
      {
         $idimpostos_cond = "gt";
      }
      if (!isset($sigla_impostos_cond) || empty($sigla_impostos_cond))
      {
         $sigla_impostos_cond = "qp";
      }
      if (!isset($descricao_imposto_cond) || empty($descricao_imposto_cond))
      {
         $descricao_imposto_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_percentual_default = (in_array($percentual_default_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idimpostos = (in_array($idimpostos_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_sigla_impostos = (in_array($sigla_impostos_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_descricao_imposto = (in_array($descricao_imposto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($percentual_default) || $percentual_default == "")
      {
          $percentual_default = "";
      }
      if (isset($percentual_default) && !empty($percentual_default))
      {
         $tmp_pos = strpos($percentual_default, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $percentual_default = substr($percentual_default, 0, $tmp_pos);
         }
      }
      if (!isset($idimpostos) || $idimpostos == "")
      {
          $idimpostos = "";
      }
      if (isset($idimpostos) && !empty($idimpostos))
      {
         $tmp_pos = strpos($idimpostos, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idimpostos = substr($idimpostos, 0, $tmp_pos);
         }
      }
      if (!isset($sigla_impostos) || $sigla_impostos == "")
      {
          $sigla_impostos = "";
      }
      if (isset($sigla_impostos) && !empty($sigla_impostos))
      {
         $tmp_pos = strpos($sigla_impostos, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $sigla_impostos = substr($sigla_impostos, 0, $tmp_pos);
         }
      }
      if (!isset($descricao_imposto) || $descricao_imposto == "")
      {
          $descricao_imposto = "";
      }
      if (isset($descricao_imposto) && !empty($descricao_imposto))
      {
         $tmp_pos = strpos($descricao_imposto, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $descricao_imposto = substr($descricao_imposto, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_percentual_default_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['percentual_default'])) ? $this->New_label['percentual_default'] : "Percentual Default"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_percentual_default_cond" name="percentual_default_cond" onChange="nm_campos_between(document.getElementById('id_vis_percentual_default'), this, 'percentual_default')">
       <OPTION value="gt" <?php if ("gt" == $percentual_default_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $percentual_default_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $percentual_default_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_percentual_default" <?php echo $str_hide_percentual_default?> valign="top">
 ...
 $nmgp_tab_label .= "percentual_default?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_percentual_default" name="percentual_default" value="<?php echo NM_encode_input($percentual_default) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_idimpostos_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idimpostos'])) ? $this->New_label['idimpostos'] : "Id Impostos"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idimpostos_cond" name="idimpostos_cond" onChange="nm_campos_between(document.getElementById('id_vis_idimpostos'), this, 'idimpostos')">
       <OPTION value="gt" <?php if ("gt" == $idimpostos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idimpostos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idimpostos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idimpostos" <?php echo $str_hide_idimpostos?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idimpostos'])) ? $this->New_label['idimpostos'] : "Id Impostos";
 $nmgp_tab_label .= "idimpostos?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idimpostos" name="idimpostos" value="<?php echo NM_encode_input($idimpostos) ?>" size=19 alt="{datatype: 'integer', maxLength: 19, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_sigla_impostos_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['sigla_impostos'])) ? $this->New_label['sigla_impostos'] : "Sigla Impostos"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_sigla_impostos_cond" name="sigla_impostos_cond" onChange="nm_campos_between(document.getElementById('id_vis_sigla_impostos'), this, 'sigla_impostos')">
       <OPTION value="qp" <?php if ("qp" == $sigla_impostos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $sigla_impostos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sigla_impostos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $sigla_impostos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_sigla_impostos" <?php echo $str_hide_sigla_impostos?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['sigla_impostos'])) ? $this->New_label['sigla_impostos'] : "Sigla Impostos";
 $nmgp_tab_label .= "sigla_impostos?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $sigla_impostos;
      }
?>
<INPUT  type="text" id="SC_sigla_impostos" name="sigla_impostos" value="<?php echo NM_encode_input($sigla_impostos) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_sigla_impostos" name="sigla_impostos_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_descricao_imposto_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['descricao_imposto'])) ? $this->New_label['descricao_imposto'] : "Descricao Imposto"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_descricao_imposto_cond" name="descricao_imposto_cond" onChange="nm_campos_between(document.getElementById('id_vis_descricao_imposto'), this, 'descricao_imposto')">
       <OPTION value="qp" <?php if ("qp" == $descricao_imposto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $descricao_imposto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $descricao_imposto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $descricao_imposto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_descricao_imposto" <?php echo $str_hide_descricao_imposto?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['descricao_imposto'])) ? $this->New_label['descricao_imposto'] : "Descricao Imposto";
 $nmgp_tab_label .= "descricao_imposto?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $descricao_imposto;
      }
?>
<INPUT  type="text" id="SC_descricao_imposto" name="descricao_imposto" value="<?php echo NM_encode_input($descricao_imposto) ?>"  size=50 alt="{datatype: 'text', maxLength: 8000, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_descricao_imposto" name="descricao_imposto_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 8000, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_dbo_impostos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_dbo_impostos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_dbo_impostos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.percentual_default_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_percentual_default'), document.F1.percentual_default_cond, 'percentual_default');
   document.F1.percentual_default.value = "";
   document.F1.idimpostos_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idimpostos'), document.F1.idimpostos_cond, 'idimpostos');
   document.F1.idimpostos.value = "";
   document.F1.sigla_impostos_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_sigla_impostos'), document.F1.sigla_impostos_cond, 'sigla_impostos');
   document.F1.sigla_impostos.value = "";
   document.F1.sigla_impostos_autocomp.value = "";
   document.F1.descricao_imposto_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_descricao_imposto'), document.F1.descricao_imposto_cond, 'descricao_imposto');
   document.F1.descricao_imposto.value = "";
   document.F1.descricao_imposto_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_percentual_default_cond'] = 'cond';
      $tp_fields['SC_percentual_default'] = 'text';
      $tp_fields['SC_idimpostos_cond'] = 'cond';
      $tp_fields['SC_idimpostos'] = 'text';
      $tp_fields['SC_sigla_impostos_cond'] = 'cond';
      $tp_fields['SC_sigla_impostos'] = 'text_aut';
      $tp_fields['id_ac_sigla_impostos'] = 'text_aut';
      $tp_fields['SC_descricao_imposto_cond'] = 'cond';
      $tp_fields['SC_descricao_imposto'] = 'text_aut';
      $tp_fields['id_ac_descricao_imposto'] = 'text_aut';
   ...
   {
      global $percentual_default_cond, $percentual_default,
             $idimpostos_cond, $idimpostos,
             $sigla_impostos_cond, $sigla_impostos, $sigla_impostos_autocomp,
             $descricao_imposto_cond, $descricao_imposto, $descricao_imposto_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      if (!empty($sigla_impostos_autocomp) && empty($sigla_impostos))
      {
          $sigla_impostos = $sigla_impostos_autocomp;
      }
      if (!empty($descricao_imposto_autocomp) && empty($descricao_imposto))
      {
          $descricao_imposto = $descricao_imposto_autocomp;
      }
      $percentual_default_cond_salva = $percentual_default_cond; 
      if (!isset($percentual_default_input_2) || $percentual_default_input_2 == "")
      {
          $percentual_default_input_2 = $percentual_default;
      }
      $idimpostos_cond_salva = $idimpostos_cond; 
      if (!isset($idimpostos_input_2) || $idimpostos_input_2 == "")
      {
          $idimpostos_input_2 = $idimpostos;
      }
      $sigla_impostos_cond_salva = $sigla_impostos_cond; 
      if (!isset($sigla_impostos_input_2) || $sigla_impostos_input_2 == "")
      {
          $sigla_impostos_input_2 = $sigla_impostos;
      }
      $descricao_imposto_cond_salva = $descricao_imposto_cond; 
      if (!isset($descricao_imposto_input_2) || $descricao_imposto_input_2 == "")
      {
          $descricao_imposto_input_2 = $descricao_imposto;
      }
      if ($percentual_default_cond != "in")
      {
          nm_limpa_numero($percentual_default, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idimpostos_cond != "in")
      {
          nm_limpa_numero($idimpostos, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']  = array(); 
      ...
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['percentual_default'] = $percentual_default; 
      if (is_array($percentual_default) && !empty($percentual_default))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['val'][0] = $percentual_default;
      }
      elseif ($percentual_default_cond_salva == "nu" || $percentual_default_cond_salva == "nn" || $percentual_default_cond_salva == "ep" || $percentual_default_cond_salva == "ne" || !empty($percentual_default))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['val'][0][0] = $percentual_default;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['percentual_default_cond'] = $percentual_default_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['cmp'] = "percentual_default"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['opc'] = $percentual_default_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq']['percentual_default'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['idimpostos'] = $idimpostos; 
      if (is_array($idimpostos) && !empty($idimpostos))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['val'][0] = $idimpostos;
      }
      elseif ($idimpostos_cond_salva == "nu" || $idimpostos_cond_salva == "nn" || $idimpostos_cond_salva == "ep" || $idimpostos_cond_salva == "ne" || !empty($idimpostos))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['val'][0][0] = $idimpostos;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['idimpostos_cond'] = $idimpostos_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['cmp'] = "idimpostos"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['opc'] = $idimpostos_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq']['idimpostos'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['sigla_impostos'] = $sigla_impostos; 
      if (is_array($sigla_impostos) && !empty($sigla_impostos))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['val'][0] = $sigla_impostos;
      }
      elseif ($sigla_impostos_cond_salva == "nu" || $sigla_impostos_cond_salva == "nn" || $sigla_impostos_cond_salva == "ep" || $sigla_impostos_cond_salva == "ne" || !empty($sigla_impostos))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['val'][0][0] = $sigla_impostos;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['sigla_impostos_cond'] = $sigla_impostos_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['cmp'] = "sigla_impostos"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['opc'] = $sigla_impostos_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq']['sigla_impostos'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['descricao_imposto'] = $descricao_imposto; 
      if (is_array($descricao_imposto) && !empty($descricao_imposto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['val'][0] = $descricao_imposto;
      }
      elseif ($descricao_imposto_cond_salva == "nu" || $descricao_imposto_cond_salva == "nn" || $descricao_imposto_cond_salva == "ep" || $descricao_imposto_cond_salva == "ne" || !empty($descricao_imposto))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['val'][0][0] = $descricao_imposto;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['descricao_imposto_cond'] = $descricao_imposto_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['cmp'] = "descricao_imposto"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid]['opc'] = $descricao_imposto_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['grid_pesq']['descricao_imposto'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $percentual_default;
      if (strtoupper($percentual_default_cond) != "II" && strtoupper($percentual_default_cond) != "QP" && strtoupper($percentual_default_cond) != "NP" && strtoupper($percentual_default_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['percentual_default'] = $Conteudo;
      $Conteudo = $idimpostos;
      if (strtoupper($idimpostos_cond) != "II" && strtoupper($idimpostos_cond) != "QP" && strtoupper($idimpostos_cond) != "NP" && strtoupper($idimpostos_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idimpostos'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($sigla_impostos != '') {
      $sigla_impostos_look = substr($this->Db->qstr($sigla_impostos), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['sigla_impostos'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['sigla_impostos'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['sigla_impostos'] = $sigla_impostos;
      }
      $nmgp_def_dados = array();
    if ($descricao_imposto != '') {
      $descricao_imposto_look = substr($this->Db->qstr($descricao_imposto), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['descricao_imposto'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['descricao_imposto'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['descricao_imposto'] = $descricao_imposto;
      }

      //----- $percentual_default
      $this->Date_part = false;
      if (isset($percentual_default) || $percentual_default_cond == "nu" || $percentual_default_cond == "nn" || $percentual_default_cond == "ep" || $percentual_default_cond == "ne")
      {
         $this->monta_condicao("percentual_default", $percentual_default_cond, $percentual_default, "", "percentual_default");
      }

      //----- $idimpostos
      $this->Date_part = false;
      if (isset($idimpostos) || $idimpostos_cond == "nu" || $idimpostos_cond == "nn" || $idimpostos_cond == "ep" || $idimpostos_cond == "ne")
      {
         $this->monta_condicao("idImpostos", $idimpostos_cond, $idimpostos, "", "idimpostos");
      }

      //----- $sigla_impostos
      $this->Date_part = false;
      if (isset($sigla_impostos) || $sigla_impostos_cond == "nu" || $sigla_impostos_cond == "nn" || $sigla_impostos_cond == "ep" || $sigla_impostos_cond == "ne")
      {
         $this->monta_condicao("sigla_impostos", $sigla_impostos_cond, $sigla_impostos, "", "sigla_impostos");
      }

      //----- $descricao_imposto
      $this->Date_part = false;
      if (isset($descricao_imposto) || $descricao_imposto_cond == "nu" || $descricao_imposto_cond == "nn" || $descricao_imposto_cond == "ep" || $descricao_imposto_cond == "ne")
      {
         $this->monta_condicao("descricao_imposto", $descricao_imposto_cond, $descricao_imposto, "", "descricao_imposto");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_impostos']['cond_pesq'] .= $this->NM_operador;
