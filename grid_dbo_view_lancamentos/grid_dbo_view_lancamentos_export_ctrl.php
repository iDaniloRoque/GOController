<?php
@session_start() ;
$_SESSION['scriptcase']['grid_dbo_view_lancamentos']['sc_process_barr'] = true;
require_once('../grid_dbo_view_lancamentos/index.php');
unset($_SESSION['scriptcase']['grid_dbo_view_lancamentos']['sc_process_barr']);
$ExportCtrl = new grid_dbo_view_lancamentos_export_control;
$ExportCtrl->Export_barr();

class grid_dbo_view_lancamentos_export_control
{
