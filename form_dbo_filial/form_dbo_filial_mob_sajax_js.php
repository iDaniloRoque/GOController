  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_filial_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_filial_mob_form();
	}
...
?>
  ...
  // ---------- Validate idfilial
  function do_ajax_form_dbo_filial_mob_validate_idfilial()
  {
    var nomeCampo_idfilial = "idfilial";
    var var_idfilial = scAjaxGetFieldHidden(nomeCampo_idfilial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_filial_mob_validate_idfilial(var_idfilial, var_script_case_init, do_ajax_form_dbo_filial_mob_validate_idfilial_cb);
  } // do_ajax_form_dbo_filial_mob_validate_idfilial

  function do_ajax_form_dbo_filial_mob_validate_idfilial_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_filial_mob_validate_idfilial_cb

  // ---------- Validate idempresa
  function do_ajax_form_dbo_filial_mob_validate_idempresa()
  {
    var nomeCampo_idempresa = "idempresa";
    var var_idempresa = scAjaxGetFieldSelect(nomeCampo_idempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_filial_mob_validate_idempresa(var_idempresa, var_script_case_init, do_ajax_form_dbo_filial_mob_validate_idempresa_cb);
  } // do_ajax_form_dbo_filial_mob_validate_idempresa

  function do_ajax_form_dbo_filial_mob_validate_idempresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_filial_mob_validate_idempresa_cb

  // ---------- Validate cnpj
  function do_ajax_form_dbo_filial_mob_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldText(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_filial_mob_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_form_dbo_filial_mob_validate_cnpj_cb);
  } // do_ajax_form_dbo_filial_mob_validate_cnpj

  function do_ajax_form_dbo_filial_mob_validate_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cnpj";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_filial_mob_validate_cnpj_cb

  // ---------- Validate nome
  function do_ajax_form_dbo_filial_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_filial_mob_validate_nome(var_nome, var_script_case_init, do_ajax_form_dbo_filial_mob_validate_nome_cb);
  } // do_ajax_form_dbo_filial_mob_validate_nome

  function do_ajax_form_dbo_filial_mob_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_filial_mob_validate_nome_cb

  // ---------- Validate fantasia
  function do_ajax_form_dbo_filial_mob_validate_fantasia()
  {
    var nomeCampo_fantasia = "fantasia";
    var var_fantasia = scAjaxGetFieldText(nomeCampo_fantasia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_filial_mob_validate_fantasia(var_fantasia, var_script_case_init, do_ajax_form_dbo_filial_mob_validate_fantasia_cb);
  } // do_ajax_form_dbo_filial_mob_validate_fantasia

  function do_ajax_form_dbo_filial_mob_validate_fantasia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_filial_mob_validate_fantasia_cb

  // ---------- Validate comercial
  function do_ajax_form_dbo_filial_mob_validate_comercial()
  {
    var nomeCampo_comercial = "comercial";
    var var_comercial = scAjaxGetFieldText(nomeCampo_comercial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_filial_mob_validate_comercial(var_comercial, var_script_case_init, do_ajax_form_dbo_filial_mob_validate_comercial_cb);
  } // do_ajax_form_dbo_filial_mob_validate_comercial

  function do_ajax_form_dbo_filial_mob_validate_comercial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "comercial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_filial_mob_validate_comercial_cb

  // ---------- Validate logomarca
  function do_ajax_form_dbo_filial_mob_validate_logomarca()
  {
    var nomeCampo_logomarca = "logomarca";
    var var_logomarca = scAjaxGetFieldText(nomeCampo_logomarca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_filial_mob_validate_logomarca(var_logomarca, var_script_case_init, do_ajax_form_dbo_filial_mob_validate_logomarca_cb);
  } // do_ajax_form_dbo_filial_mob_validate_logomarca

  function do_ajax_form_dbo_filial_mob_validate_logomarca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "logomarca";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_filial_mob_validate_logomarca_cb

  // ---------- Event onchange cnpj
  function do_ajax_form_dbo_filial_mob_event_cnpj_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_dbo_filial_mob_event_cnpj_onchange(var_cnpj, var_nome, var_fantasia, var_script_case_init, do_ajax_form_dbo_filial_mob_event_cnpj_onchange_cb);
  } // do_ajax_form_dbo_filial_mob_event_cnpj_onchange

  function do_ajax_form_dbo_filial_mob_event_cnpj_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cnpj";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_filial_mob_event_cnpj_onchange_cb_after_alert);
  } // do_ajax_form_dbo_filial_mob_event_cnpj_onchange_cb
  function do_ajax_form_dbo_filial_mob_event_cnpj_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_dbo_filial_mob_event_cnpj_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_filial_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_filial_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idfilial = scAjaxGetFieldHidden("idfilial");
    var var_idempresa = scAjaxGetFieldSelect("idempresa");
    var var_cnpj = scAjaxGetFieldText("cnpj");
    var var_nome = scAjaxGetFieldText("nome");
    var var_fantasia = scAjaxGetFieldText("fantasia");
    var var_comercial = scAjaxGetFieldText("comercial");
    var var_logomarca = scAjaxGetFieldText("logomarca");
    var var_logomarca_ul_name = scAjaxSpecCharProtect(document.F1.logomarca_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_logomarca_ul_type = document.F1.logomarca_ul_type.value;
    var var_logomarca_salva = scAjaxSpecCharProtect(document.F1.logomarca_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_logomarca_limpa = document.F1.logomarca_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_filial_mob_submit_form(var_idfilial, var_idempresa, var_cnpj, var_nome, var_fantasia, var_comercial, var_logomarca, var_logomarca_ul_name, var_logomarca_ul_type, var_logomarca_salva, var_logomarca_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_filial_mob_submit_form_cb);
  } // do_ajax_form_dbo_filial_mob_submit_form

  function do_ajax_form_dbo_filial_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("comercial");
      scAjaxHideErrorDisplay("logomarca");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.logomarca_limpa && document.F1.logomarca_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("logomarca", oImgTemp, "", "", "", "N");
      }
    document.F1.logomarca_ul_name.value = '';
    document.F1.logomarca_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_filial_mob_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_filial_mob_submit_form_cb
  function do_ajax_form_dbo_filial_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_filial_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_filial_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_filial_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_filial_mob_navigate_form();
    }
  }

  function perform_ajax_form_dbo_filial_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("comercial");
    scAjaxHideErrorDisplay("logomarca");
    var var_idfilial = document.F2.idfilial.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_filial_mob_navigate_form(var_idfilial, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_filial_mob_navigate_form_cb);
  } // do_ajax_form_dbo_filial_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_filial_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_filial_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idfilial.value = scAjaxGetKeyValue("idfilial");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_filial_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_filial_mob_navigate_form_cb
  function do_ajax_form_dbo_filial_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_filial_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_filial_mob_navigate_form_cb_after_alert
  function sc_hide_form_dbo_filial_mob_form()
  {
  ...
  ajax_field_list[0] = "idfilial";
  ajax_field_list[1] = "idempresa";
  ajax_field_list[2] = "cnpj";
  ajax_field_list[3] = "nome";
  ajax_field_list[4] = "fantasia";
  ajax_field_list[5] = "comercial";
  ajax_field_list[6] = "logomarca";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idfilial": {"label": "Cod.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idempresa": {"label": "Empresa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "comercial": {"label": "Comercial", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "logomarca": {"label": "Logomarca", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["comercial"][1] = "comercial";
  ajax_field_mult["logomarca"][1] = "logomarca";

  var ajax_field_id = {
    "idfilial": new Array("hidden_field_label_idfilial", "hidden_field_data_idfilial"),
    "idempresa": new Array("hidden_field_label_idempresa", "hidden_field_data_idempresa"),
    ...
    "comercial": new Array("hidden_field_label_comercial", "hidden_field_data_comercial"),
    "logomarca": new Array("hidden_field_label_logomarca", "hidden_field_data_logomarca")
  };
