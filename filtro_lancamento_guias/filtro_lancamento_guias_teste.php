<?php  
  ...
  session_start() ;
  class filtro_lancamento_guias_form_teste
  {
   function filtro_lancamento_guias_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "filtro_lancamento_guias/img";
...
?> 
<br> 
<B><FONT SIZE="4">filtro_lancamento_guias</FONT></B> 
<br> 
<br> 
...
usr_idContratos&nbsp;&nbsp;<input type="text" name="usr_idContratos" size=20><br> 
...
<input type="submit" value="filtro_lancamento_guias"> 
</form> 
<script language=javascript> 
 document.Fedit.usr_idEmpresa.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new filtro_lancamento_guias_form_teste();
  $frm_teste->filtro_lancamento_guias_teste();
?>
