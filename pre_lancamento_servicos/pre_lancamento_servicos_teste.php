<?php  
  ...
  session_start() ;
  class pre_lancamento_servicos_form_teste
  {
   function pre_lancamento_servicos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "pre_lancamento_servicos/img";
...
?> 
<br> 
<B><FONT SIZE="4">pre_lancamento_servicos</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="pre_lancamento_servicos"> 
</form> 
...
<?php
  ...
  $frm_teste = new pre_lancamento_servicos_form_teste();
  $frm_teste->pre_lancamento_servicos_teste();
?>
