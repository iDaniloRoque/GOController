  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_pre_lancamento_servicos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_pre_lancamento_servicos_form();
	}
...
?>
  ...
  function do_ajax_pre_lancamento_servicos_validate_idpre_lancamento()
  {
    ...
    x_ajax_pre_lancamento_servicos_validate_idpre_lancamento(var_idpre_lancamento, var_script_case_init, do_ajax_pre_lancamento_servicos_validate_idpre_lancamento_cb);
  } // do_ajax_pre_lancamento_servicos_validate_idpre_lancamento

  function do_ajax_pre_lancamento_servicos_validate_idpre_lancamento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_validate_idpre_lancamento_cb

  // ---------- Validate idespecialidade_servicos
  function do_ajax_pre_lancamento_servicos_validate_idespecialidade_servicos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_validate_idespecialidade_servicos(var_idespecialidade_servicos, var_script_case_init, do_ajax_pre_lancamento_servicos_validate_idespecialidade_servicos_cb);
  } // do_ajax_pre_lancamento_servicos_validate_idespecialidade_servicos

  function do_ajax_pre_lancamento_servicos_validate_idespecialidade_servicos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_validate_idespecialidade_servicos_cb

  // ---------- Validate idpessoas
  function do_ajax_pre_lancamento_servicos_validate_idpessoas()
  {
    var nomeCampo_idpessoas = "idpessoas";
    var var_idpessoas = scAjaxGetFieldSelect(nomeCampo_idpessoas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_validate_idpessoas(var_idpessoas, var_script_case_init, do_ajax_pre_lancamento_servicos_validate_idpessoas_cb);
  } // do_ajax_pre_lancamento_servicos_validate_idpessoas

  function do_ajax_pre_lancamento_servicos_validate_idpessoas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_validate_idpessoas_cb

  // ---------- Validate idprofissional
  function do_ajax_pre_lancamento_servicos_validate_idprofissional()
  {
    var nomeCampo_idprofissional = "idprofissional";
    var var_idprofissional = scAjaxGetFieldSelect(nomeCampo_idprofissional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_validate_idprofissional(var_idprofissional, var_script_case_init, do_ajax_pre_lancamento_servicos_validate_idprofissional_cb);
  } // do_ajax_pre_lancamento_servicos_validate_idprofissional

  function do_ajax_pre_lancamento_servicos_validate_idprofissional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_validate_idprofissional_cb

  // ---------- Validate num_guia
  function do_ajax_pre_lancamento_servicos_validate_num_guia()
  {
    var nomeCampo_num_guia = "num_guia";
    var var_num_guia = scAjaxGetFieldText(nomeCampo_num_guia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_validate_num_guia(var_num_guia, var_script_case_init, do_ajax_pre_lancamento_servicos_validate_num_guia_cb);
  } // do_ajax_pre_lancamento_servicos_validate_num_guia

  function do_ajax_pre_lancamento_servicos_validate_num_guia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_validate_num_guia_cb

  // ---------- Validate anexo_guia
  function do_ajax_pre_lancamento_servicos_validate_anexo_guia()
  {
    var nomeCampo_anexo_guia = "anexo_guia";
    var var_anexo_guia = scAjaxGetFieldText(nomeCampo_anexo_guia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_validate_anexo_guia(var_anexo_guia, var_script_case_init, do_ajax_pre_lancamento_servicos_validate_anexo_guia_cb);
  } // do_ajax_pre_lancamento_servicos_validate_anexo_guia

  function do_ajax_pre_lancamento_servicos_validate_anexo_guia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_validate_anexo_guia_cb

  // ---------- Validate data_do_servico
  function do_ajax_pre_lancamento_servicos_validate_data_do_servico()
  {
    ...
    setTimeout(function() {
      var var_data_do_servico = scAjaxGetFieldText(nomeCampo_data_do_servico);
      x_ajax_pre_lancamento_servicos_validate_data_do_servico(var_data_do_servico, var_script_case_init, do_ajax_pre_lancamento_servicos_validate_data_do_servico_cb);
    }, 200);
  } // do_ajax_pre_lancamento_servicos_validate_data_do_servico

  function do_ajax_pre_lancamento_servicos_validate_data_do_servico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_validate_data_do_servico_cb

  // ---------- Validate __calend_all_day__
  function do_ajax_pre_lancamento_servicos_validate___calend_all_day__()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_validate___calend_all_day__(var___calend_all_day__, var_script_case_init, do_ajax_pre_lancamento_servicos_validate___calend_all_day___cb);
  } // do_ajax_pre_lancamento_servicos_validate___calend_all_day__

  function do_ajax_pre_lancamento_servicos_validate___calend_all_day___cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_validate___calend_all_day___cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_pre_lancamento_servicos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_pre_lancamento_servicos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_pre_lancamento_servicos_submit_form(var_idpre_lancamento, var_idespecialidade_servicos, var_idpessoas, var_idprofissional, var_num_guia, var_anexo_guia, var_data_do_servico, var___calend_all_day__, var_anexo_guia_ul_name, var_anexo_guia_ul_type, var_anexo_guia_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_pre_lancamento_servicos_submit_form_cb);
  } // do_ajax_pre_lancamento_servicos_submit_form

  function do_ajax_pre_lancamento_servicos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_pre_lancamento_servicos_submit_form_cb_after_alert);
  } // do_ajax_pre_lancamento_servicos_submit_form_cb
  function do_ajax_pre_lancamento_servicos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_pre_lancamento_servicos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_pre_lancamento_servicos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_pre_lancamento_servicos_navigate_form, function() {});
    } else {
      perform_ajax_pre_lancamento_servicos_navigate_form();
    }
  }

  function perform_ajax_pre_lancamento_servicos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_pre_lancamento_servicos_navigate_form(var_idpre_lancamento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_pre_lancamento_servicos_navigate_form_cb);
  } // do_ajax_pre_lancamento_servicos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_pre_lancamento_servicos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_pre_lancamento_servicos_navigate_form_cb_after_alert);
  } // do_ajax_pre_lancamento_servicos_navigate_form_cb
  function do_ajax_pre_lancamento_servicos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_pre_lancamento_servicos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_pre_lancamento_servicos_navigate_form_cb_after_alert
  function sc_hide_pre_lancamento_servicos_form()
  {
