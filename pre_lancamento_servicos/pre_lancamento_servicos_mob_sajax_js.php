  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_pre_lancamento_servicos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_pre_lancamento_servicos_mob_form();
	}
...
?>
  ...
  // ---------- Validate idpre_lancamento
  function do_ajax_pre_lancamento_servicos_mob_validate_idpre_lancamento()
  {
    var nomeCampo_idpre_lancamento = "idpre_lancamento";
    var var_idpre_lancamento = scAjaxGetFieldHidden(nomeCampo_idpre_lancamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_mob_validate_idpre_lancamento(var_idpre_lancamento, var_script_case_init, do_ajax_pre_lancamento_servicos_mob_validate_idpre_lancamento_cb);
  } // do_ajax_pre_lancamento_servicos_mob_validate_idpre_lancamento

  function do_ajax_pre_lancamento_servicos_mob_validate_idpre_lancamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpre_lancamento";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_mob_validate_idpre_lancamento_cb

  // ---------- Validate idespecialidade_servicos
  function do_ajax_pre_lancamento_servicos_mob_validate_idespecialidade_servicos()
  {
    var nomeCampo_idespecialidade_servicos = "idespecialidade_servicos";
    var var_idespecialidade_servicos = scAjaxGetFieldSelect(nomeCampo_idespecialidade_servicos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_mob_validate_idespecialidade_servicos(var_idespecialidade_servicos, var_script_case_init, do_ajax_pre_lancamento_servicos_mob_validate_idespecialidade_servicos_cb);
  } // do_ajax_pre_lancamento_servicos_mob_validate_idespecialidade_servicos

  function do_ajax_pre_lancamento_servicos_mob_validate_idespecialidade_servicos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idespecialidade_servicos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_mob_validate_idespecialidade_servicos_cb

  // ---------- Validate idpessoas
  function do_ajax_pre_lancamento_servicos_mob_validate_idpessoas()
  {
    var nomeCampo_idpessoas = "idpessoas";
    var var_idpessoas = scAjaxGetFieldSelect(nomeCampo_idpessoas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_mob_validate_idpessoas(var_idpessoas, var_script_case_init, do_ajax_pre_lancamento_servicos_mob_validate_idpessoas_cb);
  } // do_ajax_pre_lancamento_servicos_mob_validate_idpessoas

  function do_ajax_pre_lancamento_servicos_mob_validate_idpessoas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_mob_validate_idpessoas_cb

  // ---------- Validate idprofissional
  function do_ajax_pre_lancamento_servicos_mob_validate_idprofissional()
  {
    var nomeCampo_idprofissional = "idprofissional";
    var var_idprofissional = scAjaxGetFieldSelect(nomeCampo_idprofissional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_mob_validate_idprofissional(var_idprofissional, var_script_case_init, do_ajax_pre_lancamento_servicos_mob_validate_idprofissional_cb);
  } // do_ajax_pre_lancamento_servicos_mob_validate_idprofissional

  function do_ajax_pre_lancamento_servicos_mob_validate_idprofissional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idprofissional";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_mob_validate_idprofissional_cb

  // ---------- Validate num_guia
  function do_ajax_pre_lancamento_servicos_mob_validate_num_guia()
  {
    var nomeCampo_num_guia = "num_guia";
    var var_num_guia = scAjaxGetFieldText(nomeCampo_num_guia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_mob_validate_num_guia(var_num_guia, var_script_case_init, do_ajax_pre_lancamento_servicos_mob_validate_num_guia_cb);
  } // do_ajax_pre_lancamento_servicos_mob_validate_num_guia

  function do_ajax_pre_lancamento_servicos_mob_validate_num_guia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "num_guia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_mob_validate_num_guia_cb

  // ---------- Validate anexo_guia
  function do_ajax_pre_lancamento_servicos_mob_validate_anexo_guia()
  {
    var nomeCampo_anexo_guia = "anexo_guia";
    var var_anexo_guia = scAjaxGetFieldText(nomeCampo_anexo_guia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_mob_validate_anexo_guia(var_anexo_guia, var_script_case_init, do_ajax_pre_lancamento_servicos_mob_validate_anexo_guia_cb);
  } // do_ajax_pre_lancamento_servicos_mob_validate_anexo_guia

  function do_ajax_pre_lancamento_servicos_mob_validate_anexo_guia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_mob_validate_anexo_guia_cb

  // ---------- Validate data_do_servico
  function do_ajax_pre_lancamento_servicos_mob_validate_data_do_servico()
  {
    ...
    setTimeout(function() {
      var var_data_do_servico = scAjaxGetFieldText(nomeCampo_data_do_servico);
      x_ajax_pre_lancamento_servicos_mob_validate_data_do_servico(var_data_do_servico, var_script_case_init, do_ajax_pre_lancamento_servicos_mob_validate_data_do_servico_cb);
    }, 200);
  } // do_ajax_pre_lancamento_servicos_mob_validate_data_do_servico

  function do_ajax_pre_lancamento_servicos_mob_validate_data_do_servico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_mob_validate_data_do_servico_cb

  // ---------- Validate __calend_all_day__
  function do_ajax_pre_lancamento_servicos_mob_validate___calend_all_day__()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_pre_lancamento_servicos_mob_validate___calend_all_day__(var___calend_all_day__, var_script_case_init, do_ajax_pre_lancamento_servicos_mob_validate___calend_all_day___cb);
  } // do_ajax_pre_lancamento_servicos_mob_validate___calend_all_day__

  function do_ajax_pre_lancamento_servicos_mob_validate___calend_all_day___cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_pre_lancamento_servicos_mob_validate___calend_all_day___cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_pre_lancamento_servicos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_pre_lancamento_servicos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpre_lancamento = scAjaxGetFieldHidden("idpre_lancamento");
    var var_idespecialidade_servicos = scAjaxGetFieldSelect("idespecialidade_servicos");
    var var_idpessoas = scAjaxGetFieldSelect("idpessoas");
    var var_idprofissional = scAjaxGetFieldSelect("idprofissional");
    var var_num_guia = scAjaxGetFieldText("num_guia");
    ...
    scAjaxProcOn();
    x_ajax_pre_lancamento_servicos_mob_submit_form(var_idpre_lancamento, var_idespecialidade_servicos, var_idpessoas, var_idprofissional, var_num_guia, var_anexo_guia, var_data_do_servico, var___calend_all_day__, var_anexo_guia_ul_name, var_anexo_guia_ul_type, var_anexo_guia_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_pre_lancamento_servicos_mob_submit_form_cb);
  } // do_ajax_pre_lancamento_servicos_mob_submit_form

  function do_ajax_pre_lancamento_servicos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idpre_lancamento");
      scAjaxHideErrorDisplay("idespecialidade_servicos");
      scAjaxHideErrorDisplay("idpessoas");
      scAjaxHideErrorDisplay("idprofissional");
      scAjaxHideErrorDisplay("num_guia");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_pre_lancamento_servicos_mob_submit_form_cb_after_alert);
  } // do_ajax_pre_lancamento_servicos_mob_submit_form_cb
  function do_ajax_pre_lancamento_servicos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_pre_lancamento_servicos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_pre_lancamento_servicos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_pre_lancamento_servicos_mob_navigate_form, function() {});
    } else {
      perform_ajax_pre_lancamento_servicos_mob_navigate_form();
    }
  }

  function perform_ajax_pre_lancamento_servicos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_pre_lancamento_servicos_mob_navigate_form(var_idpre_lancamento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_pre_lancamento_servicos_mob_navigate_form_cb);
  } // do_ajax_pre_lancamento_servicos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_pre_lancamento_servicos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_pre_lancamento_servicos_mob_navigate_form_cb_after_alert);
  } // do_ajax_pre_lancamento_servicos_mob_navigate_form_cb
  function do_ajax_pre_lancamento_servicos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_pre_lancamento_servicos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_pre_lancamento_servicos_mob_navigate_form_cb_after_alert
  function sc_hide_pre_lancamento_servicos_mob_form()
  {
  ...
  ajax_field_list[0] = "idpre_lancamento";
  ajax_field_list[1] = "idespecialidade_servicos";
  ajax_field_list[2] = "idpessoas";
  ajax_field_list[3] = "idprofissional";
  ajax_field_list[4] = "num_guia";
  ajax_field_list[5] = "anexo_guia";
  ajax_field_list[6] = "data_do_servico";
  ajax_field_list[7] = "__calend_all_day__";
  ...
  var ajax_error_list = {
    "idpre_lancamento": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idespecialidade_servicos": {"label": "Especialidade", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idpessoas": {"label": "Pessoas Jurídica", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idprofissional": {"label": "Profissional", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "num_guia": {"label": "Nº Guia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anexo_guia": {"label": "Anexo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_do_servico": {"label": "Data", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idpre_lancamento": new Array(),
    "idespecialidade_servicos": new Array(),
    "idpessoas": new Array(),
    "idprofissional": new Array(),
    "num_guia": new Array(),
    "anexo_guia": new Array(),
    "data_do_servico": new Array(),
    "__calend_all_day__": new Array()
  };
  ajax_field_mult["idpre_lancamento"][1] = "idpre_lancamento";
  ajax_field_mult["idespecialidade_servicos"][1] = "idespecialidade_servicos";
  ajax_field_mult["idpessoas"][1] = "idpessoas";
  ajax_field_mult["idprofissional"][1] = "idprofissional";
  ajax_field_mult["num_guia"][1] = "num_guia";
  ...
  var ajax_field_id = {
    "idpre_lancamento": new Array("hidden_field_label_idpre_lancamento", "hidden_field_data_idpre_lancamento"),
    "idespecialidade_servicos": new Array("hidden_field_label_idespecialidade_servicos", "hidden_field_data_idespecialidade_servicos"),
    "idpessoas": new Array("hidden_field_label_idpessoas", "hidden_field_data_idpessoas"),
    "idprofissional": new Array("hidden_field_label_idprofissional", "hidden_field_data_idprofissional"),
    "num_guia": new Array("hidden_field_label_num_guia", "hidden_field_data_num_guia"),
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idespecialidade_servicos" == sIndex)
    {
