<?php
//
class pre_lancamento_servicos_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new pre_lancamento_servicos_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['pre_lancamento_servicos_mob']['upload_field_info']['anexo_guia'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'pre_lancamento_servicos_mob',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['pre_lancamento_servicos_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['pre_lancamento_servicos_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['pre_lancamento_servicos_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['pre_lancamento_servicos_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('pre_lancamento_servicos_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['pre_lancamento_servicos_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " dbo.pre_lancamento_servicos";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "pre_lancamento_servicos_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['pre_lancamento_servicos_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['pre_lancamento_servicos_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['upload_field_ul_name'][$this->anexo_guia_ul_name]))
          {
              $this->NM_ajax_info['param']['anexo_guia_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['upload_field_ul_name'][$this->anexo_guia_ul_name];
          }
      ...
      elseif (isset($this->anexo_guia_ul_name) && '' != $this->anexo_guia_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['upload_field_ul_name'][$this->anexo_guia_ul_name]))
          {
              $this->anexo_guia_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['upload_field_ul_name'][$this->anexo_guia_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['pre_lancamento_servicos_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['pre_lancamento_servicos_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['pre_lancamento_servicos_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("pre_lancamento_servicos_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'pre_lancamento_servicos/pre_lancamento_servicos_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'pre_lancamento_servicos_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'pre_lancamento_servicos_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'pre_lancamento_servicos_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'pre_lancamento_servicos/pre_lancamento_servicos_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "pre_lancamento_servicos_mob_erro.class.php"); 
      }
      $this->Erro      = new pre_lancamento_servicos_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['pre_lancamento_servicos_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['pre_lancamento_servicos_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['pre_lancamento_servicos_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "pre_lancamento_servicos_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="pre_lancamento_servicos_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="pre_lancamento_servicos_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="pre_lancamento_servicos_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_pre_lancamento_servicos_mob']) || !is_array($this->NM_ajax_info['errList']['geral_pre_lancamento_servicos_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_pre_lancamento_servicos_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_pre_lancamento_servicos_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_idespecialidade_servicos(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idespecialidade_servicos) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['Lookup_idespecialidade_servicos']) && !in_array($this->idespecialidade_servicos, $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['Lookup_idespecialidade_servicos']))
               {
                   $hasError = true;
    ...
    function ValidateField_idpessoas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idpessoas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['Lookup_idpessoas']) && !in_array($this->idpessoas, $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['Lookup_idpessoas']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idprofissional(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idprofissional) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['Lookup_idprofissional']) && !in_array($this->idprofissional, $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['Lookup_idprofissional']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_num_guia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->num_guia, 19, 0, -0, 1.0E+19, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Nº Guia; " ; 
                  if (!isset($Campos_Erros['num_guia']))
    ...
    function ValidateField_data_do_servico(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['php_cmp_required']['data_do_servico']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['php_cmp_required']['data_do_servico'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Data" ; 
              if (!isset($Campos_Erros['data_do_servico']))
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'pre_lancamento_servicos_mob_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dados_form']['anexo_guia']) && $this->anexo_guia_limpa != "S")
          {
              $this->anexo_guia = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dados_form']['anexo_guia'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idpre_lancamento']['keyVal'] = pre_lancamento_servicos_mob_pack_protect_string($this->nmgp_dados_form['idpre_lancamento']);
          }
   } // ajax_return_values
...
$aLookup[] = array(pre_lancamento_servicos_mob_pack_protect_string('') => str_replace('<', '&lt;',pre_lancamento_servicos_mob_pack_protect_string('Selecione')));
$_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['Lookup_idespecialidade_servicos'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(pre_lancamento_servicos_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', pre_lancamento_servicos_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idespecialidade_servicos']['valList'][$i] = pre_lancamento_servicos_mob_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idpessoas']['valList'][$i] = pre_lancamento_servicos_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idprofissional']['valList'][$i] = pre_lancamento_servicos_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(pre_lancamento_servicos_mob_pack_protect_string('Y') => str_replace('<', '&lt;',pre_lancamento_servicos_mob_pack_protect_string("" . $this->Ini->Nm_lang['lang_per_allday'] . "")));
$_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['Lookup___calend_all_day__'][] = 'Y';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['__calend_all_day__']['valList'][$i] = pre_lancamento_servicos_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idpre_lancamento)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opcao'] = '';
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['anexo_guia_salva'] = array(
                      'row'     => '',
              ...
              $this->nmgp_refresh_fields = array_diff(array('idpre_lancamento', 'idespecialidade_servicos', 'idpessoas', 'idprofissional', 'num_guia', 'anexo_guia', 'data_do_servico', '__calend_all_day__'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['parms'] = "idpre_lancamento?#?$this->idpre_lancamento?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['select'] = ""; 
              } 
          } 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['parms'] = "idpre_lancamento?#?$this->idpre_lancamento?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['sub_dir'][0]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out_anexo_guia))
       {
        ...
        $this->initFormPages();
    include_once("pre_lancamento_servicos_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['sc_outra_jan'] != 'pre_lancamento_servicos_mob')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
{
    $.ajax({
        url: "pre_lancamento_servicos_mob.php",
        type: "GET",
        dataType: "json",
        data: {
...
{
    $('#calendar').fullCalendar('removeEventSource', 'pre_lancamento_servicos_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
    setCategory();
    $('#calendar').fullCalendar('addEventSource', 'pre_lancamento_servicos_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
}
...
{
    tb_show('', 'pre_lancamento_servicos_mob.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
function editEvent_desktop(sEventId)
{
    tb_show('', 'pre_lancamento_servicos_mob.php?nmgp_opcao=igual_calendar&idpre_lancamento=' + sEventId + '&__orig_idpre_lancamento=' + sEventId + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
<?php
...
{
    tb_show('', 'pre_lancamento_servicos_mob.php?nmgp_opcao=importGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=150&width=400', '');
}
function mobileMenuExportClick()
{
    tb_show('', 'pre_lancamento_servicos_mob.php?nmgp_opcao=exportGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=280&width=450', '');
}
...
?>
        events: 'pre_lancamento_servicos_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
?>
        ...
        eventResize: function(event, delta, revertFunc) {
            $.post(
                'pre_lancamento_servicos_mob.php',
                {
                    'script_case_init': '<?php echo $this->Ini->sc_page ?>',
...
<?php
    ...
    function calendarOutput_formMobile()
    {
        if (isset($_SESSION['scriptcase']['device_mobile']) && $_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']) {
?>
<form name="F1" id="sc-ui-form" method="post" action="pre_lancamento_servicos.php" target="_self">
...
<?php
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['csrf_token'];
    }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "pre_lancamento_servicos_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "pre_lancamento_servicos_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos_mob']['masterValue']))
{
