...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("pre_lancamento_servicos_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('pre_lancamento_servicos_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("pre_lancamento_servicos_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['pre_lancamento_servicos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['pre_lancamento_servicos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div id="id_sc_dragdrop_anexo_guia" class="scFormDataDragNDrop"  style="<?php echo $sStyleReadInp_anexo_guia ?>"><?php echo $this->Ini->Nm_lang['lang_errm_mu_dragimg'] ?></div>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['Lookup___calend_all_day__'][] = 'Y'; ?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-6';
        $buttonMacroLabel = "";
        
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("pre_lancamento_servicos");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("pre_lancamento_servicos");
 parent.scAjaxDetailHeight("pre_lancamento_servicos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['pre_lancamento_servicos']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
