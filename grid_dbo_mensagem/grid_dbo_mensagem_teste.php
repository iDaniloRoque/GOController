<?php  
  ...
  session_start() ;
  class grid_dbo_mensagem_form_teste
  {
  function grid_dbo_mensagem_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_dbo_mensagem</FONT></B> 
<br> 
<br> 
...
sc_groups&nbsp;&nbsp;<input type=text name="sc_groups" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_dbo_mensagem"> 
</form> 
<script language=javascript> 
 document.FCons.group_id.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_dbo_mensagem_form_teste();
  $frm_teste->grid_dbo_mensagem_teste();
?>
