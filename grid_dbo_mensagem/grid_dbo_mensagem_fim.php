...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_mensagem"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Controller_____grid_dbo_mensagem"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_dbo_mensagem'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_mensagem']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_mensagem']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_mensagem']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_dbo_mensagem']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_dbo_mensagem']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_dbo_mensagem']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_dbo_mensagem']['embutida_filho'] as $ind => $sc_init)
          {
