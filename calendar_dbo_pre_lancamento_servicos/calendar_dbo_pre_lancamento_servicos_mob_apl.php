<?php
//
class calendar_dbo_pre_lancamento_servicos_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['idpessoas_profissionais']))
          {
              $this->idpessoas_profissionais = $this->NM_ajax_info['param']['idpessoas_profissionais'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['numero_da_guia']))
          {
              $this->numero_da_guia = $this->NM_ajax_info['param']['numero_da_guia'];
          }
      ...
      if (isset($this->usr_especialidade) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['usr_especialidade'] = $this->usr_especialidade;
      }
      if (isset($this->usr_idFilial) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['usr_idFilial'] = $this->usr_idFilial;
      }
      ...
      if (isset($_POST["usr_especialidade"]) && isset($this->usr_especialidade)) 
      {
          $_SESSION['usr_especialidade'] = $this->usr_especialidade;
      }
      if (isset($_POST["usr_idFilial"]) && isset($this->usr_idFilial)) 
      {
          $_SESSION['usr_idFilial'] = $this->usr_idFilial;
      }
      ...
      if (isset($_GET["usr_especialidade"]) && isset($this->usr_especialidade)) 
      {
          $_SESSION['usr_especialidade'] = $this->usr_especialidade;
      }
      if (isset($_GET["usr_idFilial"]) && isset($this->usr_idFilial)) 
      {
          $_SESSION['usr_idFilial'] = $this->usr_idFilial;
      }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_parms'];
      ...
      { 
          ...
          if (isset($this->usr_especialidade)) 
          {
              $_SESSION['usr_especialidade'] = $this->usr_especialidade;
          }
          if (!isset($this->usr_idFilial) && isset($this->usr_idfilial)) 
          {
              $this->usr_idFilial = $this->usr_idfilial;
          }
          if (isset($this->usr_idFilial)) 
          {
              $_SESSION['usr_idFilial'] = $this->usr_idFilial;
          }
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_especialidade)) 
          {
              $_SESSION['usr_especialidade'] = $this->usr_especialidade;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new calendar_dbo_pre_lancamento_servicos_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['calendar_dbo_pre_lancamento_servicos_mob']['upload_field_info']['anexo_guia'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'calendar_dbo_pre_lancamento_servicos_mob',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_dbo_pre_lancamento_servicos_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_dbo_pre_lancamento_servicos_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_dbo_pre_lancamento_servicos_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_dbo_pre_lancamento_servicos_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('calendar_dbo_pre_lancamento_servicos_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_dbo_pre_lancamento_servicos_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "calendar_dbo_pre_lancamento_servicos_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_dbo_pre_lancamento_servicos_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['calendar_dbo_pre_lancamento_servicos_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['upload_field_ul_name'][$this->anexo_guia_ul_name]))
          {
              $this->NM_ajax_info['param']['anexo_guia_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['upload_field_ul_name'][$this->anexo_guia_ul_name];
          }
      ...
      elseif (isset($this->anexo_guia_ul_name) && '' != $this->anexo_guia_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['upload_field_ul_name'][$this->anexo_guia_ul_name]))
          {
              $this->anexo_guia_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['upload_field_ul_name'][$this->anexo_guia_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_orig'] = " where idEspecialidade_servicos = " . $_SESSION['usr_especialidade'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_pesq'] = " where idEspecialidade_servicos = " . $_SESSION['usr_especialidade'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_dbo_pre_lancamento_servicos_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_dbo_pre_lancamento_servicos_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_dbo_pre_lancamento_servicos_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dados_form'];
          if (!isset($this->idpre_lancamento)){$this->idpre_lancamento = $this->nmgp_dados_form['idpre_lancamento'];} 
          if (!isset($this->mes_ano)){$this->mes_ano = $this->nmgp_dados_form['mes_ano'];} 
          if (!isset($this->idfilial)){$this->idfilial = $this->nmgp_dados_form['idfilial'];} 
          if (!isset($this->idespecialidade_servicos)){$this->idespecialidade_servicos = $this->nmgp_dados_form['idespecialidade_servicos'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("calendar_dbo_pre_lancamento_servicos_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'calendar_dbo_pre_lancamento_servicos/calendar_dbo_pre_lancamento_servicos_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'calendar_dbo_pre_lancamento_servicos_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'calendar_dbo_pre_lancamento_servicos_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'calendar_dbo_pre_lancamento_servicos_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'calendar_dbo_pre_lancamento_servicos/calendar_dbo_pre_lancamento_servicos_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "calendar_dbo_pre_lancamento_servicos_mob_erro.class.php"); 
      }
      $this->Erro      = new calendar_dbo_pre_lancamento_servicos_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_dbo_pre_lancamento_servicos_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['calendar_dbo_pre_lancamento_servicos_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['calendar_dbo_pre_lancamento_servicos_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      if (isset($this->numero_da_guia)) { $this->nm_limpa_alfa($this->numero_da_guia); }
      ...
      if (isset($this->idpessoas_profissionais)) { $this->nm_limpa_alfa($this->idpessoas_profissionais); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_idpessoas_profissionais' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idpessoas_profissionais');
          }
          if ('validate_data_do_servico' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'data_do_servico');
          }
          if ('validate_numero_da_guia' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'numero_da_guia');
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "calendar_dbo_pre_lancamento_servicos_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . "") ?></TITLE>
...
<form name="Fdown" method="get" action="calendar_dbo_pre_lancamento_servicos_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="calendar_dbo_pre_lancamento_servicos_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="calendar_dbo_pre_lancamento_servicos_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_calendar_dbo_pre_lancamento_servicos_mob']) || !is_array($this->NM_ajax_info['errList']['geral_calendar_dbo_pre_lancamento_servicos_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_calendar_dbo_pre_lancamento_servicos_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_calendar_dbo_pre_lancamento_servicos_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "idcontratos";

      if ((!is_array($filtro) && ('' == $filtro || 'idpessoas_profissionais' == $filtro)) || (is_array($filtro) && in_array('idpessoas_profissionais', $filtro)))
        $this->ValidateField_idpessoas_profissionais($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "idpessoas_profissionais";
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'numero_da_guia' == $filtro)) || (is_array($filtro) && in_array('numero_da_guia', $filtro)))
        $this->ValidateField_numero_da_guia($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $this->scFormFocusErrorName && ( !empty($Campos_Crit) || !empty($Campos_Falta) ))
          $this->scFormFocusErrorName = "numero_da_guia";
...
//---
    ...
    function ValidateField_idpessoas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->idpessoas == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['php_cmp_required']['idpessoas']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['php_cmp_required']['idpessoas'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "Pessoa Juridica" ; 
          ...
          if (!empty($this->idpessoas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas']) && !in_array($this->idpessoas, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas']))
          {
              $hasError = true;
    ...
    function ValidateField_idcontratos(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idcontratos) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idcontratos']) && !in_array($this->idcontratos, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idcontratos']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idpessoas_profissionais(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idpessoas_profissionais) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas_profissionais']) && !in_array($this->idpessoas_profissionais, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas_profissionais']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['idpessoas_profissionais']))
                   {
                       $Campos_Erros['idpessoas_profissionais'] = array();
                   }
                   $Campos_Erros['idpessoas_profissionais'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['idpessoas_profissionais']) || !is_array($this->NM_ajax_info['errList']['idpessoas_profissionais']))
                   {
                       $this->NM_ajax_info['errList']['idpessoas_profissionais'] = array();
                   }
                   $this->NM_ajax_info['errList']['idpessoas_profissionais'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'idpessoas_profissionais';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_idpessoas_profissionais
    ...
    function ValidateField_data_do_servico(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['php_cmp_required']['data_do_servico']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['php_cmp_required']['data_do_servico'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Data do Serviço" ; 
              if (!isset($Campos_Erros['data_do_servico']))
              {
                  $Campos_Erros['data_do_servico'] = array();
              }
    ...
    function ValidateField_numero_da_guia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->numero_da_guia != '')  
          { 
              $iTestSize = 19;
              if (strlen($this->numero_da_guia) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Nº da Guia: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['numero_da_guia']))
                  {
                      $Campos_Erros['numero_da_guia'] = array();
                  }
                  $Campos_Erros['numero_da_guia'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['numero_da_guia']) || !is_array($this->NM_ajax_info['errList']['numero_da_guia']))
                  {
                      $this->NM_ajax_info['errList']['numero_da_guia'] = array();
                  }
                  $this->NM_ajax_info['errList']['numero_da_guia'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->numero_da_guia, 19, 0, -0, 1.0E+19, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['numero_da_guia'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['numero_da_guia']) || !is_array($this->NM_ajax_info['errList']['numero_da_guia']))
                  {
                      $this->NM_ajax_info['errList']['numero_da_guia'] = array();
                  }
                  $this->NM_ajax_info['errList']['numero_da_guia'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'numero_da_guia';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_numero_da_guia

    function ValidateField_quantidade(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->quantidade) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_quantidade']) && !in_array($this->quantidade, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_quantidade']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_anexo_guia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            {
                $hasError = true;
                $Campos_Crit .= "Anexo Guia: " . $this->Ini->Nm_lang['lang_errm_file_invl']; 
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'calendar_dbo_pre_lancamento_servicos_mob_doc_name.php';
              }
              ...
              { 
                  ...
                  { 
                      $Campos_Crit .= "Anexo Guia " . $this->Ini->Nm_lang['lang_errm_upld']; 
                      $this->anexo_guia = "";
                      if (!isset($Campos_Erros['anexo_guia']))
                      {
                          $Campos_Erros['anexo_guia'] = array();
              ...
              { 
                  ...
                  { 
                     $Campos_Crit .= "Anexo Guia " . $this->Ini->Nm_lang['lang_errm_ivtp'];  
                      if (!isset($Campos_Erros['anexo_guia']))
                      {
                          $Campos_Erros['anexo_guia'] = array();
                      }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dados_form']['anexo_guia']) && $this->anexo_guia_limpa != "S")
          {
              $this->anexo_guia = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dados_form']['anexo_guia'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ('' !== $this->numero_da_guia || (!empty($format_fields) && isset($format_fields['numero_da_guia'])))
      {
          nmgp_Form_Num_Val($this->numero_da_guia, $this->field_config['numero_da_guia']['symbol_grp'], $this->field_config['numero_da_guia']['symbol_dec'], "0", "S", $this->field_config['numero_da_guia']['format_neg'], "", "", "-", $this->field_config['numero_da_guia']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_idpessoas_profissionais();
          $this->ajax_return_values_data_do_servico();
          $this->ajax_return_values_numero_da_guia();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idpre_lancamento']['keyVal'] = calendar_dbo_pre_lancamento_servicos_mob_pack_protect_string($this->nmgp_dados_form['idpre_lancamento']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(calendar_dbo_pre_lancamento_servicos_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', calendar_dbo_pre_lancamento_servicos_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idpessoas']['valList'][$i] = calendar_dbo_pre_lancamento_servicos_mob_pack_protect_string($v);
          }
   ...
   function ajax_return_values_idcontratos($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idcontratos", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $aLookup = array();
              $this->_tmp_lookup_idcontratos = $this->idcontratos;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idcontratos']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idcontratos'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idcontratos']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idcontratos'] = array(); 
}
if ($this->idpessoas != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idcontratos'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"idcontratos\"";
          if (isset($this->NM_ajax_info['select_html']['idcontratos']) && !empty($this->NM_ajax_info['select_html']['idcontratos']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['idcontratos']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->idcontratos == $sValue)
                  {
                      $this->_tmp_lookup_idcontratos = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['idcontratos']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['idcontratos']['valList'][$i] = calendar_dbo_pre_lancamento_servicos_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['idcontratos']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['idcontratos']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['idcontratos']['labList'] = $aLabel;
          }
   }

          //----- idpessoas_profissionais
   function ajax_return_values_idpessoas_profissionais($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idpessoas_profissionais", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->idpessoas_profissionais);
              $aLookup = array();
              $this->_tmp_lookup_idpessoas_profissionais = $this->idpessoas_profissionais;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas_profissionais']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas_profissionais'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas_profissionais']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas_profissionais'] = array(); 
}
if ($this->idcontratos != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas_profissionais'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"idpessoas_profissionais\"";
          if (isset($this->NM_ajax_info['select_html']['idpessoas_profissionais']) && !empty($this->NM_ajax_info['select_html']['idpessoas_profissionais']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['idpessoas_profissionais']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->idpessoas_profissionais == $sValue)
                  {
                      $this->_tmp_lookup_idpessoas_profissionais = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['idpessoas_profissionais'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['idpessoas_profissionais']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['idpessoas_profissionais']['valList'][$i] = calendar_dbo_pre_lancamento_servicos_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['idpessoas_profissionais']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['idpessoas_profissionais']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['idpessoas_profissionais']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_data_do_servico($bForce = false)
   {
          ...
          //----- numero_da_guia
   function ajax_return_values_numero_da_guia($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("numero_da_guia", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->numero_da_guia);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['numero_da_guia'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_quantidade($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("quantidade", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $aLookup = array();
              $this->_tmp_lookup_quantidade = $this->quantidade;

 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_quantidade']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_quantidade'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_quantidade']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_quantidade'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_quantidade'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"quantidade\"";
          if (isset($this->NM_ajax_info['select_html']['quantidade']) && !empty($this->NM_ajax_info['select_html']['quantidade']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['quantidade']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->quantidade == $sValue)
                  {
                      $this->_tmp_lookup_quantidade = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['quantidade']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['quantidade']['valList'][$i] = calendar_dbo_pre_lancamento_servicos_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['quantidade']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['quantidade']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['quantidade']['labList'] = $aLabel;
          }
   }
   ...
   $out_anexo_guia = '';
   $out1_anexo_guia = '';
   if ('' != $this->anexo_guia_ul_name && @is_file($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->anexo_guia_ul_name))
   {
       $this->anexo_guia = @file_get_contents($this->Ini->root . $this->Ini->path_imag_temp . '/' . $this->anexo_guia_ul_name);
   }
   ...
   function ajax_return_values_idpre_lancamento($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if (!isset($this->idespecialidade_servicos)){$this->idespecialidade_servicos =  $_SESSION['usr_especialidade'];}  
      if (!isset($this->mes_ano)){$this->mes_ano =  $_SESSION['usr_mesAno'];}  
      if ('incluir' == $this->nmgp_opcao && empty($this->mes_ano)) {$this->mes_ano = "" . $_SESSION['usr_mesAno'] . ""; $NM_val_null[] = "mes_ano";}  
      if (('alterar' == $this->nmgp_opcao || 'igual' == $this->nmgp_opcao) && empty($this->mes_ano)){$this->mes_ano = "" . $_SESSION['usr_mesAno'] . ""; $NM_val_null[] = "mes_ano";}  
      if ('incluir' == $this->nmgp_opcao && empty($this->idfilial)) {$this->idfilial = "" . $_SESSION['usr_idFilial'] . ""; $this->sc_force_zero[] = "idfilial";}  
      if (('alterar' == $this->nmgp_opcao || 'igual' == $this->nmgp_opcao) && empty($this->idfilial)){$this->idfilial = "" . $_SESSION['usr_idFilial'] . ""; $this->sc_force_zero[] = "idfilial";}  
      if ('incluir' == $this->nmgp_opcao && empty($this->idespecialidade_servicos)) {$this->idespecialidade_servicos = "" . $_SESSION['usr_especialidade'] . ""; $NM_val_null[] = "idespecialidade_servicos";}  
      if (('alterar' == $this->nmgp_opcao || 'igual' == $this->nmgp_opcao) && empty($this->idespecialidade_servicos)){$this->idespecialidade_servicos = "" . $_SESSION['usr_especialidade'] . ""; $NM_val_null[] = "idespecialidade_servicos";}  
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "numero_da_guia = $this->numero_da_guia, idContratos = $this->idcontratos, idPessoas = $this->idpessoas, quantidade = $this->quantidade, data_do_servico = #$this->data_do_servico#, idPessoas_profissionais = $this->idpessoas_profissionais"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "numero_da_guia = $this->numero_da_guia, idContratos = $this->idcontratos, idPessoas = $this->idpessoas, quantidade = $this->quantidade, data_do_servico = " . $this->Ini->date_delim . $this->data_do_servico . $this->Ini->date_delim1 . ", idPessoas_profissionais = $this->idpessoas_profissionais"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "numero_da_guia = $this->numero_da_guia, idContratos = $this->idcontratos, idPessoas = $this->idpessoas, quantidade = $this->quantidade, data_do_servico = EXTEND('$this->data_do_servico', YEAR TO DAY), idPessoas_profissionais = $this->idpessoas_profissionais"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['mes_ano']) && $NM_val_form['mes_ano'] != $this->nmgp_dados_select['mes_ano']) 
              { 
                  $SC_fields_update[] = "mes_ano = '$this->mes_ano'"; 
              } 
              ...
              if (isset($NM_val_form['idespecialidade_servicos']) && $NM_val_form['idespecialidade_servicos'] != $this->nmgp_dados_select['idespecialidade_servicos']) 
              { 
                  $SC_fields_update[] = "idEspecialidade_servicos = $this->idespecialidade_servicos"; 
              } 
              ...
              { 
                  if ($this->anexo_guia != "none" && $this->anexo_guia != "") 
                  { 
                      $_SESSION['scriptcase']['sc_sql_ult_comando'] = "UpdateBlob(" . $this->Ini->nm_tabela . ", Anexo_guia, " . $this->anexo_guia . ",  idPre_lancamento = $this->idpre_lancamento)"; 
                      $rs = $this->Db->UpdateBlob($this->Ini->nm_tabela, "Anexo_guia", $this->anexo_guia,  "idPre_lancamento = $this->idpre_lancamento", "image"); 
                      if ($rs === false) 
                      { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['anexo_guia_salva'] = array(
                      'row'     => '',
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['numero_da_guia'])) { $this->numero_da_guia = $NM_val_form['numero_da_guia']; }
              elseif (isset($this->numero_da_guia)) { $this->nm_limpa_alfa($this->numero_da_guia); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['idpessoas_profissionais'])) { $this->idpessoas_profissionais = $NM_val_form['idpessoas_profissionais']; }
              elseif (isset($this->idpessoas_profissionais)) { $this->nm_limpa_alfa($this->idpessoas_profissionais); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('idpessoas', 'idcontratos', 'idpessoas_profissionais', 'data_do_servico', 'numero_da_guia', 'quantidade', 'anexo_guia'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (numero_da_guia, idContratos, idPessoas, mes_ano, quantidade, data_do_servico, idPessoas_profissionais, Anexo_guia, idFilial, idEspecialidade_servicos, momento, usuario) VALUES ($this->numero_da_guia, $this->idcontratos, $this->idpessoas, '$this->mes_ano', $this->quantidade, #$this->data_do_servico#, $this->idpessoas_profissionais, '$this->anexo_guia', $this->idfilial, $this->idespecialidade_servicos, #$this->momento#, '$this->usuario')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "numero_da_guia, idContratos, idPessoas, mes_ano, quantidade, data_do_servico, idPessoas_profissionais, Anexo_guia, idFilial, idEspecialidade_servicos, momento, usuario) VALUES (" . $NM_seq_auto . "$this->numero_da_guia, $this->idcontratos, $this->idpessoas, '$this->mes_ano', $this->quantidade, " . $this->Ini->date_delim . $this->data_do_servico . $this->Ini->date_delim1 . ", $this->idpessoas_profissionais, '', $this->idfilial, $this->idespecialidade_servicos, " . $this->Ini->date_delim . $this->momento . $this->Ini->date_delim1 . ", '$this->usuario')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "numero_da_guia, idContratos, idPessoas, mes_ano, quantidade, data_do_servico, idPessoas_profissionais, Anexo_guia, idFilial, idEspecialidade_servicos, momento, usuario) VALUES (" . $NM_seq_auto . "$this->numero_da_guia, $this->idcontratos, $this->idpessoas, '$this->mes_ano', $this->quantidade, " . $this->Ini->date_delim . $this->data_do_servico . $this->Ini->date_delim1 . ", $this->idpessoas_profissionais, '', $this->idfilial, $this->idespecialidade_servicos, " . $this->Ini->date_delim . $this->momento . $this->Ini->date_delim1 . ", '$this->usuario')"; 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "numero_da_guia, idContratos, idPessoas, mes_ano, quantidade, data_do_servico, idPessoas_profissionais, Anexo_guia, idFilial, idEspecialidade_servicos, momento, usuario) VALUES (" . $NM_seq_auto . "$this->numero_da_guia, $this->idcontratos, $this->idpessoas, '$this->mes_ano', $this->quantidade, " . $this->Ini->date_delim . $this->data_do_servico . $this->Ini->date_delim1 . ", $this->idpessoas_profissionais, '$this->anexo_guia', $this->idfilial, $this->idespecialidade_servicos, " . $this->Ini->date_delim . $this->momento . $this->Ini->date_delim1 . ", '$this->usuario')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "numero_da_guia, idContratos, idPessoas, mes_ano, quantidade, data_do_servico, idPessoas_profissionais, Anexo_guia, idFilial, idEspecialidade_servicos, momento, usuario) VALUES (" . $NM_seq_auto . "$this->numero_da_guia, $this->idcontratos, $this->idpessoas, '$this->mes_ano', $this->quantidade, EXTEND('$this->data_do_servico', YEAR TO DAY), $this->idpessoas_profissionais, '$this->anexo_guia', $this->idfilial, $this->idespecialidade_servicos, EXTEND('$this->momento', YEAR TO FRACTION), '$this->usuario')"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "numero_da_guia, idContratos, idPessoas, mes_ano, quantidade, data_do_servico, idPessoas_profissionais, Anexo_guia, idFilial, idEspecialidade_servicos, momento, usuario) VALUES (" . $NM_seq_auto . "$this->numero_da_guia, $this->idcontratos, $this->idpessoas, '$this->mes_ano', $this->quantidade, " . $this->Ini->date_delim . $this->data_do_servico . $this->Ini->date_delim1 . ", $this->idpessoas_profissionais, '$this->anexo_guia', $this->idfilial, $this->idespecialidade_servicos, " . $this->Ini->date_delim . $this->momento . $this->Ini->date_delim1 . ", '$this->usuario')"; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['parms'] = "idpre_lancamento?#?$this->idpre_lancamento?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT idPre_lancamento, numero_da_guia, idContratos, idPessoas, mes_ano, quantidade, convert(char(23),data_do_servico,121), idPessoas_profissionais, Anexo_guia, idFilial, idEspecialidade_servicos, convert(char(23),momento,121), usuario from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT idPre_lancamento, numero_da_guia, idContratos, idPessoas, mes_ano, quantidade, data_do_servico, idPessoas_profissionais, Anexo_guia, idFilial, idEspecialidade_servicos, momento, usuario from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT idPre_lancamento, numero_da_guia, idContratos, idPessoas, mes_ano, quantidade, EXTEND(data_do_servico, YEAR TO DAY), idPessoas_profissionais, Anexo_guia, idFilial, idEspecialidade_servicos, EXTEND(momento, YEAR TO FRACTION), usuario from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT idPre_lancamento, numero_da_guia, idContratos, idPessoas, mes_ano, quantidade, data_do_servico, idPessoas_profissionais, Anexo_guia, idFilial, idEspecialidade_servicos, momento, usuario from " . $this->Ini->nm_tabela ; 
          ...
          $aWhere = array();
          $aWhere[] = "idEspecialidade_servicos = " . $_SESSION['usr_especialidade'] . "";
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['parms'] = "idpre_lancamento?#?$this->idpre_lancamento?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['sub_dir'][0]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['reg_start'] < $qt_geral_reg_calendar_dbo_pre_lancamento_servicos_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out_anexo_guia))
       {
        ...
        $this->initFormPages();
    include_once("calendar_dbo_pre_lancamento_servicos_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['sc_outra_jan'] != 'calendar_dbo_pre_lancamento_servicos_mob')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
{
    $.ajax({
        url: "calendar_dbo_pre_lancamento_servicos_mob.php",
        type: "GET",
        dataType: "json",
        data: {
...
{
    $('#calendar').fullCalendar('removeEventSource', 'calendar_dbo_pre_lancamento_servicos_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
    setCategory();
    $('#calendar').fullCalendar('addEventSource', 'calendar_dbo_pre_lancamento_servicos_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
}
...
{
    tb_show('', 'calendar_dbo_pre_lancamento_servicos_mob.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
function editEvent_desktop(sEventId)
{
    tb_show('', 'calendar_dbo_pre_lancamento_servicos_mob.php?nmgp_opcao=igual_calendar&idpre_lancamento=' + sEventId + '&__orig_idpre_lancamento=' + sEventId + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
<?php
...
{
    tb_show('', 'calendar_dbo_pre_lancamento_servicos_mob.php?nmgp_opcao=importGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=150&width=400', '');
}
function mobileMenuExportClick()
{
    tb_show('', 'calendar_dbo_pre_lancamento_servicos_mob.php?nmgp_opcao=exportGoogle&nmgp_outra_jan=true&script_case_init=". $this->form_encode_input($this->Ini->sc_page) ."&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=280&width=450', '');
}
...
?>
        events: 'calendar_dbo_pre_lancamento_servicos_mob.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
?>
        ...
        eventResize: function(event, delta, revertFunc) {
            $.post(
                'calendar_dbo_pre_lancamento_servicos_mob.php',
                {
                    'script_case_init': '<?php echo $this->Ini->sc_page ?>',
...
<?php
    ...
    function calendarOutput_formMobile()
    {
        if (isset($_SESSION['scriptcase']['device_mobile']) && $_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']) {
?>
<form name="F1" id="sc-ui-form" method="post" action="calendar_dbo_pre_lancamento_servicos.php" target="_self">
...
<?php
   ...
   function calendarWhere($sId, $bRecur = false, $bPrintCalendar = false, $filter = null)
   {
       ...
       $cWhere[] = "idEspecialidade_servicos = " . $_SESSION['usr_especialidade'] . "";
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_idcontratos()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idcontratos']))
{
...
{ 
   ...
   function Form_lookup_idpessoas_profissionais()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_idpessoas_profissionais']))
{
...
{ 
   ...
   function Form_lookup_quantidade()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['Lookup_quantidade']))
{
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "calendar_dbo_pre_lancamento_servicos_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "calendar_dbo_pre_lancamento_servicos_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
