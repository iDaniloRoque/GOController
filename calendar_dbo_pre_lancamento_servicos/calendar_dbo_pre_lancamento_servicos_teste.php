<?php  
  ...
  session_start() ;
  class calendar_dbo_pre_lancamento_servicos_form_teste
  {
   function calendar_dbo_pre_lancamento_servicos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "calendar_dbo_pre_lancamento_servicos/img";
...
?> 
<br> 
<B><FONT SIZE="4">calendar_dbo_pre_lancamento_servicos</FONT></B> 
<br> 
<br> 
...
usr_especialidade&nbsp;&nbsp;<input type="text" name="usr_especialidade" size=20><br> 
usr_idFilial&nbsp;&nbsp;<input type="text" name="usr_idFilial" size=20><br> 
usr_mesAno&nbsp;&nbsp;<input type="text" name="usr_mesAno" size=20><br> 
<input type="hidden" name="NM_contr_var_session" value="Yes"> 
<input type="submit" value="calendar_dbo_pre_lancamento_servicos"> 
</form> 
<script language=javascript> 
 document.Fedit.usr_especialidade.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new calendar_dbo_pre_lancamento_servicos_form_teste();
  $frm_teste->calendar_dbo_pre_lancamento_servicos_teste();
?>
