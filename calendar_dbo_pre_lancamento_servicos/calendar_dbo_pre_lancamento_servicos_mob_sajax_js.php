  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_dbo_pre_lancamento_servicos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_calendar_dbo_pre_lancamento_servicos_mob_form();
	}
...
?>
  ...
  // ---------- Validate idpessoas
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas()
  {
    var nomeCampo_idpessoas = "idpessoas";
    var var_idpessoas = scAjaxGetFieldSelect(nomeCampo_idpessoas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas(var_idpessoas, var_script_case_init, do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas_cb);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas

  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas_cb

  // ---------- Validate idcontratos
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idcontratos()
  {
    var nomeCampo_idcontratos = "idcontratos";
    var var_idcontratos = scAjaxGetFieldSelect(nomeCampo_idcontratos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idcontratos(var_idcontratos, var_script_case_init, do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idcontratos_cb);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idcontratos

  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idcontratos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idcontratos_cb

  // ---------- Validate idpessoas_profissionais
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas_profissionais()
  {
    var nomeCampo_idpessoas_profissionais = "idpessoas_profissionais";
    var var_idpessoas_profissionais = scAjaxGetFieldSelect(nomeCampo_idpessoas_profissionais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas_profissionais(var_idpessoas_profissionais, var_script_case_init, do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas_profissionais_cb);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas_profissionais

  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas_profissionais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpessoas_profissionais";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_idpessoas_profissionais_cb

  // ---------- Validate data_do_servico
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_data_do_servico()
  {
    var nomeCampo_data_do_servico = "data_do_servico";
    var var_data_do_servico = scAjaxGetFieldText(nomeCampo_data_do_servico);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_data_do_servico = scAjaxGetFieldText(nomeCampo_data_do_servico);
      x_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_data_do_servico(var_data_do_servico, var_script_case_init, do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_data_do_servico_cb);
    }, 200);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_data_do_servico

  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_data_do_servico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_do_servico";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_data_do_servico_cb

  // ---------- Validate numero_da_guia
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_numero_da_guia()
  {
    var nomeCampo_numero_da_guia = "numero_da_guia";
    var var_numero_da_guia = scAjaxGetFieldText(nomeCampo_numero_da_guia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_numero_da_guia(var_numero_da_guia, var_script_case_init, do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_numero_da_guia_cb);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_numero_da_guia

  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_numero_da_guia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero_da_guia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_numero_da_guia_cb

  // ---------- Validate quantidade
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_quantidade()
  {
    var nomeCampo_quantidade = "quantidade";
    var var_quantidade = scAjaxGetFieldSelect(nomeCampo_quantidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_quantidade(var_quantidade, var_script_case_init, do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_quantidade_cb);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_quantidade

  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_quantidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_quantidade_cb

  // ---------- Validate anexo_guia
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_anexo_guia()
  {
    var nomeCampo_anexo_guia = "anexo_guia";
    var var_anexo_guia = scAjaxGetFieldText(nomeCampo_anexo_guia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_anexo_guia(var_anexo_guia, var_script_case_init, do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_anexo_guia_cb);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_anexo_guia

  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_anexo_guia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anexo_guia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_validate_anexo_guia_cb

  // ---------- Refresh idpessoas
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idpessoas()
  {
    var var_idpessoas = scAjaxGetFieldSelect("idpessoas");
    var var_nmgp_refresh_fields = "idcontratos";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idpessoas(var_idpessoas, var_nmgp_refresh_fields, var_script_case_init, do_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idpessoas_cb);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idpessoas

  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idpessoas_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idcontratos();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idpessoas_cb

  // ---------- Refresh idcontratos
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idcontratos()
  {
    var var_idcontratos = scAjaxGetFieldSelect("idcontratos");
    var var_nmgp_refresh_fields = "idpessoas_profissionais";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idcontratos(var_idcontratos, var_nmgp_refresh_fields, var_script_case_init, do_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idcontratos_cb);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idcontratos

  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idcontratos_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_refresh_idcontratos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_dbo_pre_lancamento_servicos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpessoas = scAjaxGetFieldSelect("idpessoas");
    var var_idcontratos = scAjaxGetFieldSelect("idcontratos");
    var var_idpessoas_profissionais = scAjaxGetFieldSelect("idpessoas_profissionais");
    var var_data_do_servico = scAjaxGetFieldText("data_do_servico");
    var var_numero_da_guia = scAjaxGetFieldText("numero_da_guia");
    var var_quantidade = scAjaxGetFieldSelect("quantidade");
    var var_anexo_guia = scAjaxGetFieldText("anexo_guia");
    var var_idpre_lancamento = scAjaxGetFieldText("idpre_lancamento");
    var var_anexo_guia_ul_name = scAjaxSpecCharProtect(document.F1.anexo_guia_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_anexo_guia_ul_type = document.F1.anexo_guia_ul_type.value;
    var var_anexo_guia_limpa = document.F1.anexo_guia_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_calendar_dbo_pre_lancamento_servicos_mob_submit_form(var_idpessoas, var_idcontratos, var_idpessoas_profissionais, var_data_do_servico, var_numero_da_guia, var_quantidade, var_anexo_guia, var_idpre_lancamento, var_anexo_guia_ul_name, var_anexo_guia_ul_type, var_anexo_guia_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_dbo_pre_lancamento_servicos_mob_submit_form_cb);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_submit_form

  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("idpessoas_profissionais");
      scAjaxHideErrorDisplay("data_do_servico");
      scAjaxHideErrorDisplay("numero_da_guia");
      scAjaxHideErrorDisplay("quantidade");
      scAjaxHideErrorDisplay("anexo_guia");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.anexo_guia_limpa && document.F1.anexo_guia_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("anexo_guia", oImgTemp, "", "", "", "N");
      }
    document.F1.anexo_guia_ul_name.value = '';
    document.F1.anexo_guia_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_calendar_dbo_pre_lancamento_servicos_mob_submit_form_cb_after_alert);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_submit_form_cb
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form, function() {});
    } else {
      perform_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form();
    }
  }

  function perform_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("quantidade");
    scAjaxHideErrorDisplay("anexo_guia");
    var var_idpre_lancamento = document.F2.idpre_lancamento.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form(var_idpre_lancamento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form_cb);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_dbo_pre_lancamento_servicos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idpre_lancamento.value = scAjaxGetKeyValue("idpre_lancamento");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form_cb_after_alert);
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form_cb
  function do_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_dbo_pre_lancamento_servicos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_calendar_dbo_pre_lancamento_servicos_mob_navigate_form_cb_after_alert
  function sc_hide_calendar_dbo_pre_lancamento_servicos_mob_form()
  {
  ...
  ajax_field_list[1] = "idcontratos";
  ajax_field_list[2] = "idpessoas_profissionais";
  ajax_field_list[3] = "data_do_servico";
  ajax_field_list[4] = "numero_da_guia";
  ajax_field_list[5] = "quantidade";
  ajax_field_list[6] = "anexo_guia";
  ...
  var ajax_error_list = {
    "idpessoas": {"label": "Pessoa Juridica", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idcontratos": {"label": "Contrato", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idpessoas_profissionais": {"label": "Profissional", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_do_servico": {"label": "Data do Serviço", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numero_da_guia": {"label": "Nº da Guia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "anexo_guia": {"label": "Anexo Guia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "idpessoas_profissionais": new Array(),
    "data_do_servico": new Array(),
    "numero_da_guia": new Array(),
    "quantidade": new Array(),
    "anexo_guia": new Array()
  };
  ajax_field_mult["idpessoas"][1] = "idpessoas";
  ajax_field_mult["idcontratos"][1] = "idcontratos";
  ajax_field_mult["idpessoas_profissionais"][1] = "idpessoas_profissionais";
  ajax_field_mult["data_do_servico"][1] = "data_do_servico";
  ajax_field_mult["numero_da_guia"][1] = "numero_da_guia";
  ajax_field_mult["quantidade"][1] = "quantidade";
  ajax_field_mult["anexo_guia"][1] = "anexo_guia";
  ...
  var ajax_field_id = {
    ...
    "idpessoas_profissionais": new Array("hidden_field_label_idpessoas_profissionais", "hidden_field_data_idpessoas_profissionais"),
    "data_do_servico": new Array("hidden_field_label_data_do_servico", "hidden_field_data_data_do_servico"),
    "numero_da_guia": new Array("hidden_field_label_numero_da_guia", "hidden_field_data_numero_da_guia"),
    "quantidade": new Array("hidden_field_label_quantidade", "hidden_field_data_quantidade"),
    "anexo_guia": new Array("hidden_field_label_anexo_guia", "hidden_field_data_anexo_guia")
  };

  var ajax_read_only = {
    "idpessoas": "off",
    "idcontratos": "off",
    "idpessoas_profissionais": "off",
    "data_do_servico": "off",
    "numero_da_guia": "off",
    "quantidade": "off",
    "anexo_guia": "off"
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idpessoas_profissionais" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
