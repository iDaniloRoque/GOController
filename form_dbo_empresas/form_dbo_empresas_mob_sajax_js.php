  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_empresas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_empresas_mob_form();
	}
...
?>
  ...
  // ---------- Validate idempresa
  function do_ajax_form_dbo_empresas_mob_validate_idempresa()
  {
    var nomeCampo_idempresa = "idempresa";
    var var_idempresa = scAjaxGetFieldHidden(nomeCampo_idempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_empresas_mob_validate_idempresa(var_idempresa, var_script_case_init, do_ajax_form_dbo_empresas_mob_validate_idempresa_cb);
  } // do_ajax_form_dbo_empresas_mob_validate_idempresa

  function do_ajax_form_dbo_empresas_mob_validate_idempresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_empresas_mob_validate_idempresa_cb

  // ---------- Validate descricaoempresa
  function do_ajax_form_dbo_empresas_mob_validate_descricaoempresa()
  {
    var nomeCampo_descricaoempresa = "descricaoempresa";
    var var_descricaoempresa = scAjaxGetFieldText(nomeCampo_descricaoempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_empresas_mob_validate_descricaoempresa(var_descricaoempresa, var_script_case_init, do_ajax_form_dbo_empresas_mob_validate_descricaoempresa_cb);
  } // do_ajax_form_dbo_empresas_mob_validate_descricaoempresa

  function do_ajax_form_dbo_empresas_mob_validate_descricaoempresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descricaoempresa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_empresas_mob_validate_descricaoempresa_cb

  // ---------- Validate cnpj
  function do_ajax_form_dbo_empresas_mob_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldText(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_empresas_mob_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_form_dbo_empresas_mob_validate_cnpj_cb);
  } // do_ajax_form_dbo_empresas_mob_validate_cnpj

  function do_ajax_form_dbo_empresas_mob_validate_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cnpj";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_empresas_mob_validate_cnpj_cb

  // ---------- Validate bd
  function do_ajax_form_dbo_empresas_mob_validate_bd()
  {
    var nomeCampo_bd = "bd";
    var var_bd = scAjaxGetFieldText(nomeCampo_bd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_empresas_mob_validate_bd(var_bd, var_script_case_init, do_ajax_form_dbo_empresas_mob_validate_bd_cb);
  } // do_ajax_form_dbo_empresas_mob_validate_bd

  function do_ajax_form_dbo_empresas_mob_validate_bd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_empresas_mob_validate_bd_cb

  // ---------- Event onchange cnpj
  function do_ajax_form_dbo_empresas_mob_event_cnpj_onchange()
  {
    var var_cnpj = scAjaxGetFieldText("cnpj");
    var var_descricaoempresa = scAjaxGetFieldText("descricaoempresa");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_empresas_mob_event_cnpj_onchange(var_cnpj, var_descricaoempresa, var_script_case_init, do_ajax_form_dbo_empresas_mob_event_cnpj_onchange_cb);
  } // do_ajax_form_dbo_empresas_mob_event_cnpj_onchange

  function do_ajax_form_dbo_empresas_mob_event_cnpj_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cnpj";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_empresas_mob_event_cnpj_onchange_cb_after_alert);
  } // do_ajax_form_dbo_empresas_mob_event_cnpj_onchange_cb
  function do_ajax_form_dbo_empresas_mob_event_cnpj_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_dbo_empresas_mob_event_cnpj_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_empresas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_empresas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_descricaoempresa = scAjaxGetFieldText("descricaoempresa");
    var var_cnpj = scAjaxGetFieldText("cnpj");
    var var_bd = scAjaxGetFieldText("bd");
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_empresas_mob_submit_form(var_idempresa, var_descricaoempresa, var_cnpj, var_bd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_empresas_mob_submit_form_cb);
  } // do_ajax_form_dbo_empresas_mob_submit_form

  function do_ajax_form_dbo_empresas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("descricaoempresa");
      scAjaxHideErrorDisplay("cnpj");
      scAjaxHideErrorDisplay("bd");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_empresas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_empresas_mob_submit_form_cb
  function do_ajax_form_dbo_empresas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_empresas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_empresas_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_empresas_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_empresas_mob_navigate_form();
    }
  }

  function perform_ajax_form_dbo_empresas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_empresas_mob_navigate_form(var_idempresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_empresas_mob_navigate_form_cb);
  } // do_ajax_form_dbo_empresas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_empresas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_empresas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_empresas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_empresas_mob_navigate_form_cb
  function do_ajax_form_dbo_empresas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_empresas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_empresas_mob_navigate_form_cb_after_alert
  function sc_hide_form_dbo_empresas_mob_form()
  {
  ...
  ajax_field_list[1] = "descricaoempresa";
  ajax_field_list[2] = "cnpj";
  ajax_field_list[3] = "bd";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idempresa": {"label": "Cod.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descricaoempresa": {"label": "Descrição", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cnpj": {"label": "CNPJ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "bd": {"label": "BD", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idempresa": new Array(),
    "descricaoempresa": new Array(),
    "cnpj": new Array(),
    "bd": new Array()
  };
  ajax_field_mult["idempresa"][1] = "idempresa";
  ajax_field_mult["descricaoempresa"][1] = "descricaoempresa";
  ajax_field_mult["cnpj"][1] = "cnpj";
  ajax_field_mult["bd"][1] = "bd";

  var ajax_field_id = {
    "idempresa": new Array("hidden_field_label_idempresa", "hidden_field_data_idempresa"),
    "descricaoempresa": new Array("hidden_field_label_descricaoempresa", "hidden_field_data_descricaoempresa"),
    "cnpj": new Array("hidden_field_label_cnpj", "hidden_field_data_cnpj"),
    "bd": new Array("hidden_field_label_bd", "hidden_field_data_bd")
  };

  var ajax_read_only = {
    "idempresa": "on",
    "descricaoempresa": "off",
    "cnpj": "off",
    "bd": "off"
  };
