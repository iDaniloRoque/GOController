  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_dbo_empresas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_dbo_empresas_form();
	}
...
?>
  ...
  // ---------- Validate idempresa
  function do_ajax_form_dbo_empresas_validate_idempresa()
  {
    var nomeCampo_idempresa = "idempresa";
    var var_idempresa = scAjaxGetFieldHidden(nomeCampo_idempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_empresas_validate_idempresa(var_idempresa, var_script_case_init, do_ajax_form_dbo_empresas_validate_idempresa_cb);
  } // do_ajax_form_dbo_empresas_validate_idempresa

  function do_ajax_form_dbo_empresas_validate_idempresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_empresas_validate_idempresa_cb

  // ---------- Validate descricaoempresa
  function do_ajax_form_dbo_empresas_validate_descricaoempresa()
  {
    var nomeCampo_descricaoempresa = "descricaoempresa";
    var var_descricaoempresa = scAjaxGetFieldText(nomeCampo_descricaoempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_empresas_validate_descricaoempresa(var_descricaoempresa, var_script_case_init, do_ajax_form_dbo_empresas_validate_descricaoempresa_cb);
  } // do_ajax_form_dbo_empresas_validate_descricaoempresa

  function do_ajax_form_dbo_empresas_validate_descricaoempresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_empresas_validate_descricaoempresa_cb

  // ---------- Validate cnpj
  function do_ajax_form_dbo_empresas_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldText(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_empresas_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_form_dbo_empresas_validate_cnpj_cb);
  } // do_ajax_form_dbo_empresas_validate_cnpj

  function do_ajax_form_dbo_empresas_validate_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cnpj";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_empresas_validate_cnpj_cb

  // ---------- Validate bd
  function do_ajax_form_dbo_empresas_validate_bd()
  {
    var nomeCampo_bd = "bd";
    var var_bd = scAjaxGetFieldText(nomeCampo_bd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_dbo_empresas_validate_bd(var_bd, var_script_case_init, do_ajax_form_dbo_empresas_validate_bd_cb);
  } // do_ajax_form_dbo_empresas_validate_bd

  function do_ajax_form_dbo_empresas_validate_bd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_dbo_empresas_validate_bd_cb

  // ---------- Event onchange cnpj
  function do_ajax_form_dbo_empresas_event_cnpj_onchange()
  {
    var var_cnpj = scAjaxGetFieldText("cnpj");
    var var_descricaoempresa = scAjaxGetFieldText("descricaoempresa");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_dbo_empresas_event_cnpj_onchange(var_cnpj, var_descricaoempresa, var_script_case_init, do_ajax_form_dbo_empresas_event_cnpj_onchange_cb);
  } // do_ajax_form_dbo_empresas_event_cnpj_onchange

  function do_ajax_form_dbo_empresas_event_cnpj_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cnpj";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_dbo_empresas_event_cnpj_onchange_cb_after_alert);
  } // do_ajax_form_dbo_empresas_event_cnpj_onchange_cb
  function do_ajax_form_dbo_empresas_event_cnpj_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_dbo_empresas_event_cnpj_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_dbo_empresas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_dbo_empresas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_dbo_empresas_submit_form(var_idempresa, var_descricaoempresa, var_cnpj, var_bd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_dbo_empresas_submit_form_cb);
  } // do_ajax_form_dbo_empresas_submit_form

  function do_ajax_form_dbo_empresas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_dbo_empresas_submit_form_cb_after_alert);
  } // do_ajax_form_dbo_empresas_submit_form_cb
  function do_ajax_form_dbo_empresas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_dbo_empresas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_dbo_empresas_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_dbo_empresas_navigate_form, function() {});
    } else {
      perform_ajax_form_dbo_empresas_navigate_form();
    }
  }

  function perform_ajax_form_dbo_empresas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_dbo_empresas_navigate_form(var_idempresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_dbo_empresas_navigate_form_cb);
  } // do_ajax_form_dbo_empresas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_empresas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_dbo_empresas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_dbo_empresas_navigate_form_cb_after_alert);
  } // do_ajax_form_dbo_empresas_navigate_form_cb
  function do_ajax_form_dbo_empresas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_dbo_empresas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_dbo_empresas_navigate_form_cb_after_alert
  function sc_hide_form_dbo_empresas_form()
  {
