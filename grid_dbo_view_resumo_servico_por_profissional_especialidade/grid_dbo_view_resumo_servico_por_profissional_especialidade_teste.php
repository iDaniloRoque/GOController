<?php  
  ...
  session_start() ;
  class grid_dbo_view_resumo_servico_por_profissional_especialidade_form_teste
  {
  function grid_dbo_view_resumo_servico_por_profissional_especialidade_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_dbo_view_resumo_servico_por_profissional_especialidade</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="./" 
               target="_self"> 
usr_company&nbsp;&nbsp;<input type=text name="usr_company" size=20><br> 
usr_idPessoas&nbsp;&nbsp;<input type=text name="usr_idPessoas" size=20><br> 
usr_dt_inicial&nbsp;&nbsp;<input type=text name="usr_dt_inicial" size=20><br> 
usr_dt_final&nbsp;&nbsp;<input type=text name="usr_dt_final" size=20><br> 
usr_cab&nbsp;&nbsp;<input type=text name="usr_cab" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="grid_dbo_view_resumo_servico_por_profissional_especialidade"> 
</form> 
<script language=javascript> 
 document.FCons.usr_company.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new grid_dbo_view_resumo_servico_por_profissional_especialidade_form_teste();
  $frm_teste->grid_dbo_view_resumo_servico_por_profissional_especialidade_teste();
?>
