...
class grid_dbo_view_resumo_servico_por_profissional_especialidade_res_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xml()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo      .= ".xml";
      $this->Tit_doc       = "grid_dbo_view_resumo_servico_por_profissional_especialidade.xml";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_name'] .= ".xml";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_res_grid']) && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_return']);
   ...
   function grava_arquivo()
   {
      ...
      if ($this->New_Format)
      {
          fwrite($xml_f, "<grid_dbo_view_resumo_servico_por_profissional_especialidade>\r\n");
      }
      if ($this->Grava_view)
      {
          ...
          if ($this->New_Format)
          {
              fwrite($xml_v, "<grid_dbo_view_resumo_servico_por_profissional_especialidade>\r\n");
          }
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_res_file']['xml'] = $this->Xml_f;
          if ($this->Grava_view)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_res_file']['view'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo_view;
          }
      }
   ...
   function grava_linha($xml_f)
   {
      ...
      foreach ($this->array_linhas as $lines)
      {
          ...
          if (!$this->New_Format)
          {
              $xml_registro = "<grid_dbo_view_resumo_servico_por_profissional_especialidade";
          }
          foreach ($lines as $columns)
          {
              if (0 <= $columns['level'])
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_dbo_view_resumo_servico_por_profissional_especialidade']['xml_return']); ?>"> 
</FORM> 
</td></tr></table>
</BODY>
</HTML>
