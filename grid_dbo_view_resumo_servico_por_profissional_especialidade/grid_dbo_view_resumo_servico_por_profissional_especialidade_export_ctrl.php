<?php
@session_start() ;
$_SESSION['scriptcase']['grid_dbo_view_resumo_servico_por_profissional_especialidade']['sc_process_barr'] = true;
require_once('../grid_dbo_view_resumo_servico_por_profissional_especialidade/index.php');
unset($_SESSION['scriptcase']['grid_dbo_view_resumo_servico_por_profissional_especialidade']['sc_process_barr']);
$ExportCtrl = new grid_dbo_view_resumo_servico_por_profissional_especialidade_export_control;
$ExportCtrl->Export_barr();

class grid_dbo_view_resumo_servico_por_profissional_especialidade_export_control
{
