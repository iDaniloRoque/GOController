...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_dbo_pessoa_juridica_fisica_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_dbo_pessoa_juridica_fisica_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_dbo_pessoa_juridica_fisica_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_dbo_pessoa_juridica_fisica'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_dbo_pessoa_juridica_fisica'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idpessoas_label" id="hidden_field_label_idpessoas" style="<?php echo $sStyleHidden_idpessoas; ?>"><span id="id_label_idpessoas"><?php echo $this->nm_new_label['idpessoas']; ?></span></TD>
    <TD class="scFormDataOdd css_idpessoas_line" id="hidden_field_data_idpessoas" style="<?php echo $sStyleHidden_idpessoas; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idpessoas_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_idpessoas" class="css_idpessoas_line" style="<?php echo $sStyleReadLab_idpessoas; ?>"><?php echo $this->form_format_readonly("idpessoas", $this->form_encode_input($this->idpessoas)); ?></span><span id="id_read_off_idpessoas" class="css_read_off_idpessoas" style="<?php echo $sStyleReadInp_idpessoas; ?>"><input type="hidden" name="idpessoas" value="<?php echo $this->form_encode_input($idpessoas) . "\">"?><span id="id_ajax_label_idpessoas"><?php echo nl2br($idpessoas); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idempresa_line" id="hidden_field_data_idempresa" style="<?php echo $sStyleHidden_idempresa; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idempresa_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_pessoa_label" id="hidden_field_label_tipo_pessoa" style="<?php echo $sStyleHidden_tipo_pessoa; ?>"><span id="id_label_tipo_pessoa"><?php echo $this->nm_new_label['tipo_pessoa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['php_cmp_required']['tipo_pessoa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['php_cmp_required']['tipo_pessoa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_tipo_pessoa_line" id="hidden_field_data_tipo_pessoa" style="<?php echo $sStyleHidden_tipo_pessoa; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_pessoa_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['Lookup_tipo_pessoa'][] = ''; ?>
 <option value="">Selecionar</option>
 <option  value="PJ" <?php  if ($this->tipo_pessoa == "PJ") { echo " selected" ;} ?>>Pessoa Juridica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['Lookup_tipo_pessoa'][] = 'PJ'; ?>
 <option  value="PF" <?php  if ($this->tipo_pessoa == "PF") { echo " selected" ;} ?>>Pessoa Fisica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['Lookup_tipo_pessoa'][] = 'PF'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cpf_cnpj_label" id="hidden_field_label_cpf_cnpj" style="<?php echo $sStyleHidden_cpf_cnpj; ?>"><span id="id_label_cpf_cnpj"><?php echo $this->nm_new_label['cpf_cnpj']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['php_cmp_required']['cpf_cnpj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['php_cmp_required']['cpf_cnpj'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_cpf_cnpj_line" id="hidden_field_data_cpf_cnpj" style="<?php echo $sStyleHidden_cpf_cnpj; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cpf_cnpj_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_rg_inscricao_est_label" id="hidden_field_label_rg_inscricao_est" style="<?php echo $sStyleHidden_rg_inscricao_est; ?>"><span id="id_label_rg_inscricao_est"><?php echo $this->nm_new_label['rg_inscricao_est']; ?></span></TD>
    <TD class="scFormDataOdd css_rg_inscricao_est_line" id="hidden_field_data_rg_inscricao_est" style="<?php echo $sStyleHidden_rg_inscricao_est; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rg_inscricao_est_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nome_razao_social_label" id="hidden_field_label_nome_razao_social" style="<?php echo $sStyleHidden_nome_razao_social; ?>"><span id="id_label_nome_razao_social"><?php echo $this->nm_new_label['nome_razao_social']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['php_cmp_required']['nome_razao_social']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['php_cmp_required']['nome_razao_social'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_inscricao_municipal_label" id="hidden_field_label_inscricao_municipal" style="<?php echo $sStyleHidden_inscricao_municipal; ?>"><span id="id_label_inscricao_municipal"><?php echo $this->nm_new_label['inscricao_municipal']; ?></span></TD>
    <TD class="scFormDataOdd css_inscricao_municipal_line" id="hidden_field_data_inscricao_municipal" style="<?php echo $sStyleHidden_inscricao_municipal; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_inscricao_municipal_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_telefone_line" id="hidden_field_data_telefone" style="<?php echo $sStyleHidden_telefone; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_telefone_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_contato_label" id="hidden_field_label_contato" style="<?php echo $sStyleHidden_contato; ?>"><span id="id_label_contato"><?php echo $this->nm_new_label['contato']; ?></span></TD>
    <TD class="scFormDataOdd css_contato_line" id="hidden_field_data_contato" style="<?php echo $sStyleHidden_contato; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_contato_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_logradouro_label" id="hidden_field_label_logradouro" style="<?php echo $sStyleHidden_logradouro; ?>"><span id="id_label_logradouro"><?php echo $this->nm_new_label['logradouro']; ?></span></TD>
    <TD class="scFormDataOdd css_logradouro_line" id="hidden_field_data_logradouro" style="<?php echo $sStyleHidden_logradouro; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_logradouro_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_uf_line" id="hidden_field_data_uf" style="<?php echo $sStyleHidden_uf; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_uf_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_abertura_pessoas_label" id="hidden_field_label_data_abertura_pessoas" style="<?php echo $sStyleHidden_data_abertura_pessoas; ?>"><span id="id_label_data_abertura_pessoas"><?php echo $this->nm_new_label['data_abertura_pessoas']; ?></span></TD>
    <TD class="scFormDataOdd css_data_abertura_pessoas_line" id="hidden_field_data_data_abertura_pessoas" style="<?php echo $sStyleHidden_data_abertura_pessoas; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_abertura_pessoas_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_conselhosimounao_label" id="hidden_field_label_conselhosimounao" style="<?php echo $sStyleHidden_conselhosimounao; ?>"><span id="id_label_conselhosimounao"><?php echo $this->nm_new_label['conselhosimounao']; ?></span></TD>
    <TD class="scFormDataOdd css_conselhosimounao_line" id="hidden_field_data_conselhosimounao" style="<?php echo $sStyleHidden_conselhosimounao; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_conselhosimounao_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['Lookup_conselhosimounao'][] = ''; ?>
 <option value="">Selecione</option>
 <option  value="S" <?php  if ($this->conselhosimounao == "S") { echo " selected" ;} ?>>Sim</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['Lookup_conselhosimounao'][] = 'S'; ?>
 <option  value="N" <?php  if ($this->conselhosimounao == "N") { echo " selected" ;} ?>>Não</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['Lookup_conselhosimounao'][] = 'N'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_idconselho_classe_label" id="hidden_field_label_idconselho_classe" style="<?php echo $sStyleHidden_idconselho_classe; ?>"><span id="id_label_idconselho_classe"><?php echo $this->nm_new_label['idconselho_classe']; ?></span></TD>
    <TD class="scFormDataOdd css_idconselho_classe_line" id="hidden_field_data_idconselho_classe" style="<?php echo $sStyleHidden_idconselho_classe; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idconselho_classe_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numero_conselho_label" id="hidden_field_label_numero_conselho" style="<?php echo $sStyleHidden_numero_conselho; ?>"><span id="id_label_numero_conselho"><?php echo $this->nm_new_label['numero_conselho']; ?></span></TD>
    <TD class="scFormDataOdd css_numero_conselho_line" id="hidden_field_data_numero_conselho" style="<?php echo $sStyleHidden_numero_conselho; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numero_conselho_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Socios'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Socios'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Socios'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_socios']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init'] ]['form_dbo_pessoa_juridica_fisica']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_dbo_pessoa_juridica_fisica_empty.htm' : $this->Ini->link_form_dbo_pessoa_juridica_fisica_socios_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_Socios']) && 'nmsc_iframe_liga_form_dbo_pessoa_juridica_fisica_socios' != $this->Ini->sc_lig_target['C_@scinf_Socios'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Socios'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_socios_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_dbo_pessoa_juridica_fisica_socios"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_dbo_pessoa_juridica_fisica_socios"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_impostos'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_impostos'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_impostos'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica_impostos']['embutida_parms'] = "usr_idpessoas*scin" . $this->nmgp_dados_form['idpessoas'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init'] ]['form_dbo_pessoa_juridica_fisica']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_dbo_pessoa_juridica_fisica_empty.htm' : $this->Ini->link_form_dbo_pessoa_juridica_fisica_impostos_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_impostos']) && 'nmsc_iframe_liga_form_dbo_pessoa_juridica_fisica_impostos' != $this->Ini->sc_lig_target['C_@scinf_impostos'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_impostos'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['form_dbo_pessoa_juridica_fisica_impostos_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_dbo_pessoa_juridica_fisica_impostos"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_dbo_pessoa_juridica_fisica_impostos"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_dbo_pessoa_juridica_fisica");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_dbo_pessoa_juridica_fisica");
 parent.scAjaxDetailHeight("form_dbo_pessoa_juridica_fisica", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_dbo_pessoa_juridica_fisica']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
